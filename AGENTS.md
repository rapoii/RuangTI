...
- **Cakupan Domain Teknik Industri (742 Modul Knowledge Base Spesialis, Profesi Industri & Kurikulum Fundamental TI)**:
...
│   └── knowledge/         # 742 Modul Markdown Knowledge Base Teknik Industri
├── lib/
