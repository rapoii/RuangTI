...
GOLD_QUERIES = [
    ...
    {"q": "algoritma vehicle routing problem untuk pendistribusian barang", "module": "027", "alt_modules": ["407", "047"]},
    {"q": "pengukuran beban kerja mental dengan nasa tlx", "module": "028", "alt_modules": ["398", "169"]},
    {"q": "efek bullwhip pada peramalan permintaan rantai pasok", "module": "035"},
    {"q": "langkah menyusun fmea analisis mode kegagalan", "module": "043", "alt_modules": ["770"]},
    {"q": "algoritma craft dan corelap tata letak pabrik", "module": "044"},
    {"q": "teori permainan game theory dalam negosiasi rantai pasok", "module": "045"},
    ...
    {"q": "blockchain untuk transparansi dan traceability rantai pasok", "module": "057", "alt_modules": ["771"]},
    {"q": "logistik rantai dingin cold chain produk farmasi", "module": "060", "alt_modules": ["772"]},
    {"q": "perhitungan topsis memilih supplier terbaik", "module": "063", "alt_modules": ["125"]},
    {"q": "navigasi agv dan collision avoidance jalur otomatis", "module": "073", "alt_modules": ["520"]},
