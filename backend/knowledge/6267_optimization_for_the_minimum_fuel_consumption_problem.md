# 6267 — Operations Research & Large-Scale Optimization: Optimization for the minimum fuel consumption problem of a hybrid electric vehicle using mixed-integer linear programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimization for the minimum fuel consumption problem of a hybrid electric vehicle using mixed-integer linear programming  
**Jurnal & Sitasi Utama:** Gentaro Yamanaka, Masakatsu Kuroishi, Tadayoshi Matsumori (2023). *Engineering Optimization*. DOI: [10.1080/0305215x.2022.2098282](10.1080/0305215x.2022.2098282)  
**Sitasi Pendukung:** Gabriel Bayá, Eduardo Canale, Sergio Nesmachnow (2022). *Applied Sciences*. DOI: [10.3390/app12168212](10.3390/app12168212)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gentaro Yamanaka, Masakatsu Kuroishi, Tadayoshi Matsumori (2023) dalam jurnal *Engineering Optimization* (DOI: 10.1080/0305215x.2022.2098282) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Gabriel Bayá, Eduardo Canale, Sergio Nesmachnow (2022) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
