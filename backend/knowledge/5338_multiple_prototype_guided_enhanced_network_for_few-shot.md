# 5338 — Industrial Artificial Intelligence & Data Analytics: Multiple Prototype Guided Enhanced Network for Few-Shot Steel Surface Defect Segmentation

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Multiple Prototype Guided Enhanced Network for Few-Shot Steel Surface Defect Segmentation  
**Jurnal & Sitasi Utama:** Chen Liang, Shuang Bai (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10604061](10.1109/cvidl62147.2024.10604061)  
**Sitasi Pendukung:** Rana Alrayes, Atta Rahman (2026). *Computers*. DOI: [10.3390/computers15070417](10.3390/computers15070417)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chen Liang, Shuang Bai (2024) dalam jurnal *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl62147.2024.10604061) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Rana Alrayes, Atta Rahman (2026) yang dipublikasikan dalam *Computers* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
