# 5446 — Operations Research & Large-Scale Optimization: An Exact Algorithm for Network Dismantling Based on Logic-Based Benders Decomposition

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An Exact Algorithm for Network Dismantling Based on Logic-Based Benders Decomposition  
**Jurnal & Sitasi Utama:** Fangcheng Xiao, Xinhao Cui, Rui Luo (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6832358](10.2139/ssrn.6832358)  
**Sitasi Pendukung:** Mohammad A.M. Abdel-Aal, Md. Aqib Aman, Ashiqur Rahman Ashiq (2026). *Advanced Engineering Informatics*. DOI: [10.1016/j.aei.2026.104527](10.1016/j.aei.2026.104527)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fangcheng Xiao, Xinhao Cui, Rui Luo (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6832358) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The network dismantling problem seeks to identify the minimum set of nodes whose removal can completely disrupt a target network. This problem is critical for applications in rumor containment, epidemic control, and infrastructure protection. However, as a combinatorial optimization problem, it has been proven to be NP-hard. Due to complex topological structures and nonlinear node interactions, current research primarily relies on heuristic and learning-based methods; however, there remains a scarcity of mathematical models and exact algorithms capable of precisely formulating the network dismantling problem. In this paper, we first propose an Integer Linear Programming (ILP) model inspired by the network partitioning. Both theoretical analysis and experimental results demonstrate the validity and accuracy of the proposed ILP model in representing the network dismantling problem. Subsequently, we develop an exact algorithm based on Branch &amp;amp; Check framework. In addition, four acceleration strategies are proposed to enhance computational efficiency. Experimental results demonstrate that the proposed algorithm efficiently finds optimal solutions for various network topologies. In terms of efficiency, the algorithm outperforms commercial solvers and traditional Logic-Based Benders Decomposition (LBBD), while achieving superior solution quality compared to state-of-the-art heuristics. To our best knowledge, the proposed exact algorithm provides the benchmark for networks w"

Penelitian pendukung oleh Mohammad A.M. Abdel-Aal, Md. Aqib Aman, Ashiqur Rahman Ashiq (2026) yang dipublikasikan dalam *Advanced Engineering Informatics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
