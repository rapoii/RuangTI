# 3108 — Manufacturing Systems & Cyber-Physical Production: Towards Asset Administration Shell-Based Resource Virtualization in 5G Architecture-Enabled Cyber-Physical Production Systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Towards Asset Administration Shell-Based Resource Virtualization in 5G Architecture-Enabled Cyber-Physical Production Systems  
**Jurnal & Sitasi Utama:** Daniel Stock, Matthias Schneider, Thomas Bauernhansl (2021). *Procedia CIRP*. DOI: [10.1016/j.procir.2021.11.159](10.1016/j.procir.2021.11.159)  
**Sitasi Pendukung:** Thumeera R. Wanasinghe, Trung Q. Trinh, Trung Nguyen (2021). *IEEE Access*. DOI: [10.1109/access.2021.3103680](10.1109/access.2021.3103680)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Daniel Stock, Matthias Schneider, Thomas Bauernhansl (2021) dalam jurnal *Procedia CIRP* (DOI: 10.1016/j.procir.2021.11.159) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "One core characteristic of cyber-physical production systems (CPPS) is their architecture, which is based on service-oriented paradigms interconnecting operational technology (OT) and information technology (IT) components. With the advent of 5G architectures in production environments communication technology components become more prevalent and integral parts of a CPPS. To keep the complexity manageable all components of the ICT and OT realms need to be integrated in a unifying approach. This paper proposes a concept on how to virtualize ICT and OT resources by using Industrie 4.0 Asset Administration Shells and their respective submodels as an enabler for interoperability in CPPS."

Penelitian pendukung oleh Thumeera R. Wanasinghe, Trung Q. Trinh, Trung Nguyen (2021) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
