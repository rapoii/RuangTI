# 6215 — Operations Research & Large-Scale Optimization: A column generation approach for an inventory routing problem with fuzzy time windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A column generation approach for an inventory routing problem with fuzzy time windows  
**Jurnal & Sitasi Utama:** Amir Saeed Nikkhah Qamsari, Seyyed-Mahdi Hosseini-Motlagh, Seyed Farid Ghannadpour (2022). *Operational Research*. DOI: [10.1007/s12351-020-00593-3](10.1007/s12351-020-00593-3)  
**Sitasi Pendukung:** Yukang Su, Shuo Zhang, Chengning Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4685925](10.2139/ssrn.4685925)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amir Saeed Nikkhah Qamsari, Seyyed-Mahdi Hosseini-Motlagh, Seyed Farid Ghannadpour (2022) dalam jurnal *Operational Research* (DOI: 10.1007/s12351-020-00593-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yukang Su, Shuo Zhang, Chengning Zhang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
