# Modul Komprehensif: Game Theory Lanjutan: Non-Cooperative Games, Nash Equilibrium, & Stackelberg Model
**Nomor Modul:** [386]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Game Theory for Applied Economists (Robert Gibbons), European Journal of Operational Research (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Game Theory Lanjutan: Non-Cooperative Games, Nash Equilibrium, & Stackelberg Model**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Normal Form Games, Best Response Functions, Pure & Mixed Strategy Nash Equilibrium, Stackelberg Leader-Follower Supply Chain Pricing Games.
...
```python
# Algoritma Solusi Terapan untuk Game Theory Lanjutan: Non-Cooperative Games, Nash Equilibrium, & Stackelberg Model
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Desain Kontrak Revenue-Sharing untuk Mengeliminasi Double Marginalization antara Manufaktur dan Distributor.
...
1. Game Theory for Applied Economists (Robert Gibbons), European Journal of Operational Research (2024).
