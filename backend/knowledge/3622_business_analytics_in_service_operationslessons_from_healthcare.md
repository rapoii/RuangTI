# 3622 — Applied Statistics & Stochastic Modeling: Business analytics in service operations—Lessons from healthcare operations

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Business analytics in service operations—Lessons from healthcare operations  
**Jurnal & Sitasi Utama:** Opher Baron (2021). *Naval Research Logistics (NRL)*. DOI: [10.1002/nav.22011](10.1002/nav.22011)  
**Sitasi Pendukung:** Elena Zhbankova, Abdukodir Khakimov, Ekaterina Markova (2023). *Sensors*. DOI: [10.3390/s23198238](10.3390/s23198238)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Opher Baron (2021) dalam jurnal *Naval Research Logistics (NRL)* (DOI: 10.1002/nav.22011) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
