# 3533 — Production Planning & Inventory Control: An IoT-Enabled Real-Time Dynamic Scheduler for Flexible Job Shop Scheduling (FJSS) in an Industry 4.0-Based Manufacturing Execution System (MES 4.0)

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** An IoT-Enabled Real-Time Dynamic Scheduler for Flexible Job Shop Scheduling (FJSS) in an Industry 4.0-Based Manufacturing Execution System (MES 4.0)  
**Jurnal & Sitasi Utama:** Anum Tariq, Shoab Ahmed Khan, Wasi Haider But (2024). *IEEE Access*. DOI: [10.1109/access.2024.3384252](10.1109/access.2024.3384252)  
**Sitasi Pendukung:** Yining Chen (2023). *Journal of Enterprise and Business Intelligence*. DOI: [10.53759/5181/jebi202303007](10.53759/5181/jebi202303007)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anum Tariq, Shoab Ahmed Khan, Wasi Haider But (2024) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2024.3384252) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yining Chen (2023) yang dipublikasikan dalam *Journal of Enterprise and Business Intelligence* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
