# 5032 — Applied Statistics & Stochastic Modeling: Forecasting Carbon Emission Using ETS Exponential Smoothing, ARIMA and Regression with ARIMA errors Techniques

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Forecasting Carbon Emission Using ETS Exponential Smoothing, ARIMA and Regression with ARIMA errors Techniques  
**Jurnal & Sitasi Utama:** Jiali Feng, Baoli Huang (2024). *International Journal of Engineering and Technology*. DOI: [10.7763/ijet.2024.v16.1267](10.7763/ijet.2024.v16.1267)  
**Sitasi Pendukung:** Harpreet Singh (2020). *International Journal of Operational Research*. DOI: [10.1504/ijor.2020.10020915](10.1504/ijor.2020.10020915)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiali Feng, Baoli Huang (2024) dalam jurnal *International Journal of Engineering and Technology* (DOI: 10.7763/ijet.2024.v16.1267) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Forecasting Carbon Emissions Using Time Series Analysis Global warming is one of the most difficult and complex problems facing the world today, and forecasting carbon emissions has become a worldwide challenge. In this study, we try to use three models Exponential Smoothing (ETS) model, seasonal ARIMA and error regression Autoregressive Integrated Moving Average (ARIMA) model to train the data of carbon dioxide emissions in a region of the United States from 1990 to 2015, to simulate and forecast the carbon emissions in the United States, and to find out the optimal forecasting model."

Penelitian pendukung oleh Harpreet Singh (2020) yang dipublikasikan dalam *International Journal of Operational Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
