# 4948 — Applied Statistics & Stochastic Modeling: The strong law of large numbers and a functional central limit theorem for general markov additive processes

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** The strong law of large numbers and a functional central limit theorem for general markov additive processes  
**Jurnal & Sitasi Utama:** A. E. Kyprianou, V. Rivero (2026). *Queueing Systems*. DOI: [10.1007/s11134-025-09963-0](10.1007/s11134-025-09963-0)  
**Sitasi Pendukung:** Yueyang Zhong, Ragavendran Gopalakrishnan, Amy Ward (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4430477](10.2139/ssrn.4430477)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari A. E. Kyprianou, V. Rivero (2026) dalam jurnal *Queueing Systems* (DOI: 10.1007/s11134-025-09963-0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yueyang Zhong, Ragavendran Gopalakrishnan, Amy Ward (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
