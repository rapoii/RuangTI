# 4210 — Applied Statistics & Stochastic Modeling: Optimization of production parameters for rice husk ash-based geopolymer cement using response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Optimization of production parameters for rice husk ash-based geopolymer cement using response surface methodology  
**Jurnal & Sitasi Utama:** Kasumba A. Buyondo, Peter Wilberforce Olupot, John Baptist Kirabira (2020). *Case Studies in Construction Materials*. DOI: [10.1016/j.cscm.2020.e00461](10.1016/j.cscm.2020.e00461)  
**Sitasi Pendukung:** Nan Jiang, Yonghe Zhao, Kefeng Shang (2020). *Journal of Hazardous Materials*. DOI: [10.1016/j.jhazmat.2020.122365](10.1016/j.jhazmat.2020.122365)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kasumba A. Buyondo, Peter Wilberforce Olupot, John Baptist Kirabira (2020) dalam jurnal *Case Studies in Construction Materials* (DOI: 10.1016/j.cscm.2020.e00461) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nan Jiang, Yonghe Zhao, Kefeng Shang (2020) yang dipublikasikan dalam *Journal of Hazardous Materials* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
