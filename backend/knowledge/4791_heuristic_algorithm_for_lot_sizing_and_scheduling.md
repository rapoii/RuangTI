# 4791 — Production Planning & Inventory Control: Heuristic Algorithm for Lot Sizing and Scheduling on Identical Parallel Machines

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Heuristic Algorithm for Lot Sizing and Scheduling on Identical Parallel Machines  
**Jurnal & Sitasi Utama:** Roger Książek (2022). *Decision Making in Manufacturing and Services*. DOI: [10.7494/dmms.2022.16.4105](10.7494/dmms.2022.16.4105)  
**Sitasi Pendukung:** Daryna Dziuba, Christian Almeder (2023). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2023.06.002](10.1016/j.ejor.2023.06.002)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Roger Książek (2022) dalam jurnal *Decision Making in Manufacturing and Services* (DOI: 10.7494/dmms.2022.16.4105) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
