# 4077 — Production Planning & Inventory Control: Delayed control model for multi-stage closed-loop continuous MRP with rework and recycle

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Delayed control model for multi-stage closed-loop continuous MRP with rework and recycle  
**Jurnal & Sitasi Utama:** Mahdi Miri, Kash Barker, Andrés D. González (2025). *Journal of Industrial and Management Optimization*. DOI: [10.3934/jimo.2026019](10.3934/jimo.2026019)  
**Sitasi Pendukung:** Ayman R. Mohammed, Ahmad Abu Sleem, Mohammad A. M. Abdel-Aal (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2402.11306](10.48550/arxiv.2402.11306)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahdi Miri, Kash Barker, Andrés D. González (2025) dalam jurnal *Journal of Industrial and Management Optimization* (DOI: 10.3934/jimo.2026019) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ayman R. Mohammed, Ahmad Abu Sleem, Mohammad A. M. Abdel-Aal (2024) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
