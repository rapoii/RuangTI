# 4790 — Production Planning & Inventory Control: Dynamic Uncertainty Lot Sizing Model: Formulation, Solution Methods, and Potential Over the Static-Dynamic Uncertainty Model

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Dynamic Uncertainty Lot Sizing Model: Formulation, Solution Methods, and Potential Over the Static-Dynamic Uncertainty Model  
**Jurnal & Sitasi Utama:** Dirk Briskorn, Thomas Wensing (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4551195](10.2139/ssrn.4551195)  
**Sitasi Pendukung:** Roger Książek (2022). *Decision Making in Manufacturing and Services*. DOI: [10.7494/dmms.2022.16.4105](10.7494/dmms.2022.16.4105)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dirk Briskorn, Thomas Wensing (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4551195) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Roger Książek (2022) yang dipublikasikan dalam *Decision Making in Manufacturing and Services* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
