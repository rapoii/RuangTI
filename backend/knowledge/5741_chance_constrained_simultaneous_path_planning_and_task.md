# 5741 — Operations Research & Large-Scale Optimization: Chance Constrained Simultaneous Path Planning and Task Assignment for Multiple Robots with Stochastic Path Costs

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance Constrained Simultaneous Path Planning and Task Assignment for Multiple Robots with Stochastic Path Costs  
**Jurnal & Sitasi Utama:** Fan Yang, Nilanjan Chakraborty (2020). *2020 IEEE International Conference on Robotics and Automation (ICRA)*. DOI: [10.1109/icra40945.2020.9197354](10.1109/icra40945.2020.9197354)  
**Sitasi Pendukung:** Mehmet Pınarbaşı, Hacı Mehmet Alakaş (2020). *Engineering Optimization*. DOI: [10.1080/0305215x.2020.1716746](10.1080/0305215x.2020.1716746)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fan Yang, Nilanjan Chakraborty (2020) dalam jurnal *2020 IEEE International Conference on Robotics and Automation (ICRA)* (DOI: 10.1109/icra40945.2020.9197354) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mehmet Pınarbaşı, Hacı Mehmet Alakaş (2020) yang dipublikasikan dalam *Engineering Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
