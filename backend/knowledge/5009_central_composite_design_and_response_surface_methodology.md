# 5009 — Applied Statistics & Stochastic Modeling: Central Composite Design and Response Surface Methodology for Optimizing the Diameter of Electrospun Polyamide-6,6 Nanofiber Mat

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Central Composite Design and Response Surface Methodology for Optimizing the Diameter of Electrospun Polyamide-6,6 Nanofiber Mat  
**Jurnal & Sitasi Utama:** Saleh S. Abdelhady, Ashraf A. Ali, Said H. Zoalfakar (2024). *Nano*. DOI: [10.1142/s179329202450022x](10.1142/s179329202450022x)  
**Sitasi Pendukung:** Vaitheki Subburaj, Karthikeyan Ganesan (2025). *Asia-Pacific Journal of Chemical Engineering*. DOI: [10.1002/apj.70099](10.1002/apj.70099)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Saleh S. Abdelhady, Ashraf A. Ali, Said H. Zoalfakar (2024) dalam jurnal *Nano* (DOI: 10.1142/s179329202450022x) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
