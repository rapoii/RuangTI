# 3331 — Manufacturing Systems & Cyber-Physical Production: Analysis-oriented structure for runtime data in Industry 4.0 asset administration shells

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Analysis-oriented structure for runtime data in Industry 4.0 asset administration shells  
**Jurnal & Sitasi Utama:** Endre Sølvsberg, Christian Dalheim Øien, Sebastian Dransfeld (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.10.155](10.1016/j.promfg.2020.10.155)  
**Sitasi Pendukung:** Kesler Isoko, Joan Cordiner, Zoltán Kis (2024). *Digital Discovery*. DOI: [10.1039/d4dd00127c](10.1039/d4dd00127c)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Endre Sølvsberg, Christian Dalheim Øien, Sebastian Dransfeld (2020) dalam jurnal *Procedia Manufacturing* (DOI: 10.1016/j.promfg.2020.10.155) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kesler Isoko, Joan Cordiner, Zoltán Kis (2024) yang dipublikasikan dalam *Digital Discovery* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
