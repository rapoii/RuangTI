# 3695 — Simulation Modeling & Digital Twins: Using Simulation to Improve Marble Warehouse Operations in Housing Projects

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Using Simulation to Improve Marble Warehouse Operations in Housing Projects  
**Jurnal & Sitasi Utama:** A. A. Bakhsh (2026). *International Journal of Simulation Modelling*. DOI: [10.2507/ijsimm25-2-755](10.2507/ijsimm25-2-755)  
**Sitasi Pendukung:** J.H. Verriet (2024). *TNO Repository*. DOI: [10.openalex/w7132320700](10.openalex/w7132320700)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari A. A. Bakhsh (2026) dalam jurnal *International Journal of Simulation Modelling* (DOI: 10.2507/ijsimm25-2-755) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The Saudi 2030 Vision Housing Program aims to deliver high-quality, affordable housing on time.On-site warehouses are essential to the Jeddah Housing Project, which includes 8,649 residential units across 440 towers.High daily order volumes, a small workforce, and limited transportation resources have caused persistent delays in the marble warehouse.This study uses Simio simulation software to model the marble warehouse as a complex sociotechnical system, analyse workflow, identify bottlenecks, and evaluate operational alternatives.A base model representing current operations was created for 1,760 orders and verified with historical data.Three alternative configurations were simulated: increasing preparation unit capacity, adding preparation and transportation resources, and deploying knuckle boom trucks to improve delivery efficiency.Performance metrics included total time in system, preparation unit utilization, and average waiting times.Alternative 3 significantly reduces delays and total time, optimizing warehouse operations for large housing projects and supporting strategic decision-making."

Penelitian pendukung oleh J.H. Verriet (2024) yang dipublikasikan dalam *TNO Repository* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
