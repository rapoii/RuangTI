# 4834 — Production Planning & Inventory Control: Analysis of an inventory management model in a manufacturing process based on material requirements planning (MRP)

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Analysis of an inventory management model in a manufacturing process based on material requirements planning (MRP)  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2023). *International Journal of Advanced Natural Sciences and Engineering Researches*. DOI: [10.59287/ijanser.1507](10.59287/ijanser.1507)  
**Sitasi Pendukung:** Seyed Mahdi Javadi, Seyed Jafar Sadjadi, Ebrahim Teimoury (2025). *Scientific Reports*. DOI: [10.1038/s41598-025-13197-8](10.1038/s41598-025-13197-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2023) dalam jurnal *International Journal of Advanced Natural Sciences and Engineering Researches* (DOI: 10.59287/ijanser.1507) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
