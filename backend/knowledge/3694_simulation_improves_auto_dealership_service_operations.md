# 3694 — Simulation Modeling & Digital Twins: Simulation improves auto dealership service operations

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulation improves auto dealership service operations  
**Jurnal & Sitasi Utama:** Nistha Bhattarai, Aishwarya Jaishankar, Edward J. Williams (2026). *Peer-Reviewed Academic Journal*. DOI: [10.7148/2026-0057](10.7148/2026-0057)  
**Sitasi Pendukung:** A. A. Bakhsh (2026). *International Journal of Simulation Modelling*. DOI: [10.2507/ijsimm25-2-755](10.2507/ijsimm25-2-755)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nistha Bhattarai, Aishwarya Jaishankar, Edward J. Williams (2026) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.7148/2026-0057) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Historically, discrete-event process simulation began achieving its successes in the study and improvement of large-scale manufacturing operations. In subsequent decades, simulation has shown its mettle in a wide variety of fields, including the delivery of health care (Standridge 1999), improvement of public transport, warehousing and supply chain operations, and the delivery of service in businesses such as restaurants, banks, and retail stores. In the study presented here, discrete-event process simulation assisted the improvement of operations in the service sector of an automobile dealership; it addressed the challenges presented by labor allocation, increasingly complex vehicles, supply-chain uncertainties, and heightened customers’ expectations. Five scenarios chosen by dealership management were compared for their ability to meet these challenges without excessive expense."

Penelitian pendukung oleh A. A. Bakhsh (2026) yang dipublikasikan dalam *International Journal of Simulation Modelling* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
