# 5439 — Operations Research & Large-Scale Optimization: An Improved Genetic Algorithm for Vehicle Routing Problem with Time Windows Based on Cluster of Geographic and Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An Improved Genetic Algorithm for Vehicle Routing Problem with Time Windows Based on Cluster of Geographic and Time Windows  
**Jurnal & Sitasi Utama:** Jiani Liu, Lei Tong, Xuewen Xia (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4466179](10.2139/ssrn.4466179)  
