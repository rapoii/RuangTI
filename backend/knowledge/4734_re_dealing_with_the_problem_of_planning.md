# 4734 — Facilities Planning & Material Handling: Re: “Dealing With The Problem Of Planning Construction Site Layout Based On Quadratic Assignment Problem Method, Using Ant-Lion hybrid algorithm.

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Re: “Dealing With The Problem Of Planning Construction Site Layout Based On Quadratic Assignment Problem Method, Using Ant-Lion hybrid algorithm.  
**Jurnal & Sitasi Utama:** Pham Vu Hong Son, To Dieu Lam (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-2163075/v1](10.21203/rs.3.rs-2163075/v1)  
**Sitasi Pendukung:** Zongxing He, Zeqiang Zhang, Junqi Liu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4670055](10.2139/ssrn.4670055)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pham Vu Hong Son, To Dieu Lam (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-2163075/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
