# Modul Komprehensif: Social Network Analysis (SNA) & Teori Graf untuk Aliran Informasi Pabrik
**Nomor Modul:** [382]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Social Network Analysis: Methods and Applications (Stanley Wasserman, Katherine Faust), Human Factors and Ergonomics in Manufacturing (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Social Network Analysis (SNA) & Teori Graf untuk Aliran Informasi Pabrik**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Centrality Metrics (Degree, Closeness, Betweenness, Eigenvector), Modularity Community Detection (Louvain), Structural Holes, Knowledge Silos.
...
```python
# Algoritma Solusi Terapan untuk Social Network Analysis (SNA) & Teori Graf untuk Aliran Informasi Pabrik
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Pemetaan Hambatan Komunikasi Antara Tim R&D, Purchasing, dan Produksi Pabrik Otomotif.
...
1. Social Network Analysis: Methods and Applications (Stanley Wasserman, Katherine Faust), Human Factors and Ergonomics in Manufacturing (2024).
