# 6262 — Operations Research & Large-Scale Optimization: Makespan optimization using Timed Petri Nets and Mixed Integer Linear Programming Problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Makespan optimization using Timed Petri Nets and Mixed Integer Linear Programming Problem  
**Jurnal & Sitasi Utama:** E. Di Marino, R. Su, F. Basile (2020). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2021.04.073](10.1016/j.ifacol.2021.04.073)  
**Sitasi Pendukung:** Korawee Peerasantikul, Surapong Auwatanamongkol (2024). *2024 8th International Conference on Information Technology (InCIT)*. DOI: [10.1109/incit63192.2024.10810655](10.1109/incit63192.2024.10810655)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari E. Di Marino, R. Su, F. Basile (2020) dalam jurnal *IFAC-PapersOnLine* (DOI: 10.1016/j.ifacol.2021.04.073) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
