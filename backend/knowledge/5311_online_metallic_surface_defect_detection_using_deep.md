# 5311 — Industrial Artificial Intelligence & Data Analytics: Online Metallic Surface Defect Detection Using Deep LearningOnline Metallic Surface Defect Detection Using Deep Learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Online Metallic Surface Defect Detection Using Deep LearningOnline Metallic Surface Defect Detection Using Deep Learning  
**Jurnal & Sitasi Utama:** Feyza ÇEREZCİ, Serap KAZAN, Muhammed Ali Oz (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-41274/v1](10.21203/rs.3.rs-41274/v1)  
**Sitasi Pendukung:** Xin Guan, Junjie Sun (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11086050](10.1109/cvidl65390.2025.11086050)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Feyza ÇEREZCİ, Serap KAZAN, Muhammed Ali Oz (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-41274/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xin Guan, Junjie Sun (2025) yang dipublikasikan dalam *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
