# Modul Komprehensif: Deep Learning & Computer Vision YOLO/CNN untuk Automated Visual Inspection (AOI)
**Nomor Modul:** [331]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Deep Learning (Ian Goodfellow et al.), IEEE Transactions on Industrial Informatics (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Deep Learning & Computer Vision YOLO/CNN untuk Automated Visual Inspection (AOI)**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Convolutional Neural Networks, YOLOv8 Architecture, Non-Maximum Suppression (NMS), Intersection over Union (IoU), Mean Average Precision (mAP).
...
```python
# Algoritma Solusi Terapan untuk Deep Learning & Computer Vision YOLO/CNN untuk Automated Visual Inspection (AOI)
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Inspeksi Visual Otomatis Cacat Pengelasan Laser Bodi Mobil (Kecepatan inspeksi 45 fps, recall 99.1%).
...
1. Deep Learning (Ian Goodfellow et al.), IEEE Transactions on Industrial Informatics (2024).
