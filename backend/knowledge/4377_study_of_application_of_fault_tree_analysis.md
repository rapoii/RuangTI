# 4377 — Safety Engineering & Risk Management: Study of Application of Fault Tree Analysis Method in Safety Risk Assessment of Large-Scale Activities

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Study of Application of Fault Tree Analysis Method in Safety Risk Assessment of Large-Scale Activities  
**Jurnal & Sitasi Utama:** Quanmin Bu, Yuehong Xu (2022). *Proceedings of the 1st International Conference on Public Management, Digital Economy and Internet Technology*. DOI: [10.5220/0011767600003607](10.5220/0011767600003607)  
**Sitasi Pendukung:** Farid Wajdi Akashah, Rachid Ouache, Jianping Zhang (2020). *Handbook of Probabilistic Models*. DOI: [10.1016/b978-0-12-816514-0.00004-7](10.1016/b978-0-12-816514-0.00004-7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Quanmin Bu, Yuehong Xu (2022) dalam jurnal *Proceedings of the 1st International Conference on Public Management, Digital Economy and Internet Technology* (DOI: 10.5220/0011767600003607) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Farid Wajdi Akashah, Rachid Ouache, Jianping Zhang (2020) yang dipublikasikan dalam *Handbook of Probabilistic Models* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
