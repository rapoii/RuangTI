# 6412 — Quality Engineering & Reliability Systems: Performance improvement through Kaizen and Failure Mode and Effect Analysis (FMEA) in an academic institution

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Performance improvement through Kaizen and Failure Mode and Effect Analysis (FMEA) in an academic institution  
**Jurnal & Sitasi Utama:** Nidhin Sreedas E, Francis J Emmatty (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4042697](10.2139/ssrn.4042697)  
**Sitasi Pendukung:** Shaymaa M. M. El-Awady (2023). *Global Journal on Quality and Safety in Healthcare*. DOI: [10.36401/jqsh-23-x2](10.36401/jqsh-23-x2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nidhin Sreedas E, Francis J Emmatty (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4042697) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper aims to determine how techniques like Kaizen and Failure Mode and Effect Analysis (FMEA) can be used to identify activities that help to improve the performance of an academic institution. A detailed survey was conducted among faculty members and students in an engineering college in India. Suggestions from both are prioritized based on Kaizen scale value and Risk Priority Number (RPN). By using Kaizen and FMEA, students and faculty involvement can be ensured to improve the performance of the college cost-effectively. In this study only an online survey was conducted due to the Covid-19 pandemic situation. An offline survey could be more beneficial, and brainstorming sessions and quality circles could be implemented as part of this study. This paper offers insights into the combined application of Kaizen and FMEA in the educational sector. The research can be widened and implemented in other service sectors. One of the primary concerns in society is the quality of students completing engineering education, as a result of which industrial growth and employability rate are affected. This situation can be improved to a great extent by this cost-effective technique. This paper is one of the first studies to combine Kaizen and FMEA techniques to enhance activities in academic institutions."

Penelitian pendukung oleh Shaymaa M. M. El-Awady (2023) yang dipublikasikan dalam *Global Journal on Quality and Safety in Healthcare* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
