# 6438 — Human Factors & Cognitive Ergonomics: The impact of LMS usage on cognitive load in a programming course: an evaluation using NASA-TLX

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** The impact of LMS usage on cognitive load in a programming course: an evaluation using NASA-TLX  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2025). *UNEC Journal of Computer Science and Digital Technologies*. DOI: [10.30546/uneccsdt.2025.01.0107](10.30546/uneccsdt.2025.01.0107)  
**Sitasi Pendukung:** Skye S. Taylor, Matthew L. Bolton (2026). *IEEE Transactions on Human-Machine Systems*. DOI: [10.1109/thms.2026.3664262](10.1109/thms.2026.3664262)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2025) dalam jurnal *UNEC Journal of Computer Science and Digital Technologies* (DOI: 10.30546/uneccsdt.2025.01.0107) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
