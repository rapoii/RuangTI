# 5742 — Operations Research & Large-Scale Optimization: Balancing stochastic type-II assembly lines: chance-constrained mixed integer and constraint programming models

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Balancing stochastic type-II assembly lines: chance-constrained mixed integer and constraint programming models  
**Jurnal & Sitasi Utama:** Mehmet Pınarbaşı, Hacı Mehmet Alakaş (2020). *Engineering Optimization*. DOI: [10.1080/0305215x.2020.1716746](10.1080/0305215x.2020.1716746)  
**Sitasi Pendukung:** Rohit Kannan, James R. Luedtke (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00199-y](10.1007/s12532-020-00199-y)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mehmet Pınarbaşı, Hacı Mehmet Alakaş (2020) dalam jurnal *Engineering Optimization* (DOI: 10.1080/0305215x.2020.1716746) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
