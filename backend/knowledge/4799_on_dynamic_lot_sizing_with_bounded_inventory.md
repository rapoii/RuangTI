# 4799 — Production Planning & Inventory Control: On dynamic lot sizing with bounded inventory for a perishable product

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** On dynamic lot sizing with bounded inventory for a perishable product  
**Jurnal & Sitasi Utama:** Jie Fan, Jinwen Ou (2023). *Omega*. DOI: [10.1016/j.omega.2023.102895](10.1016/j.omega.2023.102895)  
**Sitasi Pendukung:** Arnaud. Laurent, David. Lemoine (2022). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2022.09.560](10.1016/j.ifacol.2022.09.560)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jie Fan, Jinwen Ou (2023) dalam jurnal *Omega* (DOI: 10.1016/j.omega.2023.102895) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Arnaud. Laurent, David. Lemoine (2022) yang dipublikasikan dalam *IFAC-PapersOnLine* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
