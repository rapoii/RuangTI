# 3773 — Safety Engineering & Risk Management: Dynamic simulation‐based quantitative hazard and operability process hazard analysis for a hydrocracking unit

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Dynamic simulation‐based quantitative hazard and operability process hazard analysis for a hydrocracking unit  
**Jurnal & Sitasi Utama:** Jian-Qi Yi, Haiyan Wang, Jiguo Zhang (2023). *Process Safety Progress*. DOI: [10.1002/prs.12548](10.1002/prs.12548)  
**Sitasi Pendukung:** Jarmo Alanen, Joonas Linnosmaa, Timo Malm (2021). *Reliability Engineering & System Safety*. DOI: [10.1016/j.ress.2021.108270](10.1016/j.ress.2021.108270)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jian-Qi Yi, Haiyan Wang, Jiguo Zhang (2023) dalam jurnal *Process Safety Progress* (DOI: 10.1002/prs.12548) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
