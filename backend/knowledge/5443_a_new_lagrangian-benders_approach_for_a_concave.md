# 5443 — Operations Research & Large-Scale Optimization: A new Lagrangian-Benders approach for a concave cost supply chain network design problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A new Lagrangian-Benders approach for a concave cost supply chain network design problem  
**Jurnal & Sitasi Utama:** Ahmed Saif, Ali Keyvandarian, Samir Elhedhli (2021). *INFOR: Information Systems and Operational Research*. DOI: [10.1080/03155986.2021.1923978](10.1080/03155986.2021.1923978)  
**Sitasi Pendukung:** Erik F. Alvarez, Miguel Paredes, Marcos J. Rider (2020). *IET Generation, Transmission &amp; Distribution*. DOI: [10.1049/iet-gtd.2019.0331](10.1049/iet-gtd.2019.0331)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ahmed Saif, Ali Keyvandarian, Samir Elhedhli (2021) dalam jurnal *INFOR: Information Systems and Operational Research* (DOI: 10.1080/03155986.2021.1923978) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Erik F. Alvarez, Miguel Paredes, Marcos J. Rider (2020) yang dipublikasikan dalam *IET Generation, Transmission &amp; Distribution* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
