# 3380 — Quality Engineering & Reliability Systems: An ontology-driven bayesian network approach to fault diagnosis and correction in manufacturing

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** An ontology-driven bayesian network approach to fault diagnosis and correction in manufacturing  
**Jurnal & Sitasi Utama:** Yannick Wilhelm, Peter Reimann, Wolfgang Gauchel (2026). *The International Journal of Advanced Manufacturing Technology*. DOI: [10.1007/s00170-025-17136-9](10.1007/s00170-025-17136-9)  
**Sitasi Pendukung:** István Mihálcz, Zsolt Tibor Kosztyán (2024). *Mathematics*. DOI: [10.3390/math12060841](10.3390/math12060841)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yannick Wilhelm, Peter Reimann, Wolfgang Gauchel (2026) dalam jurnal *The International Journal of Advanced Manufacturing Technology* (DOI: 10.1007/s00170-025-17136-9) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
