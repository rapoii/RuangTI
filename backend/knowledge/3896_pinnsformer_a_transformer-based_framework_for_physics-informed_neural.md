# 3896 — Industrial Artificial Intelligence & Data Analytics: PINNsFormer: A Transformer-Based Framework For Physics-Informed Neural Networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** PINNsFormer: A Transformer-Based Framework For Physics-Informed Neural Networks  
**Jurnal & Sitasi Utama:** Lizhong Zhao, Xueying Ding, B. Aditya Prakash (2023). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2307.11833](10.48550/arxiv.2307.11833)  
**Sitasi Pendukung:** Johannes Dornheim, Lukas Morand, Hemanth Janarthanam Nallani (2023). *Archives of Computational Methods in Engineering*. DOI: [10.1007/s11831-023-10009-y](10.1007/s11831-023-10009-y)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lizhong Zhao, Xueying Ding, B. Aditya Prakash (2023) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2307.11833) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Johannes Dornheim, Lukas Morand, Hemanth Janarthanam Nallani (2023) yang dipublikasikan dalam *Archives of Computational Methods in Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
