# 3786 — Safety Engineering & Risk Management: Risk assessment of solid desiccant dehydration package system using safety integrity level‐based safety instrumented system design approach

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Risk assessment of solid desiccant dehydration package system using safety integrity level‐based safety instrumented system design approach  
**Jurnal & Sitasi Utama:** Sanghyun Park, Tae Hee Lee, Kwangu Kang (2023). *Process Safety Progress*. DOI: [10.1002/prs.12518](10.1002/prs.12518)  
**Sitasi Pendukung:** Jialu Zhang, Haojie Ren, Haojie Ren (2023). *Processes*. DOI: [10.3390/pr11082454](10.3390/pr11082454)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sanghyun Park, Tae Hee Lee, Kwangu Kang (2023) dalam jurnal *Process Safety Progress* (DOI: 10.1002/prs.12518) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jialu Zhang, Haojie Ren, Haojie Ren (2023) yang dipublikasikan dalam *Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
