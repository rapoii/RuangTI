# 4575 — Operations Research & Large-Scale Optimization: Matheuristic approach and a mixed-integer linear programming model for biomass supply chain optimization with demand selection

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Matheuristic approach and a mixed-integer linear programming model for biomass supply chain optimization with demand selection  
**Jurnal & Sitasi Utama:** Mohammad A. M. Abdel Aal (2024). *International Journal of Industrial Engineering Computations*. DOI: [10.5267/j.ijiec.2023.10.001](10.5267/j.ijiec.2023.10.001)  
**Sitasi Pendukung:** Evangelos D. Spyrou, Vassilios Kappatos, Maria Gkemou (2025). *Sustainability*. DOI: [10.3390/su17177937](10.3390/su17177937)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohammad A. M. Abdel Aal (2024) dalam jurnal *International Journal of Industrial Engineering Computations* (DOI: 10.5267/j.ijiec.2023.10.001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Evangelos D. Spyrou, Vassilios Kappatos, Maria Gkemou (2025) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
