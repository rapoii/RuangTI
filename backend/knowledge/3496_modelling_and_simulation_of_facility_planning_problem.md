# 3496 — Facilities Planning & Material Handling: Modelling and Simulation of Facility Planning Problem Based on Improved SLP Method

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Modelling and Simulation of Facility Planning Problem Based on Improved SLP Method  
**Jurnal & Sitasi Utama:** Bo Zhang, Xianlin Wang (2020). *IOP Conference Series Materials Science and Engineering*. DOI: [10.1088/1757-899x/806/1/012034](10.1088/1757-899x/806/1/012034)  
**Sitasi Pendukung:** Shuyan Zhou, Lixia Liu, Yinghuan Liu (2025). *Asia Pacific Economic and Management Review*. DOI: [10.62177/apemr.v1i1.278](10.62177/apemr.v1i1.278)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bo Zhang, Xianlin Wang (2020) dalam jurnal *IOP Conference Series Materials Science and Engineering* (DOI: 10.1088/1757-899x/806/1/012034) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract Facility planning plays a critical role in various fields. An excellent facility layout can minimize the losses caused by the connection between facility units in production operations. In this paper, we improved the traditional Systematic Layout Planning (SLP) method, combine it with the multi-objective decision optimization model. The Improved SLP (ISLP) method is described in detail in this paper, including its principles, process of building model, and calculation methods. To make the ISLP more suitable for research and practical problems, we established a mathematical model for it. This optimization model was also applied to the existing facility layout problem to realistically validate the effectiveness of the ISLP and the model. Results on the established model were found first, then the Flexsim simulation software was used to simulate the layout of the facility before and after the improvement. Finally, the results of the experiment were analysed and compared."

Penelitian pendukung oleh Shuyan Zhou, Lixia Liu, Yinghuan Liu (2025) yang dipublikasikan dalam *Asia Pacific Economic and Management Review* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
