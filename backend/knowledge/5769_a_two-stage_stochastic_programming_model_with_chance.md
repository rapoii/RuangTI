# 5769 — Operations Research & Large-Scale Optimization: A two-stage stochastic programming model with chance constraint for electricity capacity expansion considering supply reliability and sustainability perspectives

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A two-stage stochastic programming model with chance constraint for electricity capacity expansion considering supply reliability and sustainability perspectives  
**Jurnal & Sitasi Utama:** Zahra Sadat Mirjamali Khozaghi, Abbas Seifi, Mahdi Noorizadegan (2026). *Annals of Operations Research*. DOI: [10.1007/s10479-026-07131-y](10.1007/s10479-026-07131-y)  
**Sitasi Pendukung:** Zheyin Zhao, Jin Zhu (2026). *Mathematics*. DOI: [10.3390/math14081292](10.3390/math14081292)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zahra Sadat Mirjamali Khozaghi, Abbas Seifi, Mahdi Noorizadegan (2026) dalam jurnal *Annals of Operations Research* (DOI: 10.1007/s10479-026-07131-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Zheyin Zhao, Jin Zhu (2026) yang dipublikasikan dalam *Mathematics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
