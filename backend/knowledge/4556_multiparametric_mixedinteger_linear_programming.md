# 4556 — Operations Research & Large-Scale Optimization: Multi‐parametric Mixed‐integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multi‐parametric Mixed‐integer Linear Programming  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2020). *Multi‐Parametric Optimization and Control*. DOI: [10.1002/9781119265245.ch5](10.1002/9781119265245.ch5)  
**Sitasi Pendukung:** Andreas Hanel, Sebastian Miehling, Jerry Lambert (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4489223](10.2139/ssrn.4489223)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2020) dalam jurnal *Multi‐Parametric Optimization and Control* (DOI: 10.1002/9781119265245.ch5) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Andreas Hanel, Sebastian Miehling, Jerry Lambert (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
