# 5286 — Industrial Artificial Intelligence & Data Analytics: Prediction of Blade Vibration Response with Uncertainty Propagation Using Physics-Informed Neural Networks and Physics-Informed Gaussian Process Regression

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Prediction of Blade Vibration Response with Uncertainty Propagation Using Physics-Informed Neural Networks and Physics-Informed Gaussian Process Regression  
**Jurnal & Sitasi Utama:** Xiaodong Zhang, Daobo Sun, Ting Liu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5357487](10.2139/ssrn.5357487)  
**Sitasi Pendukung:** Zekai Guo, Ye Li (2025). *Proceedings of the 2025 2nd Symposium on Big Data, Neural Networks, and Deep Learning*. DOI: [10.1145/3784013.3784074](10.1145/3784013.3784074)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiaodong Zhang, Daobo Sun, Ting Liu (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5357487) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Zekai Guo, Ye Li (2025) yang dipublikasikan dalam *Proceedings of the 2025 2nd Symposium on Big Data, Neural Networks, and Deep Learning* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
