# 5438 — Operations Research & Large-Scale Optimization: A Strength Pareto Evolutionary Algorithm for Solving the Capacitated Vehicle Routing Problem with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Strength Pareto Evolutionary Algorithm for Solving the Capacitated Vehicle Routing Problem with Time Windows  
**Jurnal & Sitasi Utama:** Wissam Marrouche, Haidar Harmanani (2021). *Proceedings of the 13th International Joint Conference on Computational Intelligence*. DOI: [10.5220/0010640900003063](10.5220/0010640900003063)  
**Sitasi Pendukung:** Jiani Liu, Lei Tong, Xuewen Xia (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4466179](10.2139/ssrn.4466179)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wissam Marrouche, Haidar Harmanani (2021) dalam jurnal *Proceedings of the 13th International Joint Conference on Computational Intelligence* (DOI: 10.5220/0010640900003063) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiani Liu, Lei Tong, Xuewen Xia (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
