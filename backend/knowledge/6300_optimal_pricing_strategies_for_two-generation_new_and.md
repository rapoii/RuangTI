# 6300 — Supply Chain Management & Logistics Engineering: Optimal pricing strategies for two-generation new and remanufactured short-lived products in a closed-loop supply chain

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Optimal pricing strategies for two-generation new and remanufactured short-lived products in a closed-loop supply chain  
**Jurnal & Sitasi Utama:** Satchidananda Tripathy, Akhilesh Kumar (2026). *Journal of Remanufacturing*. DOI: [10.1007/s13243-026-00169-y](10.1007/s13243-026-00169-y)  
**Sitasi Pendukung:** Huanyong Zhang, Richong Zhang (2025). *Systems*. DOI: [10.3390/systems13040257](10.3390/systems13040257)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Satchidananda Tripathy, Akhilesh Kumar (2026) dalam jurnal *Journal of Remanufacturing* (DOI: 10.1007/s13243-026-00169-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Huanyong Zhang, Richong Zhang (2025) yang dipublikasikan dalam *Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
