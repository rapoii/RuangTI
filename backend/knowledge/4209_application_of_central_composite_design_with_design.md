# 4209 — Applied Statistics & Stochastic Modeling: Application of Central Composite Design with Design Expert v13 in Process Optimization

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Application of Central Composite Design with Design Expert v13 in Process Optimization  
**Jurnal & Sitasi Utama:** Chigoziri N. Njoku, Samuel K. Otisi (2023). *IntechOpen eBooks*. DOI: [10.5772/intechopen.109704](10.5772/intechopen.109704)  
**Sitasi Pendukung:** Kasumba A. Buyondo, Peter Wilberforce Olupot, John Baptist Kirabira (2020). *Case Studies in Construction Materials*. DOI: [10.1016/j.cscm.2020.e00461](10.1016/j.cscm.2020.e00461)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chigoziri N. Njoku, Samuel K. Otisi (2023) dalam jurnal *IntechOpen eBooks* (DOI: 10.5772/intechopen.109704) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kasumba A. Buyondo, Peter Wilberforce Olupot, John Baptist Kirabira (2020) yang dipublikasikan dalam *Case Studies in Construction Materials* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
