# 5037 — Applied Statistics & Stochastic Modeling: A hybrid of artificial neural network, exponential smoothing, and ARIMA models for COVID-19 time series forecasting

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** A hybrid of artificial neural network, exponential smoothing, and ARIMA models for COVID-19 time series forecasting  
**Jurnal & Sitasi Utama:** Samir K. Safi, Olajide Idris Sanusi (2021). *Model Assisted Statistics and Applications*. DOI: [10.3233/mas-210512](10.3233/mas-210512)  
...
Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Samir K. Safi, Olajide Idris Sanusi (2021) dalam jurnal *Model Assisted Statistics and Applications* (DOI: 10.3233/mas-210512) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
