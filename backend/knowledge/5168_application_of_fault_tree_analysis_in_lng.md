# 5168 — Safety Engineering & Risk Management: Application of fault tree analysis in LNG fire risk assessment of LNG fueled ships

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Application of fault tree analysis in LNG fire risk assessment of LNG fueled ships  
**Jurnal & Sitasi Utama:** Wenxiang Wu (2021). *Vibroengineering Procedia*. DOI: [10.21595/vp.2021.21827](10.21595/vp.2021.21827)  
**Sitasi Pendukung:** Leszek Opyrchał, Stanisław Kostecki (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6538781](10.2139/ssrn.6538781)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wenxiang Wu (2021) dalam jurnal *Vibroengineering Procedia* (DOI: 10.21595/vp.2021.21827) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Assess the risk of LNG fire of LNG fueled ships navigating in the middle reaches of Yangtze River of China according to the acceptable risk criteria so that support technically to design, building and shipping safety management of LNG fueled ships and also to marine safety administration. “Fault tree analysis” was used to analyze the contribution of factors for LNG fire of LNG fueled ships. Statistical analysis base on the Normal distribution was carried out to reveal the confidence intervals of the probability of ships collision, touch and general fire. Quantitative assessment showed that LNG fuel is not suitable for passenger ships and chemical cargo carriers. It was found that ship length is the key to people onboard evacuating in case of LNG fire, so that LNG valid volume above 20M
                    3
                    was unsuitable for a ship with length less than 80 m as well as that more than 10M
                    3
                    was very dangerous for crew onboard a ship with length less than 45 m. Factors of bridges over river, berths along banks and anchorages in river, which would aggravate the consequences of LNG fire, were taken into consideration during risk assessment. In view of navigation condition in the middle reaches of Yangtze River, measures were suggested for LNG fire risk control of LNG fueled ships."

Penelitian pendukung oleh Leszek Opyrchał, Stanisław Kostecki (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
