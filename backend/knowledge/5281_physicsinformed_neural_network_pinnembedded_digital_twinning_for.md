# 5281 — Industrial Artificial Intelligence & Data Analytics: Physics‐informed neural network (PINN)‐embedded digital twinning for manufacturing sustainability: A framework for intelligent and adaptive process systems

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics‐informed neural network (PINN)‐embedded digital twinning for manufacturing sustainability: A framework for intelligent and adaptive process systems  
**Jurnal & Sitasi Utama:** Mahboubeh Moghadasi, Yinlun Huang (2026). *AIChE Journal*. DOI: [10.1002/aic.70611](10.1002/aic.70611)  
**Sitasi Pendukung:** Mujahid Khan (2024). *Peer-Reviewed Journal*. DOI: [10.31219/osf.io/9bhk7](10.31219/osf.io/9bhk7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahboubeh Moghadasi, Yinlun Huang (2026) dalam jurnal *AIChE Journal* (DOI: 10.1002/aic.70611) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
