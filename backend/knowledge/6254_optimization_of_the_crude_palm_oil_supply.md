# 6254 — Operations Research & Large-Scale Optimization: Optimization of the Crude Palm Oil Supply Chain Using a Mixed Integer Linear Programming Model

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimization of the Crude Palm Oil Supply Chain Using a Mixed Integer Linear Programming Model  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2023). *Information Sciences Letters*. DOI: [10.18576/isl/120902](10.18576/isl/120902)  
**Sitasi Pendukung:** Manjusha A. Kanawade, Mrunmai M. Ranade (2021). *2021 International Conference on Computing, Communication and Green Engineering (CCGE)*. DOI: [10.1109/ccge50943.2021.9776424](10.1109/ccge50943.2021.9776424)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2023) dalam jurnal *Information Sciences Letters* (DOI: 10.18576/isl/120902) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Manjusha A. Kanawade, Mrunmai M. Ranade (2021) yang dipublikasikan dalam *2021 International Conference on Computing, Communication and Green Engineering (CCGE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
