# 4527 — Quality Engineering & Reliability Systems: Modified non-Gaussian multivariate statistical process monitoring based on the Gaussian distribution transformation

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Modified non-Gaussian multivariate statistical process monitoring based on the Gaussian distribution transformation  
**Jurnal & Sitasi Utama:** Wenyou Du, Yingwei Zhang, Wei Zhou (2020). *Journal of Process Control*. DOI: [10.1016/j.jprocont.2017.12.001](10.1016/j.jprocont.2017.12.001)  
**Sitasi Pendukung:** Christina Parpoula, Alex Karagrigoriou (2020). *Distribution-Free Methods for Statistical Process Monitoring and Control*. DOI: [10.1007/978-3-030-25081-2_5](10.1007/978-3-030-25081-2_5)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wenyou Du, Yingwei Zhang, Wei Zhou (2020) dalam jurnal *Journal of Process Control* (DOI: 10.1016/j.jprocont.2017.12.001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
