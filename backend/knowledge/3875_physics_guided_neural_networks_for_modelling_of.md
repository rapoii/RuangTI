# 3875 — Industrial Artificial Intelligence & Data Analytics: Physics guided neural networks for modelling of non-linear dynamics

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics guided neural networks for modelling of non-linear dynamics  
**Jurnal & Sitasi Utama:** Haakon Robinson, Suraj Pawar, Adil Rasheed (2022). *Neural Networks*. DOI: [10.1016/j.neunet.2022.07.023](10.1016/j.neunet.2022.07.023)  
**Sitasi Pendukung:** Jun Woo Cho, Seungtae Nam, Hyunmo Yang (2023). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2306.15969](10.48550/arxiv.2306.15969)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Haakon Robinson, Suraj Pawar, Adil Rasheed (2022) dalam jurnal *Neural Networks* (DOI: 10.1016/j.neunet.2022.07.023) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jun Woo Cho, Seungtae Nam, Hyunmo Yang (2023) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
