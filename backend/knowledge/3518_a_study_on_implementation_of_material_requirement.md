# 3518 — Production Planning & Inventory Control: A STUDY ON IMPLEMENTATION OF MATERIAL REQUIREMENT PLANNING (MRP) FOR MANUFACTURING INDUSTRIES

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** A STUDY ON IMPLEMENTATION OF MATERIAL REQUIREMENT PLANNING (MRP) FOR MANUFACTURING INDUSTRIES  
**Jurnal & Sitasi Utama:** Anand K. Verma, Abhishek Verma, Nitesh Kumar (2024). *Peer-Reviewed Academic Journal*. DOI: [10.55524/csistw.2024.12.1.5](10.55524/csistw.2024.12.1.5)  
**Sitasi Pendukung:** Valerii Novinskyi, V. D. Popenko (2024). *Radio Electronics Computer Science Control*. DOI: [10.15588/1607-3274-2024-2-17](10.15588/1607-3274-2024-2-17)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anand K. Verma, Abhishek Verma, Nitesh Kumar (2024) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.55524/csistw.2024.12.1.5) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This review paper delves into a detailed exploration of how Materials Requirement Planning (MRP) is implemented in manufacturers catering to Small and Medium-Sized Firms and industries. The study thoroughly discusses the implementation process, associated factors, and the outcomes derived from conducting MRP[20]. The primary objective is to understand the intricate relationships between these factors. The persistent focus of this study is to identify the essential elements of MRP and apply them to address a specific problem selected for investigation. The main aim of MRP, as highlighted in the review, is to effectively manage dependent demand items while achieving high inventory turnover and minimizing payable costs[20]. The study addresses a common yet impactful problem prevalent in Manufacturing and small to medium-sized industries. It strives to comprehend the multitude of factors contributing to this issue, followed by a comprehensive discussion of potential solutions. The subsequent application of the solution procedures leads to the presentation of results that affirm the beneficial nature of executing Materials Requirement Planning (MRP).The review paper concludes with a valuable suggestion for manufacturing industries, emphasizing the importance of consistently prioritizing improvements in aspects that positively contribute to the implementation process factors of Material Requirement Planning (MRP). This recommendation aims to guide manufacturing entities in enhancin"

Penelitian pendukung oleh Valerii Novinskyi, V. D. Popenko (2024) yang dipublikasikan dalam *Radio Electronics Computer Science Control* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
