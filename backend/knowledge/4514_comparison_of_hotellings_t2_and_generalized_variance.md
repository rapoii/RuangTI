# 4514 — Quality Engineering & Reliability Systems: COMPARISON OF HOTELLING’S T2 AND GENERALIZED VARIANCE | S | MULTIVARIATE CONTROL CHARTS PROCEDURES WITH INDUSTRIAL APPLICATION

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** COMPARISON OF HOTELLING’S T2 AND GENERALIZED VARIANCE | S | MULTIVARIATE CONTROL CHARTS PROCEDURES WITH INDUSTRIAL APPLICATION  
**Jurnal & Sitasi Utama:** M. S. Hamed (2022). *Advances and Applications in Statistics*. DOI: [10.17654/0972361722037](10.17654/0972361722037)  
**Sitasi Pendukung:** John Oakland, Robert Oakland (2024). *Statistical Process Control and Data Analytics*. DOI: [10.4324/9781003439080-12](10.4324/9781003439080-12)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. S. Hamed (2022) dalam jurnal *Advances and Applications in Statistics* (DOI: 10.17654/0972361722037) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh John Oakland, Robert Oakland (2024) yang dipublikasikan dalam *Statistical Process Control and Data Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
