# 4331 — Supply Chain Management & Logistics Engineering: Neuroevolution reinforcement learning for multi-echelon inventory optimization with delivery options and uncertain discount

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Neuroevolution reinforcement learning for multi-echelon inventory optimization with delivery options and uncertain discount  
**Jurnal & Sitasi Utama:** Zakka Ugih Rizqi, Shuo-Yan Chou (2024). *Engineering Applications of Artificial Intelligence*. DOI: [10.1016/j.engappai.2024.108670](10.1016/j.engappai.2024.108670)  
**Sitasi Pendukung:** Xuguang Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7051558](10.2139/ssrn.7051558)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zakka Ugih Rizqi, Shuo-Yan Chou (2024) dalam jurnal *Engineering Applications of Artificial Intelligence* (DOI: 10.1016/j.engappai.2024.108670) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xuguang Zhang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
