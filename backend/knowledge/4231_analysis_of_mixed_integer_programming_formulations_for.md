# 4231 — Operations Research & Large-Scale Optimization: ANALYSIS OF MIXED INTEGER PROGRAMMING FORMULATIONS FOR SINGLE MACHINE SCHEDULING PROBLEMS WITH SEQUENCE DEPENDENT SETUP TIMES AND RELEASE DATES

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** ANALYSIS OF MIXED INTEGER PROGRAMMING FORMULATIONS FOR SINGLE MACHINE SCHEDULING PROBLEMS WITH SEQUENCE DEPENDENT SETUP TIMES AND RELEASE DATES  
**Jurnal & Sitasi Utama:** Thiago Henrique Nogueira, Carlos Roberto Ribeiro de Carvalho, Martı́n Gómez Ravetti (2019). *Pesquisa Operacional*. DOI: [10.1590/0101-7438.2019.039.01.0109](10.1590/0101-7438.2019.039.01.0109)  
**Sitasi Pendukung:** Vahid Hajipour, Madjid Tavana, Debora Di Caprio (2019). *Applied Mathematical Modelling*. DOI: [10.1016/j.apm.2019.03.007](10.1016/j.apm.2019.03.007)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thiago Henrique Nogueira, Carlos Roberto Ribeiro de Carvalho, Martı́n Gómez Ravetti (2019) dalam jurnal *Pesquisa Operacional* (DOI: 10.1590/0101-7438.2019.039.01.0109) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vahid Hajipour, Madjid Tavana, Debora Di Caprio (2019) yang dipublikasikan dalam *Applied Mathematical Modelling* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
