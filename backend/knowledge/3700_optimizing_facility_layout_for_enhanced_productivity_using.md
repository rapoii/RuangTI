# 3700 — Simulation Modeling & Digital Twins: Optimizing Facility Layout for Enhanced Productivity using Pro Model: A Case Study of a Shoe Manufacturing Company in Marikina, Philippines

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Optimizing Facility Layout for Enhanced Productivity using Pro Model: A Case Study of a Shoe Manufacturing Company in Marikina, Philippines  
**Jurnal & Sitasi Utama:** Eisen Jules S. Cabusas, Cyra Eve A. Helis, Duane Marc Malonda (2023). *Peer-Reviewed Academic Journal*. DOI: [10.46254/ap04.20230044](10.46254/ap04.20230044)  
**Sitasi Pendukung:** Mohammad Sholikhan Arif, Sefer Anil Gunbeyaz, Rafet Emek Kurt (2026). *Ocean Engineering*. DOI: [10.1016/j.oceaneng.2026.124303](10.1016/j.oceaneng.2026.124303)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eisen Jules S. Cabusas, Cyra Eve A. Helis, Duane Marc Malonda (2023) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.46254/ap04.20230044) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Efficient facility layout plays a critical role in the success of manufacturing industrial production by optimizing company operations and meeting employee needs. It ensures a smooth flow within the system, minimizes space waste, and maximizes resource utilization. This study focuses on evaluating the facility layout of a shoe manufacturing company located in Marikina, with the aim of identifying and addressing issues that cause waste and hinder productivity. To achieve this objective, the Ishikawa Diagram was employed to identify the root causes of problems within the current facility layout. Furthermore, Pro Model simulation software was utilized to analyze and propose an innovative facility layout design that minimizes waste and maximizes output in the company's production process. The findings of the study uncovered that the current facility layout was a significant contributor to reduced production levels. As a result, a redesigned facility layout was proposed, which yielded a substantial increase of 16.67% in production output. Implementing the suggested facility layout design holds the potential to enhance productivity, minimize waste, and optimize the production processes of the shoe factory. This paper contributes valuable insights to the field of facility layout optimization, demonstrating its importance in driving efficiency and overall operational performance."

Penelitian pendukung oleh Mohammad Sholikhan Arif, Sefer Anil Gunbeyaz, Rafet Emek Kurt (2026) yang dipublikasikan dalam *Ocean Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
