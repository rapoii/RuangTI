# 3901 — Industrial Artificial Intelligence & Data Analytics: An Enhanced Single-Particle Model Using a Physics-Informed Neural Network Considering Electrolyte Dynamics for Lithium-Ion Batteries

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** An Enhanced Single-Particle Model Using a Physics-Informed Neural Network Considering Electrolyte Dynamics for Lithium-Ion Batteries  
**Jurnal & Sitasi Utama:** Chenyu Xue, Bo Jiang, Jiangong Zhu (2023). *Batteries*. DOI: [10.3390/batteries9100511](10.3390/batteries9100511)  
**Sitasi Pendukung:** Junwoo Cho, Seungtae Nam, Hyunmo Yang (2022). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2211.08761](10.48550/arxiv.2211.08761)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chenyu Xue, Bo Jiang, Jiangong Zhu (2023) dalam jurnal *Batteries* (DOI: 10.3390/batteries9100511) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Junwoo Cho, Seungtae Nam, Hyunmo Yang (2022) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
