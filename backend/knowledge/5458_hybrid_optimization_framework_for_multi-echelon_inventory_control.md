# 5458 — Supply Chain Management & Logistics Engineering: Hybrid Optimization Framework for Multi-Echelon Inventory Control Integrating Stochastic Demand, Lead Time Uncertainty, and Real-Time Data Analytics

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Hybrid Optimization Framework for Multi-Echelon Inventory Control Integrating Stochastic Demand, Lead Time Uncertainty, and Real-Time Data Analytics  
**Jurnal & Sitasi Utama:** Testimony Chikaodi Onebunne (2025). *International Journal of Research Publication and Reviews*. DOI: [10.55248/gengpi.6.0825.2929](10.55248/gengpi.6.0825.2929)  
**Sitasi Pendukung:** Shalini Rathore, Madhu Jain, Rakesh Kumar Meena (2022). *Inventory Optimization*. DOI: [10.1007/978-981-19-6337-7_11](10.1007/978-981-19-6337-7_11)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Testimony Chikaodi Onebunne (2025) dalam jurnal *International Journal of Research Publication and Reviews* (DOI: 10.55248/gengpi.6.0825.2929) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shalini Rathore, Madhu Jain, Rakesh Kumar Meena (2022) yang dipublikasikan dalam *Inventory Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
