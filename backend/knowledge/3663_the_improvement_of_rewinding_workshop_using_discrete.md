# 3663 — Simulation Modeling & Digital Twins: The Improvement of Rewinding Workshop Using Discrete Event Simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** The Improvement of Rewinding Workshop Using Discrete Event Simulation  
**Jurnal & Sitasi Utama:** M. B. Othman, F. Albar, Ahmed A. Bakhsh (2025). *International Journal of Simulation Modelling*. DOI: [10.2507/ijsimm24-2-721](10.2507/ijsimm24-2-721)  
**Sitasi Pendukung:** E. Chaves Salas, Michael Arias, Santiago Aguirre (2024). *IEEE Access*. DOI: [10.1109/access.2024.3501157](10.1109/access.2024.3501157)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. B. Othman, F. Albar, Ahmed A. Bakhsh (2025) dalam jurnal *International Journal of Simulation Modelling* (DOI: 10.2507/ijsimm24-2-721) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The study investigates the efficiency optimization of the compressor rewinding workshop at King Abdulaziz University (KAU) using modelling and simulation analysis.The assessment starts with a base model showing current operations and identifies inefficiencies, including high completion and waiting times and overutilization of mechanics.Alternative scenarios, combining different numbers of mechanics and station resources, were analysed to identify the most effective configuration.The findings highlighted Scenario 9, including four mechanics and a single set of workstations, as the satisficing configuration.This scenario achieves a significant reduction in completion time (95.54 hours) and waiting time (43.77hours) while balancing resource utilization (39.09 %).The study underscores the value of simulation in streamlining complex workflows and demonstrates a cost-effective solution for improving operational efficiency.Practical implications include enhanced resource allocation and reduced maintenance delays, supporting KAU's efforts to maintain its extensive infrastructure."

Penelitian pendukung oleh E. Chaves Salas, Michael Arias, Santiago Aguirre (2024) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
