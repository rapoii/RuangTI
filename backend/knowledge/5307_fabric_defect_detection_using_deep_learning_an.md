# 5307 — Industrial Artificial Intelligence & Data Analytics: Fabric defect detection using deep learning: An Improved Faster R-approach

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Fabric defect detection using deep learning: An Improved Faster R-approach  
**Jurnal & Sitasi Utama:** Meng An, Shiyu Wang, Liaomo Zheng (2020). *2020 International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl51233.2020.00-78](10.1109/cvidl51233.2020.00-78)  
**Sitasi Pendukung:** Vineet Bhatia, Ranjan Arora, Sumati Sidharth (2024). *2024 International Conference on Intelligent Computing and Emerging Communication Technologies (ICEC)*. DOI: [10.1109/icec59683.2024.10837564](10.1109/icec59683.2024.10837564)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Meng An, Shiyu Wang, Liaomo Zheng (2020) dalam jurnal *2020 International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl51233.2020.00-78) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vineet Bhatia, Ranjan Arora, Sumati Sidharth (2024) yang dipublikasikan dalam *2024 International Conference on Intelligent Computing and Emerging Communication Technologies (ICEC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
