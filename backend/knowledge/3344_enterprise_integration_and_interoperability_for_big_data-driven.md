# 3344 — Manufacturing Systems & Cyber-Physical Production: Enterprise Integration and Interoperability for Big Data-Driven Processes in the Frame of Industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Enterprise Integration and Interoperability for Big Data-Driven Processes in the Frame of Industry 4.0  
**Jurnal & Sitasi Utama:** Alexandros Bousdekis, Gregoris Mentzas (2021). *Frontiers in Big Data*. DOI: [10.3389/fdata.2021.644651](10.3389/fdata.2021.644651)  
**Sitasi Pendukung:** Bongcheol Kim, Seyun Kim, Hans Teijgeler (2022). *Processes*. DOI: [10.3390/pr10102155](10.3390/pr10102155)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alexandros Bousdekis, Gregoris Mentzas (2021) dalam jurnal *Frontiers in Big Data* (DOI: 10.3389/fdata.2021.644651) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Bongcheol Kim, Seyun Kim, Hans Teijgeler (2022) yang dipublikasikan dalam *Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
