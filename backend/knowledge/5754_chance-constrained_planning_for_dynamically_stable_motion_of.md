# 5754 — Operations Research & Large-Scale Optimization: Chance-Constrained Planning for Dynamically Stable Motion of Reconfigurable Vehicles

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance-Constrained Planning for Dynamically Stable Motion of Reconfigurable Vehicles  
**Jurnal & Sitasi Utama:** Jiazhi Song, Inna Sharf (2024). *Peer-Reviewed Journal*. DOI: [10.36227/techrxiv.21777359](10.36227/techrxiv.21777359)  
**Sitasi Pendukung:** Sasan Barak, Reza Moghdani, Davood Mohammadi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5019801](10.2139/ssrn.5019801)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiazhi Song, Inna Sharf (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.36227/techrxiv.21777359) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sasan Barak, Reza Moghdani, Davood Mohammadi (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
