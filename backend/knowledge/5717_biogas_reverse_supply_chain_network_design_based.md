# 5717 — Operations Research & Large-Scale Optimization: Biogas Reverse Supply Chain Network Design based on Biomass Quality Levels using Robust Programming and Benders decomposition approach

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Biogas Reverse Supply Chain Network Design based on Biomass Quality Levels using Robust Programming and Benders decomposition approach  
**Jurnal & Sitasi Utama:** A. Hamidieh, B. Akhgari (2024). *Scientia Iranica*. DOI: [10.24200/sci.2024.61889.7541](10.24200/sci.2024.61889.7541)  
