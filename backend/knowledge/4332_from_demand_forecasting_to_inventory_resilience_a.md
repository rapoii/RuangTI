# 4332 — Supply Chain Management & Logistics Engineering: From Demand Forecasting to Inventory Resilience: A Risk-sensitive Decision-Support Framework for Multi-echelon Enterprise Operations

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** From Demand Forecasting to Inventory Resilience: A Risk-sensitive Decision-Support Framework for Multi-echelon Enterprise Operations  
**Jurnal & Sitasi Utama:** Xuguang Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7051558](10.2139/ssrn.7051558)  
**Sitasi Pendukung:** Xiaotian Liu, Ming Hu, Yijie Peng (2024). *SSRN Electronic Journal*. DOI: [10.2139/ssrn.4262186](10.2139/ssrn.4262186)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xuguang Zhang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7051558) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Demand forecasting is central to enterprise operations, yet statistical forecast accuracy does not directly determine whether an inventory system avoids stockouts, excessive stock accumulation, unstable ordering, and service-level degradation. This paper proposes a risk-sensitive decision-support framework that translates SKU-store demand forecasts into downstream inventory-resilience outcomes. The empirical study uses the public M5/Walmart forecasting benchmark, containing 30,490 finest-level SKU-store daily sales series across 3,049 items, 10 stores, 3 states, and three product categories. A transparent active-sample rule retains 26,483 SKU-store series with recent and holdout demand activity. Eight forecasting policies are evaluated over the final 28-day holdout window, including seven transparent statistical policies and one applied machine-learning baseline based on global Ridge regression with lag, rolling-window, calendar, and hierarchy features. Forecasts are then passed into a simulated multi-echelon replenishment environment consisting of store-level base-stock control and state-level distribution-center aggregation. The simulation reports service level, stockout rate, overstock exposure, holding cost, order frequency, and an Inventory Resilience Score (IRS). The results show that Moving Average 28 achieves the lowest MAE (1.164) and WAPE (0.724), whereas Risk-Adjusted MA28 achieves the highest IRS (88.021), the highest service level (96.29%), and the lowest stockou"

Penelitian pendukung oleh Xiaotian Liu, Ming Hu, Yijie Peng (2024) yang dipublikasikan dalam *SSRN Electronic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
