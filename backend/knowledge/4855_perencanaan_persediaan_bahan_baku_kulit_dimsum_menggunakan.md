# 4855 — Production Planning & Inventory Control: Perencanaan Persediaan Bahan Baku Kulit Dimsum Menggunakan Metode Material Requirements Planning (MRP)

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Perencanaan Persediaan Bahan Baku Kulit Dimsum Menggunakan Metode Material Requirements Planning (MRP)  
**Jurnal & Sitasi Utama:** Ach. Iqbal Bhayundha, Taufiq Rahman Humaidi, Septine Brillyantina (2026). *Jurnal Manajemen, Bisnis dan Kewirausahaan*. DOI: [10.55606/jumbiku.v6i2.7586](10.55606/jumbiku.v6i2.7586)  
**Sitasi Pendukung:** Gunandar Syofrial (2021). *Industrika : Jurnal Ilmiah Teknik Industri*. DOI: [10.37090/indstrk.v3i1.130](10.37090/indstrk.v3i1.130)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ach. Iqbal Bhayundha, Taufiq Rahman Humaidi, Septine Brillyantina (2026) dalam jurnal *Jurnal Manajemen, Bisnis dan Kewirausahaan* (DOI: 10.55606/jumbiku.v6i2.7586) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Dimsum skin is the outer wrapping layer of dim sum, made mainly from wheat flour, salt, water, and tapioca starch. At CV. XYZ, a small food-processing enterprise in Sidoarjo Regency, demand followed a similar pattern in 2024 and 2025, rising in March-April and December and declining in July, yet the company still orders a fixed 85 sacks of raw material without proper projection, risking overstock or shortage. This study develops a raw-material inventory plan using Material Requirements Planning (MRP) with the Lot for Lot (LFL) and Economic Order Quantity (EOQ) techniques. Sales data for 24 months were forecasted using Single Exponential Smoothing (SES) and Moving Average, compared through the MAD, MSE, and MAPE accuracy tests. SES with alpha = 0.2 produced the lowest error, and MRP with EOQ produced the lowest Total Inventory Cost (TIC) of Rp566,149 per month, saving about 65 percent compared with LFL (Rp1,638,240). MRP with EOQ is therefore recommended as the most efficient raw-material planning technique for CV. XYZ."

Penelitian pendukung oleh Gunandar Syofrial (2021) yang dipublikasikan dalam *Industrika : Jurnal Ilmiah Teknik Industri* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
