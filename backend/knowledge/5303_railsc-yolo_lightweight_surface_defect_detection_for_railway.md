# 5303 — Industrial Artificial Intelligence & Data Analytics: RailSC-YOLO: Lightweight Surface Defect Detection for Railway Metal Components

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** RailSC-YOLO: Lightweight Surface Defect Detection for Railway Metal Components  
**Jurnal & Sitasi Utama:** Demin Fu, Jianhui Yi, DeShui Han (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637960](10.1109/cvidl70130.2026.11637960)  
**Sitasi Pendukung:** Viacheslav Voronin, Roman Sizyakin, Evgeny A. Semenishchev (2023). *Automated Visual Inspection and Machine Vision V*. DOI: [10.1117/12.2678116](10.1117/12.2678116)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Demin Fu, Jianhui Yi, DeShui Han (2026) dalam jurnal *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl70130.2026.11637960) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Viacheslav Voronin, Roman Sizyakin, Evgeny A. Semenishchev (2023) yang dipublikasikan dalam *Automated Visual Inspection and Machine Vision V* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
