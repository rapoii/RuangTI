# 4166 — Engineering Economics & Cost Optimization: Demand-side management via optimal production scheduling in power-intensive industries: The case of metal casting process

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Demand-side management via optimal production scheduling in power-intensive industries: The case of metal casting process  
**Jurnal & Sitasi Utama:** Danial Ramin, Stefano Spinelli, Alessandro Brusaferri (2018). *Applied Energy*. DOI: [10.1016/j.apenergy.2018.03.084](10.1016/j.apenergy.2018.03.084)  
**Sitasi Pendukung:** Sacha Epskamp, Lourens Waldorp, René Mõttus (2018). *Multivariate Behavioral Research*. DOI: [10.1080/00273171.2018.1454823](10.1080/00273171.2018.1454823)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Danial Ramin, Stefano Spinelli, Alessandro Brusaferri (2018) dalam jurnal *Applied Energy* (DOI: 10.1016/j.apenergy.2018.03.084) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
