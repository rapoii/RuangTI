# 4397 — Safety Engineering & Risk Management: Risk assessment of Cryptosporidium intake in drinking water treatment plant by a combination of predictive models and event-tree and fault-tree techniques

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Risk assessment of Cryptosporidium intake in drinking water treatment plant by a combination of predictive models and event-tree and fault-tree techniques  
**Jurnal & Sitasi Utama:** E. Doménech, S. Martorell, G.O.M. Kombo-Mpindou (2022). *Science of The Total Environment*. DOI: [10.1016/j.scitotenv.2022.156500](10.1016/j.scitotenv.2022.156500)  
**Sitasi Pendukung:** Man Cheol Kim (2024). *Nuclear Engineering and Technology*. DOI: [10.1016/j.net.2023.09.018](10.1016/j.net.2023.09.018)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari E. Doménech, S. Martorell, G.O.M. Kombo-Mpindou (2022) dalam jurnal *Science of The Total Environment* (DOI: 10.1016/j.scitotenv.2022.156500) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Man Cheol Kim (2024) yang dipublikasikan dalam *Nuclear Engineering and Technology* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
