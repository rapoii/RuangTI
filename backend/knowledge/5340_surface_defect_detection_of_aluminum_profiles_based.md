# 5340 — Industrial Artificial Intelligence & Data Analytics: Surface defect detection of aluminum profiles based on deep learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Surface defect detection of aluminum profiles based on deep learning  
**Jurnal & Sitasi Utama:** Yuqian Wang, Junyan Wang (2024). *2024 8th International Conference on Electrical, Mechanical and Computer Engineering (ICEMCE)*. DOI: [10.1109/icemce64157.2024.10862601](10.1109/icemce64157.2024.10862601)  
**Sitasi Pendukung:** Meiling Ding, Wei Li (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637499](10.1109/cvidl70130.2026.11637499)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuqian Wang, Junyan Wang (2024) dalam jurnal *2024 8th International Conference on Electrical, Mechanical and Computer Engineering (ICEMCE)* (DOI: 10.1109/icemce64157.2024.10862601) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Meiling Ding, Wei Li (2026) yang dipublikasikan dalam *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
