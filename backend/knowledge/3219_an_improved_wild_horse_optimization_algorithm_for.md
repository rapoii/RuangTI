# 3219 — Operations Research & Large-Scale Optimization: An improved wild horse optimization algorithm for reliability based optimal DG planning of radial distribution networks

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An improved wild horse optimization algorithm for reliability based optimal DG planning of radial distribution networks  
**Jurnal & Sitasi Utama:** Mohammed Hamouda Ali, Salah Kamel, Mohamed H. Hassan (2021). *Energy Reports*. DOI: [10.1016/j.egyr.2021.12.023](10.1016/j.egyr.2021.12.023)  
**Sitasi Pendukung:** Eyüp Ensar Işık, Seyda Topaloglu Yildiz (2023). *Expert Systems with Applications*. DOI: [10.1016/j.eswa.2023.120510](10.1016/j.eswa.2023.120510)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohammed Hamouda Ali, Salah Kamel, Mohamed H. Hassan (2021) dalam jurnal *Energy Reports* (DOI: 10.1016/j.egyr.2021.12.023) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
