# 4513 — Quality Engineering & Reliability Systems: Statistical Process Control Using Control Charts with Variable Parameters

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Statistical Process Control Using Control Charts with Variable Parameters  
**Jurnal & Sitasi Utama:** Tadeusz Sałaciński, Jarosław Chrzanowski, Tomasz Chmielewski (2023). *Processes*. DOI: [10.3390/pr11092744](10.3390/pr11092744)  
**Sitasi Pendukung:** M. S. Hamed (2022). *Advances and Applications in Statistics*. DOI: [10.17654/0972361722037](10.17654/0972361722037)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tadeusz Sałaciński, Jarosław Chrzanowski, Tomasz Chmielewski (2023) dalam jurnal *Processes* (DOI: 10.3390/pr11092744) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh M. S. Hamed (2022) yang dipublikasikan dalam *Advances and Applications in Statistics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
