# 5034 — Applied Statistics & Stochastic Modeling: modeltime: The Tidymodels Extension for Time Series Modeling

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** modeltime: The Tidymodels Extension for Time Series Modeling  
**Jurnal & Sitasi Utama:** Matt Dancho (2020). *CRAN: Contributed Packages*. DOI: [10.32614/cran.package.modeltime](10.32614/cran.package.modeltime)  
**Sitasi Pendukung:** Yuhuen Fei (2026). *Advances in Economics, Management and Political Sciences*. DOI: [10.54254/2754-1169/2026.ld31678](10.54254/2754-1169/2026.ld31678)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Matt Dancho (2020) dalam jurnal *CRAN: Contributed Packages* (DOI: 10.32614/cran.package.modeltime) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
