# 4242 — Simulation Modeling & Digital Twins: Design of material handling systems in the context of industry 4.0

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Design of material handling systems in the context of industry 4.0  
**Jurnal & Sitasi Utama:** Zakarya Soufi (2023). *theses.fr (ABES)*. DOI: [10.openalex/w4416047876](10.openalex/w4416047876)  
**Sitasi Pendukung:** DANIEL LUIS KLEIN (2024). *LA Referencia (Red Federada de Repositorios Institucionales de Publicaciones Científicas)*. DOI: [10.openalex/w7120780369](10.openalex/w7120780369)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zakarya Soufi (2023) dalam jurnal *theses.fr (ABES)* (DOI: 10.openalex/w4416047876) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "L'économie mondiale a entraîné d'importantes transformations et défis pour les industries, notamment dans le domaine de la fabrication. L’indisponibilité des ressources humaines a perturbé les processus de production, entraînant des pertes performances industrielles. Pour s'adapter à l'évolution du paysage économique, les entreprises manufacturières ont reconnu la nécessité de disposer de capacités de réaction en temps réel et d'améliorer les processus de production pour répondre rapidement et avec une grande qualité aux demandes du marché. Ces changements ont donné lieu aux tendances de la production de masse et de la personnalisation de masse, mettant l'accent sur la réduction des coûts et des délais de réponse.Dans ce contexte, les systèmes de logistique interne sont devenus des composants essentiels pour assurer des opérations de fabrication efficaces. Le coût des opérations ses activités revêt une importance significative dans les coûts de fabrication globaux, tandis que l'efficacité du système de logistique interne influence les performances de l'ensemble du système. Par conséquent, l'optimisation et l'amélioration de ces systèmes sont essentielles pour améliorer les processus de fabrication et atteindre l'excellence opérationnelle. Cependant, la conception des systèmes de logistique interne à l'échelle de l'usine est une tâche complexe en raison des divers éléments interdépendants et des contraintes à prendre en compte.La littérature existante ne propose pas d'approche"

Penelitian pendukung oleh DANIEL LUIS KLEIN (2024) yang dipublikasikan dalam *LA Referencia (Red Federada de Repositorios Institucionales de Publicaciones Científicas)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
