# 5756 — Operations Research & Large-Scale Optimization: A chance-constrained programming approach to optimal planning of low-carbon transition of a regional energy system

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A chance-constrained programming approach to optimal planning of low-carbon transition of a regional energy system  
**Jurnal & Sitasi Utama:** Jiaqi Zhang, Guang Tian, Xiangyu Chen (2023). *Energy*. DOI: [10.1016/j.energy.2023.127813](10.1016/j.energy.2023.127813)  
**Sitasi Pendukung:** Misagh Rahbari, Alireza Arshadi Khamseh, Mohammad Mohammadi (2025). *Computers &amp; Chemical Engineering*. DOI: [10.1016/j.compchemeng.2024.108914](10.1016/j.compchemeng.2024.108914)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiaqi Zhang, Guang Tian, Xiangyu Chen (2023) dalam jurnal *Energy* (DOI: 10.1016/j.energy.2023.127813) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Misagh Rahbari, Alireza Arshadi Khamseh, Mohammad Mohammadi (2025) yang dipublikasikan dalam *Computers &amp; Chemical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
