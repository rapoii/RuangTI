# 5083 — Simulation Modeling & Digital Twins: Scenario Simulation to Investigate new Solutions for Port Terminals and Plants based on Intelligent Data Fusion and Supply Chain Modeling

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Scenario Simulation to Investigate new Solutions for Port Terminals and Plants based on Intelligent Data Fusion and Supply Chain Modeling  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2024). *Proceedings of the 26th International Conference on Harbor, Maritime and Multimodal Logistic Modeling &amp; Simulation*. DOI: [10.46354/i3m.2024.hms.013](10.46354/i3m.2024.hms.013)  
**Sitasi Pendukung:** Taejong Yoo (2020). *Supply Chain and Logistics Management*. DOI: [10.4018/978-1-7998-0945-6.ch040](10.4018/978-1-7998-0945-6.ch040)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2024) dalam jurnal *Proceedings of the 26th International Conference on Harbor, Maritime and Multimodal Logistic Modeling &amp; Simulation* (DOI: 10.46354/i3m.2024.hms.013) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Taejong Yoo (2020) yang dipublikasikan dalam *Supply Chain and Logistics Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
