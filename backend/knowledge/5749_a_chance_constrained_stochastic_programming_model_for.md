# 5749 — Operations Research & Large-Scale Optimization: A Chance Constrained Stochastic Programming Model for Designing Two-tiered Emergency Medical Service Systems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Chance Constrained Stochastic Programming Model for Designing Two-tiered Emergency Medical Service Systems  
**Jurnal & Sitasi Utama:** Sondes Hammami, Rania Boujemaa, Aida Jebali (2023). *2023 IEEE International Conference on Advanced Systems and Emergent Technologies (IC_ASET)*. DOI: [10.1109/ic_aset58101.2023.10151012](10.1109/ic_aset58101.2023.10151012)  
**Sitasi Pendukung:** Vicente J. Bolos, Rafael Benitez, Vicente Coll (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4749365](10.2139/ssrn.4749365)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sondes Hammami, Rania Boujemaa, Aida Jebali (2023) dalam jurnal *2023 IEEE International Conference on Advanced Systems and Emergent Technologies (IC_ASET)* (DOI: 10.1109/ic_aset58101.2023.10151012) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vicente J. Bolos, Rafael Benitez, Vicente Coll (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
