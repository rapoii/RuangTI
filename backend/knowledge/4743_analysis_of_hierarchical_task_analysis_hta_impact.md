# 4743 — Human Factors & Cognitive Ergonomics: Analysis of Hierarchical Task Analysis (HTA) Impact 
on cognitive workload using NASA TLX: A Study on 
the Assembly of a Three Jaw Chuck

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Analysis of Hierarchical Task Analysis (HTA) Impact 
on cognitive workload using NASA TLX: A Study on 
the Assembly of a Three Jaw Chuck  
**Jurnal & Sitasi Utama:** KarthiK Patel, Hanumakeerthy E, Shailaja V.N (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202409.2329.v1](10.20944/preprints202409.2329.v1)  
**Sitasi Pendukung:** Faizal Mega Hardiansyah, Boy Isma Putra (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.386](10.21070/ups.386)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari KarthiK Patel, Hanumakeerthy E, Shailaja V.N (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.20944/preprints202409.2329.v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Faizal Mega Hardiansyah, Boy Isma Putra (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
