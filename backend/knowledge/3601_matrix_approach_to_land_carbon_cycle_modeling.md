# 3601 — Engineering Economics & Cost Optimization: Matrix Approach to Land Carbon Cycle Modeling

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Matrix Approach to Land Carbon Cycle Modeling  
**Jurnal & Sitasi Utama:** Yiqi Luo, Yuanyuan Huang, Carlos A. Sierra (2022). *Journal of Advances in Modeling Earth Systems*. DOI: [10.1029/2022ms003008](10.1029/2022ms003008)  
**Sitasi Pendukung:** Rohit Kumar, Arvind Bhardwaj, Lakhwinder Pal Singh (2024). *Scientific Reports*. DOI: [10.1038/s41598-024-57623-9](10.1038/s41598-024-57623-9)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yiqi Luo, Yuanyuan Huang, Carlos A. Sierra (2022) dalam jurnal *Journal of Advances in Modeling Earth Systems* (DOI: 10.1029/2022ms003008) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
