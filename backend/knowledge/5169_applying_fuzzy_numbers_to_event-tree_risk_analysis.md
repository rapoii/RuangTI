# 5169 — Safety Engineering & Risk Management: Applying Fuzzy Numbers to Event-Tree Risk Analysis — The Niedów Dam Case

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Applying Fuzzy Numbers to Event-Tree Risk Analysis — The Niedów Dam Case  
**Jurnal & Sitasi Utama:** Leszek Opyrchał, Stanisław Kostecki (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6538781](10.2139/ssrn.6538781)  
**Sitasi Pendukung:** Qing Yu, Yuhao Li, Hong Zhu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4737287](10.2139/ssrn.4737287)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Leszek Opyrchał, Stanisław Kostecki (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6538781) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "On 7 August 2010, the Niedów dam in southwest Poland failed as a result of a rare sequence of human- and nature-driven events. This paper analyses the causes and temporal progression of the failure using Event Tree Analysis (ETA) enhanced with fuzzy numbers to incorporate uncertainty in subjective, linguistic-based probability assessments. Nine contributing events were identified, including design and construction errors, turbine maintenance timing, and rapid reservoir inflow. The annual probability of failure was estimated at 1.4 × 10⁻⁶ when fuzzy numbers are applied, which is two orders of magnitude higher than the value obtained using classical probability calculations. The results demonstrate that the incorporation of uncertainty significantly influences the final probability estimate and better reflects the variability in expert-based judgments. The analysis shows that the failure of the Niedów dam resulted from a long temporal chain of contributing factors, highlighting the need to consider such scenarios in dam safety assessments."

Penelitian pendukung oleh Qing Yu, Yuhao Li, Hong Zhu (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
