# 2997 — Operations Research & Large-Scale Optimization: Branch-Cut-and-Price for the Time-Dependent Green Vehicle Routing Problem with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Branch-Cut-and-Price for the Time-Dependent Green Vehicle Routing Problem with Time Windows  
**Jurnal & Sitasi Utama:** Yiming Liu, Yang Yu, Yu Zhang (2022). *INFORMS journal on computing*. DOI: [10.1287/ijoc.2022.1195](10.1287/ijoc.2022.1195)  
**Sitasi Pendukung:** Amin Mansour‐Saatloo, Yasin Pezhmani, Mohammad Amin Mirzaei (2021). *Applied Energy*. DOI: [10.1016/j.apenergy.2021.117635](10.1016/j.apenergy.2021.117635)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yiming Liu, Yang Yu, Yu Zhang (2022) dalam jurnal *INFORMS journal on computing* (DOI: 10.1287/ijoc.2022.1195) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
