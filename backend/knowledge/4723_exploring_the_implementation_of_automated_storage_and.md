# 4723 — Facilities Planning & Material Handling: Exploring the Implementation of Automated Storage and Retrieval Systems in the Logistics Industry

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Exploring the Implementation of Automated Storage and Retrieval Systems in the Logistics Industry  
**Jurnal & Sitasi Utama:** Chun-Ting You, Liang-Bi Chen, Szu-Yu Kuo (2025). *2025 IEEE International Conference on Consumer Electronics (ICCE)*. DOI: [10.1109/icce63647.2025.10930089](10.1109/icce63647.2025.10930089)  
**Sitasi Pendukung:** Tone Lerher, Mirko Ficko, Iztok Palčič (2021). *Applied Mathematical Modelling*. DOI: [10.1016/j.apm.2020.10.032](10.1016/j.apm.2020.10.032)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chun-Ting You, Liang-Bi Chen, Szu-Yu Kuo (2025) dalam jurnal *2025 IEEE International Conference on Consumer Electronics (ICCE)* (DOI: 10.1109/icce63647.2025.10930089) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tone Lerher, Mirko Ficko, Iztok Palčič (2021) yang dipublikasikan dalam *Applied Mathematical Modelling* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
