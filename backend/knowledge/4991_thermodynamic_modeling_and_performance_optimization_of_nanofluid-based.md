# 4991 — Applied Statistics & Stochastic Modeling: Thermodynamic modeling and performance optimization of nanofluid-based photovoltaic/thermal system using central composite design scheme of response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Thermodynamic modeling and performance optimization of nanofluid-based photovoltaic/thermal system using central composite design scheme of response surface methodology  
**Jurnal & Sitasi Utama:** Praveen Kumar Tyagi, Rajan Kumar (2024). *Renewable Energy*. DOI: [10.1016/j.renene.2024.120341](10.1016/j.renene.2024.120341)  
**Sitasi Pendukung:** Chengbing Yu, Shun Liu, Andong Tao (2024). *Inorganic Chemistry Communications*. DOI: [10.1016/j.inoche.2024.112827](10.1016/j.inoche.2024.112827)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Praveen Kumar Tyagi, Rajan Kumar (2024) dalam jurnal *Renewable Energy* (DOI: 10.1016/j.renene.2024.120341) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chengbing Yu, Shun Liu, Andong Tao (2024) yang dipublikasikan dalam *Inorganic Chemistry Communications* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
