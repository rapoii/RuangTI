# 3936 — Continuous Improvement & Lean Six Sigma: IDENTIFIKASI DAN ELIMINASI PEMBOROSAN DENGAN MENGGUNAKAN KOMBINASI METODE VALUE STREAM MAPPING (VSM) DAN COST TIME PROFILE (CTP): STUDI KASUS DI PT SABE INDONESIA

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** IDENTIFIKASI DAN ELIMINASI PEMBOROSAN DENGAN MENGGUNAKAN KOMBINASI METODE VALUE STREAM MAPPING (VSM) DAN COST TIME PROFILE (CTP): STUDI KASUS DI PT SABE INDONESIA  
**Jurnal & Sitasi Utama:** Jonatan Kurnia, I Gede Agus Widyadana (2022). *Dimensi Utama Teknik Sipil*. DOI: [10.9744/duts.9.2.168-183](10.9744/duts.9.2.168-183)  
**Sitasi Pendukung:** Monika Sekaninová (2022). *International Journal of Entrepreneurial Knowledge*. DOI: [10.37335/ijek.v10i2.170](10.37335/ijek.v10i2.170)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jonatan Kurnia, I Gede Agus Widyadana (2022) dalam jurnal *Dimensi Utama Teknik Sipil* (DOI: 10.9744/duts.9.2.168-183) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Monika Sekaninová (2022) yang dipublikasikan dalam *International Journal of Entrepreneurial Knowledge* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
