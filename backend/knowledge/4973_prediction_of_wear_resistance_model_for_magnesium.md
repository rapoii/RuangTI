# 4973 — Applied Statistics & Stochastic Modeling: Prediction of wear resistance model for magnesium metal composite by response surface methodology using central composite design

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Prediction of wear resistance model for magnesium metal composite by response surface methodology using central composite design  
**Jurnal & Sitasi Utama:** Prem Sagar, Amit Handa (2021). *World Journal of Engineering*. DOI: [10.1108/wje-08-2020-0379](10.1108/wje-08-2020-0379)  
**Sitasi Pendukung:** Chinkhai Ong, Wengnam Lee, Patrik Ohberg (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-3972031/v1](10.21203/rs.3.rs-3972031/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Prem Sagar, Amit Handa (2021) dalam jurnal *World Journal of Engineering* (DOI: 10.1108/wje-08-2020-0379) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chinkhai Ong, Wengnam Lee, Patrik Ohberg (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
