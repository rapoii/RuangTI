# 4581 — Operations Research & Large-Scale Optimization: Exact Complexity Certification of a Standard Branch and Bound Method for Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Exact Complexity Certification of a Standard Branch and Bound Method for Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Shamisa Shoja, Daniel Arnstrom, Daniel Axehill (2022). *2022 IEEE 61st Conference on Decision and Control (CDC)*. DOI: [10.1109/cdc51059.2022.9992451](10.1109/cdc51059.2022.9992451)  
**Sitasi Pendukung:** Haotian Ling, Zhihai Wang, Jie Wang (2024). *Proceedings of the AAAI Conference on Artificial Intelligence*. DOI: [10.1609/aaai.v38i18.30064](10.1609/aaai.v38i18.30064)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shamisa Shoja, Daniel Arnstrom, Daniel Axehill (2022) dalam jurnal *2022 IEEE 61st Conference on Decision and Control (CDC)* (DOI: 10.1109/cdc51059.2022.9992451) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Haotian Ling, Zhihai Wang, Jie Wang (2024) yang dipublikasikan dalam *Proceedings of the AAAI Conference on Artificial Intelligence* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
