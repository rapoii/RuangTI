# 6271 — Operations Research & Large-Scale Optimization: Optimizing Maintenance Part Allocation Using Association Rules and Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimizing Maintenance Part Allocation Using Association Rules and Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Ehsan Esmaeeli, Mohsen Varmazyar, Vahid Hekmatshoar (2025). *2025 5th International Conference on Applied Automation and Industrial Diagnostics (ICAAID)*. DOI: [10.1109/icaaid68975.2025.11357995](10.1109/icaaid68975.2025.11357995)  
**Sitasi Pendukung:** Lead Industrial Researchers (2022). *Multi-level Mixed-Integer Optimization*. DOI: [10.1515/9783110760316-fm](10.1515/9783110760316-fm)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ehsan Esmaeeli, Mohsen Varmazyar, Vahid Hekmatshoar (2025) dalam jurnal *2025 5th International Conference on Applied Automation and Industrial Diagnostics (ICAAID)* (DOI: 10.1109/icaaid68975.2025.11357995) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2022) yang dipublikasikan dalam *Multi-level Mixed-Integer Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
