# 5454 — Supply Chain Management & Logistics Engineering: Multi-Echelon Inventory Optimization for Offshore Wind Farms Maintenance Components

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Multi-Echelon Inventory Optimization for Offshore Wind Farms Maintenance Components  
**Jurnal & Sitasi Utama:** Md Imran Hasan Tusar, B. R. Sarker (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4719924](10.2139/ssrn.4719924)  
**Sitasi Pendukung:** Roberto Rossi (2021). *Inventory Analytics*. DOI: [10.11647/obp.0252.05](10.11647/obp.0252.05)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Md Imran Hasan Tusar, B. R. Sarker (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4719924) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Roberto Rossi (2021) yang dipublikasikan dalam *Inventory Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
