# 3185 — Human Factors & Cognitive Ergonomics: Workload Assessment of Operators: Correlation Between NASA-TLX and Pupillary Responses

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Workload Assessment of Operators: Correlation Between NASA-TLX and Pupillary Responses  
**Jurnal & Sitasi Utama:** Yun Wu, Yao Zhang, Bin Zheng (2024). *Applied Sciences*. DOI: [10.3390/app142411975](10.3390/app142411975)  
**Sitasi Pendukung:** Wenbin Li, Rong Li, Xiaoping Xie (2022). *Brain and Behavior*. DOI: [10.1002/brb3.2489](10.1002/brb3.2489)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yun Wu, Yao Zhang, Bin Zheng (2024) dalam jurnal *Applied Sciences* (DOI: 10.3390/app142411975) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wenbin Li, Rong Li, Xiaoping Xie (2022) yang dipublikasikan dalam *Brain and Behavior* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
