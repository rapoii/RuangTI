# 4444 — Manufacturing Systems & Cyber-Physical Production: Digital Twin-based Production Simulation of Discrete Manufacturing Shop-floor for Onsite Performance Analysis

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Digital Twin-based Production Simulation of Discrete Manufacturing Shop-floor for Onsite Performance Analysis  
**Jurnal & Sitasi Utama:** Y. F. Zhang, Y. Q. Shao, J. F. Wang (2020). *2020 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem45057.2020.9309928](10.1109/ieem45057.2020.9309928)  
**Sitasi Pendukung:** Louie Webb, Mohammad  Osman Tokhi, Bugra Alkan (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5517139](10.2139/ssrn.5517139)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Y. F. Zhang, Y. Q. Shao, J. F. Wang (2020) dalam jurnal *2020 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)* (DOI: 10.1109/ieem45057.2020.9309928) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Louie Webb, Mohammad  Osman Tokhi, Bugra Alkan (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
