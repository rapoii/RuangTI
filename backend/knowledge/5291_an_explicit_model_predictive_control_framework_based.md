# 5291 — Industrial Artificial Intelligence & Data Analytics: An explicit model predictive control framework based on physics-informed neural networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** An explicit model predictive control framework based on physics-informed neural networks  
**Jurnal & Sitasi Utama:** Argyri Kardamaki, Teo Protoulis, Alex Alexandridis (2026). *Journal of Process Control*. DOI: [10.1016/j.jprocont.2026.103634](10.1016/j.jprocont.2026.103634)  
**Sitasi Pendukung:** Levent Ugur, Shubham B. Karpe, Po-Han Huang (2025). *AIAA AVIATION FORUM AND ASCEND 2025*. DOI: [10.2514/6.2025-3219](10.2514/6.2025-3219)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Argyri Kardamaki, Teo Protoulis, Alex Alexandridis (2026) dalam jurnal *Journal of Process Control* (DOI: 10.1016/j.jprocont.2026.103634) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
