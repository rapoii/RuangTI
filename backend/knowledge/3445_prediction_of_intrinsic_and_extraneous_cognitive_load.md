# 3445 — Human Factors & Cognitive Ergonomics: Prediction of intrinsic and extraneous cognitive load with oculometric and biometric indicators

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Prediction of intrinsic and extraneous cognitive load with oculometric and biometric indicators  
**Jurnal & Sitasi Utama:** Merve Ekin, Krzysztof Krejtz, Carlos Duarte (2025). *Scientific Reports*. DOI: [10.1038/s41598-025-89336-y](10.1038/s41598-025-89336-y)  
**Sitasi Pendukung:** Şeniz Harputlu Aksu, Erman Çakıt, Metin Dağdeviren (2024). *Applied Sciences*. DOI: [10.3390/app14062282](10.3390/app14062282)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Merve Ekin, Krzysztof Krejtz, Carlos Duarte (2025) dalam jurnal *Scientific Reports* (DOI: 10.1038/s41598-025-89336-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Şeniz Harputlu Aksu, Erman Çakıt, Metin Dağdeviren (2024) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
