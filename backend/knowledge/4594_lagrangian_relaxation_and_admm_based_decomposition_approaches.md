# 4594 — Operations Research & Large-Scale Optimization: Lagrangian relaxation and ADMM based decomposition approaches for the road network design problem considering travel time variability

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Lagrangian relaxation and ADMM based decomposition approaches for the road network design problem considering travel time variability  
**Jurnal & Sitasi Utama:** Maocan Song, Lin Cheng (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-2028763/v1](10.21203/rs.3.rs-2028763/v1)  
**Sitasi Pendukung:** Saiede Jamshaidpour, Nadereh Ghorbani (2021). *Journal of Research in Science, Engineering and Technology*. DOI: [10.24200/jrset.vol9iss03pp24-63](10.24200/jrset.vol9iss03pp24-63)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Maocan Song, Lin Cheng (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-2028763/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
