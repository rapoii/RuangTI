# 5173 — Safety Engineering & Risk Management: Fault Tree Analysis and application

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Fault Tree Analysis and application  
**Jurnal & Sitasi Utama:** Mohammad Ali Farsi (2025). *Reliability Assessment and Optimization of Complex Systems*. DOI: [10.1016/b978-0-443-29112-8.00015-3](10.1016/b978-0-443-29112-8.00015-3)  
**Sitasi Pendukung:** Yunus Emre Senol (2024). *Ocean Engineering*. DOI: [10.1016/j.oceaneng.2024.117559](10.1016/j.oceaneng.2024.117559)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohammad Ali Farsi (2025) dalam jurnal *Reliability Assessment and Optimization of Complex Systems* (DOI: 10.1016/b978-0-443-29112-8.00015-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yunus Emre Senol (2024) yang dipublikasikan dalam *Ocean Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
