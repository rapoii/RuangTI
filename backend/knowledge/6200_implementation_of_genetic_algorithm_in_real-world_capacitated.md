# 6200 — Operations Research & Large-Scale Optimization: Implementation of Genetic Algorithm in Real-World Capacitated Vehicle Routing Problem with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Implementation of Genetic Algorithm in Real-World Capacitated Vehicle Routing Problem with Time Windows  
**Jurnal & Sitasi Utama:** Syeda Fatema Azmi, Chaowalit Hamontree (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4876984](10.2139/ssrn.4876984)  
**Sitasi Pendukung:** Kai Yoshida, Ken Kobayashi, Kazuma Kawai (2026). *Proceedings of the 15th International Conference on Operations Research and Enterprise Systems*. DOI: [10.5220/0014461800004055](10.5220/0014461800004055)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Syeda Fatema Azmi, Chaowalit Hamontree (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4876984) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kai Yoshida, Ken Kobayashi, Kazuma Kawai (2026) yang dipublikasikan dalam *Proceedings of the 15th International Conference on Operations Research and Enterprise Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
