# 5436 — Operations Research & Large-Scale Optimization: Hybrid Large Neighborhood Search for the Capacitated Vehicle Routing Problem and the Vehicle Routing Problem with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Hybrid Large Neighborhood Search for the Capacitated Vehicle Routing Problem and the Vehicle Routing Problem with Time Windows  
**Jurnal & Sitasi Utama:** Stefan Voigt, Markus Frank, Pirmin Fontaine (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4176106](10.2139/ssrn.4176106)  
**Sitasi Pendukung:** Shiping Wu, Hongguang Bo, Chun Jin (2024). *Computers &amp; Operations Research*. DOI: [10.1016/j.cor.2023.106523](10.1016/j.cor.2023.106523)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Stefan Voigt, Markus Frank, Pirmin Fontaine (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4176106) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
