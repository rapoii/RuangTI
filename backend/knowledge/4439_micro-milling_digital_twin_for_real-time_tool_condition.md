# 4439 — Manufacturing Systems & Cyber-Physical Production: Micro-milling digital twin for real-time tool condition monitoring

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Micro-milling digital twin for real-time tool condition monitoring  
**Jurnal & Sitasi Utama:** Darren Low Wei Wen, Hong Geok Soon, A. Senthil Kumar (2024). *Manufacturing Letters*. DOI: [10.1016/j.mfglet.2024.09.149](10.1016/j.mfglet.2024.09.149)  
**Sitasi Pendukung:** Chenyuan Zhang, Fei Tao, Weiran Liu (2025). *Journal of Manufacturing Systems*. DOI: [10.1016/j.jmsy.2025.07.017](10.1016/j.jmsy.2025.07.017)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Darren Low Wei Wen, Hong Geok Soon, A. Senthil Kumar (2024) dalam jurnal *Manufacturing Letters* (DOI: 10.1016/j.mfglet.2024.09.149) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chenyuan Zhang, Fei Tao, Weiran Liu (2025) yang dipublikasikan dalam *Journal of Manufacturing Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
