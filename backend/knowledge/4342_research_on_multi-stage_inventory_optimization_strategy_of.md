# 4342 — Supply Chain Management & Logistics Engineering: Research on Multi-stage Inventory Optimization Strategy of Multi-echelon Supply Chain Based on Dynamic Programming Algorithm

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Research on Multi-stage Inventory Optimization Strategy of Multi-echelon Supply Chain Based on Dynamic Programming Algorithm  
**Jurnal & Sitasi Utama:** Xiaoqing Wu (2026). *Lecture Notes in Electrical Engineering*. DOI: [10.1007/978-981-92-1030-5_7](10.1007/978-981-92-1030-5_7)  
**Sitasi Pendukung:** Pan Li (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7051299](10.2139/ssrn.7051299)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiaoqing Wu (2026) dalam jurnal *Lecture Notes in Electrical Engineering* (DOI: 10.1007/978-981-92-1030-5_7) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Pan Li (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
