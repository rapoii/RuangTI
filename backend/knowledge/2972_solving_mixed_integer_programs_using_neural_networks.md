# 2972 — Operations Research & Large-Scale Optimization: Solving Mixed Integer Programs Using Neural Networks

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Solving Mixed Integer Programs Using Neural Networks  
**Jurnal & Sitasi Utama:** Vinod Nair, Sergey Bartunov, Felix Gimeno (2020). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2012.13349](10.48550/arxiv.2012.13349)  
**Sitasi Pendukung:** Gregor Hendel (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-021-00209-7](10.1007/s12532-021-00209-7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Vinod Nair, Sergey Bartunov, Felix Gimeno (2020) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2012.13349) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
