# 6421 — Human Factors & Cognitive Ergonomics: The NASA-TLX Approach to Understand Workers Workload in Human-Robot Collaboration

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** The NASA-TLX Approach to Understand Workers Workload in Human-Robot Collaboration  
**Jurnal & Sitasi Utama:** A. Javernik, B. Buchmeister, R. Ojstersek (2023). *International Journal of Simulation Modelling*. DOI: [10.2507/ijsimm22-4-658](10.2507/ijsimm22-4-658)  
**Sitasi Pendukung:** Pavol Švorc, Soňa Grešová, Pavol Švorc (2023). *Physiological Reports*. DOI: [10.14814/phy2.15827](10.14814/phy2.15827)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari A. Javernik, B. Buchmeister, R. Ojstersek (2023) dalam jurnal *International Journal of Simulation Modelling* (DOI: 10.2507/ijsimm22-4-658) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
