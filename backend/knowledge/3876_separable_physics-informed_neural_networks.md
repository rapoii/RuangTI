# 3876 — Industrial Artificial Intelligence & Data Analytics: Separable Physics-Informed Neural Networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Separable Physics-Informed Neural Networks  
**Jurnal & Sitasi Utama:** Jun Woo Cho, Seungtae Nam, Hyunmo Yang (2023). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2306.15969](10.48550/arxiv.2306.15969)  
**Sitasi Pendukung:** Federico Antonello, Jacopo Buongiorno, Enrico Zio (2023). *Nuclear Engineering and Technology*. DOI: [10.1016/j.net.2023.06.027](10.1016/j.net.2023.06.027)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jun Woo Cho, Seungtae Nam, Hyunmo Yang (2023) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2306.15969) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
