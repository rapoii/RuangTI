# 3817 — Maintenance Engineering & Asset Life Cycle: A probabilistic reliability‐centred maintenance approach for electrical distribution networks

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** A probabilistic reliability‐centred maintenance approach for electrical distribution networks  
**Jurnal & Sitasi Utama:** Habib Allah Ravaghi Ardabili, Mahmoud‐Reza Haghifam, Seyyed Mostafa Abedi (2020). *IET Generation Transmission & Distribution*. DOI: [10.1049/gtd2.12081](10.1049/gtd2.12081)  
**Sitasi Pendukung:** Mahmood Shafiee, Tobi Elusakin, Evenye Enjema (2020). *Journal of Loss Prevention in the Process Industries*. DOI: [10.1016/j.jlp.2020.104170](10.1016/j.jlp.2020.104170)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Habib Allah Ravaghi Ardabili, Mahmoud‐Reza Haghifam, Seyyed Mostafa Abedi (2020) dalam jurnal *IET Generation Transmission & Distribution* (DOI: 10.1049/gtd2.12081) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mahmood Shafiee, Tobi Elusakin, Evenye Enjema (2020) yang dipublikasikan dalam *Journal of Loss Prevention in the Process Industries* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
