# 3736 — Industrial Energy Management & Decarbonization: A simultaneous approach for integration of thermal energy storages in industrial processes using multiperiod heat integration

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** A simultaneous approach for integration of thermal energy storages in industrial processes using multiperiod heat integration  
**Jurnal & Sitasi Utama:** Simon Möhren, Christian Schäfer, Jörg Meyer (2022). *Energy Storage and Saving*. DOI: [10.1016/j.enss.2022.04.002](10.1016/j.enss.2022.04.002)  
**Sitasi Pendukung:** Raymond R. Tan, Kathleen B. Aviso, Santanu Bandyopadhyay (2021). *Cleaner Engineering and Technology*. DOI: [10.1016/j.clet.2021.100141](10.1016/j.clet.2021.100141)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Simon Möhren, Christian Schäfer, Jörg Meyer (2022) dalam jurnal *Energy Storage and Saving* (DOI: 10.1016/j.enss.2022.04.002) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
