# 4950 — Applied Statistics & Stochastic Modeling: On the design and analysis of near-term quantum network protocols using Markov decision processes

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** On the design and analysis of near-term quantum network protocols using Markov decision processes  
**Jurnal & Sitasi Utama:** Sumeet Khatri (2022). *AVS Quantum Science*. DOI: [10.1116/5.0084653](10.1116/5.0084653)  
**Sitasi Pendukung:** Oualid Missaoui (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4535241](10.2139/ssrn.4535241)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sumeet Khatri (2022) dalam jurnal *AVS Quantum Science* (DOI: 10.1116/5.0084653) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
