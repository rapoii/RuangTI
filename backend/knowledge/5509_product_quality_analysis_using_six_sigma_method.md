# 5509 — Quality Engineering & Reliability Systems: Product Quality Analysis Using Six Sigma Method and Failure Mode And Effect Analysis (FMEA) in Furniture Products

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Product Quality Analysis Using Six Sigma Method and Failure Mode And Effect Analysis (FMEA) in Furniture Products  
**Jurnal & Sitasi Utama:** Muhammad Adi Arifianto, Wiwik Sulistiyowati (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.2996](10.21070/ups.2996)  
**Sitasi Pendukung:** Tarnveer Singh (2025). *Digital Resilience, Cybersecurity and Supply Chains*. DOI: [10.4324/9781003604969-4](10.4324/9781003604969-4)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Muhammad Adi Arifianto, Wiwik Sulistiyowati (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21070/ups.2996) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tarnveer Singh (2025) yang dipublikasikan dalam *Digital Resilience, Cybersecurity and Supply Chains* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
