# 5833 — Supply Chain Management & Logistics Engineering: An efficient matheuristic algorithm for bi-objective sustainable closed-loop supply chain networks

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** An efficient matheuristic algorithm for bi-objective sustainable closed-loop supply chain networks  
**Jurnal & Sitasi Utama:** Chandra Ade Irawan, Muhammad D. Abdulrahman, Saı̈d Salhi (2022). *IMA Journal of Management Mathematics*. DOI: [10.1093/imaman/dpac003](10.1093/imaman/dpac003)  
**Sitasi Pendukung:** Hasith Gunasekara, J.R. Gamage, H. K. G. Punchihewa (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.02.146](10.1016/j.promfg.2020.02.146)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chandra Ade Irawan, Muhammad D. Abdulrahman, Saı̈d Salhi (2022) dalam jurnal *IMA Journal of Management Mathematics* (DOI: 10.1093/imaman/dpac003) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
