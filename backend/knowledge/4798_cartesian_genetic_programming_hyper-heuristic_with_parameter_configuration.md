# 4798 — Production Planning & Inventory Control: Cartesian Genetic Programming Hyper-Heuristic with Parameter Configuration for Production Lot-Sizing

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Cartesian Genetic Programming Hyper-Heuristic with Parameter Configuration for Production Lot-Sizing  
**Jurnal & Sitasi Utama:** Luis Filipe de Araujo Pessoa, Bernd Hellingrath, Fernando Buarque de Lima Neto (2020). *2020 IEEE Congress on Evolutionary Computation (CEC)*. DOI: [10.1109/cec48606.2020.9185602](10.1109/cec48606.2020.9185602)  
**Sitasi Pendukung:** Jie Fan, Jinwen Ou (2023). *Omega*. DOI: [10.1016/j.omega.2023.102895](10.1016/j.omega.2023.102895)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Luis Filipe de Araujo Pessoa, Bernd Hellingrath, Fernando Buarque de Lima Neto (2020) dalam jurnal *2020 IEEE Congress on Evolutionary Computation (CEC)* (DOI: 10.1109/cec48606.2020.9185602) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jie Fan, Jinwen Ou (2023) yang dipublikasikan dalam *Omega* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
