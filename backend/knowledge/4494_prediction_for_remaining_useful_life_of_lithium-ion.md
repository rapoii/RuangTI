# 4494 — Maintenance Engineering & Asset Life Cycle: Prediction for Remaining Useful Life of Lithium-ion Batteries Based on NGO-VMD and LSTM

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Prediction for Remaining Useful Life of Lithium-ion Batteries Based on NGO-VMD and LSTM  
**Jurnal & Sitasi Utama:** Wantong Xu, Yingshun Li, Bin Yang (2024). *2024 Prognostics and System Health Management Conference (PHM)*. DOI: [10.1109/phm61473.2024.00013](10.1109/phm61473.2024.00013)  
**Sitasi Pendukung:** Jaeyeon Jang (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-1588424/v1](10.21203/rs.3.rs-1588424/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wantong Xu, Yingshun Li, Bin Yang (2024) dalam jurnal *2024 Prognostics and System Health Management Conference (PHM)* (DOI: 10.1109/phm61473.2024.00013) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jaeyeon Jang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
