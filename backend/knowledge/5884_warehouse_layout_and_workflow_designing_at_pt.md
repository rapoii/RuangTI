# 5884 — Facilities Planning & Material Handling: Warehouse layout and workflow designing at PT. PMS using systematic layout planning method

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Warehouse layout and workflow designing at PT. PMS using systematic layout planning method  
**Jurnal & Sitasi Utama:** Tamimi Zakirah, Riyan Emeraldi, Octavianus M. Handi (2018). *IOP Conference Series Earth and Environmental Science*. DOI: [10.1088/1755-1315/195/1/012026](10.1088/1755-1315/195/1/012026)  
**Sitasi Pendukung:** Peter Mårdberg, Jessica Fredby, Klas Engström (2018). *Procedia CIRP*. DOI: [10.1016/j.procir.2018.03.158](10.1016/j.procir.2018.03.158)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tamimi Zakirah, Riyan Emeraldi, Octavianus M. Handi (2018) dalam jurnal *IOP Conference Series Earth and Environmental Science* (DOI: 10.1088/1755-1315/195/1/012026) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "PT. PMS, a company which has specialization in offshore and onshore services has many equipments to support their service operation. The equipment has been classified into four divisions, Diving, ROV, Cleaning and Painting. The problems observed in PT. PMS warehouse were their disorganized warehouse system which has no fixed layout design. For the purpose of improvement, a new warehouse layout design was proposed in this study to solve the problem. The method of modified Systematic Layout Planning (SLP) has been used to design an efficient warehouse layout. Step by step layout procedure has been done. It consists of Activity Relationship Chart and Activity Relationship Diagram that have been discussed. It is proved from this study that SLP method provides an effective method in layout designing, even in the service company that has many equipments to be stored in an efficient manner."

Penelitian pendukung oleh Peter Mårdberg, Jessica Fredby, Klas Engström (2018) yang dipublikasikan dalam *Procedia CIRP* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
