# 4447 — Manufacturing Systems & Cyber-Physical Production: An ontology-based shop-floor digital twin configuration approach

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** An ontology-based shop-floor digital twin configuration approach  
**Jurnal & Sitasi Utama:** Xiaolang Yang, Xuemei Liu, Heng Zhang (2023). *Procedia CIRP*. DOI: [10.1016/j.procir.2023.08.058](10.1016/j.procir.2023.08.058)  
**Sitasi Pendukung:** İlker GÜVEN, Fuat ŞİMŞİR (2021). *Sakarya University Journal of Science*. DOI: [10.16984/saufenbilder.842423](10.16984/saufenbilder.842423)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiaolang Yang, Xuemei Liu, Heng Zhang (2023) dalam jurnal *Procedia CIRP* (DOI: 10.1016/j.procir.2023.08.058) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
