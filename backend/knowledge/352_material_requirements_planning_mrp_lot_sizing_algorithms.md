# Modul Komprehensif: Material Requirements Planning (MRP I): Netting, Offsetting, & Lot Sizing
**Nomor Modul:** [352]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Factory Physics (Wallace J. Hopp, Mark L. Spearman), Computers & Industrial Engineering (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Material Requirements Planning (MRP I): Netting, Offsetting, & Lot Sizing**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: MRP Matrix Logic (Gross Requirements, Scheduled Receipts, Projected Available, Net Requirements, Planned Order Receipts/Releases), Lot Sizing (L4L, EOQ, POQ, Wagner-Whitin, Silver-Meal, Part Period Balancing).
...
```python
# Algoritma Solusi Terapan untuk Material Requirements Planning (MRP I): Netting, Offsetting, & Lot Sizing
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penerapan Algoritma Lot Sizing Silver-Meal pada 4.500 Komponen Perakitan Generator Listrik.
...
1. Factory Physics (Wallace J. Hopp, Mark L. Spearman), Computers & Industrial Engineering (2024).
