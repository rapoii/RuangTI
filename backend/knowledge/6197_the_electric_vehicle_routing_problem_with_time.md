# 6197 — Operations Research & Large-Scale Optimization: The Electric Vehicle Routing Problem with Time Windows and Three Charging Options

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** The Electric Vehicle Routing Problem with Time Windows and Three Charging Options  
**Jurnal & Sitasi Utama:** Zhihao Jiang, Fuguang Bao, Ning Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4263893](10.2139/ssrn.4263893)  
**Sitasi Pendukung:** Ping Lou, Zikang Zhou, Yuhang Zeng (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-3000408/v1](10.21203/rs.3.rs-3000408/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zhihao Jiang, Fuguang Bao, Ning Wang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4263893) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "With the gradual popularization of electric vehicles, the endurance of electric vehicles becomes increasingly prominent. On the basis of traditional vehicle routing problem with time windows, this paper proposes the electric vehicle routing problem with time windows and three charging options. In this problem, on the precondition of satisfying the constraints such as time windows, we need to judge whether charging is necessary according to the electric quantity of electric vehicle and the tasks to be completed. If charging is necessary, we need to select charging station and charging strategy. The charging strategy includes: slow charging strategy, fast charging strategy and battery swapping strategy. In order to solve the problem, this paper designs an improved ant colony algorithm with a probability selection model, in which the urgency of customers&amp;apos; needs is considered, and the elite ant strategy is adopted. Finally, three types of instances are used to verify the algorithm, and the computational results show that the proposed algorithm has more advantages in running time and solution quality."

Penelitian pendukung oleh Ping Lou, Zikang Zhou, Yuhang Zeng (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
