# 5315 — Industrial Artificial Intelligence & Data Analytics: Automated Welding Defect Detection Using YOLO: A Deep Learning Approach for Industrial Quality Assurance

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Automated Welding Defect Detection Using YOLO: A Deep Learning Approach for Industrial Quality Assurance  
**Jurnal & Sitasi Utama:** Srujan Hrudhay Geddam (2024). *Peer-Reviewed Journal*. DOI: [10.31224/6685](10.31224/6685)  
**Sitasi Pendukung:** Yulan Zeng, Wansu Lim (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11085992](10.1109/cvidl65390.2025.11085992)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Srujan Hrudhay Geddam (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.31224/6685) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yulan Zeng, Wansu Lim (2025) yang dipublikasikan dalam *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
