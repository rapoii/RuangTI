# 3604 — Applied Statistics & Stochastic Modeling: Queuing Network Models of Multiservice RANs

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Queuing Network Models of Multiservice RANs  
**Jurnal & Sitasi Utama:** Andrea Marin, Michela Meo, Matteo Sereno (2024). *ACM Transactions on Modeling and Performance Evaluation of Computing Systems*. DOI: [10.1145/3649307](10.1145/3649307)  
**Sitasi Pendukung:** Sonja Otten, Ruslan Krenzler, Lin Xie (2021). *OR Spectrum*. DOI: [10.1007/s00291-021-00662-9](10.1007/s00291-021-00662-9)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Andrea Marin, Michela Meo, Matteo Sereno (2024) dalam jurnal *ACM Transactions on Modeling and Performance Evaluation of Computing Systems* (DOI: 10.1145/3649307) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
