# 3632 — Applied Statistics & Stochastic Modeling: Developing Sustainable Hospital Capacity Management Protocols Using Clinical Prognostic Analysis: A Novel Stochastic Model for Covid-19

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Developing Sustainable Hospital Capacity Management Protocols Using Clinical Prognostic Analysis: A Novel Stochastic Model for Covid-19  
**Jurnal & Sitasi Utama:** Mohsen Saadat, Mohammad Heydari, Zhai Dongsheng (2024). *Preprints.org*. DOI: [10.20944/preprints202405.1255.v1](10.20944/preprints202405.1255.v1)  
**Sitasi Pendukung:** A. J. Schneider (2020). *Peer-Reviewed Academic Journal*. DOI: [10.3990/1.9789036550345](10.3990/1.9789036550345)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohsen Saadat, Mohammad Heydari, Zhai Dongsheng (2024) dalam jurnal *Preprints.org* (DOI: 10.20944/preprints202405.1255.v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
