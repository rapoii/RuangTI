# 6207 — Operations Research & Large-Scale Optimization: A Real-World Multi-Depot, Multi-Period, and Multi-Trip Vehicle Routing Problem with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Real-World Multi-Depot, Multi-Period, and Multi-Trip Vehicle Routing Problem with Time Windows  
**Jurnal & Sitasi Utama:** Mirko Cavecchia, Thiago Alves de Queiroz, Riccardo Lancellotti (2025). *Proceedings of the 14th International Conference on Operations Research and Enterprise Systems*. DOI: [10.5220/0013153100003893](10.5220/0013153100003893)  
**Sitasi Pendukung:** Pedro Munari (2024). *Peer-Reviewed Journal*. DOI: [10.52843/cassyni.hwprdn](10.52843/cassyni.hwprdn)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mirko Cavecchia, Thiago Alves de Queiroz, Riccardo Lancellotti (2025) dalam jurnal *Proceedings of the 14th International Conference on Operations Research and Enterprise Systems* (DOI: 10.5220/0013153100003893) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Pedro Munari (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
