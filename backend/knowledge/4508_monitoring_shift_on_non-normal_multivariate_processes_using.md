# 4508 — Quality Engineering & Reliability Systems: Monitoring shift on non-normal multivariate processes using T2 hotelling double Bootstrap control chart

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Monitoring shift on non-normal multivariate processes using T2 hotelling double Bootstrap control chart  
**Jurnal & Sitasi Utama:** Jauharin Insiyah, Suci Astutik, Loekito Adi Soehono (2023). *AIP Conference Proceedings*. DOI: [10.1063/5.0167234](10.1063/5.0167234)  
**Sitasi Pendukung:** Julian Morris (2021). *Encyclopedia of Systems and Control*. DOI: [10.1007/978-3-030-44184-5_250](10.1007/978-3-030-44184-5_250)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jauharin Insiyah, Suci Astutik, Loekito Adi Soehono (2023) dalam jurnal *AIP Conference Proceedings* (DOI: 10.1063/5.0167234) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Julian Morris (2021) yang dipublikasikan dalam *Encyclopedia of Systems and Control* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
