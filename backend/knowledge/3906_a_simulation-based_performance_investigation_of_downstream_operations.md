# 3906 — Continuous Improvement & Lean Six Sigma: A simulation-based performance investigation of downstream operations in the Indian Surimi Supply Chain using environmental value stream mapping

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** A simulation-based performance investigation of downstream operations in the Indian Surimi Supply Chain using environmental value stream mapping  
**Jurnal & Sitasi Utama:** Farook Abdullah Sultan, Srikanta Routroy, Maitri Thakur (2020). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2020.125389](10.1016/j.jclepro.2020.125389)  
**Sitasi Pendukung:** Qingqi Liu, Hualong Yang (2020). *IEEE Access*. DOI: [10.1109/access.2020.3037660](10.1109/access.2020.3037660)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Farook Abdullah Sultan, Srikanta Routroy, Maitri Thakur (2020) dalam jurnal *Journal of Cleaner Production* (DOI: 10.1016/j.jclepro.2020.125389) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qingqi Liu, Hualong Yang (2020) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
