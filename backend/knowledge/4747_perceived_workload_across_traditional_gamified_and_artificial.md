# 4747 — Human Factors & Cognitive Ergonomics: Perceived Workload Across Traditional, Gamified and Artificial Intelligence-Supported Learning Conditions: A NASA-TLX Study in Higher Education

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Perceived Workload Across Traditional, Gamified and Artificial Intelligence-Supported Learning Conditions: A NASA-TLX Study in Higher Education  
**Jurnal & Sitasi Utama:** MARIAROSARIA SPERANZA, Nadia Gamboz, Simona Collina (2024). *Peer-Reviewed Journal*. DOI: [10.35542/osf.io/e5bk2_v1](10.35542/osf.io/e5bk2_v1)  
**Sitasi Pendukung:** Zia Dwi Arta, Dony Satriyo, Janu Apriyadi (2025). *Metode : Jurnal Teknik Industri*. DOI: [10.33506/mt.v11i2.4531](10.33506/mt.v11i2.4531)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari MARIAROSARIA SPERANZA, Nadia Gamboz, Simona Collina (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.35542/osf.io/e5bk2_v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Gamification and artificial intelligence-supported learning are often introduced in higher education with a familiar promise: more engagement, greater efficiency and better preparation for digitally mediated work. Much less attention is paid to the workload that students experience while moving through these environments. This exploratory study focuses on that point. It compares perceived workload in three conditions of a university experiment: traditional individual study, conventional gamification and gamification with conditioned progression supported by artificial intelligence functions. Workload was measured with the NASA Task Load Index (NASA-TLX), using six 0-10 ratings: mental demand, physical demand, temporal demand, perceived performance, effort and frustration. Welch ANOVAs did not show statistically significant differences between the three groups on any of the six dimensions. Mental demand was high in all conditions, while physical demand remained low, as expected in a study-based digital task. An exploratory analysis of the NASA-TLX pairwise weighting procedure showed two significant differences, involving mental demand versus perceived performance and temporal demand versus perceived performance. These results do not support a simple claim that gamification or AI-supported progression either increases or reduces workload. They suggest instead that cognitive sustainability depends on how the path is designed, paced, explained and supervised. The paper reads thes"

Penelitian pendukung oleh Zia Dwi Arta, Dony Satriyo, Janu Apriyadi (2025) yang dipublikasikan dalam *Metode : Jurnal Teknik Industri* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
