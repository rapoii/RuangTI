# 5288 — Industrial Artificial Intelligence & Data Analytics: Hybrid Physics-Informed Neural Networks for Thermal Process Identification and Control

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Hybrid Physics-Informed Neural Networks for Thermal Process Identification and Control  
**Jurnal & Sitasi Utama:** Sahar Hemmati, Mohammadreza Babaei, John Hedengren (2026). *Systems and Control Transactions*. DOI: [10.69997/sct.135132](10.69997/sct.135132)  
**Sitasi Pendukung:** Miquel Noguer I Alonso (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5297552](10.2139/ssrn.5297552)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sahar Hemmati, Mohammadreza Babaei, John Hedengren (2026) dalam jurnal *Systems and Control Transactions* (DOI: 10.69997/sct.135132) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Miquel Noguer I Alonso (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
