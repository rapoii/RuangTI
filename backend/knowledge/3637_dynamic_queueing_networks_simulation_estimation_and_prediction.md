# 3637 — Applied Statistics & Stochastic Modeling: Dynamic queueing networks: Simulation, estimation and prediction

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Dynamic queueing networks: Simulation, estimation and prediction  
**Jurnal & Sitasi Utama:** Anthony Ebert (2020). *Queensland University of Technology*. DOI: [10.5204/thesis.eprints.180771](10.5204/thesis.eprints.180771)  
**Sitasi Pendukung:** Carlos Brito, Gabriel Araújo, Paulo A. L. Rêgo (2023). *Research Square*. DOI: [10.21203/rs.3.rs-3408896/v1](10.21203/rs.3.rs-3408896/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anthony Ebert (2020) dalam jurnal *Queensland University of Technology* (DOI: 10.5204/thesis.eprints.180771) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Carlos Brito, Gabriel Araújo, Paulo A. L. Rêgo (2023) yang dipublikasikan dalam *Research Square* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
