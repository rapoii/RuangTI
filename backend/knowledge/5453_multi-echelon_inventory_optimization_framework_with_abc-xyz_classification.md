# 5453 — Supply Chain Management & Logistics Engineering: Multi-Echelon Inventory Optimization Framework with ABC-XYZ Classification: Evidence from Simulation-Based Validation

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Multi-Echelon Inventory Optimization Framework with ABC-XYZ Classification: Evidence from Simulation-Based Validation  
**Jurnal & Sitasi Utama:** Qingze Zhu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5407306](10.2139/ssrn.5407306)  
**Sitasi Pendukung:** Md Imran Hasan Tusar, B. R. Sarker (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4719924](10.2139/ssrn.4719924)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Qingze Zhu (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5407306) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Md Imran Hasan Tusar, B. R. Sarker (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
