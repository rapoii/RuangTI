# 5077 — Simulation Modeling & Digital Twins: Simulation Modeling of Logistics Supply Chain Based on AnyLogic

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulation Modeling of Logistics Supply Chain Based on AnyLogic  
**Jurnal & Sitasi Utama:** Ya Yang (2025). *Advances in Engineering Technology Research*. DOI: [10.56028/aetr.13.1.299.2025](10.56028/aetr.13.1.299.2025)  
**Sitasi Pendukung:** Zakka Ugih Rizqi (2025). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2025.100150](10.1016/j.sca.2025.100150)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ya Yang (2025) dalam jurnal *Advances in Engineering Technology Research* (DOI: 10.56028/aetr.13.1.299.2025) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "In response to the complexity of the pharmacy supply chain network, AnyLogic software is utilized to conduct simulation analysis on this supply chain network. The relationships among the main warehouse, regional warehouses, and stores are connected through agents and flowcharts, and the final results are intuitively displayed in GIS. The product flow and layout of the regional warehouses are analyzed, and the logistics costs in the initial state are statistically calculated. Then, AnyLogic is used again for simulation to verify the optimization results."

Penelitian pendukung oleh Zakka Ugih Rizqi (2025) yang dipublikasikan dalam *Supply Chain Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
