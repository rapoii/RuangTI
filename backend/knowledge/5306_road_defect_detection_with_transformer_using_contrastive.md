# 5306 — Industrial Artificial Intelligence & Data Analytics: Road Defect Detection with Transformer Using Contrastive Learning and Adaptive Computing

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Road Defect Detection with Transformer Using Contrastive Learning and Adaptive Computing  
**Jurnal & Sitasi Utama:** Shichun Wang (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637601](10.1109/cvidl70130.2026.11637601)  
**Sitasi Pendukung:** Meng An, Shiyu Wang, Liaomo Zheng (2020). *2020 International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl51233.2020.00-78](10.1109/cvidl51233.2020.00-78)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shichun Wang (2026) dalam jurnal *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl70130.2026.11637601) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Meng An, Shiyu Wang, Liaomo Zheng (2020) yang dipublikasikan dalam *2020 International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
