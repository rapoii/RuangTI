# 5062 — Simulation Modeling & Digital Twins: A supply chain analytics framework for selective supplier rewiring using agent-based network simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** A supply chain analytics framework for selective supplier rewiring using agent-based network simulation  
**Jurnal & Sitasi Utama:** Islam El-Nakib (2026). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2026.100225](10.1016/j.sca.2026.100225)  
**Sitasi Pendukung:** Yucheng Wang (2024). *Peer-Reviewed Journal*. DOI: [10.32920/ryerson.14662929](10.32920/ryerson.14662929)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Islam El-Nakib (2026) dalam jurnal *Supply Chain Analytics* (DOI: 10.1016/j.sca.2026.100225) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yucheng Wang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
