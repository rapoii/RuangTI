# 4667 — Manufacturing Systems & Cyber-Physical Production: Industry 4.0 more than a challenge in modeling, identification, and control for cyber-physical systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Industry 4.0 more than a challenge in modeling, identification, and control for cyber-physical systems  
**Jurnal & Sitasi Utama:** Paolo Mercorelli, Hamidreza Nemati, Quanmin Zhu (2024). *Modeling, Identification, and Control for Cyber- Physical Systems Towards Industry 4.0*. DOI: [10.1016/b978-0-32-395207-1.00010-x](10.1016/b978-0-32-395207-1.00010-x)  
**Sitasi Pendukung:** Yasin Ranjbar, Arash Nemati (2025). *Internet of Things and Cyber-Physical Systems*. DOI: [10.1016/j.iotcps.2026.03.004](10.1016/j.iotcps.2026.03.004)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Paolo Mercorelli, Hamidreza Nemati, Quanmin Zhu (2024) dalam jurnal *Modeling, Identification, and Control for Cyber- Physical Systems Towards Industry 4.0* (DOI: 10.1016/b978-0-32-395207-1.00010-x) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yasin Ranjbar, Arash Nemati (2025) yang dipublikasikan dalam *Internet of Things and Cyber-Physical Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
