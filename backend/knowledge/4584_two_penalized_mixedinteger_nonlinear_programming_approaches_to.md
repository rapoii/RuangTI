# 4584 — Operations Research & Large-Scale Optimization: Two penalized mixed–integer nonlinear programming approaches to tackle multicollinearity and outliers effects in linear regression models

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Two penalized mixed–integer nonlinear programming approaches to tackle multicollinearity and outliers effects in linear regression models  
**Jurnal & Sitasi Utama:** Mahdi Roozbeh, Saman Babaie–Kafaki, Zohre Aminifard (2021). *Journal of Industrial &amp; Management Optimization*. DOI: [10.3934/jimo.2020128](10.3934/jimo.2020128)  
**Sitasi Pendukung:** Abir Hasnaoui, Abdelhafid Omari, Zin-Eddine Azzouz (2022). *2022 2nd International Conference on Advanced Electrical Engineering (ICAEE)*. DOI: [10.1109/icaee53772.2022.9962068](10.1109/icaee53772.2022.9962068)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahdi Roozbeh, Saman Babaie–Kafaki, Zohre Aminifard (2021) dalam jurnal *Journal of Industrial &amp; Management Optimization* (DOI: 10.3934/jimo.2020128) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
