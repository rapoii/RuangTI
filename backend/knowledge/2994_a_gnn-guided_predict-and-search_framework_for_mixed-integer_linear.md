# 2994 — Operations Research & Large-Scale Optimization: A GNN-Guided Predict-and-Search Framework for Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A GNN-Guided Predict-and-Search Framework for Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Han, Qingyu, Yang, Linxin, Chen, Qian (2023). *arXiv (Cornell University)*. DOI: [10.4230/lipics.cp.2026.61](10.4230/lipics.cp.2026.61)  
**Sitasi Pendukung:** Roberto Bargetto, Thierry Garaix, Xiaolan Xie (2023). *Computers & Operations Research*. DOI: [10.1016/j.cor.2022.106136](10.1016/j.cor.2022.106136)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Han, Qingyu, Yang, Linxin, Chen, Qian (2023) dalam jurnal *arXiv (Cornell University)* (DOI: 10.4230/lipics.cp.2026.61) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
