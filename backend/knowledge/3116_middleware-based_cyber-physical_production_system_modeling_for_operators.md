# 3116 — Manufacturing Systems & Cyber-Physical Production: Middleware-based Cyber-Physical Production System Modeling for Operators

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Middleware-based Cyber-Physical Production System Modeling for Operators  
**Jurnal & Sitasi Utama:** Daniel Stock, Daniel Schel, Thomas Bauernhansl (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.02.031](10.1016/j.promfg.2020.02.031)  
**Sitasi Pendukung:** Harish Kumar Pakala, Kazeem. O. Oladipupo, Sebastian Käbisch (2021). *Digitalen Hochschulbibliothek Sachsen-Anhalt (Universitäts- und Landesbibliothek Sachsen-Anhalt)*. DOI: [10.25673/39570](10.25673/39570)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Daniel Stock, Daniel Schel, Thomas Bauernhansl (2020) dalam jurnal *Procedia Manufacturing* (DOI: 10.1016/j.promfg.2020.02.031) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Harish Kumar Pakala, Kazeem. O. Oladipupo, Sebastian Käbisch (2021) yang dipublikasikan dalam *Digitalen Hochschulbibliothek Sachsen-Anhalt (Universitäts- und Landesbibliothek Sachsen-Anhalt)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
