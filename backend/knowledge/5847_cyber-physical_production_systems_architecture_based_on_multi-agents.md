# 5847 — Manufacturing Systems & Cyber-Physical Production: Cyber-physical production systems architecture based on multi-agent’s design pattern—comparison of selected approaches mapping four agent patterns

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Cyber-physical production systems architecture based on multi-agent’s design pattern—comparison of selected approaches mapping four agent patterns  
**Jurnal & Sitasi Utama:** Luis Alberto Cruz Salazar, Daria Ryashentseva, Arndt Lüder (2019). *The International Journal of Advanced Manufacturing Technology*. DOI: [10.1007/s00170-019-03800-4](10.1007/s00170-019-03800-4)  
**Sitasi Pendukung:** Alejandro Seif, Carlos Toro, Humza Akhtar (2019). *Procedia Computer Science*. DOI: [10.1016/j.procs.2019.09.204](10.1016/j.procs.2019.09.204)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Luis Alberto Cruz Salazar, Daria Ryashentseva, Arndt Lüder (2019) dalam jurnal *The International Journal of Advanced Manufacturing Technology* (DOI: 10.1007/s00170-019-03800-4) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
