# 6219 — Operations Research & Large-Scale Optimization: Completion of Capacitated Vehicle Routing Problem (CVRP) and Capacitated Vehicle Routing Problem with Time Windows (CVRPTW) Using Bee Algorithm Approach to Optimize Waste Picking Transportation Problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Completion of Capacitated Vehicle Routing Problem (CVRP) and Capacitated Vehicle Routing Problem with Time Windows (CVRPTW) Using Bee Algorithm Approach to Optimize Waste Picking Transportation Problem  
**Jurnal & Sitasi Utama:** C. Natalia, V. Triyanti, G. Setiawan (2021). *Journal of Modern Manufacturing Systems and Technology*. DOI: [10.15282/jmmst.v5i2.6855](10.15282/jmmst.v5i2.6855)  
**Sitasi Pendukung:** Yuan Yuan, Diego Cattaruzza, Maxime Ogier (2021). *Transportation Research Part E: Logistics and Transportation Review*. DOI: [10.1016/j.tre.2021.102391](10.1016/j.tre.2021.102391)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari C. Natalia, V. Triyanti, G. Setiawan (2021) dalam jurnal *Journal of Modern Manufacturing Systems and Technology* (DOI: 10.15282/jmmst.v5i2.6855) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
