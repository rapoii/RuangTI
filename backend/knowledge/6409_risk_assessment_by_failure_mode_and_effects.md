# 6409 — Quality Engineering & Reliability Systems: Risk assessment by failure mode and effects analysis (FMEA) using an interval number based logistic regression model

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Risk assessment by failure mode and effects analysis (FMEA) using an interval number based logistic regression model  
**Jurnal & Sitasi Utama:** Pushparenu Bhattacharjee, Vidyut Dey, U.K. Mandal (2020). *Safety Science*. DOI: [10.1016/j.ssci.2020.104967](10.1016/j.ssci.2020.104967)  
**Sitasi Pendukung:** Yunisa Rahmawati, Kardiman, Oleh (2024). *Jurnal Pendidikan Teknik Mesin Undiksha*. DOI: [10.23887/jptm.v12i2.75652](10.23887/jptm.v12i2.75652)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pushparenu Bhattacharjee, Vidyut Dey, U.K. Mandal (2020) dalam jurnal *Safety Science* (DOI: 10.1016/j.ssci.2020.104967) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
