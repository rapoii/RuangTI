# 5734 — Operations Research & Large-Scale Optimization: Chance-Constrained Global Programming to Expansion Planning of Coupled Gas-Electricity Networks in the Presence of Interconnected Energy Hubs

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance-Constrained Global Programming to Expansion Planning of Coupled Gas-Electricity Networks in the Presence of Interconnected Energy Hubs  
**Jurnal & Sitasi Utama:** Mohammad Hemmati (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4442264](10.2139/ssrn.4442264)  
**Sitasi Pendukung:** Jin  Peng Liu, Kai Huang, Lan Wu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3968768](10.2139/ssrn.3968768)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohammad Hemmati (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4442264) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jin  Peng Liu, Kai Huang, Lan Wu (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
