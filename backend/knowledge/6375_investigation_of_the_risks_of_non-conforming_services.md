# 6375 — Quality Engineering & Reliability Systems: Investigation of the Risks of Non-Conforming Services in Logistics: Failure Mode and Effects Analysis (FMEA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Investigation of the Risks of Non-Conforming Services in Logistics: Failure Mode and Effects Analysis (FMEA)  
**Jurnal & Sitasi Utama:** Marieta Stefanova (2022). *Integrating Quality and Risk Management in Logistics*. DOI: [10.5772/intechopen.103755](10.5772/intechopen.103755)  
**Sitasi Pendukung:** Syahrul Hidayat, Wiwik Sulistiyowati (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.2818](10.21070/ups.2818)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marieta Stefanova (2022) dalam jurnal *Integrating Quality and Risk Management in Logistics* (DOI: 10.5772/intechopen.103755) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Syahrul Hidayat, Wiwik Sulistiyowati (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
