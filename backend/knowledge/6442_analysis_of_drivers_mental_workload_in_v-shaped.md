# 6442 — Human Factors & Cognitive Ergonomics: Analysis of Drivers’ Mental Workload in V-Shaped Undersea Tunnels Based on Heart Rate Variability

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Analysis of Drivers’ Mental Workload in V-Shaped Undersea Tunnels Based on Heart Rate Variability  
**Jurnal & Sitasi Utama:** Fuquan Pan, Lei Yan, Lixia Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4676210](10.2139/ssrn.4676210)  
**Sitasi Pendukung:** Esra Fatma Birol, Yaşar Daşdemir (2026). *Displays*. DOI: [10.1016/j.displa.2026.103492](10.1016/j.displa.2026.103492)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fuquan Pan, Lei Yan, Lixia Zhang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4676210) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Esra Fatma Birol, Yaşar Daşdemir (2026) yang dipublikasikan dalam *Displays* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
