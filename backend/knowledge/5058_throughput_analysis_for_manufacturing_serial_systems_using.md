# 5058 — Simulation Modeling & Digital Twins: Throughput Analysis for Manufacturing Serial Systems using Discrete-Event Simulation and Analytical Calculation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Throughput Analysis for Manufacturing Serial Systems using Discrete-Event Simulation and Analytical Calculation  
**Jurnal & Sitasi Utama:** Hema Vanasarla, Herman Tang (2022). *Engineering &amp; Technology Review*. DOI: [10.47285/etr.v3i1.117](10.47285/etr.v3i1.117)  
**Sitasi Pendukung:** Yiyun Fei, Mulang Song, Roger J. Jiao (2025). *Proceedings of the International Conference on Industrial Engineering and Operations Management*. DOI: [10.46254/an15.20250432](10.46254/an15.20250432)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hema Vanasarla, Herman Tang (2022) dalam jurnal *Engineering &amp; Technology Review* (DOI: 10.47285/etr.v3i1.117) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "In this paper, throughput analysis is studied by employing different industrial factors like reliability, buffer system, cycle time, and production time in the manufacturing workstation's layout. The research investigates the variations in throughput with both DES simulation and analytical methods by allocating different inputs. The results of analytical calculations and DES model throughputs are close, which explains the framework applying the production line cases that are proved effective to the system reliability challenge of serial manufacturing for increasing performance. The different inputs are selected based upon the real manufacturing layouts."

Penelitian pendukung oleh Yiyun Fei, Mulang Song, Roger J. Jiao (2025) yang dipublikasikan dalam *Proceedings of the International Conference on Industrial Engineering and Operations Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
