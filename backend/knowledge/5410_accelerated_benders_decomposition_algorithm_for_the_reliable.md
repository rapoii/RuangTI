# 5410 — Operations Research & Large-Scale Optimization: Accelerated Benders decomposition algorithm for the reliable service network design problem under disruption

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Accelerated Benders decomposition algorithm for the reliable service network design problem under disruption  
**Jurnal & Sitasi Utama:** Ehsan Mirzaei, Ehsan Nikbakhsh, Ali Husseinzadeh Kashan (2025). *Computers &amp; Industrial Engineering*. DOI: [10.1016/j.cie.2025.111234](10.1016/j.cie.2025.111234)  
**Sitasi Pendukung:** Md. Aqib Aman, Ashiqur Rahman Ashiq, Mohammad A.M. Abdel-Aal (2025). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2025.09.165](10.1016/j.ifacol.2025.09.165)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ehsan Mirzaei, Ehsan Nikbakhsh, Ali Husseinzadeh Kashan (2025) dalam jurnal *Computers &amp; Industrial Engineering* (DOI: 10.1016/j.cie.2025.111234) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Md. Aqib Aman, Ashiqur Rahman Ashiq, Mohammad A.M. Abdel-Aal (2025) yang dipublikasikan dalam *IFAC-PapersOnLine* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
