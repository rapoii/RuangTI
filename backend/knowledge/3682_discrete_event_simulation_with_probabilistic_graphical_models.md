# 3682 — Simulation Modeling & Digital Twins: Discrete event simulation with probabilistic graphical models

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Discrete event simulation with probabilistic graphical models  
**Jurnal & Sitasi Utama:** Carmen María Yago Sánchez (2026). *UNED repository*. DOI: [10.openalex/w7161657125](10.openalex/w7161657125)  
**Sitasi Pendukung:** M. Dobrzańska, Paweł Dobrzański (2025). *Acta Tecnología*. DOI: [10.22306/atec.v11i2.279](10.22306/atec.v11i2.279)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Carmen María Yago Sánchez (2026) dalam jurnal *UNED repository* (DOI: 10.openalex/w7161657125) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
