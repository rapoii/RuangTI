# 6362 — Manufacturing Systems & Cyber-Physical Production: Extending Signal Temporal Logic with Quantitative Semantics by Intervals for Robust Monitoring of Cyber-physical Systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Extending Signal Temporal Logic with Quantitative Semantics by Intervals for Robust Monitoring of Cyber-physical Systems  
**Jurnal & Sitasi Utama:** Bingzhuo Zhong, Claudius Jordan, Julien Provost (2021). *ACM Transactions on Cyber-Physical Systems*. DOI: [10.1145/3377868](10.1145/3377868)  
**Sitasi Pendukung:** M. A. Bär, A. W. Colombo (2023). *IET Conference Proceedings*. DOI: [10.1049/icp.2023.1730](10.1049/icp.2023.1730)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bingzhuo Zhong, Claudius Jordan, Julien Provost (2021) dalam jurnal *ACM Transactions on Cyber-Physical Systems* (DOI: 10.1145/3377868) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh M. A. Bär, A. W. Colombo (2023) yang dipublikasikan dalam *IET Conference Proceedings* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
