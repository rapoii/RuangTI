# 4228 — Operations Research & Large-Scale Optimization: Branch-and-check methods for multi-level operating room planning and scheduling

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Branch-and-check methods for multi-level operating room planning and scheduling  
**Jurnal & Sitasi Utama:** Vahid Roshanaei, Kyle E. C. Booth, Dionne M. Aleman (2019). *International Journal of Production Economics*. DOI: [10.1016/j.ijpe.2019.07.006](10.1016/j.ijpe.2019.07.006)  
**Sitasi Pendukung:** Anirudh Subramanyam, Chrysanthos E. Gounaris, Wolfram Wiesemann (2019). *Mathematical Programming Computation*. DOI: [10.1007/s12532-019-00174-2](10.1007/s12532-019-00174-2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Vahid Roshanaei, Kyle E. C. Booth, Dionne M. Aleman (2019) dalam jurnal *International Journal of Production Economics* (DOI: 10.1016/j.ijpe.2019.07.006) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
