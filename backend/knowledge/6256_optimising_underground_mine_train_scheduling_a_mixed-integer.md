# 6256 — Operations Research & Large-Scale Optimization: OPTIMISING UNDERGROUND MINE TRAIN SCHEDULING: A MIXED-INTEGER LINEAR PROGRAMMING APPROACH

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** OPTIMISING UNDERGROUND MINE TRAIN SCHEDULING: A MIXED-INTEGER LINEAR PROGRAMMING APPROACH  
**Jurnal & Sitasi Utama:** H.J. Snyman, C. Bisset, R. Luies (2024). *34th Annual Southern African Institute for Industrial Engineering Conference 2024 (SAIIE34)*. DOI: [10.52202/078172-0004](10.52202/078172-0004)  
**Sitasi Pendukung:** Bowen Song, Hiroto Saigo (2024). *Peer-Reviewed Journal*. DOI: [10.26434/chemrxiv.15001462/v1](10.26434/chemrxiv.15001462/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari H.J. Snyman, C. Bisset, R. Luies (2024) dalam jurnal *34th Annual Southern African Institute for Industrial Engineering Conference 2024 (SAIIE34)* (DOI: 10.52202/078172-0004) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Bowen Song, Hiroto Saigo (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
