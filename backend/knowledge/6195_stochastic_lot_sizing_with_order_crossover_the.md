# 6195 — Production Planning & Inventory Control: Stochastic Lot Sizing with Order Crossover: The Three-Fifths Law

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Stochastic Lot Sizing with Order Crossover: The Three-Fifths Law  
**Jurnal & Sitasi Utama:** Xingyu Bai (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7403898](10.2139/ssrn.7403898)  
**Sitasi Pendukung:** Xingyu Bai (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7403898](10.2139/ssrn.7403898)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xingyu Bai (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7403898) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "&lt;div&gt;
 We study a continuous-review single-item inventory system with Poisson demand process, backlogging, fixed ordering costs, and independent exponential order lead times.&amp;nbsp;&lt;span&gt;Splitting supply across more batches diversifies lead-time risk but incurs more fixed costs.&amp;nbsp;&lt;/span&gt;&lt;span&gt;In the high-demand regime, we show that the optimal long-run average cost over a broad class of stationary nonanticipating policies scales as $\Theta(\lambda^{3/5})$.&amp;nbsp;&lt;/span&gt;&lt;span&gt;The lower bound uses stationary flow identities and a weighted Bernoulli anti-concentration argument to capture unavoidable short-window supply fluctuations under adaptive, unequal batches.&amp;nbsp;&lt;/span&gt;&lt;span&gt;For the upper bound, we introduce the \emph{Batched Pipeline-Drift Policy} (BPDP), which combines fixed-size batches with inventory-responsive pipeline targets.&amp;nbsp;&lt;/span&gt;&lt;span&gt;We prove positive recurrence and a stationary inventory bound.&amp;nbsp;&lt;/span&gt;&lt;span&gt;With batch size $\Theta(\lambda^{2/5})$, BPDP achieves $O(\lambda^{3/5})$ total cost and therefore matches the optimal demand-rate exponent despite its restricted event-driven structure.&lt;/span&gt;
&lt;/div&gt;"

Penelitian pendukung oleh Xingyu Bai (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
