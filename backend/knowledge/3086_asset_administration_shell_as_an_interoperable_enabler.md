# 3086 — Manufacturing Systems & Cyber-Physical Production: Asset Administration Shell as an interoperable enabler of Industry 4.0 software architectures: a case study

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Asset Administration Shell as an interoperable enabler of Industry 4.0 software architectures: a case study  
**Jurnal & Sitasi Utama:** Walter Quadrini, Chiara Cimino, Tasnim A. Abdel-Aty (2023). *Procedia Computer Science*. DOI: [10.1016/j.procs.2022.12.379](10.1016/j.procs.2022.12.379)  
**Sitasi Pendukung:** Robert Harrison, Daniel Vera, Bilal Ahmad (2021). *Proceedings of the IEEE*. DOI: [10.1109/jproc.2020.3046525](10.1109/jproc.2020.3046525)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Walter Quadrini, Chiara Cimino, Tasnim A. Abdel-Aty (2023) dalam jurnal *Procedia Computer Science* (DOI: 10.1016/j.procs.2022.12.379) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
