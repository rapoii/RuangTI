# 5280 — Industrial Artificial Intelligence & Data Analytics: Practical inverse mask synthesis via data-efficient physics-informed neural networks (PINN) model

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Practical inverse mask synthesis via data-efficient physics-informed neural networks (PINN) model  
**Jurnal & Sitasi Utama:** Kuan-Hsun Wang, Po-Hsun Fang, Peichen Yu (2025). *DTCO and Computational Patterning IV*. DOI: [10.1117/12.3056774](10.1117/12.3056774)  
**Sitasi Pendukung:** Mahboubeh Moghadasi, Yinlun Huang (2026). *AIChE Journal*. DOI: [10.1002/aic.70611](10.1002/aic.70611)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kuan-Hsun Wang, Po-Hsun Fang, Peichen Yu (2025) dalam jurnal *DTCO and Computational Patterning IV* (DOI: 10.1117/12.3056774) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mahboubeh Moghadasi, Yinlun Huang (2026) yang dipublikasikan dalam *AIChE Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
