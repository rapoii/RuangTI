# 6213 — Operations Research & Large-Scale Optimization: The Two-Tier Multi-Depot Vehicle Routing Problem with Robot Stations and Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** The Two-Tier Multi-Depot Vehicle Routing Problem with Robot Stations and Time Windows  
**Jurnal & Sitasi Utama:** Giovanni Campuzano, Eduardo Lalla-Ruiz, Martijn  R.K. Mes (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4921329](10.2139/ssrn.4921329)  
**Sitasi Pendukung:** Ilias Chakour, Otman Abdoun (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-6548569/v1](10.21203/rs.3.rs-6548569/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Giovanni Campuzano, Eduardo Lalla-Ruiz, Martijn  R.K. Mes (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4921329) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The deployment of self-driving or autonomous robots in last-mile logistics can significantly reduce traffic congestion and operational costs. Delivery systems that split the distribution process into two layers, with trucks in the first layer and autonomous robots at robot stations in the second layer, are known as Two-Tier Vehicle Routing Problems with Robot Stations (2T-VRP-RS). This paper extends the 2T-VRP-RS to include multiple depots supplying robot stations with parcels, which then deploy robots to serve customers within their time windows (2T-MDVRP-RS-TW). To solve the 2T-MDVRP-RS-TW, we propose a Mixed-Integer Linear Programming (MILP) formulation and develop a Multi-Start Iterated Local Search metaheuristic with Crossover and Repair (MS-ILS-CR) operators. Our approach integrates three strategies: (i) a Multi-Start mechanism, (ii) a Crossover operator, and (iii) a Repair operator from Variable Neighborhood Search, Genetic Algorithm, and Adaptive Large Neighborhood Search metaheuristics, respectively. We introduce a new instance set for comparison and validation, providing decision-makers with insights into the 2T-MVRP-RS-TW. Results show that the exact method is competitive only for small instances, while our metaheuristic approach outperforms the MILP model in both solution quality and computational times for small instances. Additionally, the multi-start, crossover, and repair operators in the MS-ILS-CR improve performance over similar metaheuristic approaches. The"

Penelitian pendukung oleh Ilias Chakour, Otman Abdoun (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
