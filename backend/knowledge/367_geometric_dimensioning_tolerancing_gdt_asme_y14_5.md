# Modul Komprehensif: Toleransi Geometris (Geometric Dimensioning and Tolerancing / GD&T - ASME Y14.5)
**Nomor Modul:** [367]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *GeoTol Pro: A Practical Guide to Geometric Tolerancing (Al Neumann, Scott Neumann), ASME Y14.5-2018 Standard, ISO 1101*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Toleransi Geometris (Geometric Dimensioning and Tolerancing / GD&T - ASME Y14.5)**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Datum Reference Frame (Primary, Secondary, Tertiary Datums), Feature Control Frame, 14 Karakteristik Geometris (Form, Orientation, Location, Runout, Profile), Maximum Material Condition (MMC) & Least Material Condition (LMC), Bonus Tolerance.
...
```python
# Algoritma Solusi Terapan untuk Toleransi Geometris (Geometric Dimensioning and Tolerancing / GD&T - ASME Y14.5)
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penerapan GD&T Posisi Lubang Baut Blok Silinder Mesin Mobil untuk Mencegah Kebocoran Kompresi.
...
1. GeoTol Pro: A Practical Guide to Geometric Tolerancing (Al Neumann, Scott Neumann), ASME Y14.5-2018 Standard, ISO 1101.
