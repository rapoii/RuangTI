# 6320 — Supply Chain Management & Logistics Engineering: Data-Driven Optimization of Closed-Loop Supply Chains: Addressing Challenges in Reverse Logistics and Product Recovery

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Data-Driven Optimization of Closed-Loop Supply Chains: Addressing Challenges in Reverse Logistics and Product Recovery  
**Jurnal & Sitasi Utama:** Qiran Wu (2025). *Advances in Economics, Management and Political Sciences*. DOI: [10.54254/2754-1169/2025.bl29405](10.54254/2754-1169/2025.bl29405)  
**Sitasi Pendukung:** Suqin Sun, Haodong Zheng, Tao Hang (2023). *12th International Conference on Logistics and Systems Engineering 2023*. DOI: [10.52202/068701-0021](10.52202/068701-0021)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Qiran Wu (2025) dalam jurnal *Advances in Economics, Management and Political Sciences* (DOI: 10.54254/2754-1169/2025.bl29405) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Closed-loop supply chains (CLSCs), which integrate forward and reverse logistics, are pivotal for establishing sustainable production, distribution, and product recovery systems. Their importance is escalating in response to the global waste crisis and mounting pressure on businesses to adopt circular economy principles. This article examined how CLSCs can be optimised using data-driven methods, especially in reverse logistics and product recovery. The discussion on the case has identified electronics, automotive, and retail practices and digital enablers like blockchain, artificial intelligence, and digital twins. The analysis established that there were six major issues that included high costs, unstandardization, data fragmentation, doubtful product quality, poor recycling facilities, and low consumer involvement. The paper has offered specific solutions to overcome such challenges, such as AI-based route optimization, transparency facilitated by blockchain, predictive analytics, advanced sorting, incentive programs, and infrastructure investment. These steps enhance efficiency, trust, and engagement within supply networks. This study underscores the transformative potential of data-driven approaches in building resilient and sustainable CLSCs that deliver simultaneous business, environmental, and social value."

Penelitian pendukung oleh Suqin Sun, Haodong Zheng, Tao Hang (2023) yang dipublikasikan dalam *12th International Conference on Logistics and Systems Engineering 2023* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
