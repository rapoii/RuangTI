# 6318 — Supply Chain Management & Logistics Engineering: Remanufacturing process innovation in closed-loop supply chain under cost-sharing mechanism and different power structures

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Remanufacturing process innovation in closed-loop supply chain under cost-sharing mechanism and different power structures  
**Jurnal & Sitasi Utama:** Haitao Chen, Zhaohui Dong, Gendao Li (2021). *Computers &amp; Industrial Engineering*. DOI: [10.1016/j.cie.2021.107743](10.1016/j.cie.2021.107743)  
**Sitasi Pendukung:** Hanbing Xia, Zhiyuan Chen, Jelena Milisavljevic-Syed (2024). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2024.100155](10.1016/j.clscn.2024.100155)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Haitao Chen, Zhaohui Dong, Gendao Li (2021) dalam jurnal *Computers &amp; Industrial Engineering* (DOI: 10.1016/j.cie.2021.107743) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hanbing Xia, Zhiyuan Chen, Jelena Milisavljevic-Syed (2024) yang dipublikasikan dalam *Cleaner Logistics and Supply Chain* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
