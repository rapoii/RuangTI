# 5323 — Industrial Artificial Intelligence & Data Analytics: The Appearance Defect Detection Recognition and Classification of Fuses Based on Deep Learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** The Appearance Defect Detection Recognition and Classification of Fuses Based on Deep Learning  
**Jurnal & Sitasi Utama:** Jintao Ding, Yufeng Chen, Yang Wang (2025). *2025 IEEE 2nd International Conference on Deep Learning and Computer Vision (DLCV)*. DOI: [10.1109/dlcv65218.2025.11088872](10.1109/dlcv65218.2025.11088872)  
**Sitasi Pendukung:** Xiaojie Huang, Peng Han, Yutong Fu (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603960](10.1109/cvidl62147.2024.10603960)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jintao Ding, Yufeng Chen, Yang Wang (2025) dalam jurnal *2025 IEEE 2nd International Conference on Deep Learning and Computer Vision (DLCV)* (DOI: 10.1109/dlcv65218.2025.11088872) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xiaojie Huang, Peng Han, Yutong Fu (2024) yang dipublikasikan dalam *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
