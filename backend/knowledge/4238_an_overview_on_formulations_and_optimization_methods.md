# 4238 — Operations Research & Large-Scale Optimization: An overview on formulations and optimization methods for the unit-based short-term hydro scheduling problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An overview on formulations and optimization methods for the unit-based short-term hydro scheduling problem  
**Jurnal & Sitasi Utama:** Jiehong Kong, Hans Ivar Skjelbred, Olav Bjarte Fosso (2019). *Electric Power Systems Research*. DOI: [10.1016/j.epsr.2019.106027](10.1016/j.epsr.2019.106027)  
**Sitasi Pendukung:** Leilei Meng, Chaoyong Zhang, Biao Zhang (2019). *IEEE Access*. DOI: [10.1109/access.2019.2916468](10.1109/access.2019.2916468)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiehong Kong, Hans Ivar Skjelbred, Olav Bjarte Fosso (2019) dalam jurnal *Electric Power Systems Research* (DOI: 10.1016/j.epsr.2019.106027) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Leilei Meng, Chaoyong Zhang, Biao Zhang (2019) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
