# 4078 — Production Planning & Inventory Control: Linear and Non-Linear Models for Master Scheduling of Dynamic Resources Product Mix

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Linear and Non-Linear Models for Master Scheduling of Dynamic Resources Product Mix  
**Jurnal & Sitasi Utama:** Ayman R. Mohammed, Ahmad Abu Sleem, Mohammad A. M. Abdel-Aal (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2402.11306](10.48550/arxiv.2402.11306)  
**Sitasi Pendukung:** Alina Itu (2025). *Applied Sciences*. DOI: [10.3390/app151910823](10.3390/app151910823)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ayman R. Mohammed, Ahmad Abu Sleem, Mohammad A. M. Abdel-Aal (2024) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2402.11306) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Alina Itu (2025) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
