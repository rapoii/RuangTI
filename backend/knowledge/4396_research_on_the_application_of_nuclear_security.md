# 4396 — Safety Engineering & Risk Management: RESEARCH ON THE APPLICATION OF NUCLEAR SECURITY EVENT RISK ASSESSMENT BASED ON FAULT TREE ANALYSIS METHOD

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** RESEARCH ON THE APPLICATION OF NUCLEAR SECURITY EVENT RISK ASSESSMENT BASED ON FAULT TREE ANALYSIS METHOD  
**Jurnal & Sitasi Utama:** Ma liang, Wang long, yang li yuan (2023). *The Proceedings of the International Conference on Nuclear Engineering (ICONE)*. DOI: [10.1299/jsmeicone.2023.30.1930](10.1299/jsmeicone.2023.30.1930)  
**Sitasi Pendukung:** E. Doménech, S. Martorell, G.O.M. Kombo-Mpindou (2022). *Science of The Total Environment*. DOI: [10.1016/j.scitotenv.2022.156500](10.1016/j.scitotenv.2022.156500)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ma liang, Wang long, yang li yuan (2023) dalam jurnal *The Proceedings of the International Conference on Nuclear Engineering (ICONE)* (DOI: 10.1299/jsmeicone.2023.30.1930) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh E. Doménech, S. Martorell, G.O.M. Kombo-Mpindou (2022) yang dipublikasikan dalam *Science of The Total Environment* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
