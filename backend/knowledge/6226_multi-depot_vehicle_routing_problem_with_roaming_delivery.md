# 6226 — Operations Research & Large-Scale Optimization: Multi-Depot Vehicle Routing Problem with Roaming Delivery Locations Considering Hard Time Windows: Solved by a Hybrid Els-Lns Algorithm

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multi-Depot Vehicle Routing Problem with Roaming Delivery Locations Considering Hard Time Windows: Solved by a Hybrid Els-Lns Algorithm  
**Jurnal & Sitasi Utama:** Ali Aghadavoudi Jolfaei, Mahdi alinaghian (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4698429](10.2139/ssrn.4698429)  
**Sitasi Pendukung:** Alan Osorio‐Mora, Timo Gschwind (2026). *Networks*. DOI: [10.1002/net.70065](10.1002/net.70065)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ali Aghadavoudi Jolfaei, Mahdi alinaghian (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4698429) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Alan Osorio‐Mora, Timo Gschwind (2026) yang dipublikasikan dalam *Networks* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
