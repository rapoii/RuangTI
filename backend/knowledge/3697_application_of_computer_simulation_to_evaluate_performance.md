# 3697 — Simulation Modeling & Digital Twins: Application of Computer Simulation to Evaluate Performance Parameters of the Selective Soldering Process

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Application of Computer Simulation to Evaluate Performance Parameters of the Selective Soldering Process  
**Jurnal & Sitasi Utama:** Maciej Dominik, Marek Kęsek (2025). *Applied Sciences*. DOI: [10.3390/app15158649](10.3390/app15158649)  
**Sitasi Pendukung:** Manikandan, Kanishk (2025). *DSpace VŠB-TUO (VŠB-TUO)*. DOI: [10.openalex/w7113165237](10.openalex/w7113165237)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Maciej Dominik, Marek Kęsek (2025) dalam jurnal *Applied Sciences* (DOI: 10.3390/app15158649) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Manikandan, Kanishk (2025) yang dipublikasikan dalam *DSpace VŠB-TUO (VŠB-TUO)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
