# 5313 — Industrial Artificial Intelligence & Data Analytics: Multiclass Deep Learning for Automated Solar Panel Surface Defect Detection Using the Solar Augmented Dataset

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Multiclass Deep Learning for Automated Solar Panel Surface Defect Detection Using the Solar Augmented Dataset  
**Jurnal & Sitasi Utama:** Mohamed HADADI (2026). *Materials Research Proceedings*. DOI: [10.21741/9781644904091-65](10.21741/9781644904091-65)  
**Sitasi Pendukung:** Ummu Najwa Nur Yusrizal, Noram Noram Irwan Ramli, Putri Zulaiha Razi (2026). *International Journal of Computer Graphics &amp; Animation*. DOI: [10.5121/ijcga.2026.16302](10.5121/ijcga.2026.16302)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohamed HADADI (2026) dalam jurnal *Materials Research Proceedings* (DOI: 10.21741/9781644904091-65) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ummu Najwa Nur Yusrizal, Noram Noram Irwan Ramli, Putri Zulaiha Razi (2026) yang dipublikasikan dalam *International Journal of Computer Graphics &amp; Animation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
