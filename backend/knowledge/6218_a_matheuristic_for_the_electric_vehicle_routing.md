# 6218 — Operations Research & Large-Scale Optimization: A Matheuristic for the Electric Vehicle Routing Problem with Time Windows and a Realistic Energy Consumption Model

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Matheuristic for the Electric Vehicle Routing Problem with Time Windows and a Realistic Energy Consumption Model  
**Jurnal & Sitasi Utama:** Maurizio Bruglieri, Massimo Paolucci, Ornella Pisacane (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4110443](10.2139/ssrn.4110443)  
**Sitasi Pendukung:** C. Natalia, V. Triyanti, G. Setiawan (2021). *Journal of Modern Manufacturing Systems and Technology*. DOI: [10.15282/jmmst.v5i2.6855](10.15282/jmmst.v5i2.6855)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Maurizio Bruglieri, Massimo Paolucci, Ornella Pisacane (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4110443) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
