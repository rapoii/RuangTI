# 4007 — Facilities Planning & Material Handling: Generative design for sustainability-oriented factory planning

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Generative design for sustainability-oriented factory planning  
**Jurnal & Sitasi Utama:** Sebastian Thiede, Shengyu Liu (2026). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2026.147893](10.1016/j.jclepro.2026.147893)  
**Sitasi Pendukung:** Denny Nurkertamanda, Yusuf Widharto, Lovena Oki Oktavian (2023). *International Journal of Applied Science and Engineering Review*. DOI: [10.52267/ijaser.2023.4603](10.52267/ijaser.2023.4603)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sebastian Thiede, Shengyu Liu (2026) dalam jurnal *Journal of Cleaner Production* (DOI: 10.1016/j.jclepro.2026.147893) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Factories are key for efficient value creation but are also connected to significant environmental impact over their life cycle. While factory design significantly influences later performance and life cycle impact, early-stage assessment and decision support remains challenging due to data gaps as well as the high degree of uncertainty and complexity. This paper presents a novel generative design approach to derive and systematically analyze multiple layout scenarios in factory planning. With an integrated perspective on both environmental impact and factory performance, it allows the identification of critical factors and promising design parameters towards an informed life cycle engineering of factories."

Penelitian pendukung oleh Denny Nurkertamanda, Yusuf Widharto, Lovena Oki Oktavian (2023) yang dipublikasikan dalam *International Journal of Applied Science and Engineering Review* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
