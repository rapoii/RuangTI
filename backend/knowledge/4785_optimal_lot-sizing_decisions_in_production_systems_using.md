# 4785 — Production Planning & Inventory Control: Optimal Lot-Sizing Decisions in Production Systems Using the Wagner-Whitin Algorithm for Data-Driven Inventory Control

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Optimal Lot-Sizing Decisions in Production Systems Using the Wagner-Whitin Algorithm for Data-Driven Inventory Control  
**Jurnal & Sitasi Utama:** Bela Pitria Hakim, Muhammad Nashir Ardiansyah (2025). *International Journal on Advanced Science, Engineering and Information Technology*. DOI: [10.18517/ijaseit.15.3.20835](10.18517/ijaseit.15.3.20835)  
**Sitasi Pendukung:** Martin Krockert, Marvin Matthes, Torsten Munkelt (2021). *Proceedings of the 13th International Conference on Agents and Artificial Intelligence*. DOI: [10.5220/0010300803610367](10.5220/0010300803610367)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bela Pitria Hakim, Muhammad Nashir Ardiansyah (2025) dalam jurnal *International Journal on Advanced Science, Engineering and Information Technology* (DOI: 10.18517/ijaseit.15.3.20835) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The intersection of automation, visualization, and lot sizing, particularly through the Wagner-Whitin algorithm, plays a crucial role in optimizing production processes and improving decision-making efficiency. Determining optimal lot sizes in multi-period production systems is complex due to fluctuating demand, setup costs, holding costs, and capacity constraints. Effective solutions must dynamically address these variables to ensure optimal resource utilization and minimize waste. This study aims to develop an automated calculator that streamlines lot-sizing computations by integrating advanced mathematical models, such as the Wagner-Whitin algorithm, and innovative data visualization techniques. To design and evaluate this calculator, the study compares its effectiveness with traditional methods, such as lot-for-lot, with a focus on enhanced usability and user satisfaction. The study uses historical production data, including demand forecasts, setup costs, holding costs, and capacity constraints, to validate the model. The tool integrates the Wagner-Whitin algorithm for optimal lot sizing and incorporates sensitivity analysis to assess various scenarios. A comparative analysis is performed, testing the automated calculator against conventional methods. Performance metrics, including accuracy, calculation speed, scalability, and error reduction, are evaluated in simulated multi-period production environments. The results demonstrate that the automated calculator significant"

Penelitian pendukung oleh Martin Krockert, Marvin Matthes, Torsten Munkelt (2021) yang dipublikasikan dalam *Proceedings of the 13th International Conference on Agents and Artificial Intelligence* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
