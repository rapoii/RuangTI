# 4265 — Simulation Modeling & Digital Twins: Insights into Blockchain Implementation in Construction: Models for Supply Chain Management

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Insights into Blockchain Implementation in Construction: Models for Supply Chain Management  
**Jurnal & Sitasi Utama:** Algan Tezel, Pedro Febrero, Eleni Papadonikolaki (2021). *Journal of Management in Engineering*. DOI: [10.1061/(asce)me.1943-5479.0000939](10.1061/(asce)me.1943-5479.0000939)  
**Sitasi Pendukung:** Hung Khanh Nguyen, Raymond Chiong, Manuel Chica (2019). *Journal of Artificial Societies and Social Simulation*. DOI: [10.18564/jasss.4008](10.18564/jasss.4008)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Algan Tezel, Pedro Febrero, Eleni Papadonikolaki (2021) dalam jurnal *Journal of Management in Engineering* (DOI: 10.1061/(asce)me.1943-5479.0000939) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
