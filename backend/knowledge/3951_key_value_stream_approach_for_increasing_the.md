# 3951 — Continuous Improvement & Lean Six Sigma: Key Value Stream Approach for Increasing the Effectiveness of Business Processes

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Key Value Stream Approach for Increasing the Effectiveness of Business Processes  
**Jurnal & Sitasi Utama:** Semra Birgün, Kemal Güven Gülen (2020). *DergiPark (Istanbul University)*. DOI: [10.openalex/w3139534508](10.openalex/w3139534508)  
**Sitasi Pendukung:** Abu M. Fuad, Nusra Akter Takia, Hasin Ahmad Zafir (2025). *PLoS ONE*. DOI: [10.1371/journal.pone.0320761](10.1371/journal.pone.0320761)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Semra Birgün, Kemal Güven Gülen (2020) dalam jurnal *DergiPark (Istanbul University)* (DOI: 10.openalex/w3139534508) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Abu M. Fuad, Nusra Akter Takia, Hasin Ahmad Zafir (2025) yang dipublikasikan dalam *PLoS ONE* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
