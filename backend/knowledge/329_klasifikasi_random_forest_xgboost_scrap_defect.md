# Modul Komprehensif: Klasifikasi: Random Forest, XGBoost, LightGBM untuk Prediksi Cacat Produksi
**Nomor Modul:** [329]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *The Elements of Statistical Learning (Hastie, Tibshirani, Friedman), IEEE Transactions on Semiconductor Manufacturing (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Klasifikasi: Random Forest, XGBoost, LightGBM untuk Prediksi Cacat Produksi**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Decision Trees, Gini Impurity, Information Gain Entropy, Bagging Random Forest, Gradient Boosting XGBoost Objective & Regularization.
...
```python
# Algoritma Solusi Terapan untuk Klasifikasi: Random Forest, XGBoost, LightGBM untuk Prediksi Cacat Produksi
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Prediksi Dini Cacat Wafer Semikonduktor (Akurasi F1-Score 96.4%, reduksi scrap $1.2M/tahun).
...
1. The Elements of Statistical Learning (Hastie, Tibshirani, Friedman), IEEE Transactions on Semiconductor Manufacturing (2024).
