# 4392 — Safety Engineering & Risk Management: A Method to Reduce Rotorcraft Development Risk by Integrating Historical Quantitative Risk Assessment into Fault Tree Models

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** A Method to Reduce Rotorcraft Development Risk by Integrating Historical Quantitative Risk Assessment into Fault Tree Models  
**Jurnal & Sitasi Utama:** John Hewitt, Loan (Joan) Pham (2022). *Proceedings of the Vertical Flight Society 78th Annual Forum and Technology Display*. DOI: [10.4050/f-0078-2022-1276](10.4050/f-0078-2022-1276)  
**Sitasi Pendukung:** Yongfeng Li, Liping Zhu (2026). *Applied Sciences*. DOI: [10.3390/app16041979](10.3390/app16041979)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari John Hewitt, Loan (Joan) Pham (2022) dalam jurnal *Proceedings of the Vertical Flight Society 78th Annual Forum and Technology Display* (DOI: 10.4050/f-0078-2022-1276) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yongfeng Li, Liping Zhu (2026) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
