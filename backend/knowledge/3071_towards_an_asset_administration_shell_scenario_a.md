# 3071 — Manufacturing Systems & Cyber-Physical Production: Towards an Asset Administration Shell scenario: a use case for interoperability and standardization in Industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Towards an Asset Administration Shell scenario: a use case for interoperability and standardization in Industry 4.0  
**Jurnal & Sitasi Utama:** Miguel A. Inigo, Alain Porto, Blanca Kremer (2020). *Peer-Reviewed Academic Journal*. DOI: [10.1109/noms47738.2020.9110410](10.1109/noms47738.2020.9110410)  
**Sitasi Pendukung:** Jakub Arm, Tomáš Benešl, P. Marcoň (2021). *Sensors*. DOI: [10.3390/s21062004](10.3390/s21062004)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Miguel A. Inigo, Alain Porto, Blanca Kremer (2020) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.1109/noms47738.2020.9110410) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
