# 3246 — Operations Research & Large-Scale Optimization: Mixed-Integer Linear Programming Model and Heuristic for Short-Term Scheduling of Pressing Process in Multi-Layer Printed Circuit Board Manufacturing

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Mixed-Integer Linear Programming Model and Heuristic for Short-Term Scheduling of Pressing Process in Multi-Layer Printed Circuit Board Manufacturing  
**Jurnal & Sitasi Utama:** Teeradech Laisupannawong, Boonyarit Intiyot, Chawalit Jeenanunta (2021). *Mathematics*. DOI: [10.3390/math9060653](10.3390/math9060653)  
**Sitasi Pendukung:** Nils Collath, Benedikt Tepe, Stefan Englberger (2022). *Journal of Energy Storage*. DOI: [10.1016/j.est.2022.105634](10.1016/j.est.2022.105634)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Teeradech Laisupannawong, Boonyarit Intiyot, Chawalit Jeenanunta (2021) dalam jurnal *Mathematics* (DOI: 10.3390/math9060653) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nils Collath, Benedikt Tepe, Stefan Englberger (2022) yang dipublikasikan dalam *Journal of Energy Storage* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
