# 4977 — Applied Statistics & Stochastic Modeling: PROCESS OPTIMIZATION OF BIODIESEL PRODUCTION USING CENTRAL COMPOSITE ROTATABLE DESIGN (CCRD) MODEL BY RESPONSE SURFACE METHODOLOGY (RSM)

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** PROCESS OPTIMIZATION OF BIODIESEL PRODUCTION USING CENTRAL COMPOSITE ROTATABLE DESIGN (CCRD) MODEL BY RESPONSE SURFACE METHODOLOGY (RSM)  
**Jurnal & Sitasi Utama:** Ameh, C. U., Eterigho, E. J., Musa A. A. (2022). *SCIREA Journal of Chemical Engineering*. DOI: [10.54647/chemical53039](10.54647/chemical53039)  
**Sitasi Pendukung:** Nabilah Saafie, Muhamad Fakhrul Ridhwan Samsudin, Suriati Sufian (2020). *Key Engineering Materials*. DOI: [10.4028/www.scientific.net/kem.841.220](10.4028/www.scientific.net/kem.841.220)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ameh, C. U., Eterigho, E. J., Musa A. A. (2022) dalam jurnal *SCIREA Journal of Chemical Engineering* (DOI: 10.54647/chemical53039) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nabilah Saafie, Muhamad Fakhrul Ridhwan Samsudin, Suriati Sufian (2020) yang dipublikasikan dalam *Key Engineering Materials* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
