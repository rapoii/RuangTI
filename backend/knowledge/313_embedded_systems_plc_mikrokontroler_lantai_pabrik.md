# Modul Komprehensif: Embedded Systems, Arduino/ESP32, & PLC untuk Otomasi Lantai Pabrik
**Nomor Modul:** [313]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Programmable Logic Controllers (Frank D. Petruzella), Industrial Automation and Control System Security (ISA-99)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Embedded Systems, Arduino/ESP32, & PLC untuk Otomasi Lantai Pabrik**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: IEC 61131-3 Programming Languages (Ladder Diagram, Structured Text, Function Block), Interrupts, Real-Time Operating Systems (FreeRTOS), Debouncing.
...
```python
# Algoritma Solusi Terapan untuk Embedded Systems, Arduino/ESP32, & PLC untuk Otomasi Lantai Pabrik
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Pemasangan Modul IoT ESP32 Penghitung Siklus Stamping Manual (Retrofit Industri 4.0 Murah).
...
1. Programmable Logic Controllers (Frank D. Petruzella), Industrial Automation and Control System Security (ISA-99).
