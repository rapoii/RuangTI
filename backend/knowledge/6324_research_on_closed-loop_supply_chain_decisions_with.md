# 6324 — Supply Chain Management & Logistics Engineering: Research on Closed-Loop Supply Chain Decisions with Manufacturer Risk Aversion under Hybrid Recycling Mode

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Research on Closed-Loop Supply Chain Decisions with Manufacturer Risk Aversion under Hybrid Recycling Mode  
**Jurnal & Sitasi Utama:** JIANG Lin, HU Lang (2025). *14th International Conference on Logistics and Systems Engineering (ICLSE 2024)*. DOI: [10.52202/078960-0071](10.52202/078960-0071)  
...
Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari JIANG Lin, HU Lang (2025) dalam jurnal *14th International Conference on Logistics and Systems Engineering (ICLSE 2024)* (DOI: 10.52202/078960-0071) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
