# 6374 — Quality Engineering & Reliability Systems: Quality Control Analysis of UD. Tiga Putra Crackers Product Using the Six Sigma Method and Failure Mode and Effect Analysisi (FMEA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Quality Control Analysis of UD. Tiga Putra Crackers Product Using the Six Sigma Method and Failure Mode and Effect Analysisi (FMEA)  
**Jurnal & Sitasi Utama:** Eka Ayuning Agustin, Hana Catur Wahyuni (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.3034](10.21070/ups.3034)  
**Sitasi Pendukung:** Marieta Stefanova (2022). *Integrating Quality and Risk Management in Logistics*. DOI: [10.5772/intechopen.103755](10.5772/intechopen.103755)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eka Ayuning Agustin, Hana Catur Wahyuni (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21070/ups.3034) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Marieta Stefanova (2022) yang dipublikasikan dalam *Integrating Quality and Risk Management in Logistics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
