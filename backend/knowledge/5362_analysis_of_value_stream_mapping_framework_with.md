# 5362 — Continuous Improvement & Lean Six Sigma: Analysis Of Value Stream Mapping Framework with Machine Learning Techniques

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Analysis Of Value Stream Mapping Framework with Machine Learning Techniques  
**Jurnal & Sitasi Utama:** Sameena H. S., Piyush Pareek (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4532851](10.2139/ssrn.4532851)  
**Sitasi Pendukung:** Nur Islahudin, Rindra Yusianto, Tegar Theo Jodanta (2024). *El-Cezeri Fen ve Mühendislik Dergisi*. DOI: [10.31202/ecjse.1409431](10.31202/ecjse.1409431)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sameena H. S., Piyush Pareek (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4532851) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "significant shift from mass production to lean manufacturing has been taking place in the industrial systems. The primary objective of mass manufacturing is high-volume production, with just a few product options available. The goal of lean manufacturing is to reduce waste wherever possible, which in turn simplifies and streamlines production processes and helps bring down costs. Eliminating seven different types of waste is the primary goal of lean manufacturing. These wastes include overproduction, processing, waiting, transportation, faults, inventory, and storage. Recent years have seen an increase in the number of waste categories, with the eighth now being underutilised worker creativity and the ninth being environmental waste."

Penelitian pendukung oleh Nur Islahudin, Rindra Yusianto, Tegar Theo Jodanta (2024) yang dipublikasikan dalam *El-Cezeri Fen ve Mühendislik Dergisi* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
