# 4778 — Human Factors & Cognitive Ergonomics: Workload Analysis for Coating Operator in the Quality Control Department Using Cardiovascular Load and NASA-TLX Questionnaire

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Workload Analysis for Coating Operator in the Quality Control Department Using Cardiovascular Load and NASA-TLX Questionnaire  
**Jurnal & Sitasi Utama:** Wyke Kusmasari, Nugraha Adi Candra (2025). *Jurnal Teknik Industri Terintegrasi*. DOI: [10.31004/jutin.v8i2.44658](10.31004/jutin.v8i2.44658)  
...
Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wyke Kusmasari, Nugraha Adi Candra (2025) dalam jurnal *Jurnal Teknik Industri Terintegrasi* (DOI: 10.31004/jutin.v8i2.44658) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
