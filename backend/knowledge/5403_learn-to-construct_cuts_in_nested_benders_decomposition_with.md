# 5403 — Operations Research & Large-Scale Optimization: Learn-to-Construct Cuts in Nested Benders Decomposition with Application to Large-scale Stochastic Multi-Stage Network Design and Scheduling

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Learn-to-Construct Cuts in Nested Benders Decomposition with Application to Large-scale Stochastic Multi-Stage Network Design and Scheduling  
**Jurnal & Sitasi Utama:** Babak Aslani, Shima Mohebbi, Ran Ji (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5895134](10.2139/ssrn.5895134)  
**Sitasi Pendukung:** Yanzi Zhang, Hongzhen Li, Yaping Ren (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5063437](10.2139/ssrn.5063437)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Babak Aslani, Shima Mohebbi, Ran Ji (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5895134) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yanzi Zhang, Hongzhen Li, Yaping Ren (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
