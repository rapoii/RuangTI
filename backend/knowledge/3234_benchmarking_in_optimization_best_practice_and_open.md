# 3234 — Operations Research & Large-Scale Optimization: Benchmarking in Optimization: Best Practice and Open Issues

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Benchmarking in Optimization: Best Practice and Open Issues  
**Jurnal & Sitasi Utama:** Thomas Bartz–Beielstein, Carola Doerr, Berg, Daan van den (2020). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2007.03488](10.48550/arxiv.2007.03488)  
**Sitasi Pendukung:** Jakob Witzig, Timo Berthold, Stefan Heinz (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-021-00202-0](10.1007/s12532-021-00202-0)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thomas Bartz–Beielstein, Carola Doerr, Berg, Daan van den (2020) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2007.03488) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
