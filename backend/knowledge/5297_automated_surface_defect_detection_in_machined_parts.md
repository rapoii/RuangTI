# 5297 — Industrial Artificial Intelligence & Data Analytics: Automated Surface Defect Detection in Machined Parts Using Deep Learning Techniques and Machine Vision

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Automated Surface Defect Detection in Machined Parts Using Deep Learning Techniques and Machine Vision  
**Jurnal & Sitasi Utama:** Akbar Abrorov, Musurmon Juraev, Khodjayeva Nodira (2025). *Diffusion Foundations and Materials Applications*. DOI: [10.4028/p-umcty0](10.4028/p-umcty0)  
**Sitasi Pendukung:** Yiqun Chang, Jianyu Xiao, Zhongan Wang (2025). *2025 IEEE 2nd International Conference on Deep Learning and Computer Vision (DLCV)*. DOI: [10.1109/dlcv65218.2025.11088510](10.1109/dlcv65218.2025.11088510)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Akbar Abrorov, Musurmon Juraev, Khodjayeva Nodira (2025) dalam jurnal *Diffusion Foundations and Materials Applications* (DOI: 10.4028/p-umcty0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yiqun Chang, Jianyu Xiao, Zhongan Wang (2025) yang dipublikasikan dalam *2025 IEEE 2nd International Conference on Deep Learning and Computer Vision (DLCV)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
