# 4186 — Applied Statistics & Stochastic Modeling: Methods for experimental design, central composite design and the Box–Behnken design, to optimise operational parameters: A review

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Methods for experimental design, central composite design and the Box–Behnken design, to optimise operational parameters: A review  
**Jurnal & Sitasi Utama:** Nikolett Szpisják-Gulyás, Aws N. Al-Tayawi, Zs. H. Horváth (2023). *Acta Alimentaria*. DOI: [10.1556/066.2023.00235](10.1556/066.2023.00235)  
**Sitasi Pendukung:** Sankha Bhattacharya (2021). *IntechOpen eBooks*. DOI: [10.5772/intechopen.95835](10.5772/intechopen.95835)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nikolett Szpisják-Gulyás, Aws N. Al-Tayawi, Zs. H. Horváth (2023) dalam jurnal *Acta Alimentaria* (DOI: 10.1556/066.2023.00235) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sankha Bhattacharya (2021) yang dipublikasikan dalam *IntechOpen eBooks* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
