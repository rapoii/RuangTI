# 4680 — Facilities Planning & Material Handling: Evaluation and Proposed Improvements to The Packaging Room Layout of PT. X Using the Activity Relationship Chart Method

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Evaluation and Proposed Improvements to The Packaging Room Layout of PT. X Using the Activity Relationship Chart Method  
**Jurnal & Sitasi Utama:** Theodora Octaviona Andriyani, I Ketut Satriawan Satriawan (2026). *RA JOURNAL OF APPLIED RESEARCH*. DOI: [10.47191/rajar/v12i7.09](10.47191/rajar/v12i7.09)  
**Sitasi Pendukung:** Dwi Julianti, Fitra Fitra, Muhammad Haikal (2025). *Jurnal Teknik Industri: Jurnal Hasil Penelitian dan Karya Ilmiah dalam Bidang Teknik Industri*. DOI: [10.24014/jti.v11i2.38058](10.24014/jti.v11i2.38058)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Theodora Octaviona Andriyani, I Ketut Satriawan Satriawan (2026) dalam jurnal *RA JOURNAL OF APPLIED RESEARCH* (DOI: 10.47191/rajar/v12i7.09) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "PT. X is a food industry that produces various types of products, including ready-to-eat products. The products are packaged in a 6.5×5 m2 packaging room used for two types of packaging: small and large. Ideally, these two packaging processes should not be carried out simultaneously, but during peak season conditions, both must be implemented, leading to waste motion, cross-flow of work, and potential workplace accidents. This research aims to redesign the packaging space layout so that both packages can be in line and increase labour productivity. The method used is the Activity Relationship Chart (ARC) to design the new layout. Subsequently, cycle time and Euclidean distance were measured before and after the proposed improvements. The research results show that reducing the average time brought the 30 kg bulk WIP from 7.43 seconds to 4.54 seconds and decreased the transfer time from the small packaging machine to the metal detector from 8.90 seconds to 3.15 seconds. The Euclidean distance calculation also shows a decrease in worker travel distance at the small packaging (250 grams) and large packaging (1 kg) production stages. For small packaging, the distance decreased by 7% from the Bulk WIP Pallet to the Small Packaging Machine Platform and by 62% from the Small Packaging Machine to the Metal Detector, while one transfer path remained unchanged. For large packaging, all transfer paths experienced a decrease in distance, with percentages of 50%, 39%, and 23% respectively"

Penelitian pendukung oleh Dwi Julianti, Fitra Fitra, Muhammad Haikal (2025) yang dipublikasikan dalam *Jurnal Teknik Industri: Jurnal Hasil Penelitian dan Karya Ilmiah dalam Bidang Teknik Industri* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
