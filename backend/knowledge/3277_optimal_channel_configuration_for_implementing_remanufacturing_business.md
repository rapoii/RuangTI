# 3277 — Supply Chain Management & Logistics Engineering: Optimal Channel Configuration for Implementing Remanufacturing Business in a Closed-Loop Supply Chain

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Optimal Channel Configuration for Implementing Remanufacturing Business in a Closed-Loop Supply Chain  
**Jurnal & Sitasi Utama:** Juntao Wang, Nozomu Mishima, Tsuyoshi Adachi (2021). *International Journal of Information Systems and Supply Chain Management*. DOI: [10.4018/ijisscm.2021010105](10.4018/ijisscm.2021010105)  
**Sitasi Pendukung:** Kai Liu, Chunfa Li, Runde Gu (2021). *Sustainability*. DOI: [10.3390/su132011357](10.3390/su132011357)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Juntao Wang, Nozomu Mishima, Tsuyoshi Adachi (2021) dalam jurnal *International Journal of Information Systems and Supply Chain Management* (DOI: 10.4018/ijisscm.2021010105) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kai Liu, Chunfa Li, Runde Gu (2021) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
