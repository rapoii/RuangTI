# 4080 — Production Planning & Inventory Control: Interactive reactive scheduling of an unbalanced production line by human learning and machine induction

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Interactive reactive scheduling of an unbalanced production line by human learning and machine induction  
**Jurnal & Sitasi Utama:** Deogratias Kibira (2022). *UNSWorks (University of New South Wales, Sydney, Australia)*. DOI: [10.26190/unsworks/4478](10.26190/unsworks/4478)  
**Sitasi Pendukung:** Beatrice Marchi, Ivan Ferretti, Simone Zanoni (2023). *IFIP advances in information and communication technology*. DOI: [10.1007/978-3-031-43670-3_52](10.1007/978-3-031-43670-3_52)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Deogratias Kibira (2022) dalam jurnal *UNSWorks (University of New South Wales, Sydney, Australia)* (DOI: 10.26190/unsworks/4478) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Engineering for their invaluable suggestions to the work related to human learning and machine induction and for allowing me access to facilities in the Artificial Intelligence laboratory.Thanks are also extended to some Alcatel STC's staff members especially Michael Skeen and Ken Wilcox for"

Penelitian pendukung oleh Beatrice Marchi, Ivan Ferretti, Simone Zanoni (2023) yang dipublikasikan dalam *IFIP advances in information and communication technology* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
