# 3266 — Supply Chain Management & Logistics Engineering: Modelling closed-loop dual-channel supply chain: A game-theoretic approach to maximize the profit

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Modelling closed-loop dual-channel supply chain: A game-theoretic approach to maximize the profit  
**Jurnal & Sitasi Utama:** Umangi Pathak, Ravi Kant, Ravi Shankar (2022). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2022.100064](10.1016/j.clscn.2022.100064)  
**Sitasi Pendukung:** Anushka Lydia Issac (2024). *Impact of Industry 4.0 on Supply Chain Sustainability*. DOI: [10.1108/978-1-83797-777-220241011](10.1108/978-1-83797-777-220241011)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Umangi Pathak, Ravi Kant, Ravi Shankar (2022) dalam jurnal *Cleaner Logistics and Supply Chain* (DOI: 10.1016/j.clscn.2022.100064) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
