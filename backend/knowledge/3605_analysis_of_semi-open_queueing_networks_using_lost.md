# 3605 — Applied Statistics & Stochastic Modeling: Analysis of semi-open queueing networks using lost customers approximation with an application to robotic mobile fulfilment systems

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Analysis of semi-open queueing networks using lost customers approximation with an application to robotic mobile fulfilment systems  
**Jurnal & Sitasi Utama:** Sonja Otten, Ruslan Krenzler, Lin Xie (2021). *OR Spectrum*. DOI: [10.1007/s00291-021-00662-9](10.1007/s00291-021-00662-9)  
**Sitasi Pendukung:** Galit Yom-Tov, Fiona Sloothaak, Johan van Leeuwaarden (2025). *SSRN Electronic Journal*. DOI: [10.2139/ssrn.5880142](10.2139/ssrn.5880142)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sonja Otten, Ruslan Krenzler, Lin Xie (2021) dalam jurnal *OR Spectrum* (DOI: 10.1007/s00291-021-00662-9) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Galit Yom-Tov, Fiona Sloothaak, Johan van Leeuwaarden (2025) yang dipublikasikan dalam *SSRN Electronic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
