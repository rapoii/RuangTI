# 4065 — Production Planning & Inventory Control: Enhancing Rolling Horizon Production Planning Through Stochastic Optimization Evaluated by Means of Simulation

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Enhancing Rolling Horizon Production Planning Through Stochastic Optimization Evaluated by Means of Simulation  
**Jurnal & Sitasi Utama:** Manuel Schlenkrich, Wolfgang Seiringer, Klaus Altendorfer (2024). *RePEc: Research Papers in Economics*. DOI: [10.48550/arxiv.2402.14506](10.48550/arxiv.2402.14506)  
**Sitasi Pendukung:** Stefan Kassen, Holger Tammen, Maximilian Zarte (2021). *Processes*. DOI: [10.3390/pr9081362](10.3390/pr9081362)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Manuel Schlenkrich, Wolfgang Seiringer, Klaus Altendorfer (2024) dalam jurnal *RePEc: Research Papers in Economics* (DOI: 10.48550/arxiv.2402.14506) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Stefan Kassen, Holger Tammen, Maximilian Zarte (2021) yang dipublikasikan dalam *Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
