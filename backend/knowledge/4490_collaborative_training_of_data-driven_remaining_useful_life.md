# 4490 — Maintenance Engineering & Asset Life Cycle: Collaborative Training of Data-Driven Remaining Useful Life Prediction Models Using Federated Learning

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Collaborative Training of Data-Driven Remaining Useful Life Prediction Models Using Federated Learning  
**Jurnal & Sitasi Utama:** Wilhelm Söderkvist Vermelin, Madhav Mishra, Mattias P. Eng (2024). *International Journal of Prognostics and Health Management*. DOI: [10.36001/ijphm.2024.v15i2.3821](10.36001/ijphm.2024.v15i2.3821)  
**Sitasi Pendukung:** Hongguang Du, Fan Zhang, Zhenyang Ma (2024). *2024 Global Reliability and Prognostics and Health Management Conference (PHM-Beijing)*. DOI: [10.1109/phm-beijing63284.2024.10874595](10.1109/phm-beijing63284.2024.10874595)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wilhelm Söderkvist Vermelin, Madhav Mishra, Mattias P. Eng (2024) dalam jurnal *International Journal of Prognostics and Health Management* (DOI: 10.36001/ijphm.2024.v15i2.3821) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hongguang Du, Fan Zhang, Zhenyang Ma (2024) yang dipublikasikan dalam *2024 Global Reliability and Prognostics and Health Management Conference (PHM-Beijing)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
