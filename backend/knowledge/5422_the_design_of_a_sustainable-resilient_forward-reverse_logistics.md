# 5422 — Operations Research & Large-Scale Optimization: The design of a sustainable-resilient forward-reverse logistics network considering resource sharing and using an accelerated benders decomposition algorithm

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** The design of a sustainable-resilient forward-reverse logistics network considering resource sharing and using an accelerated benders decomposition algorithm  
**Jurnal & Sitasi Utama:** Hamid Saffari, Morteza Abbasi, Jafar Gheidar Kheljani (2024). *International Journal of Shipping and Transport Logistics*. DOI: [10.1504/ijstl.2024.10062137](10.1504/ijstl.2024.10062137)  
**Sitasi Pendukung:** Simon Belieres, Mike Hewitt, Nicolas Jozefowiez (2022). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.07.056](10.1016/j.ejor.2021.07.056)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hamid Saffari, Morteza Abbasi, Jafar Gheidar Kheljani (2024) dalam jurnal *International Journal of Shipping and Transport Logistics* (DOI: 10.1504/ijstl.2024.10062137) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
