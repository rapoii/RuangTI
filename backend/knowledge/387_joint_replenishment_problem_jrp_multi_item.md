# Modul Komprehensif: Joint Replenishment Problem (JRP) & Pengelompokan Pemesanan Multi-Item
**Nomor Modul:** [387]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Deterministic Inventory Theory (Sven Axsäter - Springer), Naval Research Logistics (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Joint Replenishment Problem (JRP) & Pengelompokan Pemesanan Multi-Item**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Major Ordering Cost $S$ vs Minor Ordering Cost $s_i$, Dasar Siklus Waktu $T$, Bilangan Bulat Pengali $k_i$, Algoritma RAND, Heuristik Silver, Direct Search Algorithm.
...
```python
# Algoritma Solusi Terapan untuk Joint Replenishment Problem (JRP) & Pengelompokan Pemesanan Multi-Item
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Optimasi Pengadaan Bersama 450 Jenis Suku Cadang Mesin Pabrik Tekstil Menghemat Biaya Pemesanan 34%.
...
1. Deterministic Inventory Theory (Sven Axsäter - Springer), Naval Research Logistics (2024).
