# 6000 — Maintenance Engineering & Asset Life Cycle: Perancangan Jadwal Perawatan Mesin Menggunakan Pendekatan Reliability Centered Maintenance (RCM) pada PT. XYZ

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Perancangan Jadwal Perawatan Mesin Menggunakan Pendekatan Reliability Centered Maintenance (RCM) pada PT. XYZ  
**Jurnal & Sitasi Utama:** Nurhayati Sembiring, Gita Ade Elvira (2018). *Talenta Conference Series: Energy and Engineering (EE)*. DOI: [10.32734/ee.v1i2.245](10.32734/ee.v1i2.245)  
**Sitasi Pendukung:** Noel Shannon, Anna Trubetskaya, Javed Iqbal (2023). *Heliyon*. DOI: [10.1016/j.heliyon.2023.e20516](10.1016/j.heliyon.2023.e20516)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nurhayati Sembiring, Gita Ade Elvira (2018) dalam jurnal *Talenta Conference Series: Energy and Engineering (EE)* (DOI: 10.32734/ee.v1i2.245) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
