# 5755 — Operations Research & Large-Scale Optimization: A Chance Constrained Programming for Green Unequal-Area Facility Layout Problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Chance Constrained Programming for Green Unequal-Area Facility Layout Problem  
**Jurnal & Sitasi Utama:** Sasan Barak, Reza Moghdani, Davood Mohammadi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5019801](10.2139/ssrn.5019801)  
**Sitasi Pendukung:** Jiaqi Zhang, Guang Tian, Xiangyu Chen (2023). *Energy*. DOI: [10.1016/j.energy.2023.127813](10.1016/j.energy.2023.127813)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sasan Barak, Reza Moghdani, Davood Mohammadi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5019801) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiaqi Zhang, Guang Tian, Xiangyu Chen (2023) yang dipublikasikan dalam *Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
