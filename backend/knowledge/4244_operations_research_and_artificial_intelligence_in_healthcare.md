# 4244 — Simulation Modeling & Digital Twins: Operations Research and Artificial Intelligence in Healthcare Management

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Operations Research and Artificial Intelligence in Healthcare Management  
**Jurnal & Sitasi Utama:** Paolo Landa, André Côté, Jean‐Baptiste Gartner (2025). *Springer proceedings in mathematics & statistics*. DOI: [10.1007/978-3-031-95659-1](10.1007/978-3-031-95659-1)  
**Sitasi Pendukung:** Alan Rizzato Espessato, Aline Naiara Zito, João Henrique de Freitas (2024). *Peer-Reviewed Academic Journal*. DOI: [10.22533/at.ed.9642414101](10.22533/at.ed.9642414101)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Paolo Landa, André Côté, Jean‐Baptiste Gartner (2025) dalam jurnal *Springer proceedings in mathematics & statistics* (DOI: 10.1007/978-3-031-95659-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This open access book focuses on innovation in a post-pandemic health and social services system under the lens of artificial intelligence and operations"

Penelitian pendukung oleh Alan Rizzato Espessato, Aline Naiara Zito, João Henrique de Freitas (2024) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
