# 4573 — Operations Research & Large-Scale Optimization: An Optimization Approach for A Biogas Supply Chain using Goal Programming and Mixed Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An Optimization Approach for A Biogas Supply Chain using Goal Programming and Mixed Integer Linear Programming  
**Jurnal & Sitasi Utama:** Onur DERSE, Elifcan GÖÇMEN (2023). *Bitlis Eren Üniversitesi Fen Bilimleri Dergisi*. DOI: [10.17798/bitlisfen.1228978](10.17798/bitlisfen.1228978)  
**Sitasi Pendukung:** Christian Reintjes, Ulf Lorenz (2021). *Optimization and Engineering*. DOI: [10.1007/s11081-020-09541-8](10.1007/s11081-020-09541-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Onur DERSE, Elifcan GÖÇMEN (2023) dalam jurnal *Bitlis Eren Üniversitesi Fen Bilimleri Dergisi* (DOI: 10.17798/bitlisfen.1228978) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Christian Reintjes, Ulf Lorenz (2021) yang dipublikasikan dalam *Optimization and Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
