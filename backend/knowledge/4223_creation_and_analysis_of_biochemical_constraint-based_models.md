# 4223 — Operations Research & Large-Scale Optimization: Creation and analysis of biochemical constraint-based models using the COBRA Toolbox v.3.0

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Creation and analysis of biochemical constraint-based models using the COBRA Toolbox v.3.0  
**Jurnal & Sitasi Utama:** Laurent Heirendt, Sylvain Arreckx, Thomas Pfau (2019). *Nature Protocols*. DOI: [10.1038/s41596-018-0098-2](10.1038/s41596-018-0098-2)  
**Sitasi Pendukung:** Fabio Furini, Emiliano Traversi, Pietro Belotti (2018). *Mathematical Programming Computation*. DOI: [10.1007/s12532-018-0147-4](10.1007/s12532-018-0147-4)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Laurent Heirendt, Sylvain Arreckx, Thomas Pfau (2019) dalam jurnal *Nature Protocols* (DOI: 10.1038/s41596-018-0098-2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
