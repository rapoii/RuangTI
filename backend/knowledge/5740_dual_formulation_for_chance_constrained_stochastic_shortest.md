# 5740 — Operations Research & Large-Scale Optimization: Dual Formulation for Chance Constrained Stochastic Shortest Path with Application to Autonomous Vehicle Behavior Planning

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Dual Formulation for Chance Constrained Stochastic Shortest Path with Application to Autonomous Vehicle Behavior Planning  
**Jurnal & Sitasi Utama:** Rashid Alyassi, Majid Khonji (2021). *2021 60th IEEE Conference on Decision and Control (CDC)*. DOI: [10.1109/cdc45484.2021.9683656](10.1109/cdc45484.2021.9683656)  
**Sitasi Pendukung:** Fan Yang, Nilanjan Chakraborty (2020). *2020 IEEE International Conference on Robotics and Automation (ICRA)*. DOI: [10.1109/icra40945.2020.9197354](10.1109/icra40945.2020.9197354)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rashid Alyassi, Majid Khonji (2021) dalam jurnal *2021 60th IEEE Conference on Decision and Control (CDC)* (DOI: 10.1109/cdc45484.2021.9683656) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Fan Yang, Nilanjan Chakraborty (2020) yang dipublikasikan dalam *2020 IEEE International Conference on Robotics and Automation (ICRA)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
