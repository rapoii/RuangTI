# 3180 — Human Factors & Cognitive Ergonomics: Multimodal Physiological Signals for Workload Prediction in Robot-assisted Surgery

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Multimodal Physiological Signals for Workload Prediction in Robot-assisted Surgery  
**Jurnal & Sitasi Utama:** Tian Zhou, Jackie Cha, Glebys Gonzalez (2020). *ACM Transactions on Human-Robot Interaction*. DOI: [10.1145/3368589](10.1145/3368589)  
**Sitasi Pendukung:** Quentin Meteier, Marine Capallera, Simon Ruffieux (2021). *Frontiers in Psychology*. DOI: [10.3389/fpsyg.2021.596038](10.3389/fpsyg.2021.596038)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tian Zhou, Jackie Cha, Glebys Gonzalez (2020) dalam jurnal *ACM Transactions on Human-Robot Interaction* (DOI: 10.1145/3368589) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Quentin Meteier, Marine Capallera, Simon Ruffieux (2021) yang dipublikasikan dalam *Frontiers in Psychology* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
