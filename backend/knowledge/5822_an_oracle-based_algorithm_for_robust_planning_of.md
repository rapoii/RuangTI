# 5822 — Supply Chain Management & Logistics Engineering: An oracle-based algorithm for robust planning of production routing problems in closed-loop supply chains of beverage glass bottles

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** An oracle-based algorithm for robust planning of production routing problems in closed-loop supply chains of beverage glass bottles  
**Jurnal & Sitasi Utama:** Ali Borumand, Ahmadreza Marandi, Ali Shahandeh Nookabadi (2023). *Omega*. DOI: [10.1016/j.omega.2023.102939](10.1016/j.omega.2023.102939)  
**Sitasi Pendukung:** Anna M. Walker, Walter J.V. Vermeulen, Alberto Simboli (2020). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2020.125457](10.1016/j.jclepro.2020.125457)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ali Borumand, Ahmadreza Marandi, Ali Shahandeh Nookabadi (2023) dalam jurnal *Omega* (DOI: 10.1016/j.omega.2023.102939) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Anna M. Walker, Walter J.V. Vermeulen, Alberto Simboli (2020) yang dipublikasikan dalam *Journal of Cleaner Production* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
