# 4898 — Engineering Economics & Cost Optimization: Beyond Real Options: When Is Valuation under the Real-World Measure Arbitrage-Free?

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Beyond Real Options: When Is Valuation under the Real-World Measure Arbitrage-Free?  
**Jurnal & Sitasi Utama:** Mike Felpel, Lutz Hahnenstein (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6786658](10.2139/ssrn.6786658)  
**Sitasi Pendukung:** Gualter Couto, Pedro Pimentel, Carla Oliveira (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3532349](10.2139/ssrn.3532349)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mike Felpel, Lutz Hahnenstein (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6786658) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper introduces a unified arbitrage-free framework that links real-world expectations to risk-neutral valuation. We incorporate valuation under the real-world measure into the standard risk-neutral pricing paradigm and extend it to general contingent claims, deriving closed-form representations for certainty equivalents and risk-adjusted discount rates.&amp;nbsp; &lt;br&gt;&lt;br&gt;Within this setting, we show that the traditional discounted cash flow (DCF) method emerges as a special case of arbitrage-free valuation under the real-world measure and is valid only for payoff structures that are linear in the numéraire return. For non-linear claims, including but not limited to investments containing real options, standard beta-based discounting is generally inconsistent with arbitrage-free pricing and can induce economically material mispricing.&lt;br&gt;&lt;br&gt;More broadly, the framework clarifies the conceptual relationships among risk-neutral valuation, pricing kernels, certainty equivalents, and cost-of-capital approaches within a unified theoretical model. It also provides a precise characterization of the conditions under which real-world valuation methods remain consistent with arbitrage-free pricing."

Penelitian pendukung oleh Gualter Couto, Pedro Pimentel, Carla Oliveira (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
