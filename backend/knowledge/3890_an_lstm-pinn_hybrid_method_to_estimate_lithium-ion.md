# 3890 — Industrial Artificial Intelligence & Data Analytics: An LSTM-PINN Hybrid Method to Estimate Lithium-Ion Battery Pack Temperature

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** An LSTM-PINN Hybrid Method to Estimate Lithium-Ion Battery Pack Temperature  
**Jurnal & Sitasi Utama:** Gyouho Cho, Di Zhu, Jeffrey Joseph Campbell (2022). *IEEE Access*. DOI: [10.1109/access.2022.3208103](10.1109/access.2022.3208103)  
**Sitasi Pendukung:** Ahmad Moeineddin, Carolina Seguí, Stephan Dueber (2023). *Landslides*. DOI: [10.1007/s10346-023-02072-0](10.1007/s10346-023-02072-0)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gyouho Cho, Di Zhu, Jeffrey Joseph Campbell (2022) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2022.3208103) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
