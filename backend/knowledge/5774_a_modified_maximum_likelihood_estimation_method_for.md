# 5774 — Quality Engineering & Reliability Systems: A modified Maximum Likelihood estimation method for Weibull distribution based accelerated life testing

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** A modified Maximum Likelihood estimation method for Weibull distribution based accelerated life testing  
**Jurnal & Sitasi Utama:** Jingxiao Yao, Ling Li, Zengqiang Zhong (2024). *2024 15th International Conference on Reliability, Maintenance and Safety (ICRMS)*. DOI: [10.1109/icrms63553.2024.00059](10.1109/icrms63553.2024.00059)  
**Sitasi Pendukung:** Jingxiao Yao, Ling Li, Zengqiang Zhong (2024). *2024 15th International Conference on Reliability, Maintenance and Safety (ICRMS)*. DOI: [10.1109/icrms63553.2024.00059](10.1109/icrms63553.2024.00059)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jingxiao Yao, Ling Li, Zengqiang Zhong (2024) dalam jurnal *2024 15th International Conference on Reliability, Maintenance and Safety (ICRMS)* (DOI: 10.1109/icrms63553.2024.00059) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jingxiao Yao, Ling Li, Zengqiang Zhong (2024) yang dipublikasikan dalam *2024 15th International Conference on Reliability, Maintenance and Safety (ICRMS)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
