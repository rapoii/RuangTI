# 5759 — Operations Research & Large-Scale Optimization: Stochastic optimization model for integrated energy system under uncertainty based on chance-constrained programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Stochastic optimization model for integrated energy system under uncertainty based on chance-constrained programming  
**Jurnal & Sitasi Utama:** Baoju Li, Yong Sun, Xu Li (2021). *Journal of Physics: Conference Series*. DOI: [10.1088/1742-6596/2005/1/012153](10.1088/1742-6596/2005/1/012153)  
**Sitasi Pendukung:** Jitesh J. Thakkar (2022). *Management and Industrial Engineering*. DOI: [10.1007/978-981-15-3695-3_6](10.1007/978-981-15-3695-3_6)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Baoju Li, Yong Sun, Xu Li (2021) dalam jurnal *Journal of Physics: Conference Series* (DOI: 10.1088/1742-6596/2005/1/012153) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jitesh J. Thakkar (2022) yang dipublikasikan dalam *Management and Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
