# 6278 — Operations Research & Large-Scale Optimization: Constraint violation reduction search for 0–1 mixed integer linear programming problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Constraint violation reduction search for 0–1 mixed integer linear programming problems  
**Jurnal & Sitasi Utama:** Ankit Bansal, Reha Uzsoy (2021). *Engineering Optimization*. DOI: [10.1080/0305215x.2020.1742710](10.1080/0305215x.2020.1742710)  
**Sitasi Pendukung:** Shamisa Shoja, Daniel Axehill (2023). *2023 62nd IEEE Conference on Decision and Control (CDC)*. DOI: [10.1109/cdc49753.2023.10384105](10.1109/cdc49753.2023.10384105)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ankit Bansal, Reha Uzsoy (2021) dalam jurnal *Engineering Optimization* (DOI: 10.1080/0305215x.2020.1742710) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shamisa Shoja, Daniel Axehill (2023) yang dipublikasikan dalam *2023 62nd IEEE Conference on Decision and Control (CDC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
