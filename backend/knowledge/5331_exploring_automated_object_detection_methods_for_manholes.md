# 5331 — Industrial Artificial Intelligence & Data Analytics: Exploring automated object detection methods for manholes using classical computer vision and deep learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Exploring automated object detection methods for manholes using classical computer vision and deep learning  
**Jurnal & Sitasi Utama:** Shika Rao, Nitya Mitnala (2023). *Machine Graphics and Vision*. DOI: [10.22630/mgv.2023.32.1.2](10.22630/mgv.2023.32.1.2)  
**Sitasi Pendukung:** Xinyu Liu, Song Jiang, Maopu Wu (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603543](10.1109/cvidl62147.2024.10603543)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shika Rao, Nitya Mitnala (2023) dalam jurnal *Machine Graphics and Vision* (DOI: 10.22630/mgv.2023.32.1.2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
