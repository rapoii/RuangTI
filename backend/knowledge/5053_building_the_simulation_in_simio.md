# 5053 — Simulation Modeling & Digital Twins: Building the Simulation in Simio

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Building the Simulation in Simio  
**Jurnal & Sitasi Utama:** Andrew Greasley (2022). *Simulation Modelling*. DOI: [10.4324/9781003124092-12](10.4324/9781003124092-12)  
**Sitasi Pendukung:** Udo W. Pooch, James A. Wall (2024). *Discrete Event Simulation*. DOI: [10.1201/9781003575054-8](10.1201/9781003575054-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Andrew Greasley (2022) dalam jurnal *Simulation Modelling* (DOI: 10.4324/9781003124092-12) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
