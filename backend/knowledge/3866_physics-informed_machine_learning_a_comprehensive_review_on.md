# 3866 — Industrial Artificial Intelligence & Data Analytics: Physics-informed machine learning: A comprehensive review on applications in anomaly detection and condition monitoring

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-informed machine learning: A comprehensive review on applications in anomaly detection and condition monitoring  
**Jurnal & Sitasi Utama:** Yuandi Wu, Brett Sicard, S. Andrew Gadsden (2024). *Expert Systems with Applications*. DOI: [10.1016/j.eswa.2024.124678](10.1016/j.eswa.2024.124678)  
**Sitasi Pendukung:** Ivan Malashin, В С Тынченко, Andrei Gantimurov (2025). *Polymers*. DOI: [10.3390/polym17081108](10.3390/polym17081108)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuandi Wu, Brett Sicard, S. Andrew Gadsden (2024) dalam jurnal *Expert Systems with Applications* (DOI: 10.1016/j.eswa.2024.124678) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
