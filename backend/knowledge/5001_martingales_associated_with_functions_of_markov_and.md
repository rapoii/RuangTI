# 5001 — Applied Statistics & Stochastic Modeling: Martingales associated with functions of Markov and finite variation processes

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Martingales associated with functions of Markov and finite variation processes  
**Jurnal & Sitasi Utama:** Offer Kella (2022). *Queueing Systems*. DOI: [10.1007/s11134-022-09749-8](10.1007/s11134-022-09749-8)  
**Sitasi Pendukung:** Ioannis Dimitriou (2025). *Queueing Systems*. DOI: [10.1007/s11134-025-09948-z](10.1007/s11134-025-09948-z)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Offer Kella (2022) dalam jurnal *Queueing Systems* (DOI: 10.1007/s11134-022-09749-8) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ioannis Dimitriou (2025) yang dipublikasikan dalam *Queueing Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
