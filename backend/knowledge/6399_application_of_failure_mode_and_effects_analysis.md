# 6399 — Quality Engineering & Reliability Systems: Application of Failure Mode and Effects Analysis (FMEA) for Risk Assessment in Food Microenterprises

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Application of Failure Mode and Effects Analysis (FMEA) for Risk Assessment in Food Microenterprises  
**Jurnal & Sitasi Utama:** Brenda Durán Carmona, Roberto Baeza Serrato (2026). *European Modern Studies Journal*. DOI: [10.59573/emsj.10(3).2026.36](10.59573/emsj.10(3).2026.36)  
**Sitasi Pendukung:** Richard A. Harpster (2022). *2022 Annual Reliability and Maintainability Symposium (RAMS)*. DOI: [10.1109/rams51457.2022.9893956](10.1109/rams51457.2022.9893956)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Brenda Durán Carmona, Roberto Baeza Serrato (2026) dalam jurnal *European Modern Studies Journal* (DOI: 10.59573/emsj.10(3).2026.36) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Failure Mode and Effect Analysis (FMEA) is a widely used risk management tool due to its adaptability across different products, services, and processes, regardless of organization size. This study applies FMEA to a microenterprise selling fried chicken and burgers to identify and evaluate potential failures in its production and delivery processes. The results show that the delivery area requires more attention due to delays, which directly affect customer satisfaction and may lead to consumer loss. Opportunities for improvement in salad preparation and staff service were also identified. Once failures are detected, it is essential to analyze their causes to implement corrective actions that reduce their occurrence and minimize their effects. It is concluded that FMEA is an effective tool for supporting decision-making, improving the quality of processes and products, and strengthening the competitiveness of micro-enterprises."

Penelitian pendukung oleh Richard A. Harpster (2022) yang dipublikasikan dalam *2022 Annual Reliability and Maintainability Symposium (RAMS)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
