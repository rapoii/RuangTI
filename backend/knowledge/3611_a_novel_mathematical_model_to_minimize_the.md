# 3611 — Applied Statistics & Stochastic Modeling: A novel mathematical model to minimize the total cost of the hospital and COVID-19 outbreak concerning waiting time of patients using Jackson queueing networks, a case study

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** A novel mathematical model to minimize the total cost of the hospital and COVID-19 outbreak concerning waiting time of patients using Jackson queueing networks, a case study  
**Jurnal & Sitasi Utama:** Shirin Ghasemi, Fateme Taghipour, Amir Aghsami (2023). *Scientia Iranica*. DOI: [10.24200/sci.2023.60803.6999](10.24200/sci.2023.60803.6999)  
**Sitasi Pendukung:** Hoang Huy Nguyen, Sushil Mahavir Varma, Siva Theja Maguluri (2025). *Peer-Reviewed Academic Journal*. DOI: [10.1145/3726854.3727287](10.1145/3726854.3727287)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shirin Ghasemi, Fateme Taghipour, Amir Aghsami (2023) dalam jurnal *Scientia Iranica* (DOI: 10.24200/sci.2023.60803.6999) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hoang Huy Nguyen, Sushil Mahavir Varma, Siva Theja Maguluri (2025) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
