# 5136 — Industrial Energy Management & Decarbonization: Comparative study between the Energy Information System (EIS) and the Energy Management System (EnMS) according to ISO 50001

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Comparative study between the Energy Information System (EIS) and the Energy Management System (EnMS) according to ISO 50001  
**Jurnal & Sitasi Utama:** Séraphin Ebagninin Kouaho, Christophe Marvillet, Yao N'Guessan (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4660585](10.2139/ssrn.4660585)  
**Sitasi Pendukung:** В.Ф. Белей, В.Ф. Паршина (2020). *Грозненский естественнонаучный бюллетень*. DOI: [10.25744/genb.2020.20.2.008](10.25744/genb.2020.20.2.008)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Séraphin Ebagninin Kouaho, Christophe Marvillet, Yao N'Guessan (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4660585) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The Energy Information System (EIS) makes it possible to respond to operational needs automatically and facilitates operation and regular monitoring of the situation of daily energy consumption. It can also serve as a support, communication and information channel for the Energy Management System (EMS), and the stakeholders (Energy Manager, Energy Referent, SEA - Shared Energy Advisor, and / or the Decision Makers…). In other words, the EIS plays a facilitating role in the implementation of the EMS and especially in identifying the scope of certification of the ISO 50001 standard.&lt;br&gt;On the other hand, the Energy Management System (EMS) is a management and steering system that helps organizations identify action levers on energy sources, through the implementation of processes and plan continuous improvements.  It is a real “taking charge” of the energy position within the body.&lt;br&gt;This study was the subject of a comparative, explanatory and statistical evaluation approach, based on the criteria of definition, objective, functionality, role or set of correlated elements (organizational structure , roles and responsibilities, planning, functioning of the organization, policy) of the ISO 50001 standard and supplemented by other criteria specific to the two Systems (EIS and EMS).&lt;br&gt;The comparative study carried out in this article between the Energy Information System (EIS) and the Energy Management System (EMS) shows a link or complementarity of 40%, dependin"

Penelitian pendukung oleh В.Ф. Белей, В.Ф. Паршина (2020) yang dipublikasikan dalam *Грозненский естественнонаучный бюллетень* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
