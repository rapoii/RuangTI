# 3658 — Simulation Modeling & Digital Twins: An optimization–simulation closed-loop feedback framework for modeling the airport capacity management problem under uncertainty

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** An optimization–simulation closed-loop feedback framework for modeling the airport capacity management problem under uncertainty  
**Jurnal & Sitasi Utama:** Paolo Scala, Miguel Mújica Mota, Cheng‐Lung Wu (2020). *Transportation Research Part C Emerging Technologies*. DOI: [10.1016/j.trc.2020.102937](10.1016/j.trc.2020.102937)  
**Sitasi Pendukung:** Salahuddin Iskanderani, Omer Bafail, Mohammed Alamoudi (2023). *Axioms*. DOI: [10.3390/axioms12100975](10.3390/axioms12100975)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Paolo Scala, Miguel Mújica Mota, Cheng‐Lung Wu (2020) dalam jurnal *Transportation Research Part C Emerging Technologies* (DOI: 10.1016/j.trc.2020.102937) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Salahuddin Iskanderani, Omer Bafail, Mohammed Alamoudi (2023) yang dipublikasikan dalam *Axioms* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
