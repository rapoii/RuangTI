# 3209 — Human Factors & Cognitive Ergonomics: Generalisable machine learning models trained on heart rate variability data to predict mental fatigue

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Generalisable machine learning models trained on heart rate variability data to predict mental fatigue  
**Jurnal & Sitasi Utama:** András Matuz, Dimitri van der Linden, Gergely Darnai (2022). *Scientific Reports*. DOI: [10.1038/s41598-022-24415-y](10.1038/s41598-022-24415-y)  
**Sitasi Pendukung:** Murillo Pagnotta, David M. Jacobs, Patricia López de Frutos (2021). *Ergonomics*. DOI: [10.1080/00140139.2021.2016998](10.1080/00140139.2021.2016998)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari András Matuz, Dimitri van der Linden, Gergely Darnai (2022) dalam jurnal *Scientific Reports* (DOI: 10.1038/s41598-022-24415-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
