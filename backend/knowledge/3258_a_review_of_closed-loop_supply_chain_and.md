# 3258 — Supply Chain Management & Logistics Engineering: A review of closed-loop supply chain and reverse logistics models

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A review of closed-loop supply chain and reverse logistics models  
**Jurnal & Sitasi Utama:** Miqdad Nidal Eldali (2024). *Peer-Reviewed Journal*. DOI: [10.32920/19857493.v1](10.32920/19857493.v1)  
**Sitasi Pendukung:** Amrina Kausar, Chandra K. Jaggi, Sumit Maheshwari (2025). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2025.100223](10.1016/j.clscn.2025.100223)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Miqdad Nidal Eldali (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.32920/19857493.v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "&lt;p&gt;Closed-loop supply chains (CLSC) have been studied extensively in the literature due to the cost and environmental optimization in operations. CLSC consists of forward and reverse supply chains. This paper reviews the literature of CLSC networks. 223 peer-reviewed articles that have been published in international journals from 1997 to 2020 are gathered and analysed. The aim is to answer the following main questions: (i) What is the problem domain in CLSC? (ii) Which techniques are utilized frequently in CLSC? (iii) What elements, variables, and objectives are the main focus in the field? (iv) What are the gaps in the literature? After reviewing the literature, observations are provided. Finally, the evaluations conclude suggested improvements and potential future directions in the research field.  Keywords: Supply chain management (SCM); Closed-loop supply chain (CLSC); Reverse logistics (RL); Uncertainty; Game theory&lt;/p&gt;"

Penelitian pendukung oleh Amrina Kausar, Chandra K. Jaggi, Sumit Maheshwari (2025) yang dipublikasikan dalam *Cleaner Logistics and Supply Chain* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
