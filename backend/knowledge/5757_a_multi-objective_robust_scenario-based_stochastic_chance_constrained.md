# 5757 — Operations Research & Large-Scale Optimization: A multi-objective robust scenario-based stochastic chance constrained programming model for sustainable closed-loop agri-food supply chain

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A multi-objective robust scenario-based stochastic chance constrained programming model for sustainable closed-loop agri-food supply chain  
**Jurnal & Sitasi Utama:** Misagh Rahbari, Alireza Arshadi Khamseh, Mohammad Mohammadi (2025). *Computers &amp; Chemical Engineering*. DOI: [10.1016/j.compchemeng.2024.108914](10.1016/j.compchemeng.2024.108914)  
**Sitasi Pendukung:** Tao Jiang, Guodong Liu, Michael R. Starke (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4989264](10.2139/ssrn.4989264)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Misagh Rahbari, Alireza Arshadi Khamseh, Mohammad Mohammadi (2025) dalam jurnal *Computers &amp; Chemical Engineering* (DOI: 10.1016/j.compchemeng.2024.108914) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tao Jiang, Guodong Liu, Michael R. Starke (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
