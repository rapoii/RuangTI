# 6208 — Operations Research & Large-Scale Optimization: A Column Generation Based Heuristic for the Split Delivery Vehicle Routing Problem with Time Windows
...
**Jurnal & Sitasi Utama:** Pedro Munari (2024). *Peer-Reviewed Journal*. DOI: [10.52843/cassyni.hwprdn](10.52843/cassyni.hwprdn)  
**Sitasi Pendukung:** Fuqiang Lu, Zhiyuan Gao, Hualing Bi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4984553](10.2139/ssrn.4984553)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pedro Munari (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.52843/cassyni.hwprdn) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Fuqiang Lu, Zhiyuan Gao, Hualing Bi (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
