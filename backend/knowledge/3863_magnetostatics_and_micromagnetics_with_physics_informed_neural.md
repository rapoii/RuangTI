# 3863 — Industrial Artificial Intelligence & Data Analytics: Magnetostatics and micromagnetics with physics informed neural networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Magnetostatics and micromagnetics with physics informed neural networks  
**Jurnal & Sitasi Utama:** Alexander Kovacs, Lukas Exl, Alexander Kornell (2022). *Journal of Magnetism and Magnetic Materials*. DOI: [10.1016/j.jmmm.2021.168951](10.1016/j.jmmm.2021.168951)  
**Sitasi Pendukung:** Jiangce Chen, Justin Pierce, Glen Williams (2023). *Journal of Computing and Information Science in Engineering*. DOI: [10.1115/1.4062852](10.1115/1.4062852)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alexander Kovacs, Lukas Exl, Alexander Kornell (2022) dalam jurnal *Journal of Magnetism and Magnetic Materials* (DOI: 10.1016/j.jmmm.2021.168951) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiangce Chen, Justin Pierce, Glen Williams (2023) yang dipublikasikan dalam *Journal of Computing and Information Science in Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
