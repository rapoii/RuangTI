# 4722 — Quality Engineering & Reliability Systems: Multivariate Nonparametric Control Charts Based on Ordered Samples, Signs and Ranks

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Multivariate Nonparametric Control Charts Based on Ordered Samples, Signs and Ranks  
**Jurnal & Sitasi Utama:** Elisavet M. Sofikitou, Markos V. Koutras (2020). *Distribution-Free Methods for Statistical Process Monitoring and Control*. DOI: [10.1007/978-3-030-25081-2_2](10.1007/978-3-030-25081-2_2)  
**Sitasi Pendukung:** Lead Industrial Researchers (2020). *Introduction to Statistical Process Control*. DOI: [10.1002/9781119528425.ch3](10.1002/9781119528425.ch3)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Elisavet M. Sofikitou, Markos V. Koutras (2020) dalam jurnal *Distribution-Free Methods for Statistical Process Monitoring and Control* (DOI: 10.1007/978-3-030-25081-2_2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
