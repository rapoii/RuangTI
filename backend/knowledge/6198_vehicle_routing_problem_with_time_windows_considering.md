# 6198 — Operations Research & Large-Scale Optimization: Vehicle routing problem with time windows considering carbon emission

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Vehicle routing problem with time windows considering carbon emission  
**Jurnal & Sitasi Utama:** Ping Lou, Zikang Zhou, Yuhang Zeng (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-3000408/v1](10.21203/rs.3.rs-3000408/v1)  
**Sitasi Pendukung:** Zhengquan yang, Defeng Sun, Ren Zhao (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6864487](10.2139/ssrn.6864487)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ping Lou, Zikang Zhou, Yuhang Zeng (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-3000408/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
