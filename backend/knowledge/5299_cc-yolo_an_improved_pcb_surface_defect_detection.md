# 5299 — Industrial Artificial Intelligence & Data Analytics: CC-YOLO: An Improved PCB Surface Defect Detection Model for YOLOv7

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** CC-YOLO: An Improved PCB Surface Defect Detection Model for YOLOv7  
**Jurnal & Sitasi Utama:** Xiangyu Yi, Xudong Song (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603706](10.1109/cvidl62147.2024.10603706)  
**Sitasi Pendukung:** Yinglong Zhang, Honggang Yang, Junwei Cheng (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11085735](10.1109/cvidl65390.2025.11085735)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiangyu Yi, Xudong Song (2024) dalam jurnal *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl62147.2024.10603706) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yinglong Zhang, Honggang Yang, Junwei Cheng (2025) yang dipublikasikan dalam *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
