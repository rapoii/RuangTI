# 3877 — Industrial Artificial Intelligence & Data Analytics: Physics informed neural networks for surrogate modeling of accidental scenarios in nuclear power plants

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics informed neural networks for surrogate modeling of accidental scenarios in nuclear power plants  
**Jurnal & Sitasi Utama:** Federico Antonello, Jacopo Buongiorno, Enrico Zio (2023). *Nuclear Engineering and Technology*. DOI: [10.1016/j.net.2023.06.027](10.1016/j.net.2023.06.027)  
**Sitasi Pendukung:** Renato G. Nascimento, Felipe Viana, Matteo Corbetta (2023). *Scientific Reports*. DOI: [10.1038/s41598-023-33018-0](10.1038/s41598-023-33018-0)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Federico Antonello, Jacopo Buongiorno, Enrico Zio (2023) dalam jurnal *Nuclear Engineering and Technology* (DOI: 10.1016/j.net.2023.06.027) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
