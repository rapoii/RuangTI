# 4380 — Safety Engineering & Risk Management: Event tree analysis for risk-based assessment of digitalised condition-based maintenance in railway

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Event tree analysis for risk-based assessment of digitalised condition-based maintenance in railway  
**Jurnal & Sitasi Utama:** Peter Söderholm, Per-Anders Akersteen (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-4557508/v1](10.21203/rs.3.rs-4557508/v1)  
**Sitasi Pendukung:** Eva Doménech, Sebastian Martorell, Gilver Odilon Mendel Kombo Mpindou (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4028242](10.2139/ssrn.4028242)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Peter Söderholm, Per-Anders Akersteen (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-4557508/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
