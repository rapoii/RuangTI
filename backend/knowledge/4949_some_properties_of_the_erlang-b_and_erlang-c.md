# 4949 — Applied Statistics & Stochastic Modeling: Some Properties of the Erlang-B and Erlang-C Formulae (Technical Supplement to 'Behavior-Aware Queueing: The Finite-Buffer Setting with Many Strategic Servers')

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Some Properties of the Erlang-B and Erlang-C Formulae (Technical Supplement to 'Behavior-Aware Queueing: The Finite-Buffer Setting with Many Strategic Servers')  
**Jurnal & Sitasi Utama:** Yueyang Zhong, Ragavendran Gopalakrishnan, Amy Ward (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4430477](10.2139/ssrn.4430477)  
**Sitasi Pendukung:** Sumeet Khatri (2022). *AVS Quantum Science*. DOI: [10.1116/5.0084653](10.1116/5.0084653)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yueyang Zhong, Ragavendran Gopalakrishnan, Amy Ward (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4430477) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sumeet Khatri (2022) yang dipublikasikan dalam *AVS Quantum Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
