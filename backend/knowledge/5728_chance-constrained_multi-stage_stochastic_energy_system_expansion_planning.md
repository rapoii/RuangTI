# 5728 — Operations Research & Large-Scale Optimization: Chance-Constrained Multi-Stage Stochastic Energy System Expansion Planning with Demand Satisfaction Flexibility

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance-Constrained Multi-Stage Stochastic Energy System Expansion Planning with Demand Satisfaction Flexibility  
**Jurnal & Sitasi Utama:** Yuang Chen, Beste Basciftci, Valerie Thomas (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4197654](10.2139/ssrn.4197654)  
**Sitasi Pendukung:** Luze Yang, Weiyi Cong, Chong Meng (2020). *Water*. DOI: [10.3390/w12092649](10.3390/w12092649)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuang Chen, Beste Basciftci, Valerie Thomas (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4197654) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "We consider the multi-period stochastic energy system expansion planning (ESEP) problem for situations in which there exist unexpectedly high demand scenarios. Although a multi-stage stochastic ESEP model can address the demand uncertainty problem, the model requires demand satisfaction for all scenarios immediately. However, immediate demand satisfaction for those unexpectedly high demand scenarios may result in an expensive and unsustainable system that diverts from the planner&amp;apos;s long-term goals. To address this issue, we propose a chance-constrained stochastic multi-stage ESEP model by allowing a portion of demand to remain unmet in certain years under the unexpectedly high demand scenarios, which provides more time flexibility in the planning process. A binary-search-based progressive hedging algorithm (PHA) is designed to solve the chance-constrained stochastic model when the model is large in scale. A case study using a real dataset for Rwanda demonstrates the benefits of incorporating demand uncertainty through a multi-stage stochastic programming approach with chance constraints. Implementation of chance constraints in expansion plans provides a broader understanding of the planning options and cost savings by allowing time flexibility in meeting unexpectedly high demand."

Penelitian pendukung oleh Luze Yang, Weiyi Cong, Chong Meng (2020) yang dipublikasikan dalam *Water* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
