# 6203 — Operations Research & Large-Scale Optimization: Solving the Open Route Capacitated Periodic Vehicle Routing Problem With Time Windows to Service Microgrids Powered by Uncertain Renewable Generation

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Solving the Open Route Capacitated Periodic Vehicle Routing Problem With Time Windows to Service Microgrids Powered by Uncertain Renewable Generation  
**Jurnal & Sitasi Utama:** Waleed Shawky, Ahmed Azab, Sally Kassem (2022). *Volume 2: Manufacturing Processes; Manufacturing Systems*. DOI: [10.1115/msec2022-81991](10.1115/msec2022-81991)  
**Sitasi Pendukung:** Ying Yang, Xiaodeng Hao, Silong Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7353998](10.2139/ssrn.7353998)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Waleed Shawky, Ahmed Azab, Sally Kassem (2022) dalam jurnal *Volume 2: Manufacturing Processes; Manufacturing Systems* (DOI: 10.1115/msec2022-81991) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ying Yang, Xiaodeng Hao, Silong Zhang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
