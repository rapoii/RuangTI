# 4566 — Operations Research & Large-Scale Optimization: A Multi-Objective Mixed Integer Linear Programming Approach for Simultaneous Optimization of Cost and Resilience of Power Distribution Networks

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Multi-Objective Mixed Integer Linear Programming Approach for Simultaneous Optimization of Cost and Resilience of Power Distribution Networks  
**Jurnal & Sitasi Utama:** Vandana Kumari, Sanjib Ganguly (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4813071](10.2139/ssrn.4813071)  
**Sitasi Pendukung:** yongming Liu, Guowei Chen, Chao Liu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5910404](10.2139/ssrn.5910404)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Vandana Kumari, Sanjib Ganguly (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4813071) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh yongming Liu, Guowei Chen, Chao Liu (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
