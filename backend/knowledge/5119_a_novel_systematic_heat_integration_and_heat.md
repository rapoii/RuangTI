# 5119 — Industrial Energy Management & Decarbonization: A novel systematic heat integration and heat recovery approach for reactivating abandoned mines to meet energy demand of greenhouses-application of dynamic pinch analysis

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** A novel systematic heat integration and heat recovery approach for reactivating abandoned mines to meet energy demand of greenhouses-application of dynamic pinch analysis  
**Jurnal & Sitasi Utama:** Hosein Faramarzpour, Soroush Entezari, Mikhail Sorin (2025). *Energy and Buildings*. DOI: [10.1016/j.enbuild.2025.115678](10.1016/j.enbuild.2025.115678)  
**Sitasi Pendukung:** Lead Industrial Researchers (2023). *Sustainable Process Integration and Intensification*. DOI: [10.1515/9783110782981-011](10.1515/9783110782981-011)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hosein Faramarzpour, Soroush Entezari, Mikhail Sorin (2025) dalam jurnal *Energy and Buildings* (DOI: 10.1016/j.enbuild.2025.115678) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2023) yang dipublikasikan dalam *Sustainable Process Integration and Intensification* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
