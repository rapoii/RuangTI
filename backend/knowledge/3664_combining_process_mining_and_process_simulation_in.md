# 3664 — Simulation Modeling & Digital Twins: Combining Process Mining and Process Simulation in Healthcare: A Literature Review

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Combining Process Mining and Process Simulation in Healthcare: A Literature Review  
**Jurnal & Sitasi Utama:** E. Chaves Salas, Michael Arias, Santiago Aguirre (2024). *IEEE Access*. DOI: [10.1109/access.2024.3501157](10.1109/access.2024.3501157)  
**Sitasi Pendukung:** Szymon Pawlak, Tomasz Małysa, Agnieszka Fornalczyk (2024). *Applied Sciences*. DOI: [10.3390/app142310863](10.3390/app142310863)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari E. Chaves Salas, Michael Arias, Santiago Aguirre (2024) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2024.3501157) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Organizations are increasingly incorporating new strategies to ensure that the complex processes involved in the healthcare sector are comprehensively understood and enhanced. This includes the adoption of process mining (PM) and process simulation (PS), which have been used separately or in combination with one another in the healthcare field to assist decision-makers in process optimization. Although both PM and PS have provided a number of valuable contributions to healthcare, analysis in existing literature is lacking regarding analysis of the benefits, limitations, and tools derived from their combination thereof. The present article conducts a literature review, based on the PRISMA methodology, in which both disciplines are analyzed in terms of their application to healthcare. By reviewing distinct scholarly databases, 31 research studies were selected for analysis, from which it was possible to characterize case studies, techniques, tools, perspectives and algorithms, as well as to identify key limitations. The results indicate a stronger focus on medical fields including cardiology and emergency departments, with a preference for software tools, such as ProM, Disco, Arena, and CPN Tools. The use of real data predominates across the research studies, and the two most commonly identified and detailed limitations in the analysis relate to data quality issues and the involvement of healthcare experts throughout the analysis. Moreover, there is an increasing interest in th"

Penelitian pendukung oleh Szymon Pawlak, Tomasz Małysa, Agnieszka Fornalczyk (2024) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
