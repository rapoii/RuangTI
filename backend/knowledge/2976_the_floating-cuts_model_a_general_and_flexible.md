# 2976 — Operations Research & Large-Scale Optimization: The Floating-Cuts model: a general and flexible mixed-integer programming model for non-guillotine and guillotine rectangular cutting problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** The Floating-Cuts model: a general and flexible mixed-integer programming model for non-guillotine and guillotine rectangular cutting problems  
**Jurnal & Sitasi Utama:** Elsa Silva, José Fernando Oliveira, Tiago Silveira (2022). *Omega*. DOI: [10.1016/j.omega.2022.102738](10.1016/j.omega.2022.102738)  
**Sitasi Pendukung:** Juan J. Torres, Can Li, Robert M. Apap (2022). *Algorithms*. DOI: [10.3390/a15040103](10.3390/a15040103)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Elsa Silva, José Fernando Oliveira, Tiago Silveira (2022) dalam jurnal *Omega* (DOI: 10.1016/j.omega.2022.102738) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
