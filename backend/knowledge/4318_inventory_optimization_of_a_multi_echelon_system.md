# 4318 — Supply Chain Management & Logistics Engineering: Inventory optimization of a multi echelon system supply chain using new generation metaheuristic algorithms

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Inventory optimization of a multi echelon system supply chain using new generation metaheuristic algorithms  
**Jurnal & Sitasi Utama:** Kurian John, Brijesh Paul, Jibin Noble (2024). *AIP Conference Proceedings*. DOI: [10.1063/5.0228308](10.1063/5.0228308)  
**Sitasi Pendukung:** Pavan Kumar Mutyala, Amandeep Kaur (2024). *2024 First International Conference on Pioneering Developments in Computer Science &amp;amp; Digital Technologies (IC2SDT)*. DOI: [10.1109/ic2sdt62152.2024.10696052](10.1109/ic2sdt62152.2024.10696052)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kurian John, Brijesh Paul, Jibin Noble (2024) dalam jurnal *AIP Conference Proceedings* (DOI: 10.1063/5.0228308) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Pavan Kumar Mutyala, Amandeep Kaur (2024) yang dipublikasikan dalam *2024 First International Conference on Pioneering Developments in Computer Science &amp;amp; Digital Technologies (IC2SDT)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
