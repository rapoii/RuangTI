# 5434 — Operations Research & Large-Scale Optimization: Active Distribution Network Optimal Power Flow Deploying the Benders Decomposition Method

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Active Distribution Network Optimal Power Flow Deploying the Benders Decomposition Method  
**Jurnal & Sitasi Utama:** Mahan Fakouri Fard, Farhad Elyasichamazkoti, Armin Fooladi Savadkouhi (2021). *2021 IEEE Electrical Power and Energy Conference (EPEC)*. DOI: [10.1109/epec52095.2021.9621351](10.1109/epec52095.2021.9621351)  
**Sitasi Pendukung:** Siqi Tu, Shurong Li, Zhe Liu (2020). *2020 39th Chinese Control Conference (CCC)*. DOI: [10.23919/ccc50068.2020.9189282](10.23919/ccc50068.2020.9189282)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahan Fakouri Fard, Farhad Elyasichamazkoti, Armin Fooladi Savadkouhi (2021) dalam jurnal *2021 IEEE Electrical Power and Energy Conference (EPEC)* (DOI: 10.1109/epec52095.2021.9621351) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Siqi Tu, Shurong Li, Zhe Liu (2020) yang dipublikasikan dalam *2020 39th Chinese Control Conference (CCC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
