# 3373 — Quality Engineering & Reliability Systems: Material Selection Framework for Lift-Based Wave Energy Converters Using Fuzzy TOPSIS

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Material Selection Framework for Lift-Based Wave Energy Converters Using Fuzzy TOPSIS  
**Jurnal & Sitasi Utama:** Abel Arredondo-Galeana, Baran Yeter, Farhad Abad (2023). *Energies*. DOI: [10.3390/en16217324](10.3390/en16217324)  
**Sitasi Pendukung:** Filip Anackovski, Ivo Kuzmanov, Roberto Pasic (2021). *Peer-Reviewed Academic Journal*. DOI: [10.openalex/w3202659173](10.openalex/w3202659173)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Abel Arredondo-Galeana, Baran Yeter, Farhad Abad (2023) dalam jurnal *Energies* (DOI: 10.3390/en16217324) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Filip Anackovski, Ivo Kuzmanov, Roberto Pasic (2021) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
