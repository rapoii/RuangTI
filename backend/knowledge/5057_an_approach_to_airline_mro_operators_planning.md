# 5057 — Simulation Modeling & Digital Twins: An approach to airline MRO operators planning and scheduling during aircraft line maintenance checks using discrete event simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** An approach to airline MRO operators planning and scheduling during aircraft line maintenance checks using discrete event simulation  
**Jurnal & Sitasi Utama:** Salah Albakkoush, Emanuele Pagone, Konstantinos Salonitis (2021). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2021.07.024](10.1016/j.promfg.2021.07.024)  
**Sitasi Pendukung:** Hema Vanasarla, Herman Tang (2022). *Engineering &amp; Technology Review*. DOI: [10.47285/etr.v3i1.117](10.47285/etr.v3i1.117)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Salah Albakkoush, Emanuele Pagone, Konstantinos Salonitis (2021) dalam jurnal *Procedia Manufacturing* (DOI: 10.1016/j.promfg.2021.07.024) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hema Vanasarla, Herman Tang (2022) yang dipublikasikan dalam *Engineering &amp; Technology Review* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
