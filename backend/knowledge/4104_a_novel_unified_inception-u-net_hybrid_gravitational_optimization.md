# 4104 — Engineering Economics & Cost Optimization: A novel unified Inception-U-Net hybrid gravitational optimization model (UIGO) incorporating automated medical image segmentation and feature selection for liver tumor detection

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** A novel unified Inception-U-Net hybrid gravitational optimization model (UIGO) incorporating automated medical image segmentation and feature selection for liver tumor detection  
**Jurnal & Sitasi Utama:** Tathagat Banerjee, Davinder Paul Singh, Prabhjot Kour (2025). *Scientific Reports*. DOI: [10.1038/s41598-025-14333-0](10.1038/s41598-025-14333-0)  
**Sitasi Pendukung:** Cliffton Wang, John Stansberry, Rangachary Mukundan (2025). *Chemical Reviews*. DOI: [10.1021/acs.chemrev.3c00904](10.1021/acs.chemrev.3c00904)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tathagat Banerjee, Davinder Paul Singh, Prabhjot Kour (2025) dalam jurnal *Scientific Reports* (DOI: 10.1038/s41598-025-14333-0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
