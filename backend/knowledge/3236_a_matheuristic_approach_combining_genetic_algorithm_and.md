# 3236 — Operations Research & Large-Scale Optimization: A matheuristic approach combining genetic algorithm and mixed integer linear programming model for production and distribution planning in the supply chain

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A matheuristic approach combining genetic algorithm and mixed integer linear programming model for production and distribution planning in the supply chain  
**Jurnal & Sitasi Utama:** Eduardo Guzmán, Raúl Poler, Beatriz Andrés (2023). *Advances in Production Engineering & Management*. DOI: [10.14743/apem2023.1.454](10.14743/apem2023.1.454)  
**Sitasi Pendukung:** Breno Serrano, Thibaut Vidal (2024). *Pattern Recognition*. DOI: [10.1016/j.patcog.2024.110487](10.1016/j.patcog.2024.110487)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eduardo Guzmán, Raúl Poler, Beatriz Andrés (2023) dalam jurnal *Advances in Production Engineering & Management* (DOI: 10.14743/apem2023.1.454) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
