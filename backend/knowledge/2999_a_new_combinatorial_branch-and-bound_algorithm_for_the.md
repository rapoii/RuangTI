# 2999 — Operations Research & Large-Scale Optimization: A new combinatorial branch-and-bound algorithm for the Knapsack Problem with Conflicts

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A new combinatorial branch-and-bound algorithm for the Knapsack Problem with Conflicts  
**Jurnal & Sitasi Utama:** Stefano Coniglio, Fabio Furini, Pablo San Segundo (2020). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2020.07.023](10.1016/j.ejor.2020.07.023)  
**Sitasi Pendukung:** Islem Snoussi, Nadia Hamani, Nassim Mrabti (2021). *Mathematics*. DOI: [10.3390/math9182318](10.3390/math9182318)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Stefano Coniglio, Fabio Furini, Pablo San Segundo (2020) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2020.07.023) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Islem Snoussi, Nadia Hamani, Nassim Mrabti (2021) yang dipublikasikan dalam *Mathematics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
