# 5069 — Simulation Modeling & Digital Twins: Using Agent-Based Simulation for Emergent Behavior Detection in Cyber-Physical Systems

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Using Agent-Based Simulation for Emergent Behavior Detection in Cyber-Physical Systems  
**Jurnal & Sitasi Utama:** Rob Bemthuis, Martijn Mes, Maria-Eugenia Iacob (2020). *2020 Winter Simulation Conference (WSC)*. DOI: [10.1109/wsc48552.2020.9383956](10.1109/wsc48552.2020.9383956)  
**Sitasi Pendukung:** Nithin Subba Rao, Julie Myriam T Makelberge (2025). *2025 First International Conference of Advances in Engineering and Computing Technologies for Sustainable Development (AECTSD)*. DOI: [10.1109/aectsd65988.2025.11411236](10.1109/aectsd65988.2025.11411236)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rob Bemthuis, Martijn Mes, Maria-Eugenia Iacob (2020) dalam jurnal *2020 Winter Simulation Conference (WSC)* (DOI: 10.1109/wsc48552.2020.9383956) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nithin Subba Rao, Julie Myriam T Makelberge (2025) yang dipublikasikan dalam *2025 First International Conference of Advances in Engineering and Computing Technologies for Sustainable Development (AECTSD)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
