# 5719 — Operations Research & Large-Scale Optimization: Partial Benders Decomposition: General Methodology and Application to Stochastic Network Design

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Partial Benders Decomposition: General Methodology and Application to Stochastic Network Design  
**Jurnal & Sitasi Utama:** Teodor Gabriel Crainic, Mike Hewitt, Francesca Maggioni (2021). *Transportation Science*. DOI: [10.1287/trsc.2020.1022](10.1287/trsc.2020.1022)  
...
Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Teodor Gabriel Crainic, Mike Hewitt, Francesca Maggioni (2021) dalam jurnal *Transportation Science* (DOI: 10.1287/trsc.2020.1022) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
