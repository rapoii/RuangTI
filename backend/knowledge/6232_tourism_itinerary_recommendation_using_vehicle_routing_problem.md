# 6232 — Operations Research & Large-Scale Optimization: Tourism Itinerary Recommendation using Vehicle Routing Problem Time Windows Based on Shortest Path Method and Analytics Hierarchy Process

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Tourism Itinerary Recommendation using Vehicle Routing Problem Time Windows Based on Shortest Path Method and Analytics Hierarchy Process  
**Jurnal & Sitasi Utama:** Surya Michrandi Nasution, Reza Rendian Septiawan, Fairuz Azmi (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202312.0892.v1](10.20944/preprints202312.0892.v1)  
**Sitasi Pendukung:** Pedro Munari, Martin Savelsbergh (2020). *SN Operations Research Forum*. DOI: [10.1007/s43069-020-00026-z](10.1007/s43069-020-00026-z)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Surya Michrandi Nasution, Reza Rendian Septiawan, Fairuz Azmi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.20944/preprints202312.0892.v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
