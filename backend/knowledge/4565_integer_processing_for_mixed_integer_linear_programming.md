# 4565 — Operations Research & Large-Scale Optimization: Integer Processing for Mixed Integer Linear Programming Problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Integer Processing for Mixed Integer Linear Programming Problems  
**Jurnal & Sitasi Utama:** , Hardi Tambunan, Herman Mawengkang (2025). *International Journal of Mathematics And Computer Research*. DOI: [10.47191/ijmcr/v13i10.16](10.47191/ijmcr/v13i10.16)  
**Sitasi Pendukung:** Vandana Kumari, Sanjib Ganguly (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4813071](10.2139/ssrn.4813071)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari , Hardi Tambunan, Herman Mawengkang (2025) dalam jurnal *International Journal of Mathematics And Computer Research* (DOI: 10.47191/ijmcr/v13i10.16) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The mixed integer nonlinear programming problem addressed in this paper refers to mathematical pro­gramming with continuous and discrete variables and linearities in the ob­jective function and constraints. The purpose of this article is to create an approach to solving MILP problems for integer search through active constraints, and neighborhoods, in order to reduce iterations. The study of the criteria for selecting non-basic variables for use in the integer processes has been conducted using active constraint and neighborhood approaches. The number of integration steps will be limited if the number of integer variables in the problem is finite. However, the integer processes not necessarily depend on the number of integer variables, as many integer variables may have integer values ​​in a continuous optimal solution."

Penelitian pendukung oleh Vandana Kumari, Sanjib Ganguly (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
