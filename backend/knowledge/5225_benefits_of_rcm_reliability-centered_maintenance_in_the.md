# 5225 — Maintenance Engineering & Asset Life Cycle: Benefits of RCM (Reliability-centered Maintenance) in the Maritime Industry

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Benefits of RCM (Reliability-centered Maintenance) in the Maritime Industry  
**Jurnal & Sitasi Utama:** Amit Saxena - (2025). *International Journal For Multidisciplinary Research*. DOI: [10.36948/ijfmr.2025.v07i01.37054](10.36948/ijfmr.2025.v07i01.37054)  
**Sitasi Pendukung:** Suresh Kumar Sahani (2023). *Advances in Nonlinear Variational Inequalities*. DOI: [10.52783/anvi.v26.4224](10.52783/anvi.v26.4224)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amit Saxena - (2025) dalam jurnal *International Journal For Multidisciplinary Research* (DOI: 10.36948/ijfmr.2025.v07i01.37054) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Reliability Centered Maintenance (RCM) now leads industries in better designing their upkeep strategies for important machinery. Maritime assets depend on ship engines and auxiliary machines to operate properly. RCM helps these operations work safely while saving costs via its forward-looking approach. This research analyzes how RCM helps keep ship machinery running by saving money while lowering breakdown periods and operating better. RCM helps us develop smart maintenance programs that match equipment conditions along with analyzing failure patterns to save resources while making sure equipment lasts longer. The maritime field benefits from using RCM while facing startup costs and transition difficulties but experiences significant sustained benefits. This research analyzes the methods and real-world uses of RCM shown through examples and findings from published studies to demonstrate its ability to transform ship maintenance systems."

Penelitian pendukung oleh Suresh Kumar Sahani (2023) yang dipublikasikan dalam *Advances in Nonlinear Variational Inequalities* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
