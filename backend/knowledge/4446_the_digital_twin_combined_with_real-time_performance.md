# 4446 — Manufacturing Systems & Cyber-Physical Production: The digital twin combined with real-time performance measurement in lean manufacturing

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** The digital twin combined with real-time performance measurement in lean manufacturing  
**Jurnal & Sitasi Utama:** Mira Holopainen, Juhani Ukko, Minna Saunila (2021). *Real-time Simulation for Sustainable Production*. DOI: [10.4324/9781003054214-17](10.4324/9781003054214-17)  
**Sitasi Pendukung:** Xiaolang Yang, Xuemei Liu, Heng Zhang (2023). *Procedia CIRP*. DOI: [10.1016/j.procir.2023.08.058](10.1016/j.procir.2023.08.058)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mira Holopainen, Juhani Ukko, Minna Saunila (2021) dalam jurnal *Real-time Simulation for Sustainable Production* (DOI: 10.4324/9781003054214-17) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xiaolang Yang, Xuemei Liu, Heng Zhang (2023) yang dipublikasikan dalam *Procedia CIRP* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
