# 6241 — Operations Research & Large-Scale Optimization: Support Vector Machines within a Bivariate Mixed-Integer Linear Programming Framework

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Support Vector Machines within a Bivariate Mixed-Integer Linear Programming Framework  
**Jurnal & Sitasi Utama:** John Warwicker, Steffen Rebennack (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4565890](10.2139/ssrn.4565890)  
**Sitasi Pendukung:** Fevi Febianti, Ihda Hasbiyati (2024). *Journal of Mathematical Sciences and Optimization*. DOI: [10.31258/jomso.1.1.17-24](10.31258/jomso.1.1.17-24)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari John Warwicker, Steffen Rebennack (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4565890) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Fevi Febianti, Ihda Hasbiyati (2024) yang dipublikasikan dalam *Journal of Mathematical Sciences and Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
