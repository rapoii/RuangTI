# 4563 — Operations Research & Large-Scale Optimization: Portfolio Optimization in District Heating: Merit Order or Mixed Integer Linear Programming?

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Portfolio Optimization in District Heating: Merit Order or Mixed Integer Linear Programming?  
**Jurnal & Sitasi Utama:** Miguel Gonzalez-Salazar, Julia KLOSSEK, Pascal DUBUCQ (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4157118](10.2139/ssrn.4157118)  
**Sitasi Pendukung:** In Gyu Lee, Sang Won Yoon, Daehan Won (2022). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.12.030](10.1016/j.ejor.2021.12.030)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Miguel Gonzalez-Salazar, Julia KLOSSEK, Pascal DUBUCQ (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4157118) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Long-term portfolio optimization is commonly used to find the most cost-effective design and operation of a district heating network (DHN) subject to restrictions. The state-of-the-art method is the mixed integer linear programming (MILP), which is extensively used in industry and academia but can also be computing-intensive. An alternative method to MILP is the merit order (MO) method. The aim of this paper is to investigate the potential advantages and disadvantages of MO models compared to MILP in the context of portfolio optimization of a district heating network. As study case, both methods are used to optimize the portfolio supplying a large portion of the DHN in Berlin. Four MO model variants with different levels of complexity are investigated. Results suggest that MO models including heat storage and CHP plants with multiple operational points have the potential to reduce calculation time by nearly three-orders of magnitude compared to MILP without significantly sacrificing accuracy. In fact, differences in heat generation and in the net present value of the total heating costs account for ±4% and -6%, respectively. While these differences might not be sufficient to motivate a substitution of MILP models, they suggest that MO models could be used to complement them."

Penelitian pendukung oleh In Gyu Lee, Sang Won Yoon, Daehan Won (2022) yang dipublikasikan dalam *European Journal of Operational Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
