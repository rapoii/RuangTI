# 3165 — Quality Engineering & Reliability Systems: Smart Machine Vision System to Improve Decision-Making on the Assembly Line

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Smart Machine Vision System to Improve Decision-Making on the Assembly Line  
**Jurnal & Sitasi Utama:** Carlos Américo de Souza Silva, Edson Pacheco Paladini (2025). *Machines*. DOI: [10.3390/machines13020098](10.3390/machines13020098)  
**Sitasi Pendukung:** Edward Schwalb (2021). *Journal of Autonomous Vehicles and Systems*. DOI: [10.1115/1.4049922](10.1115/1.4049922)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Carlos Américo de Souza Silva, Edson Pacheco Paladini (2025) dalam jurnal *Machines* (DOI: 10.3390/machines13020098) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Edward Schwalb (2021) yang dipublikasikan dalam *Journal of Autonomous Vehicles and Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
