# 3294 — Supply Chain Management & Logistics Engineering: Retailer remanufacturing? Pricing decisions for closed-loop supply chain with different remanufacturing models under government subsidies

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Retailer remanufacturing? Pricing decisions for closed-loop supply chain with different remanufacturing models under government subsidies  
**Jurnal & Sitasi Utama:** Guoli Wang, Donglin He, Junyan Wang (2025). *Journal of Industrial and Management Optimization*. DOI: [10.3934/jimo.2025161](10.3934/jimo.2025161)  
**Sitasi Pendukung:** Ayesa Khatun, Sahidul Islam, Rimi Karmakar (2026). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2025.100280](10.1016/j.clscn.2025.100280)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Guoli Wang, Donglin He, Junyan Wang (2025) dalam jurnal *Journal of Industrial and Management Optimization* (DOI: 10.3934/jimo.2025161) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ayesa Khatun, Sahidul Islam, Rimi Karmakar (2026) yang dipublikasikan dalam *Cleaner Logistics and Supply Chain* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
