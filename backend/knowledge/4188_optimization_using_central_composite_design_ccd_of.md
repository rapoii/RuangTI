# 4188 — Applied Statistics & Stochastic Modeling: Optimization using central composite design (CCD) of response surface methodology (RSM) for biosorption of hexavalent chromium from aqueous media

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Optimization using central composite design (CCD) of response surface methodology (RSM) for biosorption of hexavalent chromium from aqueous media  
**Jurnal & Sitasi Utama:** Jonas Bayuo, Moses Abdullai Abukari, Kenneth Bayetimani Pelig-Ba (2020). *Applied Water Science*. DOI: [10.1007/s13201-020-01213-3](10.1007/s13201-020-01213-3)  
**Sitasi Pendukung:** Sathish Thanikodi, Saravanan Rathinasamy, Jothi Arunachalam Solairaju (2024). *The International Journal of Advanced Manufacturing Technology*. DOI: [10.1007/s00170-024-13975-0](10.1007/s00170-024-13975-0)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jonas Bayuo, Moses Abdullai Abukari, Kenneth Bayetimani Pelig-Ba (2020) dalam jurnal *Applied Water Science* (DOI: 10.1007/s13201-020-01213-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
