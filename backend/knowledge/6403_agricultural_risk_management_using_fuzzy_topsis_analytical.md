# 6403 — Quality Engineering & Reliability Systems: Agricultural Risk Management Using Fuzzy TOPSIS Analytical Hierarchy Process (AHP) and Failure Mode and Effects Analysis (FMEA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Agricultural Risk Management Using Fuzzy TOPSIS Analytical Hierarchy Process (AHP) and Failure Mode and Effects Analysis (FMEA)  
**Jurnal & Sitasi Utama:** Peyman Zandi, Mohammad Rahmani, Mojtaba Khanian (2020). *Agriculture*. DOI: [10.3390/agriculture10110504](10.3390/agriculture10110504)  
**Sitasi Pendukung:** Samsudin Bahari, Adhisty Kartika Dewi, Wahyu Sidiq (2026). *JERA : Journal of Engineering Research and Application*. DOI: [10.51792/c9mzp453](10.51792/c9mzp453)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Peyman Zandi, Mohammad Rahmani, Mojtaba Khanian (2020) dalam jurnal *Agriculture* (DOI: 10.3390/agriculture10110504) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Samsudin Bahari, Adhisty Kartika Dewi, Wahyu Sidiq (2026) yang dipublikasikan dalam *JERA : Journal of Engineering Research and Application* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
