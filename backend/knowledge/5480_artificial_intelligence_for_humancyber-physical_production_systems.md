# 5480 — Manufacturing Systems & Cyber-Physical Production: Artificial intelligence for human–cyber-physical production systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Artificial intelligence for human–cyber-physical production systems  
**Jurnal & Sitasi Utama:** Dimitris Mourtzis, John Angelopoulos (2024). *Manufacturing from Industry 4.0 to Industry 5.0*. DOI: [10.1016/b978-0-443-13924-6.00012-0](10.1016/b978-0-443-13924-6.00012-0)  
**Sitasi Pendukung:** Ali Mohammad Hosseini, Thilo Sauter, Wolfgang Kastner (2021). *2021 17th IEEE International Conference on Factory Communication Systems (WFCS)*. DOI: [10.1109/wfcs46889.2021.9483606](10.1109/wfcs46889.2021.9483606)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dimitris Mourtzis, John Angelopoulos (2024) dalam jurnal *Manufacturing from Industry 4.0 to Industry 5.0* (DOI: 10.1016/b978-0-443-13924-6.00012-0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ali Mohammad Hosseini, Thilo Sauter, Wolfgang Kastner (2021) yang dipublikasikan dalam *2021 17th IEEE International Conference on Factory Communication Systems (WFCS)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
