# Modul Komprehensif: Metaheuristik Lanjutan: Tabu Search & Particle Swarm Optimization (PSO) untuk Penjadwalan Job Shop
**Nomor Modul:** [383]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Metaheuristics: From Design to Implementation (El-Ghazali Talbi - Wiley), Computers & Operations Research (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Metaheuristik Lanjutan: Tabu Search & Particle Swarm Optimization (PSO) untuk Penjadwalan Job Shop**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Flexible Job Shop Scheduling Problem (FJSP), Tabu Search (Short-Term Memory, Tabu Tenure, Aspiration Criteria), Particle Swarm Optimization (Inertia Weight $w$, Cognitive $c_1$, Social $c_2$), Makespan $C_{\max}$ Minimization.
...
```python
# Algoritma Solusi Terapan untuk Metaheuristik Lanjutan: Tabu Search & Particle Swarm Optimization (PSO) untuk Penjadwalan Job Shop
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Optimasi Penjadwalan 85 Job pada 14 Mesin CNC Menggunakan Hybrid PSO-Tabu Search Menurunkan Makespan 18%.
...
1. Metaheuristics: From Design to Implementation (El-Ghazali Talbi - Wiley), Computers & Operations Research (2024).
