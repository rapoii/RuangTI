# 3859 — Industrial Artificial Intelligence & Data Analytics: Recent advances in metasurface design and quantum optics applications with machine learning, physics-informed neural networks, and topology optimization methods

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Recent advances in metasurface design and quantum optics applications with machine learning, physics-informed neural networks, and topology optimization methods  
**Jurnal & Sitasi Utama:** Wenye Ji, Jin Chang, He‐Xiu Xu (2023). *Light Science & Applications*. DOI: [10.1038/s41377-023-01218-y](10.1038/s41377-023-01218-y)  
**Sitasi Pendukung:** Taniya Kapoor, Hongrui Wang, Alfredo Núñez (2023). *IEEE Transactions on Neural Networks and Learning Systems*. DOI: [10.1109/tnnls.2023.3310585](10.1109/tnnls.2023.3310585)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wenye Ji, Jin Chang, He‐Xiu Xu (2023) dalam jurnal *Light Science & Applications* (DOI: 10.1038/s41377-023-01218-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
