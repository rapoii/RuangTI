# 5748 — Operations Research & Large-Scale Optimization: Chance Constrained Programming Problem with Shifted Exponential Random Variables

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance Constrained Programming Problem with Shifted Exponential Random Variables  
**Jurnal & Sitasi Utama:** Jayanta Dash, Karpura Sahoo, Ajaya Mahapatra (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4656064](10.2139/ssrn.4656064)  
**Sitasi Pendukung:** Sondes Hammami, Rania Boujemaa, Aida Jebali (2023). *2023 IEEE International Conference on Advanced Systems and Emergent Technologies (IC_ASET)*. DOI: [10.1109/ic_aset58101.2023.10151012](10.1109/ic_aset58101.2023.10151012)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jayanta Dash, Karpura Sahoo, Ajaya Mahapatra (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4656064) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sondes Hammami, Rania Boujemaa, Aida Jebali (2023) yang dipublikasikan dalam *2023 IEEE International Conference on Advanced Systems and Emergent Technologies (IC_ASET)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
