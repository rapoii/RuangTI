# 5731 — Operations Research & Large-Scale Optimization: Chance-Constrained Stochastic Planning of Solar Power Systems with Pumped Hydro Energy Storage

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance-Constrained Stochastic Planning of Solar Power Systems with Pumped Hydro Energy Storage  
**Jurnal & Sitasi Utama:** Nazli Demir, Ozlem Cavus, Ayse  Selin Kocaman (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6468691](10.2139/ssrn.6468691)  
**Sitasi Pendukung:** Paolo Bevilacqua, Marco Frego, Luigi Palopoli (2021). *IEEE Transactions on Industrial Informatics*. DOI: [10.1109/tii.2020.3012094](10.1109/tii.2020.3012094)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nazli Demir, Ozlem Cavus, Ayse  Selin Kocaman (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6468691) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Renewable energy systems are increasingly integrated into power systems, yet the inherent variability of renewable generation creates challenges for reliable demand satisfaction and long-term investment planning. In solar-dominated systems, energy storage technologies such as pumped hydro energy storage (PHES) play a critical role in mitigating generation uncertainty and enhancing system reliability.This paper proposes a chance-constrained two-stage stochastic programming model for the optimal sizing of a hybrid energy system in which solar generation is complemented by a closed-loop PHES facility. The model incorporates a joint chance constraint that explicitly limits the acceptable probability of unmet demand, allowing planners to balance system reliability and investment cost while avoiding overly conservative designs.Solar radiation uncertainty is represented through scenarios generated using an autoregressive integrated moving average (ARIMA) model. To efficiently solve the resulting large-scale stochastic program, we develop a Benders-based branch-and-cut decomposition algorithm. Computational experiments demonstrate that the proposed method substantially improves computational performance compared with solving the extensive formulation directly using CPLEX. As an exact solution approach, the algorithm preserves optimal solution quality while significantly reducing solution times for large scenario sets.The results further illustrate how reliability requirements influen"

Penelitian pendukung oleh Paolo Bevilacqua, Marco Frego, Luigi Palopoli (2021) yang dipublikasikan dalam *IEEE Transactions on Industrial Informatics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
