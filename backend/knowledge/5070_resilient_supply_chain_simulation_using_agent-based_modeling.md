# 5070 — Simulation Modeling & Digital Twins: Resilient Supply Chain Simulation Using Agent-Based Modeling and Digital Thread Integration

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Resilient Supply Chain Simulation Using Agent-Based Modeling and Digital Thread Integration  
**Jurnal & Sitasi Utama:** Nithin Subba Rao, Julie Myriam T Makelberge (2025). *2025 First International Conference of Advances in Engineering and Computing Technologies for Sustainable Development (AECTSD)*. DOI: [10.1109/aectsd65988.2025.11411236](10.1109/aectsd65988.2025.11411236)  
**Sitasi Pendukung:** Moath Jarrah, Omar Al-Jarrah (2022). *Emergent Behavior in System of Systems Engineering*. DOI: [10.1201/9781003160816-9](10.1201/9781003160816-9)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nithin Subba Rao, Julie Myriam T Makelberge (2025) dalam jurnal *2025 First International Conference of Advances in Engineering and Computing Technologies for Sustainable Development (AECTSD)* (DOI: 10.1109/aectsd65988.2025.11411236) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Moath Jarrah, Omar Al-Jarrah (2022) yang dipublikasikan dalam *Emergent Behavior in System of Systems Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
