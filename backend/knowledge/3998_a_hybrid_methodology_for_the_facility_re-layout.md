# 3998 — Facilities Planning & Material Handling: A hybrid methodology for the facility re-layout problem of food production systems in Industry 5.0 context

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** A hybrid methodology for the facility re-layout problem of food production systems in Industry 5.0 context  
**Jurnal & Sitasi Utama:** Israel D. Herrera-Granda, MME Alemany, D. Peluffo-Ordóñez (2026). *Cogent Engineering*. DOI: [10.1080/23311916.2026.2634432](10.1080/23311916.2026.2634432)  
**Sitasi Pendukung:** Harys Windra Ramadhan, Rus Indiyanto TEKMAPRO (2024). *Tekmapro Journal of Industrial Engineering and Management*. DOI: [10.33005/tekmapro.v19i2.420](10.33005/tekmapro.v19i2.420)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Israel D. Herrera-Granda, MME Alemany, D. Peluffo-Ordóñez (2026) dalam jurnal *Cogent Engineering* (DOI: 10.1080/23311916.2026.2634432) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "In this paper, a novel hybrid methodology for the Facility Re-Layout Problem (FRLP) of discrete food production companies is proposed and validated through its application to a real case. One of its main originalities is its Industry 5.0 approach by means considering sustainability, human centricity and resilience aspects. As an enhanced version of the classical Systematic Layout Planning (SLP) approach, the methodology incorporates novel aspects such as the identification of the re-layout requirement, the utilization of qualitative criteria provided by experts and the evaluation of psycho-social effects of the lay-out on workers. The methodology also incorporates a quantitative analysis provided by Machine Learning (ML) and Simulation tools. As a result of our methodology, several alternatives for plant re-layout are obtained, which are further evaluated by expert criteria taking into account discrete event simulation, putting the human being back at the center of decision-making and demonstrating the robustness of these solutions."

Penelitian pendukung oleh Harys Windra Ramadhan, Rus Indiyanto TEKMAPRO (2024) yang dipublikasikan dalam *Tekmapro Journal of Industrial Engineering and Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
