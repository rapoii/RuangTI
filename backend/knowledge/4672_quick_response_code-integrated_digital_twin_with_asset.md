# 4672 — Manufacturing Systems & Cyber-Physical Production: Quick Response Code-Integrated Digital Twin with Asset Administration Shells

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Quick Response Code-Integrated Digital Twin with Asset Administration Shells  
**Jurnal & Sitasi Utama:** Björn Otto, Saida Burmaganova, Marko Ristin (2025). *2025 IEEE 8th International Conference on Industrial Cyber-Physical Systems (ICPS)*. DOI: [10.1109/icps65515.2025.11087888](10.1109/icps65515.2025.11087888)  
**Sitasi Pendukung:** Jiawen Liu, Baigang Du (2025). *2025 8th International Conference on Advanced Algorithms and Control Engineering (ICAACE)*. DOI: [10.1109/icaace65325.2025.11019393](10.1109/icaace65325.2025.11019393)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Björn Otto, Saida Burmaganova, Marko Ristin (2025) dalam jurnal *2025 IEEE 8th International Conference on Industrial Cyber-Physical Systems (ICPS)* (DOI: 10.1109/icps65515.2025.11087888) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiawen Liu, Baigang Du (2025) yang dipublikasikan dalam *2025 8th International Conference on Advanced Algorithms and Control Engineering (ICAACE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
