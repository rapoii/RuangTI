# 3927 — Continuous Improvement & Lean Six Sigma: COMBINED APPLICATION PROPOSAL OF VALUE STREAM MAPPING (VSM) AND METHODS TIME MEASUREMENT UNIVERSAL ANALYSIS SYSTEM (MTM-UAS) METHODS IN TEXTILE INDUSTRY

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** COMBINED APPLICATION PROPOSAL OF VALUE STREAM MAPPING (VSM) AND METHODS TIME MEASUREMENT UNIVERSAL ANALYSIS SYSTEM (MTM-UAS) METHODS IN TEXTILE INDUSTRY  
**Jurnal & Sitasi Utama:** özlem demirci, Tülin GÜNDÜZ (2020). *Endüstri Mühendisliği*. DOI: [10.46465/endustrimuhendisligi.728061](10.46465/endustrimuhendisligi.728061)  
**Sitasi Pendukung:** Beatriz Costa, José Varejão, Pedro Dinis Gaspar (2024). *Processes*. DOI: [10.3390/pr12081612](10.3390/pr12081612)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari özlem demirci, Tülin GÜNDÜZ (2020) dalam jurnal *Endüstri Mühendisliği* (DOI: 10.46465/endustrimuhendisligi.728061) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
