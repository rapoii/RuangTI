# 5319 — Industrial Artificial Intelligence & Data Analytics: Semiconductor Defect Detection by Hybrid Classical-Quantum Deep Learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Semiconductor Defect Detection by Hybrid Classical-Quantum Deep Learning  
**Jurnal & Sitasi Utama:** Yuan-Fu Yang, Min Sun (2022). *2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)*. DOI: [10.1109/cvpr52688.2022.00236](10.1109/cvpr52688.2022.00236)  
**Sitasi Pendukung:** Limiao Deng (2022). *Cognitive and Neural Modelling for Visual Information Representation and Memorization*. DOI: [10.1201/9781003281641-9](10.1201/9781003281641-9)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuan-Fu Yang, Min Sun (2022) dalam jurnal *2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)* (DOI: 10.1109/cvpr52688.2022.00236) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Limiao Deng (2022) yang dipublikasikan dalam *Cognitive and Neural Modelling for Visual Information Representation and Memorization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
