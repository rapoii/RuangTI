# 6280 — Operations Research & Large-Scale Optimization: On The Mixed Integer Linear Programming Model For Revenue Management Under Consumer Choice Behavior Theories

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** On The Mixed Integer Linear Programming Model For Revenue Management Under Consumer Choice Behavior Theories  
**Jurnal & Sitasi Utama:** Amirreza Talebi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4891220](10.2139/ssrn.4891220)  
**Sitasi Pendukung:** Rizka Efiyanti, Darsih Idayani (2025). *G-Tech: Jurnal Teknologi Terapan*. DOI: [10.70609/g-tech.v9i3.7302](10.70609/g-tech.v9i3.7302)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amirreza Talebi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4891220) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "&lt;p&gt;&lt;span&gt;One of the crucial concerns of Revenue Management (RM), as a highly successful application of Operations Research, is the pricing issue of products, which necessitates a precise examination of demand and supply interactions. To this end, RM leverages OR tools such as Mixed Integer Linear Programming (MILP) models to maximize the revenue with prices of products as decision variables and the link between demand and supply.&lt;/span&gt;&lt;/p&gt;
&lt;p&gt;Discrete choice models (DCMs), are the state-of-the-art for demand estimation, are usually derived from Random Utility Maximization (RUM) theory. Recently, Random Regret Minimization (RRM) based DCMs have been introduced as strong rivals or complements to RUM-based DCMs. Although countless research studies have applied DCMs in RM, there is still a gap between state-of-the-art RRM-based DCMs and RM.&lt;/p&gt;
&lt;p&gt;The role of the data on which DCMs are estimated is another issue and must be taken into account in RM. Providing an unbiased and adequate amount of data is essential, yet has been tackled through simulations, library data, experiments, etc. However, there exists no well-known empirical work studying the implications of the estimation errors of DCMs on the performance of the MILPs developed for RM.&lt;/p&gt;
&lt;p&gt;Adapting ideas of RM-based DCMs, Pacheco et al. (2017a), we have integrated an advanced RRM-based DCM through MILP models in RM to address pricing problems in both capacitated and "

Penelitian pendukung oleh Rizka Efiyanti, Darsih Idayani (2025) yang dipublikasikan dalam *G-Tech: Jurnal Teknologi Terapan* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
