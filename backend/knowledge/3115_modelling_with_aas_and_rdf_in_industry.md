# 3115 — Manufacturing Systems & Cyber-Physical Production: Modelling with AAS and RDF in Industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Modelling with AAS and RDF in Industry 4.0  
**Jurnal & Sitasi Utama:** Sjoerd Rongen, Nikoletta Nikolova, Mark van der Pas (2023). *Computers in Industry*. DOI: [10.1016/j.compind.2023.103910](10.1016/j.compind.2023.103910)  
**Sitasi Pendukung:** Daniel Stock, Daniel Schel, Thomas Bauernhansl (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.02.031](10.1016/j.promfg.2020.02.031)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sjoerd Rongen, Nikoletta Nikolova, Mark van der Pas (2023) dalam jurnal *Computers in Industry* (DOI: 10.1016/j.compind.2023.103910) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Daniel Stock, Daniel Schel, Thomas Bauernhansl (2020) yang dipublikasikan dalam *Procedia Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
