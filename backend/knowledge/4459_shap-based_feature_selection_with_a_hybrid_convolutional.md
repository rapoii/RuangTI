# 4459 — Maintenance Engineering & Asset Life Cycle: SHAP-Based Feature Selection with a Hybrid Convolutional and Recurrent Deep Learning Framework for Remaining Useful Life Prediction of Aero-Engines

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** SHAP-Based Feature Selection with a Hybrid Convolutional and Recurrent Deep Learning Framework for Remaining Useful Life Prediction of Aero-Engines  
**Jurnal & Sitasi Utama:** Naouel Ouafek, Tarek Berghout, Samira Abderrezek (2026). *International Journal of Prognostics and Health Management*. DOI: [10.36001/ijphm.2026.v17i1.4693](10.36001/ijphm.2026.v17i1.4693)  
**Sitasi Pendukung:** Youssof Fassi, Vincent Heiries, Jérôme Boutet (2024). *2024 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm61352.2024.10626501](10.1109/icphm61352.2024.10626501)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Naouel Ouafek, Tarek Berghout, Samira Abderrezek (2026) dalam jurnal *International Journal of Prognostics and Health Management* (DOI: 10.36001/ijphm.2026.v17i1.4693) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Youssof Fassi, Vincent Heiries, Jérôme Boutet (2024) yang dipublikasikan dalam *2024 IEEE International Conference on Prognostics and Health Management (ICPHM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
