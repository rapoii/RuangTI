# 3872 — Industrial Artificial Intelligence & Data Analytics: Prediction of 3D temperature field through single 2D temperature data based on transfer learning-based PINN model in laser-based directed energy deposition

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Prediction of 3D temperature field through single 2D temperature data based on transfer learning-based PINN model in laser-based directed energy deposition  
**Jurnal & Sitasi Utama:** Shitong Peng, Shoulan Yang, Baoyun Gao (2025). *Journal of Manufacturing Processes*. DOI: [10.1016/j.jmapro.2025.02.015](10.1016/j.jmapro.2025.02.015)  
**Sitasi Pendukung:** Laith Alzubaidi, Jinshuai Bai, Aiman Al-Sabaawi (2023). *Journal Of Big Data*. DOI: [10.1186/s40537-023-00727-2](10.1186/s40537-023-00727-2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shitong Peng, Shoulan Yang, Baoyun Gao (2025) dalam jurnal *Journal of Manufacturing Processes* (DOI: 10.1016/j.jmapro.2025.02.015) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Laith Alzubaidi, Jinshuai Bai, Aiman Al-Sabaawi (2023) yang dipublikasikan dalam *Journal Of Big Data* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
