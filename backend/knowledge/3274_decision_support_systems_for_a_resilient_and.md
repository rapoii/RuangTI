# 3274 — Supply Chain Management & Logistics Engineering: Decision support systems for a resilient and sustainable closed loop supply chain under risk: A systematic review and future research directions

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Decision support systems for a resilient and sustainable closed loop supply chain under risk: A systematic review and future research directions  
**Jurnal & Sitasi Utama:** Wogiye Wube, Eshetie Berhan, Gezahegn Tesfaye (2025). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2025.100217](10.1016/j.clscn.2025.100217)  
**Sitasi Pendukung:** Haoyu Zhang (2026). *Proceedings of the 2026 9th International Conference on Computers in Management and Business*. DOI: [10.1145/3802463.3802483](10.1145/3802463.3802483)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wogiye Wube, Eshetie Berhan, Gezahegn Tesfaye (2025) dalam jurnal *Cleaner Logistics and Supply Chain* (DOI: 10.1016/j.clscn.2025.100217) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Haoyu Zhang (2026) yang dipublikasikan dalam *Proceedings of the 2026 9th International Conference on Computers in Management and Business* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
