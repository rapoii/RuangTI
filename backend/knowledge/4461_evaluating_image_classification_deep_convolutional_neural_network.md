# 4461 — Maintenance Engineering & Asset Life Cycle: Evaluating Image Classification Deep Convolutional Neural Network Architectures for Remaining Useful Life Estimation of Turbofan Engines

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Evaluating Image Classification Deep Convolutional Neural Network Architectures for Remaining Useful Life Estimation of Turbofan Engines  
**Jurnal & Sitasi Utama:** Nathaniel DeVol, Christopher Saldana, Katherine Fu (2022). *International Journal of Prognostics and Health Management*. DOI: [10.36001/ijphm.2022.v13i2.3284](10.36001/ijphm.2022.v13i2.3284)  
**Sitasi Pendukung:** Sourajit Behera (2026). *2026 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm69567.2026.11585213](10.1109/icphm69567.2026.11585213)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nathaniel DeVol, Christopher Saldana, Katherine Fu (2022) dalam jurnal *International Journal of Prognostics and Health Management* (DOI: 10.36001/ijphm.2022.v13i2.3284) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
