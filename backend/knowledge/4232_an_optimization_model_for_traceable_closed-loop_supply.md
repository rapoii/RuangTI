# 4232 — Operations Research & Large-Scale Optimization: An optimization model for traceable closed-loop supply chain networks

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An optimization model for traceable closed-loop supply chain networks  
**Jurnal & Sitasi Utama:** Vahid Hajipour, Madjid Tavana, Debora Di Caprio (2019). *Applied Mathematical Modelling*. DOI: [10.1016/j.apm.2019.03.007](10.1016/j.apm.2019.03.007)  
**Sitasi Pendukung:** Masar Al-Rabeeah, Elias Munapo, Ali Al-Hasani (2019). *International Journal of Mathematical Engineering and Management Sciences*. DOI: [10.33889/ijmems.2019.4.5-090](10.33889/ijmems.2019.4.5-090)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Vahid Hajipour, Madjid Tavana, Debora Di Caprio (2019) dalam jurnal *Applied Mathematical Modelling* (DOI: 10.1016/j.apm.2019.03.007) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Masar Al-Rabeeah, Elias Munapo, Ali Al-Hasani (2019) yang dipublikasikan dalam *International Journal of Mathematical Engineering and Management Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
