# 5804 — Human Factors & Cognitive Ergonomics: Multimodal Brain–Computer Interface for In-Vehicle Driver Cognitive Load Measurement: Dataset and Baselines

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Multimodal Brain–Computer Interface for In-Vehicle Driver Cognitive Load Measurement: Dataset and Baselines  
**Jurnal & Sitasi Utama:** Prithila Angkan, Behnam Behinaein, Zunayed Mahmud (2024). *IEEE Transactions on Intelligent Transportation Systems*. DOI: [10.1109/tits.2023.3345846](10.1109/tits.2023.3345846)  
**Sitasi Pendukung:** Yekta Said Can, Niaz Chalabianloo, Deniz Ekiz (2020). *IEEE Access*. DOI: [10.1109/access.2020.2975351](10.1109/access.2020.2975351)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Prithila Angkan, Behnam Behinaein, Zunayed Mahmud (2024) dalam jurnal *IEEE Transactions on Intelligent Transportation Systems* (DOI: 10.1109/tits.2023.3345846) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yekta Said Can, Niaz Chalabianloo, Deniz Ekiz (2020) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
