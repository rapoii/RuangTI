# 3626 — Applied Statistics & Stochastic Modeling: The principal-agent problem for service rate event-dependency

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** The principal-agent problem for service rate event-dependency  
**Jurnal & Sitasi Utama:** Benjamin Legros (2021). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.09.020](10.1016/j.ejor.2021.09.020)  
**Sitasi Pendukung:** Nico van Dijk, Barteld Schilstra (2021). *Annals of Operations Research*. DOI: [10.1007/s10479-021-03940-5](10.1007/s10479-021-03940-5)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Benjamin Legros (2021) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2021.09.020) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nico van Dijk, Barteld Schilstra (2021) yang dipublikasikan dalam *Annals of Operations Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
