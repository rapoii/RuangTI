# Modul Komprehensif: Anomaly Detection: Isolation Forest & Autoencoders Monitoring Kualitas
**Nomor Modul:** [333]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Outlier Analysis (Charu C. Aggarwal), Journal of Quality Technology (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Anomaly Detection: Isolation Forest & Autoencoders Monitoring Kualitas**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Isolation Forest Path Length, Reconstruction Error Autoencoder, One-Class SVM, Mahalanobis Control Charts, Real-Time Streaming Drift.
...
```python
# Algoritma Solusi Terapan untuk Anomaly Detection: Isolation Forest & Autoencoders Monitoring Kualitas
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Deteksi Anomali Tekanan Injeksi Molding Plastik secara Real-Time pada Interval 10 Milidetik.
...
1. Outlier Analysis (Charu C. Aggarwal), Journal of Quality Technology (2024).
