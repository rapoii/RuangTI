# 5056 — Simulation Modeling & Digital Twins: Semantic Model Complexity for Event Graph Discrete-Event Simulation Models via Abstract State Machines

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Semantic Model Complexity for Event Graph Discrete-Event Simulation Models via Abstract State Machines  
**Jurnal & Sitasi Utama:** Keng Yeo, Haobin Li (2026). *Proceedings of the 16th International Conference on Simulation and Modeling Methodologies, Technologies and Applications*. DOI: [10.5220/0015003400004094](10.5220/0015003400004094)  
**Sitasi Pendukung:** Salah Albakkoush, Emanuele Pagone, Konstantinos Salonitis (2021). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2021.07.024](10.1016/j.promfg.2021.07.024)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Keng Yeo, Haobin Li (2026) dalam jurnal *Proceedings of the 16th International Conference on Simulation and Modeling Methodologies, Technologies and Applications* (DOI: 10.5220/0015003400004094) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Salah Albakkoush, Emanuele Pagone, Konstantinos Salonitis (2021) yang dipublikasikan dalam *Procedia Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
