# 3302 — Supply Chain Management & Logistics Engineering: Game Theoretical Perspectives On Dual-Channel Closed Loop Supply Chain With A Reward-Driven Remanufacturing Policy

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Game Theoretical Perspectives On Dual-Channel Closed Loop Supply Chain With A Reward-Driven Remanufacturing Policy  
**Jurnal & Sitasi Utama:** Soumita Kundu (2024). *IOSR Journal of Mathematics*. DOI: [10.9790/0661-2006014349](10.9790/0661-2006014349)  
**Sitasi Pendukung:** Armin Aminipour, Zied Bahroun, Moncer Hariga (2021). *Sustainable Production and Consumption*. DOI: [10.1016/j.spc.2020.08.002](10.1016/j.spc.2020.08.002)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Soumita Kundu (2024) dalam jurnal *IOSR Journal of Mathematics* (DOI: 10.9790/0661-2006014349) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper evaluates the impact of reward driven remanufacturing policy and pricing schemes on the dualchannel supply chain competition. In the proposed model, a manufacturer sells products both through a retailer
and directly to end users in the forward supply chain. In the reverse supply chain, the manufacturer collects
used products to remanufacture them into new ones. Mathematical models for the supplier Stackelberg, retailer Stackelberg, Nash game, and centralized scenarios are developed to define pricing decisions and remanufacturing strategies. The optimality of all proposed models is analyzed theoretically"

Penelitian pendukung oleh Armin Aminipour, Zied Bahroun, Moncer Hariga (2021) yang dipublikasikan dalam *Sustainable Production and Consumption* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
