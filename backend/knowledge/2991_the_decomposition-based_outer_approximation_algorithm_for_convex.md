# 2991 — Operations Research & Large-Scale Optimization: The decomposition-based outer approximation algorithm for convex mixed-integer nonlinear programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** The decomposition-based outer approximation algorithm for convex mixed-integer nonlinear programming  
**Jurnal & Sitasi Utama:** Pavlo Muts, Ivo Nowak, E.M.T. Hendrix (2020). *Journal of Global Optimization*. DOI: [10.1007/s10898-020-00888-x](10.1007/s10898-020-00888-x)  
**Sitasi Pendukung:** Martina Kuchlbauer, Frauke Liers, Michael Stingl (2022). *Journal of Optimization Theory and Applications*. DOI: [10.1007/s10957-022-02114-y](10.1007/s10957-022-02114-y)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pavlo Muts, Ivo Nowak, E.M.T. Hendrix (2020) dalam jurnal *Journal of Global Optimization* (DOI: 10.1007/s10898-020-00888-x) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
