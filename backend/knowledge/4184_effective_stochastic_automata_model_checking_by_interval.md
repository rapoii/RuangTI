# 4184 — Applied Statistics & Stochastic Modeling: Effective Stochastic Automata Model Checking by Interval Abstraction (extended version)

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Effective Stochastic Automata Model Checking by Interval Abstraction (extended version)  
**Jurnal & Sitasi Utama:** Pedro R. D'Argenio, Arnd Hartmanns, Annabell Petri (2026). *arXiv (Cornell University)*. DOI: [10.openalex/w7167290492](10.openalex/w7167290492)  
**Sitasi Pendukung:** Frances Anne Pogacar (2021). *TSpace (University of Toronto)*. DOI: [10.openalex/w7132881544](10.openalex/w7132881544)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pedro R. D'Argenio, Arnd Hartmanns, Annabell Petri (2026) dalam jurnal *arXiv (Cornell University)* (DOI: 10.openalex/w7167290492) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Frances Anne Pogacar (2021) yang dipublikasikan dalam *TSpace (University of Toronto)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
