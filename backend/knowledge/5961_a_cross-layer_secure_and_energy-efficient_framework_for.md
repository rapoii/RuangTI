# 5961 — Safety Engineering & Risk Management: A Cross-Layer Secure and Energy-Efficient Framework for the Internet of Things: A Comprehensive Survey

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** A Cross-Layer Secure and Energy-Efficient Framework for the Internet of Things: A Comprehensive Survey  
**Jurnal & Sitasi Utama:** Rashid Mustafa, Nurul I. Sarkar, Mahsa Mohaghegh (2024). *Sensors*. DOI: [10.3390/s24227209](10.3390/s24227209)  
**Sitasi Pendukung:** David Holcomb, Alexander Huning, Michael Muhlheim (2021). *Peer-Reviewed Academic Journal*. DOI: [10.2172/1824962](10.2172/1824962)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rashid Mustafa, Nurul I. Sarkar, Mahsa Mohaghegh (2024) dalam jurnal *Sensors* (DOI: 10.3390/s24227209) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh David Holcomb, Alexander Huning, Michael Muhlheim (2021) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
