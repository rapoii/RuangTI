# 5301 — Industrial Artificial Intelligence & Data Analytics: Steel Surface Defect Detection Algorithm Based on Improved YOLOv11n

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Steel Surface Defect Detection Algorithm Based on Improved YOLOv11n  
**Jurnal & Sitasi Utama:** Yu Liu, Wentao Wang, Hanting Xu (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11086055](10.1109/cvidl65390.2025.11086055)  
**Sitasi Pendukung:** Songsen Yu, Chicheng Zhang, Huan Yang (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603508](10.1109/cvidl62147.2024.10603508)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yu Liu, Wentao Wang, Hanting Xu (2025) dalam jurnal *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl65390.2025.11086055) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
