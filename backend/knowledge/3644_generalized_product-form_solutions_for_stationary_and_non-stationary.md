# 3644 — Applied Statistics & Stochastic Modeling: Generalized Product-Form Solutions for Stationary and Non-Stationary Queuing Networks with Application to Maritime and Railway Transport

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Generalized Product-Form Solutions for Stationary and Non-Stationary Queuing Networks with Application to Maritime and Railway Transport  
**Jurnal & Sitasi Utama:** Г. Ш. Цициашвили (2025). *Mathematics*. DOI: [10.3390/math13172810](10.3390/math13172810)  
**Sitasi Pendukung:** Louis Leconte, Matthieu Jonckheere, Sergey Samsonov (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2405.00017](10.48550/arxiv.2405.00017)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Г. Ш. Цициашвили (2025) dalam jurnal *Mathematics* (DOI: 10.3390/math13172810) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Louis Leconte, Matthieu Jonckheere, Sergey Samsonov (2024) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
