# 3745 — Industrial Energy Management & Decarbonization: Thermal integration analysis and improved configuration for multiple effect evaporator system based on pinch analysis

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Thermal integration analysis and improved configuration for multiple effect evaporator system based on pinch analysis  
**Jurnal & Sitasi Utama:** Indra Riadi, Zulfan Adi Putra, Heri Cahyono (2021). *REAKTOR*. DOI: [10.14710/reaktor.21.2.74-93](10.14710/reaktor.21.2.74-93)  
**Sitasi Pendukung:** J. Walden, Roger Padullés (2024). *Energy Conversion and Management*. DOI: [10.1016/j.enconman.2024.118983](10.1016/j.enconman.2024.118983)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Indra Riadi, Zulfan Adi Putra, Heri Cahyono (2021) dalam jurnal *REAKTOR* (DOI: 10.14710/reaktor.21.2.74-93) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh J. Walden, Roger Padullés (2024) yang dipublikasikan dalam *Energy Conversion and Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
