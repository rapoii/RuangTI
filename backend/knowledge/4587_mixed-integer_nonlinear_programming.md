# 4587 — Operations Research & Large-Scale Optimization: Mixed-Integer Nonlinear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Mixed-Integer Nonlinear Programming  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2021). *Advanced Optimization for Process Systems Engineering*. DOI: [10.1017/9781108917834.010](10.1017/9781108917834.010)  
**Sitasi Pendukung:** Nathan Adelgren, Akshay Gupte (2022). *INFORMS Journal on Computing*. DOI: [10.1287/ijoc.2021.1092](10.1287/ijoc.2021.1092)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2021) dalam jurnal *Advanced Optimization for Process Systems Engineering* (DOI: 10.1017/9781108917834.010) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
