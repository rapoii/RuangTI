# 3538 — Production Planning & Inventory Control: Digital transformation in operations management: Fundamental change through agency reversal

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Digital transformation in operations management: Fundamental change through agency reversal  
**Jurnal & Sitasi Utama:** Spyros Angelopoulos, Elliot Bendoly, Jan C. Fransoo (2023). *Journal of Operations Management*. DOI: [10.1002/joom.1271](10.1002/joom.1271)  
**Sitasi Pendukung:** Jeroen B.H.C. Didden, Quang-Vinh Dang, Ivo Adan (2023). *Journal of Manufacturing Systems*. DOI: [10.1016/j.jmsy.2023.02.004](10.1016/j.jmsy.2023.02.004)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Spyros Angelopoulos, Elliot Bendoly, Jan C. Fransoo (2023) dalam jurnal *Journal of Operations Management* (DOI: 10.1002/joom.1271) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jeroen B.H.C. Didden, Quang-Vinh Dang, Ivo Adan (2023) yang dipublikasikan dalam *Journal of Manufacturing Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
