# 6209 — Operations Research & Large-Scale Optimization: Two-Echelon Vehicle Routing Problem with Time Windows in Crowdsourcing Mode

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Two-Echelon Vehicle Routing Problem with Time Windows in Crowdsourcing Mode  
**Jurnal & Sitasi Utama:** Fuqiang Lu, Zhiyuan Gao, Hualing Bi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4984553](10.2139/ssrn.4984553)  
**Sitasi Pendukung:** Hassan El Fahim (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202206.0074.v1](10.20944/preprints202206.0074.v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fuqiang Lu, Zhiyuan Gao, Hualing Bi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4984553) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
