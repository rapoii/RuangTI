# 5394 — Operations Research & Large-Scale Optimization: Branch-and-cut solution approach for multilevel mixed integer linear programming problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Branch-and-cut solution approach for multilevel mixed integer linear programming problems  
**Jurnal & Sitasi Utama:** Ashenafi Awraris, Berhanu Guta Wordofa, Semu Mitiku Kassa (2023). *EURO Journal on Computational Optimization*. DOI: [10.1016/j.ejco.2023.100076](10.1016/j.ejco.2023.100076)  
**Sitasi Pendukung:** Sahar Tahernejad, Ted K. Ralphs, Scott T. DeNegre (2020). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00183-6](10.1007/s12532-020-00183-6)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ashenafi Awraris, Berhanu Guta Wordofa, Semu Mitiku Kassa (2023) dalam jurnal *EURO Journal on Computational Optimization* (DOI: 10.1016/j.ejco.2023.100076) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
