# 5504 — Quality Engineering & Reliability Systems: The Objective Exposure FMEA (OE-FMEA) A Data-Grounded Alternative to Subjective RPN Scoring for Failure Mode and Effects Analysis on Established Processes

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** The Objective Exposure FMEA (OE-FMEA) A Data-Grounded Alternative to Subjective RPN Scoring for Failure Mode and Effects Analysis on Established Processes  
**Jurnal & Sitasi Utama:** Syed Muhammad Baqir (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7171621](10.2139/ssrn.7171621)  
...
> "Failure Mode and Effects Analysis (FMEA) is a widely used prospective risk assessment tool, but its central outputthe Risk Priority Number (RPN), calculated as Severity × Occurrence × Detection-is assembled from three ordinal scores that a team assigns by consensus judgment rather than measurement. This inconsistency undermines the reproducibility that quality systems are meant to guarantee: a system, by definition, should produce uniform output regardless of who applies it. This paper proposes a correction scoped to FMEA performed on an already-established process with existing data: Occurrence should be derived from process capability (Cpk) or Defects Per Million Opportunities (DPMO) already generated by the running process, and Detection should be derived from a Gage Repeatability &amp;amp; Reproducibility (Gage R&amp;amp;R) study of the inspection system already in place, rather than from unaided team judgment. Severity, which is a value judgment about consequence rather than a measurable process characteristic, is removed from the multiplicative score entirely and reported as a separate fixed category (Negligible to Catastrophic). The result, the Objective Exposure FMEA (OE-FMEA), replaces a single ambiguous RPN with two traceable figures-an objective numeric Exposure Index (O × D) and a separate Severity category-aligning two of the three RPN components with statistical tools already present in the quality toolkit."
