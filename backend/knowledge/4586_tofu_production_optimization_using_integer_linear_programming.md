# 4586 — Operations Research & Large-Scale Optimization: TOFU PRODUCTION OPTIMIZATION USING INTEGER LINEAR PROGRAMMING THROUGH BRANCH AND BOUND APPROACH

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** TOFU PRODUCTION OPTIMIZATION USING INTEGER LINEAR PROGRAMMING THROUGH BRANCH AND BOUND APPROACH  
**Jurnal & Sitasi Utama:** Khairunnisa Ani Putri (2024). *Journal of Mathematics and Scientific Computing With Applications*. DOI: [10.53806/jmscowa.v5i2.986](10.53806/jmscowa.v5i2.986)  
**Sitasi Pendukung:** Lead Industrial Researchers (2021). *Advanced Optimization for Process Systems Engineering*. DOI: [10.1017/9781108917834.010](10.1017/9781108917834.010)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Khairunnisa Ani Putri (2024) dalam jurnal *Journal of Mathematics and Scientific Computing With Applications* (DOI: 10.53806/jmscowa.v5i2.986) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2021) yang dipublikasikan dalam *Advanced Optimization for Process Systems Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
