# 4576 — Operations Research & Large-Scale Optimization: Multimodal Transport Optimization from Doorstep to Airport Using Mixed-Integer Linear Programming and Dynamic Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multimodal Transport Optimization from Doorstep to Airport Using Mixed-Integer Linear Programming and Dynamic Programming  
**Jurnal & Sitasi Utama:** Evangelos D. Spyrou, Vassilios Kappatos, Maria Gkemou (2025). *Sustainability*. DOI: [10.3390/su17177937](10.3390/su17177937)  
**Sitasi Pendukung:** Armin Cosic, Michael Stadler, Muhammad Mansoor (2021). *Energy*. DOI: [10.1016/j.energy.2021.121559](10.1016/j.energy.2021.121559)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Evangelos D. Spyrou, Vassilios Kappatos, Maria Gkemou (2025) dalam jurnal *Sustainability* (DOI: 10.3390/su17177937) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
