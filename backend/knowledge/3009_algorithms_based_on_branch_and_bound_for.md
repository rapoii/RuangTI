# 3009 — Operations Research & Large-Scale Optimization: Algorithms based on branch and bound for the flying sidekick traveling salesman problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Algorithms based on branch and bound for the flying sidekick traveling salesman problem  
**Jurnal & Sitasi Utama:** Mauro Dell’Amico, Roberto Montemanni, Stefano Novellani (2021). *Omega*. DOI: [10.1016/j.omega.2021.102493](10.1016/j.omega.2021.102493)  
**Sitasi Pendukung:** Bodo Rosenhahn (2023). *Journal of Optimization Theory and Applications*. DOI: [10.1007/s10957-023-02317-x](10.1007/s10957-023-02317-x)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mauro Dell’Amico, Roberto Montemanni, Stefano Novellani (2021) dalam jurnal *Omega* (DOI: 10.1016/j.omega.2021.102493) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
