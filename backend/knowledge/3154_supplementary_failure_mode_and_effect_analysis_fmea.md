# 3154 — Quality Engineering & Reliability Systems: SUPPLEMENTARY FAILURE MODE AND EFFECT ANALYSIS (FMEA) FOR SAFETY APPLICATION STANDARDS DIN EN ISO 13849 SAFETY FUNCTION-FMEA

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** SUPPLEMENTARY FAILURE MODE AND EFFECT ANALYSIS (FMEA) FOR SAFETY APPLICATION STANDARDS DIN EN ISO 13849 SAFETY FUNCTION-FMEA  
**Jurnal & Sitasi Utama:** Christa Düsing, David Prust (2023). *Editora Artemis eBooks*. DOI: [10.37572/edart_27022376721](10.37572/edart_27022376721)  
**Sitasi Pendukung:** Christa Düsing, Frank Will (2025). *Lecture notes in mechanical engineering*. DOI: [10.1007/978-3-031-84505-5_11](10.1007/978-3-031-84505-5_11)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Christa Düsing, David Prust (2023) dalam jurnal *Editora Artemis eBooks* (DOI: 10.37572/edart_27022376721) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Christa Düsing, Frank Will (2025) yang dipublikasikan dalam *Lecture notes in mechanical engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
