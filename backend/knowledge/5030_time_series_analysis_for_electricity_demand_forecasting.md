# 5030 — Applied Statistics & Stochastic Modeling: Time Series Analysis for Electricity Demand Forecasting: A Comparative Study of ARIMA and Exponential Smoothing Models in Indonesia

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Time Series Analysis for Electricity Demand Forecasting: A Comparative Study of ARIMA and Exponential Smoothing Models in Indonesia  
**Jurnal & Sitasi Utama:** Rizky Ilman Nugraha, Agussalim (2024). *Information Technology International Journal*. DOI: [10.33005/itij.v2i2.23](10.33005/itij.v2i2.23)  
**Sitasi Pendukung:** Vanaphol Chamsukhee (2020). *2020 - 5th International Conference on Information Technology (InCIT)*. DOI: [10.1109/incit50588.2020.9310785](10.1109/incit50588.2020.9310785)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rizky Ilman Nugraha, Agussalim (2024) dalam jurnal *Information Technology International Journal* (DOI: 10.33005/itij.v2i2.23) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vanaphol Chamsukhee (2020) yang dipublikasikan dalam *2020 - 5th International Conference on Information Technology (InCIT)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
