# 5737 — Operations Research & Large-Scale Optimization: Stochastic transitions of a mixed-integer linear programming model for the construction supply chain: chance-constrained programming and two-stage programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Stochastic transitions of a mixed-integer linear programming model for the construction supply chain: chance-constrained programming and two-stage programming  
**Jurnal & Sitasi Utama:** Aspasia Koutsokosta, Stefanos Katsavounis (2024). *Operational Research*. DOI: [10.1007/s12351-024-00856-3](10.1007/s12351-024-00856-3)  
**Sitasi Pendukung:** Xing Fu (2026). *2026 2nd International Conference on Energy Systems and Electrical Engineering (ESEE)*. DOI: [10.1109/esee69148.2026.11601791](10.1109/esee69148.2026.11601791)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Aspasia Koutsokosta, Stefanos Katsavounis (2024) dalam jurnal *Operational Research* (DOI: 10.1007/s12351-024-00856-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xing Fu (2026) yang dipublikasikan dalam *2026 2nd International Conference on Energy Systems and Electrical Engineering (ESEE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
