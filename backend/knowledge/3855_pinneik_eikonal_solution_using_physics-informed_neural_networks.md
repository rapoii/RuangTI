# 3855 — Industrial Artificial Intelligence & Data Analytics: PINNeik: Eikonal solution using physics-informed neural networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** PINNeik: Eikonal solution using physics-informed neural networks  
**Jurnal & Sitasi Utama:** Umair bin Waheed, Ehsan Haghighat, Tariq Alkhalifah (2021). *Computers & Geosciences*. DOI: [10.1016/j.cageo.2021.104833](10.1016/j.cageo.2021.104833)  
**Sitasi Pendukung:** Abdelrahman Farrag, Yuxin Yang, Nieqing Cao (2024). *Progress in Additive Manufacturing*. DOI: [10.1007/s40964-024-00612-1](10.1007/s40964-024-00612-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Umair bin Waheed, Ehsan Haghighat, Tariq Alkhalifah (2021) dalam jurnal *Computers & Geosciences* (DOI: 10.1016/j.cageo.2021.104833) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Abdelrahman Farrag, Yuxin Yang, Nieqing Cao (2024) yang dipublikasikan dalam *Progress in Additive Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
