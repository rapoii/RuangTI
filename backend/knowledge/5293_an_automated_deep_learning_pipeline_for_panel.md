# 5293 — Industrial Artificial Intelligence & Data Analytics: An Automated Deep Learning Pipeline for Panel Segmentation, Defect Detection, and 3D Reconstruction in Impact Test Analysis

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** An Automated Deep Learning Pipeline for Panel Segmentation, Defect Detection, and 3D Reconstruction in Impact Test Analysis  
**Jurnal & Sitasi Utama:** Uğur Karaca, Toygar Akgün (2026). *Proceedings of the 21st International Conference on Computer Vision Theory and Applications*. DOI: [10.5220/0014244200004084](10.5220/0014244200004084)  
**Sitasi Pendukung:** Manpreet Minhas, John Zelek (2020). *Proceedings of the 15th International Joint Conference on Computer Vision, Imaging and Computer Graphics Theory and Applications*. DOI: [10.5220/0009168005060513](10.5220/0009168005060513)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Uğur Karaca, Toygar Akgün (2026) dalam jurnal *Proceedings of the 21st International Conference on Computer Vision Theory and Applications* (DOI: 10.5220/0014244200004084) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
