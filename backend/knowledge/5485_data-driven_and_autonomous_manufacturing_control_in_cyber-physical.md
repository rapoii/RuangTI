# 5485 — Manufacturing Systems & Cyber-Physical Production: Data-driven and autonomous manufacturing control in cyber-physical production systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Data-driven and autonomous manufacturing control in cyber-physical production systems  
**Jurnal & Sitasi Utama:** Oliver Antons, Julia C. Arlinghaus (2022). *Computers in Industry*. DOI: [10.1016/j.compind.2022.103711](10.1016/j.compind.2022.103711)  
**Sitasi Pendukung:** Zhengjie Mu, Thomas Rauschenbach (2025). *2025 International Conference on Cyber-Enabled Distributed Computing and Knowledge Discovery (CyberC)*. DOI: [10.1109/cyberc66434.2025.00044](10.1109/cyberc66434.2025.00044)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Oliver Antons, Julia C. Arlinghaus (2022) dalam jurnal *Computers in Industry* (DOI: 10.1016/j.compind.2022.103711) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Zhengjie Mu, Thomas Rauschenbach (2025) yang dipublikasikan dalam *2025 International Conference on Cyber-Enabled Distributed Computing and Knowledge Discovery (CyberC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
