# 5444 — Operations Research & Large-Scale Optimization: Semidefinite relaxation and generalised benders decomposition to solve the transmission expansion network and reactive power planning

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Semidefinite relaxation and generalised benders decomposition to solve the transmission expansion network and reactive power planning  
**Jurnal & Sitasi Utama:** Erik F. Alvarez, Miguel Paredes, Marcos J. Rider (2020). *IET Generation, Transmission &amp; Distribution*. DOI: [10.1049/iet-gtd.2019.0331](10.1049/iet-gtd.2019.0331)  
**Sitasi Pendukung:** Dimitris Bertsimas, Ryan Cory-Wright, Jean Pauphilet (2025). *INFORMS Journal on Computing*. DOI: [10.1287/ijoc.2023.0074](10.1287/ijoc.2023.0074)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Erik F. Alvarez, Miguel Paredes, Marcos J. Rider (2020) dalam jurnal *IET Generation, Transmission &amp; Distribution* (DOI: 10.1049/iet-gtd.2019.0331) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Dimitris Bertsimas, Ryan Cory-Wright, Jean Pauphilet (2025) yang dipublikasikan dalam *INFORMS Journal on Computing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
