# 4083 — Production Planning & Inventory Control: Production capacity planning in motorcycle assembly line using CRP method at P T XYZ

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Production capacity planning in motorcycle assembly line using CRP method at P T XYZ  
**Jurnal & Sitasi Utama:** Humiras Hardi Purba, Siti Aisyah, R F Dewarani (2020). *IOP Conference Series Materials Science and Engineering*. DOI: [10.1088/1757-899x/885/1/012029](10.1088/1757-899x/885/1/012029)  
**Sitasi Pendukung:** Firda Dwi Pratiwi, Sawarni Hasibuan (2020). *Operations Excellence Journal of Applied Industrial Engineering*. DOI: [10.22441/oe.2020.v12.i3.007](10.22441/oe.2020.v12.i3.007)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Humiras Hardi Purba, Siti Aisyah, R F Dewarani (2020) dalam jurnal *IOP Conference Series Materials Science and Engineering* (DOI: 10.1088/1757-899x/885/1/012029) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract PT XYZ is an automotive manufacturing company that produces a motorcycle. In an effort to meet the needs of consumers precisely and quickly, PT XYZ deals with problems in terms of fulfilling the capacity in accordance with consumer demand. The problem of imbalanced production capacity occurred in assembly line 3 that produced motorcycle of FU types, consisting of 3 workgroups, namely sub assy, mainline RH, and mainline LH. The imbalance between the capacity and load was due to many work elements of an operator. Thus the load on each work in the three workgroups was greater than the available capacity. This problem was solved using the method of Capacity Requirement Planning/CRP. Based on the result using CRP, the production load of each workgroup was calculated as follows: sub assy of 115,690 minutes, mainline RH of 186,000 minutes and mainline LH of 218,701 minutes. This result showed an overload capacity in the assembly line and led to a production loss of 868 units in January, 836 units in February, and 867 units in March. It is possible to solve this under loading problem through overtime and work weekends."

Penelitian pendukung oleh Firda Dwi Pratiwi, Sawarni Hasibuan (2020) yang dipublikasikan dalam *Operations Excellence Journal of Applied Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
