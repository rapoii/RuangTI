# 3856 — Industrial Artificial Intelligence & Data Analytics: Physics-Informed Machine Learning for metal additive manufacturing

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-Informed Machine Learning for metal additive manufacturing  
**Jurnal & Sitasi Utama:** Abdelrahman Farrag, Yuxin Yang, Nieqing Cao (2024). *Progress in Additive Manufacturing*. DOI: [10.1007/s40964-024-00612-1](10.1007/s40964-024-00612-1)  
**Sitasi Pendukung:** Navid Zobeiry, Keith D. Humfeld (2021). *Engineering Applications of Artificial Intelligence*. DOI: [10.1016/j.engappai.2021.104232](10.1016/j.engappai.2021.104232)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Abdelrahman Farrag, Yuxin Yang, Nieqing Cao (2024) dalam jurnal *Progress in Additive Manufacturing* (DOI: 10.1007/s40964-024-00612-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Navid Zobeiry, Keith D. Humfeld (2021) yang dipublikasikan dalam *Engineering Applications of Artificial Intelligence* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
