# 5217 — Maintenance Engineering & Asset Life Cycle: Proposed Maintenance Planning Using Reliability Centered Maintenance (RCM) at PT. Djabesmen

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Proposed Maintenance Planning Using Reliability Centered Maintenance (RCM) at PT. Djabesmen  
**Jurnal & Sitasi Utama:** Muhamad Fahrurroji Muhamad Fahrurroji (2021). *Industry Xplore*. DOI: [10.36805/teknikindustri.v6i2.1458](10.36805/teknikindustri.v6i2.1458)  
**Sitasi Pendukung:** Adi Candra TEKMAPRO (2023). *Tekmapro*. DOI: [10.33005/tekmapro.v17i2.294](10.33005/tekmapro.v17i2.294)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Muhamad Fahrurroji Muhamad Fahrurroji (2021) dalam jurnal *Industry Xplore* (DOI: 10.36805/teknikindustri.v6i2.1458) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
In this study the analytical method used is Reliability Centered Maintenance (RCM), which is a maintenance analysis method used to determine critical components and improve maintenance systems that focus on improving engine reliability. &#x0D;
...
Keywords : Maintenance, Reliability, RCM, Main Machine, Failure"

Penelitian pendukung oleh Adi Candra TEKMAPRO (2023) yang dipublikasikan dalam *Tekmapro* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
