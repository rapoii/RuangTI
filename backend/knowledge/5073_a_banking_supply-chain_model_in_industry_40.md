# 5073 — Simulation Modeling & Digital Twins: A Banking Supply-Chain Model in Industry 4.0 Using Agent-Based Simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** A Banking Supply-Chain Model in Industry 4.0 Using Agent-Based Simulation  
**Jurnal & Sitasi Utama:** vahid shahabi, Adel Azar, farshad faezy razi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4008852](10.2139/ssrn.4008852)  
**Sitasi Pendukung:** Aicha Ben Mekki, Jihene Tounsi, Lamjed Ben Said (2020). *2020 International Multi-Conference on: “Organization of Knowledge and Advanced Technologies” (OCTA)*. DOI: [10.1109/octa49274.2020.9151848](10.1109/octa49274.2020.9151848)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari vahid shahabi, Adel Azar, farshad faezy razi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4008852) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The advent of Industry 4.0 has generated a profound change in the nature of business processes all around the world and the introduction of a concept as digital transformation has greatly affected the supply chain of businesses, including the supply chain of banking services. Thus, it is necessary to redefine this supply chain in the new era. This study investigated the supply chain of banking services of Industry 4.0 and its simulation based on agent-based modeling. What the model did was follow up the profit flow and other important financial parameters related to customers, banks, FinTechs, and other actors in the digital banking service supply chain for 2016-2021. The results of experimenting, executing, and analyzing in multiple simulation times showed the rate of change of parameters in the face of developments based on Industry 4.0. Connecting new players, including organizations and fintechs, to the supply chain has revolutionized banking services, both structurally and in terms of financial, information, and service flows."

Penelitian pendukung oleh Aicha Ben Mekki, Jihene Tounsi, Lamjed Ben Said (2020) yang dipublikasikan dalam *2020 International Multi-Conference on: “Organization of Knowledge and Advanced Technologies” (OCTA)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
