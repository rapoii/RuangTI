# 5283 — Industrial Artificial Intelligence & Data Analytics: S-PINN: physics-informed neural networks for solving weakly hyperbolic systems

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** S-PINN: physics-informed neural networks for solving weakly hyperbolic systems  
**Jurnal & Sitasi Utama:** Jain M Francis, Rakesh Kumar, Chandhini G (2025). *Physica Scripta*. DOI: [10.1088/1402-4896/ae2391](10.1088/1402-4896/ae2391)  
**Sitasi Pendukung:** Y. Ke, C.W. Liu, Shi-Shun Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5162809](10.2139/ssrn.5162809)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jain M Francis, Rakesh Kumar, Chandhini G (2025) dalam jurnal *Physica Scripta* (DOI: 10.1088/1402-4896/ae2391) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Y. Ke, C.W. Liu, Shi-Shun Zhang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
