# 5903 — Simulation Modeling & Digital Twins: Optimization of production process of manufacturing parts using simulation modeling of aperture

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Optimization of production process of manufacturing parts using simulation modeling of aperture  
**Jurnal & Sitasi Utama:** I. V. Revina, G N Boyarkin (2018). *Proceedings of the International Conference "Actual Issues of Mechanical Engineering" (AIME 2018)*. DOI: [10.2991/aime-18.2018.101](10.2991/aime-18.2018.101)  
**Sitasi Pendukung:** Ayhan Menteş, Erdem Koç, Muhammed Alperen Güngör (2025). *Transactions on Maritime Science*. DOI: [10.7225/toms.v14.n01.011](10.7225/toms.v14.n01.011)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari I. V. Revina, G N Boyarkin (2018) dalam jurnal *Proceedings of the International Conference "Actual Issues of Mechanical Engineering" (AIME 2018)* (DOI: 10.2991/aime-18.2018.101) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The article considers the model of the technological line operation for parts manufacturing, made in the simulation system Arena Rockwell. The relevance of the study is to reveal the "bottlenecks" and to answer a "what if" question when considering different models. Optimization parameters are the maximum possible number of parts manufactured and the maximum load of equipment, i.e. maximizing profit. Reject rates and parts reworking are considered to be limitations. As a result of modeling, having considered various models of the production process organization, the following was established: the machines load, the number of parts produced, the average length of parts in the production process, the average number of parts in the queue, profits and losses in the production process. The obtained results of simulating will organize an economically justified production process -two-point production line with a 1.45 timeincrease in profit."

Penelitian pendukung oleh Ayhan Menteş, Erdem Koç, Muhammed Alperen Güngör (2025) yang dipublikasikan dalam *Transactions on Maritime Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
