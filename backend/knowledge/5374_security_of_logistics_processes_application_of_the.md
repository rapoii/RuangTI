# 5374 — Continuous Improvement & Lean Six Sigma: Security of logistics processes – application of the Single Minute Exchange of Die (SMED) method

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Security of logistics processes – application of the Single Minute Exchange of Die (SMED) method  
**Jurnal & Sitasi Utama:** Małgorzata Oziębło (2025). *Human. Systems. Security*. DOI: [10.66061/csb/210912](10.66061/csb/210912)  
**Sitasi Pendukung:** Cicilia Sriliasta Bangun, Dani Purnama, Arief Suwandi (2023). *International Journal of Research and Review*. DOI: [10.52403/ijrr.20231247](10.52403/ijrr.20231247)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Małgorzata Oziębło (2025) dalam jurnal *Human. Systems. Security* (DOI: 10.66061/csb/210912) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Procesy logistyczne odgrywają istotną rolę w przedsiębiorstwie. Bezpieczeństwo w procesach logistycznych jest bardzo ważnym elementem, który zapewnia ciągłość i nieprzerwalność tychże procesów. Współcześnie zapewnienie bezpieczeństwa w procesach logistycznych interpretowanych przez znawców przedmiotu jako skuteczna koordynacja przepływu surowców, materiałów i produktów gotowych dla konsumenta jest wyzwaniem, ponieważ skutkiem niepewności jest poczucie braku bezpieczeństwa i stabilności. A przecież współcześnie immanentną cechą otoczenia jest nieprzewidywalność i turbulentność.  Celem artykułu jest przedstawienie jak zastosowanie metody SMED (Single Minute Exchange of Die) może przyczynić się do zwiększenia bezpieczeństwo procesów logistycznych w wybranym przedsiębiorstwie X. Przedmiotem badań są procesy przezbrojenia oraz operacyjne w otoczeniu logistycznym. Podmiotem badań jest wybrane przedsiębiorstwo logistyczne, które wdrożyło działania optymalizacyjne z wykorzystaniem metody SMED. Problem badawczy został sformułowany w postaci pytania: W jaki sposób wdrożenie metody SMED wpływa na poziom bezpieczeństwa procesów logistycznych w wybranym przedsiębiorstwie X? Hipoteza robocza: Wdrożenie metody SMED w wybranym przedsiębiorstwie logistycznym przyczynia się do zwiększenia poziomu bezpieczeństwa procesów logistycznych poprzez skrócenie czasu przezbrojenia, ograniczenie ryzyka błędów ludzkich oraz poprawę koordynacji działań operacyjnych.
Badania realizowano na podstawie dostępn"

Penelitian pendukung oleh Cicilia Sriliasta Bangun, Dani Purnama, Arief Suwandi (2023) yang dipublikasikan dalam *International Journal of Research and Review* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
