# 3646 — Applied Statistics & Stochastic Modeling: Queueing analysis of two healthcare systems where physician activity is offloaded to supporting health professionals

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Queueing analysis of two healthcare systems where physician activity is offloaded to supporting health professionals  
**Jurnal & Sitasi Utama:** Maria Antonieta Tagimacruz (2020). *Peer-Reviewed Academic Journal*. DOI: [10.11575/prism/37982](10.11575/prism/37982)  
**Sitasi Pendukung:** Eliran Sherzer (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2411.07599](10.48550/arxiv.2411.07599)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Maria Antonieta Tagimacruz (2020) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.11575/prism/37982) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
