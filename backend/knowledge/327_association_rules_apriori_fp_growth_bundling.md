# Modul Komprehensif: Analisis Asosiasi: Apriori, FP-Growth untuk Bundling Produk & Co-Purchasing
**Nomor Modul:** [327]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Introduction to Data Mining (Pang-Ning Tan, Michael Steinbach), Expert Systems with Applications (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Analisis Asosiasi: Apriori, FP-Growth untuk Bundling Produk & Co-Purchasing**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Itemset Mining, Support, Confidence, Lift, Leverage, FP-Tree Compression, Prefix-Path Projections.
...
```python
# Algoritma Solusi Terapan untuk Analisis Asosiasi: Apriori, FP-Growth untuk Bundling Produk & Co-Purchasing
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Optimalisasi Penataan Tata Letak Rak Gudang E-Commerce berdasarkan Co-Occurrence SKU.
...
1. Introduction to Data Mining (Pang-Ning Tan, Michael Steinbach), Expert Systems with Applications (2024).
