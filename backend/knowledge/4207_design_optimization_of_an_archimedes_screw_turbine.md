# 4207 — Applied Statistics & Stochastic Modeling: Design optimization of an Archimedes screw turbine for hydrokinetic applications using the response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Design optimization of an Archimedes screw turbine for hydrokinetic applications using the response surface methodology  
**Jurnal & Sitasi Utama:** Maël Bouvant, Johan Betancour, Laura Velásquez (2021). *Renewable Energy*. DOI: [10.1016/j.renene.2021.03.076](10.1016/j.renene.2021.03.076)  
**Sitasi Pendukung:** Ayesha Saleem, Ali Hussain, Asma Chaudhary (2020). *Biomass Conversion and Biorefinery*. DOI: [10.1007/s13399-020-01117-x](10.1007/s13399-020-01117-x)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Maël Bouvant, Johan Betancour, Laura Velásquez (2021) dalam jurnal *Renewable Energy* (DOI: 10.1016/j.renene.2021.03.076) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
