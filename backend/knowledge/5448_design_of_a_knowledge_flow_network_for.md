# 5448 — Operations Research & Large-Scale Optimization: Design of a Knowledge Flow Network for the Personnel of an Organization under Various Scenarios and its Solution using Lagrangian Relaxation

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Design of a Knowledge Flow Network for the Personnel of an Organization under Various Scenarios and its Solution using Lagrangian Relaxation  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2022). *International Journal of Engineering*. DOI: [10.5829/ije.2022.35.06c.07](10.5829/ije.2022.35.06c.07)  
**Sitasi Pendukung:** Luka Matijević (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4173510](10.2139/ssrn.4173510)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2022) dalam jurnal *International Journal of Engineering* (DOI: 10.5829/ije.2022.35.06c.07) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
