# 5825 — Supply Chain Management & Logistics Engineering: RETRACTED: Closed-Loop Supply Chain Design and Pricing in Competitive Conditions by Considering the Variable Value of Return Products Using the Whale Optimization Algorithm

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** RETRACTED: Closed-Loop Supply Chain Design and Pricing in Competitive Conditions by Considering the Variable Value of Return Products Using the Whale Optimization Algorithm  
**Jurnal & Sitasi Utama:** Muhammad Salman Shabbir, Ahmed Faisal Siddiqi, Lis M. Yapanto (2021). *Sustainability*. DOI: [10.3390/su13126663](10.3390/su13126663)  
**Sitasi Pendukung:** Yan Zhou, Miao Hou, Kar-Hung Wong (2023). *Sustainability*. DOI: [10.3390/su15097342](10.3390/su15097342)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Muhammad Salman Shabbir, Ahmed Faisal Siddiqi, Lis M. Yapanto (2021) dalam jurnal *Sustainability* (DOI: 10.3390/su13126663) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yan Zhou, Miao Hou, Kar-Hung Wong (2023) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
