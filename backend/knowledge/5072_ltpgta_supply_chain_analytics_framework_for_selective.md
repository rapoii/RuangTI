# 5072 — Simulation Modeling & Digital Twins: &lt;p&gt;A Supply Chain Analytics Framework for Selective Supplier Rewiring Using Agent-Based Network Simulation&lt;/p&gt;

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** &lt;p&gt;A Supply Chain Analytics Framework for Selective Supplier Rewiring Using Agent-Based Network Simulation&lt;/p&gt;  
**Jurnal & Sitasi Utama:** Islam El-Nakib (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7110138](10.2139/ssrn.7110138)  
**Sitasi Pendukung:** vahid shahabi, Adel Azar, farshad faezy razi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4008852](10.2139/ssrn.4008852)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Islam El-Nakib (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7110138) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
