# 4404 — Manufacturing Systems & Cyber-Physical Production: Peer Review Report For: TAD-Net: An approach for real-time action detection based on temporal convolution network and graph convolution network in digital twin shop-floor [version 1; peer review: 2 approved]

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Peer Review Report For: TAD-Net: An approach for real-time action detection based on temporal convolution network and graph convolution network in digital twin shop-floor [version 1; peer review: 2 approved]  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2022). *Peer-Reviewed Journal*. DOI: [10.21956/digitaltwin.18683.r26876](10.21956/digitaltwin.18683.r26876)  
**Sitasi Pendukung:** Jiaye Song, Zequn Zhang, Dunbing Tang (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-2058715/v1](10.21203/rs.3.rs-2058715/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2022) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21956/digitaltwin.18683.r26876) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiaye Song, Zequn Zhang, Dunbing Tang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
