# 4045 — Facilities Planning & Material Handling: Perancangan Tata Letak Gudang Delivery Produk Karpet Kendaraan Roda Empat Menggunakan Pendekatan Systematic Layout Planning di PT Kotobukiya Indo Classic Industries

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Perancangan Tata Letak Gudang Delivery Produk Karpet Kendaraan Roda Empat Menggunakan Pendekatan Systematic Layout Planning di PT Kotobukiya Indo Classic Industries  
**Jurnal & Sitasi Utama:** Dani Ramdani, Rizky Fajar Ramdhani (2026). *Jurnal Teknik Industri Terintegrasi*. DOI: [10.31004/jutin.v9i2.57405](10.31004/jutin.v9i2.57405)  
**Sitasi Pendukung:** Man Zhao, Xing Wei (2020). *Journal of Physics Conference Series*. DOI: [10.1088/1742-6596/1486/7/072079](10.1088/1742-6596/1486/7/072079)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dani Ramdani, Rizky Fajar Ramdhani (2026) dalam jurnal *Jurnal Teknik Industri Terintegrasi* (DOI: 10.31004/jutin.v9i2.57405) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study aims to redesign the layout of the delivery warehouse for four-wheeled vehicle carpet products at PT Kotobukiya Indo Classic Industries (KICI) using the Systematic Layout Planning (SLP) approach. The main problems identified include the accumulation of goods in the over part area, inefficient material flow, and limited warehouse capacity, which impact delivery delays. The research method was conducted through direct observation, collection of inflow–outflow data of parts, and analysis of activity relationships using relationship diagrams. The results indicate that the existing warehouse capacity is unable to accommodate the production volume of major customers such as (TMMIN), with inflow reaching 4,171 units per month for certain parts. The SLP-based layout redesign resulted in a new warehouse configuration with shorter forklift movement paths, more systematic space arrangement, and more consistent implementation of the FIFO system. The findings conclude that the application of SLP can improve material flow efficiency, reduce handling time, and increase the effective warehouse capacity."

Penelitian pendukung oleh Man Zhao, Xing Wei (2020) yang dipublikasikan dalam *Journal of Physics Conference Series* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
