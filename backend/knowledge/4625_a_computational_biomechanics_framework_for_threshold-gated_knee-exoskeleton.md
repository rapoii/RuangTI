# 4625 — Human Factors & Cognitive Ergonomics: A computational biomechanics framework for threshold-gated knee-exoskeleton assistance in leg-swing exercise for knee osteoarthritis

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** A computational biomechanics framework for threshold-gated knee-exoskeleton assistance in leg-swing exercise for knee osteoarthritis  
**Jurnal & Sitasi Utama:** Haram Mustafa, Liang Han, Almogdad  S.M. Hassan (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7323956](10.2139/ssrn.7323956)  
**Sitasi Pendukung:** Evgenii S. Shuporin, Elena S. Chudova, Oleg V. Ilyenko (2025). *Hygiene and sanitation*. DOI: [10.47470/0016-9900-2025-104-6-728-733](10.47470/0016-9900-2025-104-6-728-733)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Haram Mustafa, Liang Han, Almogdad  S.M. Hassan (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7323956) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Background and Objectives: Our companion papers established a capacity-aware neuromuscular-cost framework (Model C2) for therapeutic leg-swing exercise in knee osteoarthritis (KOA) (Paper 1), and showed the mechanistically preferred protocol for higher-symptom KOA, Zhang (deliberate backward-phase knee flexion), is least affordable in neuromuscular terms for that severity group (Paper 2). This paper tests whether knee-exoskeleton assistance can resolve that tension, comparing a passive spring against an active, phase-gated motor, and translates the effect into Model C2&amp;apos;s repetition-dose framework.,Methods: Both strategies were appended to the validated Bedo-based OpenSim models from Papers 1-2 and scored with Static Optimization using the same 29-muscle burden metric. The passive strategy (a knee spring) was swept across five stiffness levels and five rest lengths. The active strategy (a knee motor) was restricted to the backward-phase flexion window via time-segmented Static Optimization. Both were evaluated on the Zhang protocol&amp;apos;s KOA-higher kinematics across three validated severities plus one severe-weakness scenario. Burden values were used as inputs to Model C2&amp;apos;s scoring formula to compute the optimal repetition count N*.,Results: The passive spring increased burden monotonically with stiffness at every severity (524-542%), driven by knee-flexor hamstrings overcoming the spring&amp;apos;s opposition to flexion; a rest-length sweep showed a non"

Penelitian pendukung oleh Evgenii S. Shuporin, Elena S. Chudova, Oleg V. Ilyenko (2025) yang dipublikasikan dalam *Hygiene and sanitation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
