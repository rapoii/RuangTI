# 5862 — Applied Statistics & Stochastic Modeling: Serial production line performance under random variation: Dealing with the ‘Law of Variability’

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Serial production line performance under random variation: Dealing with the ‘Law of Variability’  
**Jurnal & Sitasi Utama:** Rodrigo Romero-Silva, Erika Marsillac, Sabry Shaaban (2019). *Journal of Manufacturing Systems*. DOI: [10.1016/j.jmsy.2019.01.005](10.1016/j.jmsy.2019.01.005)  
**Sitasi Pendukung:** A.G. de Kok, Christopher Grob, Marco Laumanns (2018). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2018.02.047](10.1016/j.ejor.2018.02.047)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rodrigo Romero-Silva, Erika Marsillac, Sabry Shaaban (2019) dalam jurnal *Journal of Manufacturing Systems* (DOI: 10.1016/j.jmsy.2019.01.005) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
