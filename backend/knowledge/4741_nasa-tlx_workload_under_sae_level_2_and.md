# 4741 — Human Factors & Cognitive Ergonomics: NASA-TLX Workload Under SAE Level 2 and Level 3 Automation Versus Manual: A Meta Analysis approach

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** NASA-TLX Workload Under SAE Level 2 and Level 3 Automation Versus Manual: A Meta Analysis approach  
**Jurnal & Sitasi Utama:** Ashraf Alhujailli (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7102570](10.2139/ssrn.7102570)  
**Sitasi Pendukung:** Andrea Alaimo, Antonio Esposito, Calogero Orlando (2020). *Aerospace*. DOI: [10.3390/aerospace7090137](10.3390/aerospace7090137)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ashraf Alhujailli (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7102570) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Background: The deployment of partially and conditionally automated driving systems has raised fundamental questions about driver workload, yet no prior meta-analysis has examined this relationship using the National Aeronautics and Space Administration Task Load Index (NASA-TLX) as the exclusive outcome measure, with explicit Society of Automotive Engineers (SAE) level definitions and a manual driving comparator. Methods: Seven academic search databases were searched from inception alongside forward and backward citation searching. Following deduplication and screening, eight studies (N = 322 participants; 18 comparison arms) met all eligibility criteria. Effect sizes were calculated as Hedges’ g using a random-effects model. Heterogeneity was quantified with I² and τ². Three sensitivity analyses and exploratory subgroup analyses were conducted. Results: SAE L2 automation was associated with a significant reduction in overall NASA-TLX workload compared with manual driving (g = -1.66, 95% CI [-2.58, -0.75], p = 0.0004, I² = 93%; 95% prediction interval [-5.41, +2.09]), as was L3 automation (g = -1.06, 95% CI [-1.69, -0.44], p = 0.0008, I² = 52%). The difference between the two automation levels was not significant (p = 0.29). The L2 estimate was not robust to removal of a single influential study (g = -0.21, p = 0.38 after exclusion). Subscale analyses indicated that both L2 and L3 produced significant reductions in mental demand (L2: g = -1.56, p &lt; 0.0001; L3: g = -1.15, "

Penelitian pendukung oleh Andrea Alaimo, Antonio Esposito, Calogero Orlando (2020) yang dipublikasikan dalam *Aerospace* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
