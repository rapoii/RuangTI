# 5300 — Industrial Artificial Intelligence & Data Analytics: Aluminum Surface Defect Detection Method Based on Improved YOLOv8

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Aluminum Surface Defect Detection Method Based on Improved YOLOv8  
**Jurnal & Sitasi Utama:** Yinglong Zhang, Honggang Yang, Junwei Cheng (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11085735](10.1109/cvidl65390.2025.11085735)  
**Sitasi Pendukung:** Yu Liu, Wentao Wang, Hanting Xu (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11086055](10.1109/cvidl65390.2025.11086055)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yinglong Zhang, Honggang Yang, Junwei Cheng (2025) dalam jurnal *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl65390.2025.11085735) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yu Liu, Wentao Wang, Hanting Xu (2025) yang dipublikasikan dalam *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
