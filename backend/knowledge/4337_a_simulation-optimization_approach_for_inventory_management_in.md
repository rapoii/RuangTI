# 4337 — Supply Chain Management & Logistics Engineering: A Simulation-Optimization Approach for Inventory Management in a Multi-Echelon Supply Chain Network

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A Simulation-Optimization Approach for Inventory Management in a Multi-Echelon Supply Chain Network  
**Jurnal & Sitasi Utama:** Tianjiao Sun, Ziheng Huang, Dengnan Wu (2024). *2024 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem62345.2024.10857144](10.1109/ieem62345.2024.10857144)  
**Sitasi Pendukung:** Yang Zhang, Lili He, Junhong Zheng (2024). *Electronics*. DOI: [10.3390/electronics14010066](10.3390/electronics14010066)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tianjiao Sun, Ziheng Huang, Dengnan Wu (2024) dalam jurnal *2024 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)* (DOI: 10.1109/ieem62345.2024.10857144) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yang Zhang, Lili He, Junhong Zheng (2024) yang dipublikasikan dalam *Electronics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
