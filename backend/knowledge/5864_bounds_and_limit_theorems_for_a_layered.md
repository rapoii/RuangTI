# 5864 — Applied Statistics & Stochastic Modeling: Bounds and limit theorems for a layered queueing model in electric vehicle charging

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Bounds and limit theorems for a layered queueing model in electric vehicle charging  
**Jurnal & Sitasi Utama:** Angelos Aveklouris, Maria Vlasiou, Bert Zwart (2019). *Queueing Systems*. DOI: [10.1007/s11134-019-09616-z](10.1007/s11134-019-09616-z)  
**Sitasi Pendukung:** Leonidas Lampropoulos, Michael Hicks, Benjamin C. Pierce (2019). *Proceedings of the ACM on Programming Languages*. DOI: [10.1145/3360607](10.1145/3360607)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Angelos Aveklouris, Maria Vlasiou, Bert Zwart (2019) dalam jurnal *Queueing Systems* (DOI: 10.1007/s11134-019-09616-z) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Leonidas Lampropoulos, Michael Hicks, Benjamin C. Pierce (2019) yang dipublikasikan dalam *Proceedings of the ACM on Programming Languages* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
