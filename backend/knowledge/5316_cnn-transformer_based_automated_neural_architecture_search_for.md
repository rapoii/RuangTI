# 5316 — Industrial Artificial Intelligence & Data Analytics: CNN-Transformer based Automated Neural Architecture Search for Ultrasonic Railway Track Defect Classification

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** CNN-Transformer based Automated Neural Architecture Search for Ultrasonic Railway Track Defect Classification  
**Jurnal & Sitasi Utama:** Yulan Zeng, Wansu Lim (2025). *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl65390.2025.11085992](10.1109/cvidl65390.2025.11085992)  
**Sitasi Pendukung:** Vyacheslav V. Voronin, Roman Sizyakin, Marina Zhdanova (2021). *Automated Visual Inspection and Machine Vision IV*. DOI: [10.1117/12.2592872](10.1117/12.2592872)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yulan Zeng, Wansu Lim (2025) dalam jurnal *2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl65390.2025.11085992) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vyacheslav V. Voronin, Roman Sizyakin, Marina Zhdanova (2021) yang dipublikasikan dalam *Automated Visual Inspection and Machine Vision IV* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
