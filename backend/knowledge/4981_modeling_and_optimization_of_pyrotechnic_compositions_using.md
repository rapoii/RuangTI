# 4981 — Applied Statistics & Stochastic Modeling: Modeling and optimization of pyrotechnic compositions using central composite design and response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Modeling and optimization of pyrotechnic compositions using central composite design and response surface methodology  
**Jurnal & Sitasi Utama:** Danillo Fernando Vianna Cantini, Vojtech Pelikan, Jiri Pachman (2025). *FirePhysChem*. DOI: [10.1016/j.fpc.2025.03.004](10.1016/j.fpc.2025.03.004)  
**Sitasi Pendukung:** Suying Zhu (2021). *Starch - Stärke*. DOI: [10.1002/star.202100020](10.1002/star.202100020)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Danillo Fernando Vianna Cantini, Vojtech Pelikan, Jiri Pachman (2025) dalam jurnal *FirePhysChem* (DOI: 10.1016/j.fpc.2025.03.004) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Suying Zhu (2021) yang dipublikasikan dalam *Starch - Stärke* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
