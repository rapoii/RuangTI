# 5246 — Industrial Artificial Intelligence & Data Analytics: Sd-Pinn and Sdfeet-Pinn: Novel Methods to Improve the Convergence of Physics-Informed Neural Networks for Complex Thermal Simulations

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Sd-Pinn and Sdfeet-Pinn: Novel Methods to Improve the Convergence of Physics-Informed Neural Networks for Complex Thermal Simulations  
**Jurnal & Sitasi Utama:** Amèvi TONGNE (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5354206](10.2139/ssrn.5354206)  
**Sitasi Pendukung:** Matthew  W. Loving (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7067714](10.2139/ssrn.7067714)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amèvi TONGNE (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5354206) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Matthew  W. Loving (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
