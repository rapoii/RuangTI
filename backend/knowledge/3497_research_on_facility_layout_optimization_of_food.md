# 3497 — Facilities Planning & Material Handling: Research on Facility Layout Optimization of Food Warehouse Based on SLP Method and Flexsim Simulation

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Research on Facility Layout Optimization of Food Warehouse Based on SLP Method and Flexsim Simulation  
**Jurnal & Sitasi Utama:** Shuyan Zhou, Lixia Liu, Yinghuan Liu (2025). *Asia Pacific Economic and Management Review*. DOI: [10.62177/apemr.v1i1.278](10.62177/apemr.v1i1.278)  
**Sitasi Pendukung:** Inaki Maulida Hakim, Durra Salsabila, Keval Priapratama Prajadhiana (2025). *Jurnal Sistem dan Manajemen Industri*. DOI: [10.30656/jsmi.v9i1.9212](10.30656/jsmi.v9i1.9212)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shuyan Zhou, Lixia Liu, Yinghuan Liu (2025) dalam jurnal *Asia Pacific Economic and Management Review* (DOI: 10.62177/apemr.v1i1.278) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "With the rapid development of the social economy, food enterprises face dual challenges of ensuring food safety and controlling costs, where warehouse layout has become core to enhancing production-sales adaptability and reducing operational costs. Taking Changde Taiwei Sauce Duck Factory as a case study, this research uses the SLP method to analyze its warehouse layout and identifies issues such as unreasonable functional zone planning, improper personnel allocation, and low operational efficiency. By building a model with Flexsim and simulating 7-day operation data, the optimization achieves a 12.8% reduction in labor costs and a 23.5% improvement in handling efficiency. Comparative simulation data validate the effectiveness of the optimization scheme in enhancing warehousing efficiency and space utilization. In practical application, this design reduces labor costs, achieves rational layout of personnel and equipment, and significantly improves overall operational efficiency."

Penelitian pendukung oleh Inaki Maulida Hakim, Durra Salsabila, Keval Priapratama Prajadhiana (2025) yang dipublikasikan dalam *Jurnal Sistem dan Manajemen Industri* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
