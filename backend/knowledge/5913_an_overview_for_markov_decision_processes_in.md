# 5913 — Applied Statistics & Stochastic Modeling: An Overview for Markov Decision Processes in Queues and Networks

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** An Overview for Markov Decision Processes in Queues and Networks  
**Jurnal & Sitasi Utama:** Quan‐Lin Li, Jing-Yu Ma, Rui-Na Fan (2019). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.1907.10243](10.48550/arxiv.1907.10243)  
**Sitasi Pendukung:** Xunyun Liu (2018). *Minerva Access (University of Melbourne)*. DOI: [10.openalex/w2906058720](10.openalex/w2906058720)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Quan‐Lin Li, Jing-Yu Ma, Rui-Na Fan (2019) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.1907.10243) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xunyun Liu (2018) yang dipublikasikan dalam *Minerva Access (University of Melbourne)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
