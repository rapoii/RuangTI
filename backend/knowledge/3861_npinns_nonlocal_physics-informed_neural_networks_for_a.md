# 3861 — Industrial Artificial Intelligence & Data Analytics: nPINNs: Nonlocal physics-informed neural networks for a parametrized nonlocal universal Laplacian operator. Algorithms and applications

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** nPINNs: Nonlocal physics-informed neural networks for a parametrized nonlocal universal Laplacian operator. Algorithms and applications  
**Jurnal & Sitasi Utama:** Guofei Pang, Marta D’Elia, Michael L. Parks (2020). *Journal of Computational Physics*. DOI: [10.1016/j.jcp.2020.109760](10.1016/j.jcp.2020.109760)  
**Sitasi Pendukung:** Enrico Salvati, Alessandro Tognan, Luca Laurenti (2022). *Materials & Design*. DOI: [10.1016/j.matdes.2022.111089](10.1016/j.matdes.2022.111089)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Guofei Pang, Marta D’Elia, Michael L. Parks (2020) dalam jurnal *Journal of Computational Physics* (DOI: 10.1016/j.jcp.2020.109760) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Enrico Salvati, Alessandro Tognan, Luca Laurenti (2022) yang dipublikasikan dalam *Materials & Design* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
