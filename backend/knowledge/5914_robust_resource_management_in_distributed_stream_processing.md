# 5914 — Applied Statistics & Stochastic Modeling: Robust resource management in distributed stream processing systems

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Robust resource management in distributed stream processing systems  
**Jurnal & Sitasi Utama:** Xunyun Liu (2018). *Minerva Access (University of Melbourne)*. DOI: [10.openalex/w2906058720](10.openalex/w2906058720)  
**Sitasi Pendukung:** S. Rahimi-Ghahroodi, Ahmad Al Hanbali, W.H.M. Zijm (2019). *Reliability Engineering & System Safety*. DOI: [10.1016/j.ress.2019.04.027](10.1016/j.ress.2019.04.027)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xunyun Liu (2018) dalam jurnal *Minerva Access (University of Melbourne)* (DOI: 10.openalex/w2906058720) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh S. Rahimi-Ghahroodi, Ahmad Al Hanbali, W.H.M. Zijm (2019) yang dipublikasikan dalam *Reliability Engineering & System Safety* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
