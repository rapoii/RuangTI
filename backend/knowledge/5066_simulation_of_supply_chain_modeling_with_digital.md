# 5066 — Simulation Modeling & Digital Twins: Simulation of Supply Chain Modeling with Digital Twins

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulation of Supply Chain Modeling with Digital Twins  
**Jurnal & Sitasi Utama:** H. Chung (2025). *Proceedings of the 15th International Conference on Simulation and Modeling Methodologies, Technologies and Applications*. DOI: [10.5220/0013569200003970](10.5220/0013569200003970)  
**Sitasi Pendukung:** , Davoud Hosseinnezhad, Cathal Heavey (2025). *12th Simulation Workshop (SW25) Proceedings*. DOI: [10.36819/sw25.025](10.36819/sw25.025)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari H. Chung (2025) dalam jurnal *Proceedings of the 15th International Conference on Simulation and Modeling Methodologies, Technologies and Applications* (DOI: 10.5220/0013569200003970) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh , Davoud Hosseinnezhad, Cathal Heavey (2025) yang dipublikasikan dalam *12th Simulation Workshop (SW25) Proceedings* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
