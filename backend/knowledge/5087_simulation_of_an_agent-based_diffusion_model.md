# 5087 — Simulation Modeling & Digital Twins: Simulation of an Agent-Based Diffusion Model

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulation of an Agent-Based Diffusion Model  
**Jurnal & Sitasi Utama:** Makoto Mizuno (2025). *Evolutionary Economics and Social Complexity Science*. DOI: [10.1007/978-4-431-54874-4_3](10.1007/978-4-431-54874-4_3)  
**Sitasi Pendukung:** Agostino Bruzzone (2021). *Proceedings of the 33rd European Modeling &amp; Simulation Symposium*. DOI: [10.46354/i3m.2021.emss.058](10.46354/i3m.2021.emss.058)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Makoto Mizuno (2025) dalam jurnal *Evolutionary Economics and Social Complexity Science* (DOI: 10.1007/978-4-431-54874-4_3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
