# 6301 — Supply Chain Management & Logistics Engineering: Remanufacturing Modes Selection in Competitive Closed-Loop Supply Chains

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Remanufacturing Modes Selection in Competitive Closed-Loop Supply Chains  
**Jurnal & Sitasi Utama:** Huanyong Zhang, Richong Zhang (2025). *Systems*. DOI: [10.3390/systems13040257](10.3390/systems13040257)  
**Sitasi Pendukung:** Qin Yang, Lin Sun (2024). *Sustainability*. DOI: [10.3390/su16041633](10.3390/su16041633)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Huanyong Zhang, Richong Zhang (2025) dalam jurnal *Systems* (DOI: 10.3390/systems13040257) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qin Yang, Lin Sun (2024) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
