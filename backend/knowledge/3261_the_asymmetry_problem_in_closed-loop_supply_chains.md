# 3261 — Supply Chain Management & Logistics Engineering: The Asymmetry Problem in Closed-Loop Supply Chains: Why Reverse Logistics Is Not Forward Logistics in Reverse

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** The Asymmetry Problem in Closed-Loop Supply Chains: Why Reverse Logistics Is Not Forward Logistics in Reverse  
**Jurnal & Sitasi Utama:** Hemanth Kumar Kolluru, Rohan Pratap Singh, Nijansh Verma (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6566598](10.2139/ssrn.6566598)  
**Sitasi Pendukung:** Haifeng Guo, Bai Li (2022). *2022 34th Chinese Control and Decision Conference (CCDC)*. DOI: [10.1109/ccdc55256.2022.10034001](10.1109/ccdc55256.2022.10034001)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hemanth Kumar Kolluru, Rohan Pratap Singh, Nijansh Verma (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6566598) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "&lt;span&gt;&lt;span&gt;Despite three decades of active research and over 2,000 published articles, the reverse logistics field has not converged on a unified theoretical framework explaining why operations management models designed for forward flows systematically underperform when applied to reverse flows. The dominant modeling approach treats reverse logistics as forward logistics with added uncertainty, re-estimating parameters within existing model architectures — what we term parametric adaptation. We argue that this approach is insufficient when the differences between forward and reverse logistics are structural, requiring modification of decision variables, objective functions, or constraint structures. We formalize the Asymmetry Problem: five structural asymmetries — Input Uncertainty, Value Ambiguity, Temporal Asymmetry, Demand-Supply Inversion, and Governance Fragmentation — that collectively violate core assumptions embedded in standard OM models. We demonstrate that these asymmetries form a sequential cascade in which each creates necessary or amplifying conditions for the next, and develop the Asymmetry Matrix, a diagnostic framework mapping each asymmetry to required modifications across five OM domains. We apply the framework to Savaskan, Bhattacharya, and Van Wassenhove's (2004) canonical closed-loop supply chain model, identifying the structural assumptions each asymmetry violates. The framework is validated through cross-case pattern matching drawing on p"

Penelitian pendukung oleh Haifeng Guo, Bai Li (2022) yang dipublikasikan dalam *2022 34th Chinese Control and Decision Conference (CCDC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
