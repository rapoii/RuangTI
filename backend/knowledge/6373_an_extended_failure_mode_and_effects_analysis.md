# 6373 — Quality Engineering & Reliability Systems: An extended failure mode and effects analysis (FMEA) combining cloud model, AHP and TOPSIS for cargo discharge operation failure

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** An extended failure mode and effects analysis (FMEA) combining cloud model, AHP and TOPSIS for cargo discharge operation failure  
**Jurnal & Sitasi Utama:** Sukru Ilke Sezer (2026). *Ocean Engineering*. DOI: [10.1016/j.oceaneng.2026.125334](10.1016/j.oceaneng.2026.125334)  
**Sitasi Pendukung:** Eka Ayuning Agustin, Hana Catur Wahyuni (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.3034](10.21070/ups.3034)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sukru Ilke Sezer (2026) dalam jurnal *Ocean Engineering* (DOI: 10.1016/j.oceaneng.2026.125334) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Eka Ayuning Agustin, Hana Catur Wahyuni (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
