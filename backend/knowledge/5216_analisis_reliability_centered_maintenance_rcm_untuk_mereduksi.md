# 5216 — Maintenance Engineering & Asset Life Cycle: Analisis Reliability Centered Maintenance (RCM) untuk Mereduksi Downtime Mesin Cement Mill di PT XYZ

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Analisis Reliability Centered Maintenance (RCM) untuk Mereduksi Downtime Mesin Cement Mill di PT XYZ  
**Jurnal & Sitasi Utama:** Annaufal Dzaki Ramadhan, Siti Rahayu, Fibi Eko Putra (2025). *Jurnal KaLIBRASI : Karya Lintas Ilmu Bidang Rekayasa Arsitektur, Sipil, Industri*. DOI: [10.37721/kalibrasi.v8i2.1660](10.37721/kalibrasi.v8i2.1660)  
**Sitasi Pendukung:** Muhamad Fahrurroji Muhamad Fahrurroji (2021). *Industry Xplore*. DOI: [10.36805/teknikindustri.v6i2.1458](10.36805/teknikindustri.v6i2.1458)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Annaufal Dzaki Ramadhan, Siti Rahayu, Fibi Eko Putra (2025) dalam jurnal *Jurnal KaLIBRASI : Karya Lintas Ilmu Bidang Rekayasa Arsitektur, Sipil, Industri* (DOI: 10.37721/kalibrasi.v8i2.1660) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "PT XYZ adalah produsen semen di Indonesia. PT XYZ ini telah memiliki beberapa pabrik di berbagai wilayah yang ada di Indonesia. Cement Mill adalah suatu alat yang menghasilkan semen giling pada tahap terakhir sebelum semen tersebut siap dijual atau dikirim ke packing plant. Faktanya, mesin Cement Mill ini sering mengalami kendala stopdown selama beroperasi.  Hal itu menyebabkan  terjadinya  downtime.  Tujuan yang ingin diraih dari penelitian ini adalah untuk mengurangi downtime mesin Cement Mill. Sehingga permasalahan tersebut tersebut dapat diidentifikasi dan diselesaikan secara sistematis melalui penerapan metode Reliability Centered Maintenance (RCM). Penelitian ini dapat mengidentifikasi akar penyebab downtime dan membuat pilihan perbaikan yang tepat bagi masing-masing peralatan yang rusak. Data kegagalan dikumpulkan menggunakan nilai yang diperoleh dari analisis Failure Mode Effect Analysis (FMEA) dengan Risk Priority Number (RPN) tertinggi, yaitu gearbox, belt conveyor, bucket elevator dan motor listrik. Dari hasil analisa FMEA, komponen tersebut adalah prioritas utama yang perlu dilakukan tindakan lebih lanjut. RCM dapat digunakan untuk mengurangi downtime dan meningkatkan produktivitas mesin dengan menerapkan tindakan yang tepat. Setelah dilakukan perhitungan menggunakan metode RCM, didapatkan dari hasil penjumlahan menghasilkan total persentase berkurangnya downtime sebesar 52,7% pada mesin peralatan Cement Mill."

Penelitian pendukung oleh Muhamad Fahrurroji Muhamad Fahrurroji (2021) yang dipublikasikan dalam *Industry Xplore* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
