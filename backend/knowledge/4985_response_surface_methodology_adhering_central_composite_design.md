# 4985 — Applied Statistics & Stochastic Modeling: Response surface methodology adhering central composite design for the optimization of Zn (II) adsorption using rice husk nanoadsorbent

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Response surface methodology adhering central composite design for the optimization of Zn (II) adsorption using rice husk nanoadsorbent  
**Jurnal & Sitasi Utama:** Mandeep Kaur, Santosh Kumari, Praveen Sharma (2022). *Chemical Physics Letters*. DOI: [10.1016/j.cplett.2022.139684](10.1016/j.cplett.2022.139684)  
**Sitasi Pendukung:** Dhundiraj P. Deshpande, Vivek Rangarajan, Shrikant Nanwatkar (2025). *Indian Chemical Engineer*. DOI: [10.1080/00194506.2025.2536815](10.1080/00194506.2025.2536815)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mandeep Kaur, Santosh Kumari, Praveen Sharma (2022) dalam jurnal *Chemical Physics Letters* (DOI: 10.1016/j.cplett.2022.139684) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
