# 4151 — Production Planning & Inventory Control: Construction Material Management on Project Sites

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Construction Material Management on Project Sites  
**Jurnal & Sitasi Utama:** Uppari Naveen Kumar (2018). *International Journal for Research in Applied Science and Engineering Technology*. DOI: [10.22214/ijraset.2018.1207](10.22214/ijraset.2018.1207)  
**Sitasi Pendukung:** Yuan Bian (2018). *4OR*. DOI: [10.1007/s10288-018-0379-1](10.1007/s10288-018-0379-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Uppari Naveen Kumar (2018) dalam jurnal *International Journal for Research in Applied Science and Engineering Technology* (DOI: 10.22214/ijraset.2018.1207) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Construction industry deserves the second largest one in India. The infrastructure growth of a country depends on the development of construction industry since it teems with ample employment potential. Implementation of infrastructure projects are usually failing in each stage and ultimately failure occur, which leads to cost and time overrun. The innovation of new technology in the construction field is not being adopted in project implementation. So the growth of construction industry is slow. The real problem is construction become difficult since it will not complete with in the budget cost and time and finally leads to project failure as end result. There are many reasons for project failure and some of them are project specific. Studies have indicated that materials constitute about 60% of the total project cost, and control 80% of the project schedule. Hence material has a dominating role in construction. If the material has controlled dynamically the total project cost would be reduced. In this regard, a research methodology has developed to control the material procurement and carrying cost. The methodology adopted has been validated by a computer program and same is found correct and useful for analysis and controlling any type of projects. This paper is written to fill a void created by the absence of proper materials management on construction sites. To managing a productive and cost efficient site efficient material management is very essential. Therefore the pr"

Penelitian pendukung oleh Yuan Bian (2018) yang dipublikasikan dalam *4OR* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
