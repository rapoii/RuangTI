# 3214 — Human Factors & Cognitive Ergonomics: Enhanced Accuracy for Multiclass Mental Workload Detection Using Long Short-Term Memory for Brain–Computer Interface

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Enhanced Accuracy for Multiclass Mental Workload Detection Using Long Short-Term Memory for Brain–Computer Interface  
**Jurnal & Sitasi Utama:** Umer Asgher, Khurram Khalil, Muhammad Jawad Khan (2020). *Frontiers in Neuroscience*. DOI: [10.3389/fnins.2020.00584](10.3389/fnins.2020.00584)  
**Sitasi Pendukung:** Charlotte Marchand, Jozina B. De Graaf, Nathanaël Jarrassé (2021). *Journal of NeuroEngineering and Rehabilitation*. DOI: [10.1186/s12984-021-00953-w](10.1186/s12984-021-00953-w)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Umer Asgher, Khurram Khalil, Muhammad Jawad Khan (2020) dalam jurnal *Frontiers in Neuroscience* (DOI: 10.3389/fnins.2020.00584) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Cognitive workload is one of the widely invoked human factor in the areas of Human Machine Interaction (HMI) and Neuroergonomics. The precise assessment of cognitive and mental workload (MWL) is vital and requires accurate neuroimaging to monitor and evaluate the cognitive states of brain. In this study, we have decoded four classes of mental workload (MWL) using long-short term memory (LSTM) with 89.31% average accuracy for brain-Computer Interface (BCI). The brain activity signals are acquired using functional Near-Infrared Spectroscopy (fNIRS) from the prefrontal cortex (PFC) region of brain. We performed a supervised MWL experimentation with four varying MWL levels on 15 participants (both male and female) and 10 trials of each MWL per participant. Real-time four-level MWL states are assessed using fNIRS system and initial classification is performed using three strong machine learning (ML) techniques, Support Vector Machine (SVM), k-Nearest Neighbor (k-NN) and Artificial Neural Network (ANN) with obtained average accuracies of 54.33%, 54.31%, and 69.36% respectively. In this study, novel Deep learning (DL) frameworks are proposed which utilizes Convolutional Neural Network (CNN) and Long Short-Term Memory (LSTM) with 87.45% and 89.31% average accuracies respectively, to solve high-dimensional four-level cognitive states classification problem. Statistical analysis, t- test and one-way F-test (ANOVA) is also performed on accuracies obtained through machine and deep learni"

Penelitian pendukung oleh Charlotte Marchand, Jozina B. De Graaf, Nathanaël Jarrassé (2021) yang dipublikasikan dalam *Journal of NeuroEngineering and Rehabilitation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
