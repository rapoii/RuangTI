# 4237 — Operations Research & Large-Scale Optimization: Reformulations and an exact algorithm for unrelated parallel machine scheduling problems with setup times

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Reformulations and an exact algorithm for unrelated parallel machine scheduling problems with setup times  
**Jurnal & Sitasi Utama:** Luis Fanjul-Peyro, Rubén Ruíz, Federico Perea (2018). *Computers & Operations Research*. DOI: [10.1016/j.cor.2018.07.007](10.1016/j.cor.2018.07.007)  
**Sitasi Pendukung:** Jiehong Kong, Hans Ivar Skjelbred, Olav Bjarte Fosso (2019). *Electric Power Systems Research*. DOI: [10.1016/j.epsr.2019.106027](10.1016/j.epsr.2019.106027)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Luis Fanjul-Peyro, Rubén Ruíz, Federico Perea (2018) dalam jurnal *Computers & Operations Research* (DOI: 10.1016/j.cor.2018.07.007) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jiehong Kong, Hans Ivar Skjelbred, Olav Bjarte Fosso (2019) yang dipublikasikan dalam *Electric Power Systems Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
