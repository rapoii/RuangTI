# 4820 — Production Planning & Inventory Control: Mixed-Integer Linear Programming Model for Stochastic Capacitated Lot-Sizing Problem Under Static-Dynamic Uncertainty Strategy

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Mixed-Integer Linear Programming Model for Stochastic Capacitated Lot-Sizing Problem Under Static-Dynamic Uncertainty Strategy  
**Jurnal & Sitasi Utama:** Heng Chheang, Nuanpan Buransri (2022). *2022 International Conference on Decision Aid Sciences and Applications (DASA)*. DOI: [10.1109/dasa54658.2022.9765178](10.1109/dasa54658.2022.9765178)  
**Sitasi Pendukung:** Rami As'ad, Moncer Hariga, Abdulrahim Shamayleh (2020). *Computers &amp; Industrial Engineering*. DOI: [10.1016/j.cie.2020.106800](10.1016/j.cie.2020.106800)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Heng Chheang, Nuanpan Buransri (2022) dalam jurnal *2022 International Conference on Decision Aid Sciences and Applications (DASA)* (DOI: 10.1109/dasa54658.2022.9765178) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Rami As'ad, Moncer Hariga, Abdulrahim Shamayleh (2020) yang dipublikasikan dalam *Computers &amp; Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
