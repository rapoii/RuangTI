# 5324 — Industrial Artificial Intelligence & Data Analytics: YOLOv8-BVC: Lightweight Industrial Defect Detection

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** YOLOv8-BVC: Lightweight Industrial Defect Detection  
**Jurnal & Sitasi Utama:** Xiaojie Huang, Peng Han, Yutong Fu (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603960](10.1109/cvidl62147.2024.10603960)  
**Sitasi Pendukung:** Shilpa Sondkar, Atharva Umate, Arpita Waghmode (2026). *2026 IEEE 6th International Conference on VLSI Systems, Architecture, Technology and Applications (VLSI SATA)*. DOI: [10.1109/vlsisata69163.2026.11610521](10.1109/vlsisata69163.2026.11610521)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiaojie Huang, Peng Han, Yutong Fu (2024) dalam jurnal *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl62147.2024.10603960) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shilpa Sondkar, Atharva Umate, Arpita Waghmode (2026) yang dipublikasikan dalam *2026 IEEE 6th International Conference on VLSI Systems, Architecture, Technology and Applications (VLSI SATA)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
