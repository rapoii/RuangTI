# 5064 — Simulation Modeling & Digital Twins: Supply Chain Resilience Optimization with Agent-Based Modeling (SCROAM): A Novel Hybrid Framework

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Supply Chain Resilience Optimization with Agent-Based Modeling (SCROAM): A Novel Hybrid Framework  
**Jurnal & Sitasi Utama:** Anastasia Anagnostou, Kate Mintram, Simon J E Taylor (2024). *2024 Winter Simulation Conference (WSC)*. DOI: [10.1109/wsc63780.2024.10838624](10.1109/wsc63780.2024.10838624)  
**Sitasi Pendukung:** Petri Helo, Javad Rouzafzoon (2023). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2023.100042](10.1016/j.sca.2023.100042)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anastasia Anagnostou, Kate Mintram, Simon J E Taylor (2024) dalam jurnal *2024 Winter Simulation Conference (WSC)* (DOI: 10.1109/wsc63780.2024.10838624) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Petri Helo, Javad Rouzafzoon (2023) yang dipublikasikan dalam *Supply Chain Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
