# 4817 — Production Planning & Inventory Control: Optimasi Persediaan Barang dengan Pendekatan Theory Of Constraints, Heuristic Silver Meal, dan Least Unit Cost untuk Meminimalkan Biaya

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Optimasi Persediaan Barang dengan Pendekatan Theory Of Constraints, Heuristic Silver Meal, dan Least Unit Cost untuk Meminimalkan Biaya  
**Jurnal & Sitasi Utama:** Selvia Antinah (2024). *Journal of Industrial and Engineering System*. DOI: [10.31599/1vggd716](10.31599/1vggd716)  
**Sitasi Pendukung:** Winda Winda Dwi agustin (2024). *JUSTI (Jurnal Sistem dan Teknik Industri)*. DOI: [10.30587/justicb.v4i4.8217](10.30587/justicb.v4i4.8217)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Selvia Antinah (2024) dalam jurnal *Journal of Industrial and Engineering System* (DOI: 10.31599/1vggd716) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The aim of this research is to carry out inventory control and determine the results of optimal inventory costs using the Theory of Constraints (TOC), Silver Meal Heuristic and Least Unit Cost approaches to minimize costs. The method used in this research, namely Theory of Constraints (TOC), is a management approach that aims to identify and overcome obstacles or constraints that limit company productivity and efficiency. The Silver Meal heuristic in selecting the optimal lot size is by looking at the minimum cost of each period, while the Least Unit Cost looks at the minimum cost of each unit, both methods for determining the number of orders and appropriate inventory planning. The Heuristic Silver Meal and Least Unit Cost methods can minimize storage costs by ordering raw materials 12 times in one year, compared to the company's previous policy of placing orders 6 times in one year so that the company can reduce storage costs by IDR. 5,750,220,504."

Penelitian pendukung oleh Winda Winda Dwi agustin (2024) yang dipublikasikan dalam *JUSTI (Jurnal Sistem dan Teknik Industri)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
