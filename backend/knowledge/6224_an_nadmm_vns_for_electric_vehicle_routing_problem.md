# 6224 — Operations Research & Large-Scale Optimization: An Nadmm_Vns for Electric Vehicle Routing Problem with Time Windows and Recharging Station

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An Nadmm_Vns for Electric Vehicle Routing Problem with Time Windows and Recharging Station  
**Jurnal & Sitasi Utama:** Bin QIAN, feilong feng, NaiKang Yu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4581247](10.2139/ssrn.4581247)  
**Sitasi Pendukung:** Soukayna Abibou, Dounia El Bourakadi, Ali Yahyaouy (2024). *2024 International Conference on Intelligent Systems and Computer Vision (ISCV)*. DOI: [10.1109/iscv60512.2024.10620156](10.1109/iscv60512.2024.10620156)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bin QIAN, feilong feng, NaiKang Yu (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4581247) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
