# 2989 — Operations Research & Large-Scale Optimization: A computational status update for exact rational mixed integer programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A computational status update for exact rational mixed integer programming  
**Jurnal & Sitasi Utama:** Leon Eifler, Ambros Gleixner (2022). *Mathematical Programming*. DOI: [10.1007/s10107-021-01749-5](10.1007/s10107-021-01749-5)  
**Sitasi Pendukung:** Guodong Liu, Maximiliano Ferrari, Yang Chen (2023). *IET Energy Systems Integration*. DOI: [10.1049/esi2.12103](10.1049/esi2.12103)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Leon Eifler, Ambros Gleixner (2022) dalam jurnal *Mathematical Programming* (DOI: 10.1007/s10107-021-01749-5) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
