# Modul Komprehensif: Kanban Sizing & Supermarket Design untuk Pull Production Systems
**Nomor Modul:** [363]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Toyota Production System (Taiichi Ohno), Lean Thinking (Womack & Jones), International Journal of Lean Six Sigma (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Kanban Sizing & Supermarket Design untuk Pull Production Systems**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Formula Ukuran Jumlah Kartu Kanban Toyota, Container Capacity, Lead Time Siklus Kanban, Safety Factor $\alpha$, Supermarket Min-Max Sizing.
...
```python
# Algoritma Solusi Terapan untuk Kanban Sizing & Supermarket Design untuk Pull Production Systems
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Konversi Sistem Produksi Push Menjadi Two-Card Kanban Supermarket pada Pabrik Komponen Transmisi.
...
1. Toyota Production System (Taiichi Ohno), Lean Thinking (Womack & Jones), International Journal of Lean Six Sigma (2024).
