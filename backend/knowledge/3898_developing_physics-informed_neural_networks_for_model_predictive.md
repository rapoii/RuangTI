# 3898 — Industrial Artificial Intelligence & Data Analytics: Developing physics-informed neural networks for model predictive control of periodic counter-current chromatography

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Developing physics-informed neural networks for model predictive control of periodic counter-current chromatography  
**Jurnal & Sitasi Utama:** Si-Yuan Tang, Yun-Hao Yuan, Yan-Na Sun (2024). *Journal of Chromatography A*. DOI: [10.1016/j.chroma.2024.465514](10.1016/j.chroma.2024.465514)  
**Sitasi Pendukung:** Shaikhah Alkhadhr, Mohamed Almekkawy (2023). *Sensors*. DOI: [10.3390/s23052792](10.3390/s23052792)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Si-Yuan Tang, Yun-Hao Yuan, Yan-Na Sun (2024) dalam jurnal *Journal of Chromatography A* (DOI: 10.1016/j.chroma.2024.465514) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
