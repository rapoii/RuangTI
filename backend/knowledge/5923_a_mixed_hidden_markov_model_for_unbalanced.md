# 5923 — Applied Statistics & Stochastic Modeling: A mixed hidden markov model for unbalanced longitudinal data.

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** A mixed hidden markov model for unbalanced longitudinal data.  
**Jurnal & Sitasi Utama:** Hannah Mitchell (2018). *Research Portal (Queen's University Belfast)*. DOI: [10.openalex/w2943137613](10.openalex/w2943137613)  
