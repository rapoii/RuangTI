# 6294 — Supply Chain Management & Logistics Engineering: Carbon emission reduction and coordination in a closed-loop supply chain with outsourcing remanufacturing

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Carbon emission reduction and coordination in a closed-loop supply chain with outsourcing remanufacturing  
**Jurnal & Sitasi Utama:** Na Wang, Yulin Zhang, Jing Li (2022). *Kybernetes*. DOI: [10.1108/k-11-2020-0800](10.1108/k-11-2020-0800)  
**Sitasi Pendukung:** Yang Li, Zhihui Fan, Xiaomin Zhao (2021). *2021 IEEE International Conference on Recent Advances in Systems Science and Engineering (RASSE)*. DOI: [10.1109/rasse53195.2021.9686926](10.1109/rasse53195.2021.9686926)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Na Wang, Yulin Zhang, Jing Li (2022) dalam jurnal *Kybernetes* (DOI: 10.1108/k-11-2020-0800) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yang Li, Zhihui Fan, Xiaomin Zhao (2021) yang dipublikasikan dalam *2021 IEEE International Conference on Recent Advances in Systems Science and Engineering (RASSE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
