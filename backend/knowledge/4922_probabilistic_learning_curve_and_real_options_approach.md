# 4922 — Engineering Economics & Cost Optimization: Probabilistic learning curve and real options approach to the valuation of cross-training with product life cycle

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Probabilistic learning curve and real options approach to the valuation of cross-training with product life cycle  
**Jurnal & Sitasi Utama:** Thanasiri Muttulingam (2024). *Peer-Reviewed Journal*. DOI: [10.32920/ryerson.14644158](10.32920/ryerson.14644158)  
**Sitasi Pendukung:** Yanping Bao, Chan Lyu (2022). *Economic and Business Management*. DOI: [10.1201/9781003203704-8](10.1201/9781003203704-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thanasiri Muttulingam (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.32920/ryerson.14644158) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yanping Bao, Chan Lyu (2022) yang dipublikasikan dalam *Economic and Business Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
