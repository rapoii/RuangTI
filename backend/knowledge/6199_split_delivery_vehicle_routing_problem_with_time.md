# 6199 — Operations Research & Large-Scale Optimization: Split Delivery Vehicle Routing Problem With Time Windows and Commodity Incompatibility

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Split Delivery Vehicle Routing Problem With Time Windows and Commodity Incompatibility  
**Jurnal & Sitasi Utama:** Zhengquan yang, Defeng Sun, Ren Zhao (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6864487](10.2139/ssrn.6864487)  
**Sitasi Pendukung:** Syeda Fatema Azmi, Chaowalit Hamontree (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4876984](10.2139/ssrn.4876984)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zhengquan yang, Defeng Sun, Ren Zhao (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6864487) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper addresses the Split Delivery Vehicle Routing Problem with Time Windows and Commodity Incompatibility (SDVRPTWCI), a critical challenge observed in the delivery network of a large petrochemical corporation. The objective is to timely transport multiple-type commodities from a central warehouse to customers with consideration of commodity incompatibility, allowing split deliveries to optimize cost efficiency. Given the NP-hard nature of SDVRPTWCI, we propose a Hybrid Genetic Search (HGS) algorithm enhanced by Reinforcement Learning to efficiently tackles the problem. Numerical experiments are conducted to assess the algorithm&amp;apos;s performance and derive managerial insights. The results demonstrate that our proposed algorithm outperforms the state-of-the-art MIP solver (Gurobi) and other benchmark algorithms, delivering high-quality solutions within shorter computation times."

Penelitian pendukung oleh Syeda Fatema Azmi, Chaowalit Hamontree (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
