# 5023 — Applied Statistics & Stochastic Modeling: A statistical modeling-optimization approach for efficiency photocatalytic degradation of textile azo dye using cerium-doped mesoporous ZnO: A central composite design in response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** A statistical modeling-optimization approach for efficiency photocatalytic degradation of textile azo dye using cerium-doped mesoporous ZnO: A central composite design in response surface methodology  
**Jurnal & Sitasi Utama:** Hanane Chaker, Alaa Eddine Attar, Mustapha Djennas (2021). *Chemical Engineering Research and Design*. DOI: [10.1016/j.cherd.2021.05.008](10.1016/j.cherd.2021.05.008)  
**Sitasi Pendukung:** Payal Mazumder, Akhil PM, Jyoti (2021). *Journal of Environmental Management*. DOI: [10.1016/j.jenvman.2021.112461](10.1016/j.jenvman.2021.112461)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hanane Chaker, Alaa Eddine Attar, Mustapha Djennas (2021) dalam jurnal *Chemical Engineering Research and Design* (DOI: 10.1016/j.cherd.2021.05.008) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Payal Mazumder, Akhil PM, Jyoti (2021) yang dipublikasikan dalam *Journal of Environmental Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
