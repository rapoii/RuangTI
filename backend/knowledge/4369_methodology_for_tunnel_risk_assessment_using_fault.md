# 4369 — Safety Engineering & Risk Management: Methodology for tunnel risk assessment using fault and event tree analysis

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Methodology for tunnel risk assessment using fault and event tree analysis  
**Jurnal & Sitasi Utama:** Zlatko Zafirovski, Vasko Gacevski, Zoran Krakutovski (2021). *International Conference on Road and Rail Infrastructure*. DOI: [10.5592/co/cetra.2020.1051](10.5592/co/cetra.2020.1051)  
**Sitasi Pendukung:** Akram Batikh, Mihai Diaconeasa (2025). *19th International Conference on Probabilistic Safety Assessment and Analysis (PSA 2025)*. DOI: [10.13182/xyz-46619](10.13182/xyz-46619)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zlatko Zafirovski, Vasko Gacevski, Zoran Krakutovski (2021) dalam jurnal *International Conference on Road and Rail Infrastructure* (DOI: 10.5592/co/cetra.2020.1051) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
