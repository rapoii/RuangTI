# 5432 — Operations Research & Large-Scale Optimization: Research on transfer schedule optimization of high-speed railway based on benders decomposition algorithm

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Research on transfer schedule optimization of high-speed railway based on benders decomposition algorithm  
**Jurnal & Sitasi Utama:** Wentao Dong (2022). *International Conference on Algorithms, Microchips and Network Applications*. DOI: [10.1117/12.2636519](10.1117/12.2636519)  
**Sitasi Pendukung:** Hailei Gong, Zhi-Hai Zhang (2022). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.04.039](10.1016/j.ejor.2021.04.039)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wentao Dong (2022) dalam jurnal *International Conference on Algorithms, Microchips and Network Applications* (DOI: 10.1117/12.2636519) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
