# 6388 — Quality Engineering & Reliability Systems: Perbaikan Kualitas Collapsible Tube Pada Proses Printing Dengan Metode Failure Mode And Effetc Analysis (FMEA) di PT XYZ

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Perbaikan Kualitas Collapsible Tube Pada Proses Printing Dengan Metode Failure Mode And Effetc Analysis (FMEA) di PT XYZ  
**Jurnal & Sitasi Utama:** Murwan Widyantoro (2024). *Journal of Industrial and Engineering System*. DOI: [10.31599/pb4ev917](10.31599/pb4ev917)  
**Sitasi Pendukung:** Marija Panić, Que Xiaojun (2025). *The Journal of Risk Model Validation*. DOI: [10.21314/jrmv.2025.009](10.21314/jrmv.2025.009)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Murwan Widyantoro (2024) dalam jurnal *Journal of Industrial and Engineering System* (DOI: 10.31599/pb4ev917) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Marija Panić, Que Xiaojun (2025) yang dipublikasikan dalam *The Journal of Risk Model Validation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
