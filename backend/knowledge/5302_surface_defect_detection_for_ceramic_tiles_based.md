# 5302 — Industrial Artificial Intelligence & Data Analytics: Surface Defect Detection for Ceramic Tiles Based on Multi-Anchor Mechanism

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Surface Defect Detection for Ceramic Tiles Based on Multi-Anchor Mechanism  
**Jurnal & Sitasi Utama:** Songsen Yu, Chicheng Zhang, Huan Yang (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603508](10.1109/cvidl62147.2024.10603508)  
**Sitasi Pendukung:** Demin Fu, Jianhui Yi, DeShui Han (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637960](10.1109/cvidl70130.2026.11637960)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Songsen Yu, Chicheng Zhang, Huan Yang (2024) dalam jurnal *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl62147.2024.10603508) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Demin Fu, Jianhui Yi, DeShui Han (2026) yang dipublikasikan dalam *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
