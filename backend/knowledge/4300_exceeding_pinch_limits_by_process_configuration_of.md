# 4300 — Industrial Energy Management & Decarbonization: Exceeding Pinch limits by process configuration of an existing modern crude oil distillation unit – A case study from refining industry

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Exceeding Pinch limits by process configuration of an existing modern crude oil distillation unit – A case study from refining industry  
**Jurnal & Sitasi Utama:** Omar S. Bayomie, Omar Y. Abdelaziz, Mamdouh A. Gadalla (2019). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2019.05.041](10.1016/j.jclepro.2019.05.041)  
**Sitasi Pendukung:** Mohsen Ghaderi, Christopher G. Reddick, Mikhaı̈l Sorin (2023). *Energies*. DOI: [10.3390/en16145493](10.3390/en16145493)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Omar S. Bayomie, Omar Y. Abdelaziz, Mamdouh A. Gadalla (2019) dalam jurnal *Journal of Cleaner Production* (DOI: 10.1016/j.jclepro.2019.05.041) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
