# 5911 — Applied Statistics & Stochastic Modeling: Automated compositional importance splitting

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Automated compositional importance splitting  
**Jurnal & Sitasi Utama:** Carlos E. Budde, Pedro R. D’Argenio, Arnd Hartmanns (2019). *Science of Computer Programming*. DOI: [10.1016/j.scico.2019.01.006](10.1016/j.scico.2019.01.006)  
**Sitasi Pendukung:** Angelos Aveklouris, Maria Vlasiou, Bert Zwart (2019). *IEEE Transactions on Control of Network Systems*. DOI: [10.1109/tcns.2019.2915651](10.1109/tcns.2019.2915651)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Carlos E. Budde, Pedro R. D’Argenio, Arnd Hartmanns (2019) dalam jurnal *Science of Computer Programming* (DOI: 10.1016/j.scico.2019.01.006) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Angelos Aveklouris, Maria Vlasiou, Bert Zwart (2019) yang dipublikasikan dalam *IEEE Transactions on Control of Network Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
