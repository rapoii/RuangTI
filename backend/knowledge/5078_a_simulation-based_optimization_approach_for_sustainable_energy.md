# 5078 — Simulation Modeling & Digital Twins: A simulation-based optimization approach for sustainable energy supply chain transitions

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** A simulation-based optimization approach for sustainable energy supply chain transitions  
**Jurnal & Sitasi Utama:** Zakka Ugih Rizqi (2025). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2025.100150](10.1016/j.sca.2025.100150)  
**Sitasi Pendukung:** Douglas S Thomas, Jennifer Helgeson, Ireland Crowther (2025). *Peer-Reviewed Journal*. DOI: [10.6028/nist.ams.100-71](10.6028/nist.ams.100-71)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zakka Ugih Rizqi (2025) dalam jurnal *Supply Chain Analytics* (DOI: 10.1016/j.sca.2025.100150) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Douglas S Thomas, Jennifer Helgeson, Ireland Crowther (2025) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
