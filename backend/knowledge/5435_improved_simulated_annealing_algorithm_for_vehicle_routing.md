# 5435 — Operations Research & Large-Scale Optimization: Improved Simulated Annealing Algorithm for Vehicle Routing Problem with Multiple Time Windows using Column Generation

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Improved Simulated Annealing Algorithm for Vehicle Routing Problem with Multiple Time Windows using Column Generation  
**Jurnal & Sitasi Utama:** Siqi Tu, Shurong Li, Zhe Liu (2020). *2020 39th Chinese Control Conference (CCC)*. DOI: [10.23919/ccc50068.2020.9189282](10.23919/ccc50068.2020.9189282)  
**Sitasi Pendukung:** Stefan Voigt, Markus Frank, Pirmin Fontaine (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4176106](10.2139/ssrn.4176106)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Siqi Tu, Shurong Li, Zhe Liu (2020) dalam jurnal *2020 39th Chinese Control Conference (CCC)* (DOI: 10.23919/ccc50068.2020.9189282) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Stefan Voigt, Markus Frank, Pirmin Fontaine (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
