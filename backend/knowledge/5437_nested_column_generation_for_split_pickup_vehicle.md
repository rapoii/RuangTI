# 5437 — Operations Research & Large-Scale Optimization: Nested column generation for split pickup vehicle routing problem with time windows and time-dependent demand

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Nested column generation for split pickup vehicle routing problem with time windows and time-dependent demand  
**Jurnal & Sitasi Utama:** Shiping Wu, Hongguang Bo, Chun Jin (2024). *Computers &amp; Operations Research*. DOI: [10.1016/j.cor.2023.106523](10.1016/j.cor.2023.106523)  
**Sitasi Pendukung:** Wissam Marrouche, Haidar Harmanani (2021). *Proceedings of the 13th International Joint Conference on Computational Intelligence*. DOI: [10.5220/0010640900003063](10.5220/0010640900003063)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shiping Wu, Hongguang Bo, Chun Jin (2024) dalam jurnal *Computers &amp; Operations Research* (DOI: 10.1016/j.cor.2023.106523) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wissam Marrouche, Haidar Harmanani (2021) yang dipublikasikan dalam *Proceedings of the 13th International Joint Conference on Computational Intelligence* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
