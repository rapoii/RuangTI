# 4354 — Safety Engineering & Risk Management: Identification of K3 (occupational safety and health) risk factors in cargo handling processes at PT. PELINDO 4 branch Samarinda using the hazard analysis and operability study (HAZOP) method

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Identification of K3 (occupational safety and health) risk factors in cargo handling processes at PT. PELINDO 4 branch Samarinda using the hazard analysis and operability study (HAZOP) method  
**Jurnal & Sitasi Utama:** Dharma Widada, Masayu Widiastuti (2026). *AIP Conference Proceedings*. DOI: [10.1063/5.0334355](10.1063/5.0334355)  
**Sitasi Pendukung:** Alfanny Kuswanda, Solichin ., Ema Novita Deniati (2021). *KnE Life Sciences*. DOI: [10.18502/kls.v0i0.8888](10.18502/kls.v0i0.8888)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dharma Widada, Masayu Widiastuti (2026) dalam jurnal *AIP Conference Proceedings* (DOI: 10.1063/5.0334355) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Alfanny Kuswanda, Solichin ., Ema Novita Deniati (2021) yang dipublikasikan dalam *KnE Life Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
