# 3869 — Industrial Artificial Intelligence & Data Analytics: Single-track thermal analysis of laser powder bed fusion process: Parametric solution through physics-informed neural networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Single-track thermal analysis of laser powder bed fusion process: Parametric solution through physics-informed neural networks  
**Jurnal & Sitasi Utama:** E. Hosseini, Pooriya Scheel, O. Müller (2023). *Computer Methods in Applied Mechanics and Engineering*. DOI: [10.1016/j.cma.2023.116019](10.1016/j.cma.2023.116019)  
**Sitasi Pendukung:** Lu Lu, Raphaël Pestourie, Wenjie Yao (2021). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2102.04626](10.48550/arxiv.2102.04626)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari E. Hosseini, Pooriya Scheel, O. Müller (2023) dalam jurnal *Computer Methods in Applied Mechanics and Engineering* (DOI: 10.1016/j.cma.2023.116019) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lu Lu, Raphaël Pestourie, Wenjie Yao (2021) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
