# 5320 — Industrial Artificial Intelligence & Data Analytics: Carrot defect detection and grading based on computer vision and deep learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Carrot defect detection and grading based on computer vision and deep learning  
**Jurnal & Sitasi Utama:** Limiao Deng (2022). *Cognitive and Neural Modelling for Visual Information Representation and Memorization*. DOI: [10.1201/9781003281641-9](10.1201/9781003281641-9)  
**Sitasi Pendukung:** Chunliang Gu, Xinying Yu, Zhenzhen Huang (2024). *2024 International Conference on Image Processing, Computer Vision and Machine Learning (ICICML)*. DOI: [10.1109/icicml63543.2024.10957949](10.1109/icicml63543.2024.10957949)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Limiao Deng (2022) dalam jurnal *Cognitive and Neural Modelling for Visual Information Representation and Memorization* (DOI: 10.1201/9781003281641-9) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chunliang Gu, Xinying Yu, Zhenzhen Huang (2024) yang dipublikasikan dalam *2024 International Conference on Image Processing, Computer Vision and Machine Learning (ICICML)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
