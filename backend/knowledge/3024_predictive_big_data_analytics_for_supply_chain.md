# 3024 — Supply Chain Management & Logistics Engineering: Predictive big data analytics for supply chain demand forecasting: methods, applications, and research opportunities

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Predictive big data analytics for supply chain demand forecasting: methods, applications, and research opportunities  
**Jurnal & Sitasi Utama:** Mahya Seyedan, Fereshteh Mafakheri (2020). *Journal Of Big Data*. DOI: [10.1186/s40537-020-00329-2](10.1186/s40537-020-00329-2)  
**Sitasi Pendukung:** Ziyue Chen, Lizhen Huang (2020). *Energy*. DOI: [10.1016/j.energy.2020.119712](10.1016/j.energy.2020.119712)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahya Seyedan, Fereshteh Mafakheri (2020) dalam jurnal *Journal Of Big Data* (DOI: 10.1186/s40537-020-00329-2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ziyue Chen, Lizhen Huang (2020) yang dipublikasikan dalam *Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
