# 3528 — Production Planning & Inventory Control: Material Requirement Planning (MRP) Pada Pekerjaan Proyek Peningkatan Jalan Klasari-Wonosobo Kabupaten Sorong

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Material Requirement Planning (MRP) Pada Pekerjaan Proyek Peningkatan Jalan Klasari-Wonosobo Kabupaten Sorong  
**Jurnal & Sitasi Utama:** Frans Howay, Hanafi Ashad, Watono (2025). *Jurnal TESLINK Teknik Sipil dan Lingkungan*. DOI: [10.52005/teslink.v1i1.575](10.52005/teslink.v1i1.575)  
**Sitasi Pendukung:** Witold Torbacki (2021). *Sustainability*. DOI: [10.3390/su13168833](10.3390/su13168833)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Frans Howay, Hanafi Ashad, Watono (2025) dalam jurnal *Jurnal TESLINK Teknik Sipil dan Lingkungan* (DOI: 10.52005/teslink.v1i1.575) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Material mobilization in Eastern Indonesia is different from other locations, difficult road access will cause large shipping prices, so it can affect the increase in the price of a material. The success of a construction work cannot be separated from the optimization of the implementation of three main components, namely cost, time and quality. Each component plays an important role and is interdependent with each other. One of the methods that may be used in material procurement planning is Material Requirement Planning or called MRP. From the problem of scheduling the arrival of materials in the Klasari – Wonosobo Road Improvement project, Sorong Regency, MRP (Material Requirement Planning) can be analyzed, starting with making project scheduling and then continuing with planning the ordering of materials needed during the project with the lot sizing method to produce more efficient material supply time so that it can be used and applied by contractors to plan more material purchases effective and efficient. The results of the research were the material needs of concrete road structures and talud structures in the Klasari-Wonosobo road improvement project in Sorong Regency using the requirement planning method, 925,161 kg of cement material was obtained; rough ggregate ; 2,288,752.50 kg ; Fine agregate 1,545,822 kg ; U24 plain iron 20,259.44 kg; U32 threaded iron 3,181.73 kg and water 490,074 liters. The material that is broken down is cement; rough agregate ; smooth agreg"

Penelitian pendukung oleh Witold Torbacki (2021) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
