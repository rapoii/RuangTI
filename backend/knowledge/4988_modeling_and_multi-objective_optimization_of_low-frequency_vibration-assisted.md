# 4988 — Applied Statistics & Stochastic Modeling: Modeling and multi-objective optimization of low-frequency vibration-assisted chemical machining using central composite design in response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Modeling and multi-objective optimization of low-frequency vibration-assisted chemical machining using central composite design in response surface methodology  
**Jurnal & Sitasi Utama:** J. Rahmani, M. M. Mohamamdi, R. Khamedi (2023). *Scientia Iranica*. DOI: [10.24200/sci.2023.59618.6339](10.24200/sci.2023.59618.6339)  
**Sitasi Pendukung:** Soumitra Maiti, Basheshwer Prasad, Ashwani Kumar Minocha (2020). *SN Applied Sciences*. DOI: [10.1007/s42452-020-03892-8](10.1007/s42452-020-03892-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari J. Rahmani, M. M. Mohamamdi, R. Khamedi (2023) dalam jurnal *Scientia Iranica* (DOI: 10.24200/sci.2023.59618.6339) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Soumitra Maiti, Basheshwer Prasad, Ashwani Kumar Minocha (2020) yang dipublikasikan dalam *SN Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
