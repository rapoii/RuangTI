# 5513 — Quality Engineering & Reliability Systems: Multivariate Hotelling T2 Control Chart for Monitoring Some Quality Characteristics in Medium Density Fiberboard Manufacturing Process

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Multivariate Hotelling T2 Control Chart for Monitoring Some Quality Characteristics in Medium Density Fiberboard Manufacturing Process  
**Jurnal & Sitasi Utama:** Sebahattin Tiryaki, Aytaç Aydin (2022). *Drvna industrija*. DOI: [10.5552/drvind.2022.2046](10.5552/drvind.2022.2046)  
**Sitasi Pendukung:** Aamir Saghir, Attila Imre Katona, Zsolt Tibor Kosztyan (2023). *CRAN: Contributed Packages*. DOI: [10.32614/cran.package.rbcc](10.32614/cran.package.rbcc)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sebahattin Tiryaki, Aytaç Aydin (2022) dalam jurnal *Drvna industrija* (DOI: 10.5552/drvind.2022.2046) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
