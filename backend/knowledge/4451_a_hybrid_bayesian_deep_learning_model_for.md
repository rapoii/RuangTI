# 4451 — Maintenance Engineering & Asset Life Cycle: A Hybrid Bayesian Deep Learning Model for Remaining Useful Life Prognostics and Uncertainty Quantification

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** A Hybrid Bayesian Deep Learning Model for Remaining Useful Life Prognostics and Uncertainty Quantification  
**Jurnal & Sitasi Utama:** Dengshan Huang, Rui Bai, Shuai Zhao (2021). *2021 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm51084.2021.9486527](10.1109/icphm51084.2021.9486527)  
**Sitasi Pendukung:** Yilin Wang, Yuanxiang Li, Yuxuan Zhang (2021). *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)*. DOI: [10.1109/phm-nanjing52125.2021.9612945](10.1109/phm-nanjing52125.2021.9612945)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dengshan Huang, Rui Bai, Shuai Zhao (2021) dalam jurnal *2021 IEEE International Conference on Prognostics and Health Management (ICPHM)* (DOI: 10.1109/icphm51084.2021.9486527) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yilin Wang, Yuanxiang Li, Yuxuan Zhang (2021) yang dipublikasikan dalam *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
