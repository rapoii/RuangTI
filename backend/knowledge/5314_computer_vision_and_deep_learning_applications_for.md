# 5314 — Industrial Artificial Intelligence & Data Analytics: COMPUTER VISION AND DEEP LEARNING APPLICATIONS FOR ROAD SURFACE DEFECT DETECTION: A NARRATIVE REVIEW

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** COMPUTER VISION AND DEEP LEARNING APPLICATIONS FOR ROAD SURFACE DEFECT DETECTION: A NARRATIVE REVIEW  
**Jurnal & Sitasi Utama:** Ummu Najwa Nur Yusrizal, Noram Noram Irwan Ramli, Putri Zulaiha Razi (2026). *International Journal of Computer Graphics &amp; Animation*. DOI: [10.5121/ijcga.2026.16302](10.5121/ijcga.2026.16302)  
**Sitasi Pendukung:** Srujan Hrudhay Geddam (2024). *Peer-Reviewed Journal*. DOI: [10.31224/6685](10.31224/6685)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ummu Najwa Nur Yusrizal, Noram Noram Irwan Ramli, Putri Zulaiha Razi (2026) dalam jurnal *International Journal of Computer Graphics &amp; Animation* (DOI: 10.5121/ijcga.2026.16302) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Defects on road surfaces, such as potholes and pavement cracks, significantly influence the road safety, driving comfort and road inspection processes. Modern technological innovations like computer vision and deep learning enable the development of automated systems of road surface defects that can increase accuracy and reduce manual inspections. This paper provides a narrative analysis of 25 studies carried out between 2021 and 2026 regarding the detection of road surface defects. The literature analysis is synthesised considering the approaches of defect detection, segmentation methods, advanced deep learning, characteristics of performance, and future areas of research. The results indicated that YOLObased models dominate current research due to their high detection accuracy and real-time processing capability, while segmentation and transformer-based approaches provide more detailed defect representation. However, certain issues still arise concerning environment variability, limitations of datasets, complex computational nature and generalisation of models. The review highlights current research trends and future opportunities for developing more intelligent road defect detection systems."

Penelitian pendukung oleh Srujan Hrudhay Geddam (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
