# 5052 — Simulation Modeling & Digital Twins: Modeling Risk Prioritization of a Manufacturing Supply Chain using Discrete Event Simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Modeling Risk Prioritization of a Manufacturing Supply Chain using Discrete Event Simulation  
**Jurnal & Sitasi Utama:** Arpita Chari, Silvan Marti, Björn Johansson (2023). *2023 Winter Simulation Conference (WSC)*. DOI: [10.1109/wsc60868.2023.10407643](10.1109/wsc60868.2023.10407643)  
**Sitasi Pendukung:** Andrew Greasley (2022). *Simulation Modelling*. DOI: [10.4324/9781003124092-12](10.4324/9781003124092-12)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Arpita Chari, Silvan Marti, Björn Johansson (2023) dalam jurnal *2023 Winter Simulation Conference (WSC)* (DOI: 10.1109/wsc60868.2023.10407643) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Andrew Greasley (2022) yang dipublikasikan dalam *Simulation Modelling* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
