# 5076 — Simulation Modeling & Digital Twins: Modeling and Simulation of a Multi-agent Green Supply Chain Management System for Retailers

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Modeling and Simulation of a Multi-agent Green Supply Chain Management System for Retailers  
**Jurnal & Sitasi Utama:** Danfeng Wei (2020). *Journal Européen des Systèmes Automatisés*. DOI: [10.18280/jesa.530414](10.18280/jesa.530414)  
**Sitasi Pendukung:** Ya Yang (2025). *Advances in Engineering Technology Research*. DOI: [10.56028/aetr.13.1.299.2025](10.56028/aetr.13.1.299.2025)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Danfeng Wei (2020) dalam jurnal *Journal Européen des Systèmes Automatisés* (DOI: 10.18280/jesa.530414) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ya Yang (2025) yang dipublikasikan dalam *Advances in Engineering Technology Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
