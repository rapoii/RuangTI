# 5512 — Quality Engineering & Reliability Systems: Multivariate statistical process monitoring and control of machining process using principal component-based Hotelling T&lt;SUP align="right"&gt;2&lt;/SUP&gt; charts: a machine vision approach

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Multivariate statistical process monitoring and control of machining process using principal component-based Hotelling T&lt;SUP align="right"&gt;2&lt;/SUP&gt; charts: a machine vision approach  
**Jurnal & Sitasi Utama:** Ketaki Joshi, Bhushan Patil (2022). *International Journal of Productivity and Quality Management*. DOI: [10.1504/ijpqm.2022.120709](10.1504/ijpqm.2022.120709)  
**Sitasi Pendukung:** Sebahattin Tiryaki, Aytaç Aydin (2022). *Drvna industrija*. DOI: [10.5552/drvind.2022.2046](10.5552/drvind.2022.2046)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ketaki Joshi, Bhushan Patil (2022) dalam jurnal *International Journal of Productivity and Quality Management* (DOI: 10.1504/ijpqm.2022.120709) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sebahattin Tiryaki, Aytaç Aydin (2022) yang dipublikasikan dalam *Drvna industrija* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
