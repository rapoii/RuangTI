# 3339 — Manufacturing Systems & Cyber-Physical Production: Dynamic Lean 4.0 Cyber-Physical System for Polymeric Products Manufacturing in Industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Dynamic Lean 4.0 Cyber-Physical System for Polymeric Products Manufacturing in Industry 4.0  
**Jurnal & Sitasi Utama:** D-S Ionel, C Gh Opran (2021). *IOP Conference Series Materials Science and Engineering*. DOI: [10.1088/1757-899x/1182/1/012030](10.1088/1757-899x/1182/1/012030)  
**Sitasi Pendukung:** Amon Göppert, Lea Grahn, Jonas Rachner (2021). *Journal of Intelligent Manufacturing*. DOI: [10.1007/s10845-021-01860-6](10.1007/s10845-021-01860-6)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari D-S Ionel, C Gh Opran (2021) dalam jurnal *IOP Conference Series Materials Science and Engineering* (DOI: 10.1088/1757-899x/1182/1/012030) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract In the polymer products industry, the adoption of the intelligent production system offers solutions to increase automation and reduce the complexity of manufacturing processes. Simultaneously with the emergence and development of the Industry 4.0 concept and techniques, numerous approaches have appeared in order to implement Lean principles and tools at the intelligent production system level, with the main purpose of increasing efficiency and eliminating waste. Lean 4.0 architectures rely on the physical and digital resources of Industry 4.0, which can be active (directly involved in the production processes of the product) and passive (which have a supporting role). The implementation of Lean 4.0 principles is based on Lean 4.0 tools, defined at cybernetic level, and on the corresponding physical assets, which intervene in the management of the production flow. The objective of this paperwork is to present the realization and implementation framework of the cyber-physical system Lean 4.0 at the manufacturing cell level into an Industry 4.0 production system."

Penelitian pendukung oleh Amon Göppert, Lea Grahn, Jonas Rachner (2021) yang dipublikasikan dalam *Journal of Intelligent Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
