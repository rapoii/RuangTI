# 3546 — Production Planning & Inventory Control: Release date optimisation in MRP using clearing functions

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Release date optimisation in MRP using clearing functions  
**Jurnal & Sitasi Utama:** Wolfgang Seiringer, Klaus Altendorfer, Reha Uzsoy (2026). *International Journal of Production Research*. DOI: [10.1080/00207543.2026.2625240](10.1080/00207543.2026.2625240)  
**Sitasi Pendukung:** Reni Amaranti, Chaznin R. Muhammad, Milda Viani Septandri (2020). *IOP Conference Series Materials Science and Engineering*. DOI: [10.1088/1757-899x/830/4/042003](10.1088/1757-899x/830/4/042003)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wolfgang Seiringer, Klaus Altendorfer, Reha Uzsoy (2026) dalam jurnal *International Journal of Production Research* (DOI: 10.1080/00207543.2026.2625240) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper integrates a clearing function (CF)-based release planning approach into Material Requirements Planning (MRP) to address its limitations in modelling capacity constraints and dynamic lead times. The proposed optimisation model replaces MRP’s backward scheduling step while preserving its overall structure. Performance is evaluated through simulation experiments on two flow shop systems that explore a range of demand uncertainties and utilisation levels. Computational results show that the proposed approach is capable of yielding significant improvements over the conventional backward scheduling approach, due to its ability to compute planned lead times for individual production orders as opposed to BOM items."

Penelitian pendukung oleh Reni Amaranti, Chaznin R. Muhammad, Milda Viani Septandri (2020) yang dipublikasikan dalam *IOP Conference Series Materials Science and Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
