# 4976 — Applied Statistics & Stochastic Modeling: Modelling and Optimization of Thermal Expansion and Thermal Conductivity Using Face Centered Central Composite Design Based Response Surface Methodology: An Experimental Approach

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Modelling and Optimization of Thermal Expansion and Thermal Conductivity Using Face Centered Central Composite Design Based Response Surface Methodology: An Experimental Approach  
**Jurnal & Sitasi Utama:** Gurukarthik Babu Balachandran, Vishnu Karan Baskaran, Hariharasudhan Thangaraj (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4637712](10.2139/ssrn.4637712)  
**Sitasi Pendukung:** Ameh, C. U., Eterigho, E. J., Musa A. A. (2022). *SCIREA Journal of Chemical Engineering*. DOI: [10.54647/chemical53039](10.54647/chemical53039)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gurukarthik Babu Balachandran, Vishnu Karan Baskaran, Hariharasudhan Thangaraj (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4637712) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ameh, C. U., Eterigho, E. J., Musa A. A. (2022) yang dipublikasikan dalam *SCIREA Journal of Chemical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
