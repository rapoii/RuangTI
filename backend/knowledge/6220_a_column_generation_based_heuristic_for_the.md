# 6220 — Operations Research & Large-Scale Optimization: A column generation based heuristic for the generalized vehicle routing problem with time windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A column generation based heuristic for the generalized vehicle routing problem with time windows  
**Jurnal & Sitasi Utama:** Yuan Yuan, Diego Cattaruzza, Maxime Ogier (2021). *Transportation Research Part E: Logistics and Transportation Review*. DOI: [10.1016/j.tre.2021.102391](10.1016/j.tre.2021.102391)  
**Sitasi Pendukung:** Md Anisul Islam, Yuvraj Gajpal, Tarek Y. Elmekkawy (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5027102](10.2139/ssrn.5027102)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuan Yuan, Diego Cattaruzza, Maxime Ogier (2021) dalam jurnal *Transportation Research Part E: Logistics and Transportation Review* (DOI: 10.1016/j.tre.2021.102391) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Md Anisul Islam, Yuvraj Gajpal, Tarek Y. Elmekkawy (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
