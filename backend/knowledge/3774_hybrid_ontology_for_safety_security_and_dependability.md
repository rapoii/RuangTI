# 3774 — Safety Engineering & Risk Management: Hybrid ontology for safety, security, and dependability risk assessments and Security Threat Analysis (STA) method for industrial control systems

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Hybrid ontology for safety, security, and dependability risk assessments and Security Threat Analysis (STA) method for industrial control systems  
**Jurnal & Sitasi Utama:** Jarmo Alanen, Joonas Linnosmaa, Timo Malm (2021). *Reliability Engineering & System Safety*. DOI: [10.1016/j.ress.2021.108270](10.1016/j.ress.2021.108270)  
**Sitasi Pendukung:** Nelson H. Carreras Guzman, Igor Kozine, Mary Ann Lundteigen (2021). *Safety Science*. DOI: [10.1016/j.ssci.2021.105458](10.1016/j.ssci.2021.105458)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jarmo Alanen, Joonas Linnosmaa, Timo Malm (2021) dalam jurnal *Reliability Engineering & System Safety* (DOI: 10.1016/j.ress.2021.108270) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nelson H. Carreras Guzman, Igor Kozine, Mary Ann Lundteigen (2021) yang dipublikasikan dalam *Safety Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
