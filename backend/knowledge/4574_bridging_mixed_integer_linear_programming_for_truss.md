# 4574 — Operations Research & Large-Scale Optimization: Bridging mixed integer linear programming for truss topology optimization and additive manufacturing

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Bridging mixed integer linear programming for truss topology optimization and additive manufacturing  
**Jurnal & Sitasi Utama:** Christian Reintjes, Ulf Lorenz (2021). *Optimization and Engineering*. DOI: [10.1007/s11081-020-09541-8](10.1007/s11081-020-09541-8)  
**Sitasi Pendukung:** Mohammad A. M. Abdel Aal (2024). *International Journal of Industrial Engineering Computations*. DOI: [10.5267/j.ijiec.2023.10.001](10.5267/j.ijiec.2023.10.001)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Christian Reintjes, Ulf Lorenz (2021) dalam jurnal *Optimization and Engineering* (DOI: 10.1007/s11081-020-09541-8) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
