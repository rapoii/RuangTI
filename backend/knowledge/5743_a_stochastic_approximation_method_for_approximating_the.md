# 5743 — Operations Research & Large-Scale Optimization: A stochastic approximation method for approximating the efficient frontier of chance-constrained nonlinear programs

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A stochastic approximation method for approximating the efficient frontier of chance-constrained nonlinear programs  
**Jurnal & Sitasi Utama:** Rohit Kannan, James R. Luedtke (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00199-y](10.1007/s12532-020-00199-y)  
**Sitasi Pendukung:** Anirudh Subramanyam (2023). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_788-1](10.1007/978-3-030-54621-2_788-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rohit Kannan, James R. Luedtke (2021) dalam jurnal *Mathematical Programming Computation* (DOI: 10.1007/s12532-020-00199-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Anirudh Subramanyam (2023) yang dipublikasikan dalam *Encyclopedia of Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
