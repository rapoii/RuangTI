# 4692 — Facilities Planning & Material Handling: Travel time model for multiple-deep shuttle-based storage and retrieval systems

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Travel time model for multiple-deep shuttle-based storage and retrieval systems  
**Jurnal & Sitasi Utama:** Nenad Kosanić, Jakob Marolt, Nenad Zrnić (2024). *International Journal of Production Research*. DOI: [10.1080/00207543.2023.2221750](10.1080/00207543.2023.2221750)  
**Sitasi Pendukung:** Peng Yang, Peiran Tao, Ping Xu (2023). *Engineering Optimization*. DOI: [10.1080/0305215x.2022.2096881](10.1080/0305215x.2022.2096881)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nenad Kosanić, Jakob Marolt, Nenad Zrnić (2024) dalam jurnal *International Journal of Production Research* (DOI: 10.1080/00207543.2023.2221750) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Peng Yang, Peiran Tao, Ping Xu (2023) yang dipublikasikan dalam *Engineering Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
