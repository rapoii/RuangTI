# 6402 — Quality Engineering & Reliability Systems: Evaluation of Quality Failures in the Production Process Using the Seven Tools and Failure Mode and Effect Analysis (FMEA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Evaluation of Quality Failures in the Production Process Using the Seven Tools and Failure Mode and Effect Analysis (FMEA)  
**Jurnal & Sitasi Utama:** Achmad Luqman Hakim, Wiwin Widiasih (2025). *PROZIMA (Productivity, Optimization and Manufacturing System Engineering)*. DOI: [10.21070/prozima.v9i2.1761](10.21070/prozima.v9i2.1761)  
**Sitasi Pendukung:** Peyman Zandi, Mohammad Rahmani, Mojtaba Khanian (2020). *Agriculture*. DOI: [10.3390/agriculture10110504](10.3390/agriculture10110504)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Achmad Luqman Hakim, Wiwin Widiasih (2025) dalam jurnal *PROZIMA (Productivity, Optimization and Manufacturing System Engineering)* (DOI: 10.21070/prozima.v9i2.1761) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Peyman Zandi, Mohammad Rahmani, Mojtaba Khanian (2020) yang dipublikasikan dalam *Agriculture* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
