# 3289 — Supply Chain Management & Logistics Engineering: Simultaneous Pickup-and-Delivery Production-Routing Problem in Closed-Loop Supply Chain with Remanufacturing and Disassembly Consideration

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Simultaneous Pickup-and-Delivery Production-Routing Problem in Closed-Loop Supply Chain with Remanufacturing and Disassembly Consideration  
**Jurnal & Sitasi Utama:** Muhammad Khoirul Khakim Habibi, Ramzi Hammami, Olga Battaia (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4416322](10.2139/ssrn.4416322)  
**Sitasi Pendukung:** Lu Xiao, Xian-Jia Wang, Kwai-Sang Chin (2020). *Transportation Research Part E: Logistics and Transportation Review*. DOI: [10.1016/j.tre.2020.101898](10.1016/j.tre.2020.101898)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Muhammad Khoirul Khakim Habibi, Ramzi Hammami, Olga Battaia (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4416322) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
