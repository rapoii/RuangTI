# 4504 — Quality Engineering & Reliability Systems: Other types of control charts for variables

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Other types of control charts for variables  
**Jurnal & Sitasi Utama:** John Oakland, Robert Oakland (2024). *Statistical Process Control and Data Analytics*. DOI: [10.4324/9781003439080-10](10.4324/9781003439080-10)  
**Sitasi Pendukung:** Amir Khurshid, Ajaya Kumar Pani (2024). *2024 Control Instrumentation System Conference (CISCON)*. DOI: [10.1109/ciscon62171.2024.10696756](10.1109/ciscon62171.2024.10696756)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari John Oakland, Robert Oakland (2024) dalam jurnal *Statistical Process Control and Data Analytics* (DOI: 10.4324/9781003439080-10) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Amir Khurshid, Ajaya Kumar Pani (2024) yang dipublikasikan dalam *2024 Control Instrumentation System Conference (CISCON)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
