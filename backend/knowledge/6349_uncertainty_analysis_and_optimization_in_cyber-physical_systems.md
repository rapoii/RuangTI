# 6349 — Manufacturing Systems & Cyber-Physical Production: Uncertainty Analysis and Optimization in Cyber-Physical Systems of Reservoir Production

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Uncertainty Analysis and Optimization in Cyber-Physical Systems of Reservoir Production  
**Jurnal & Sitasi Utama:** Hui Zhao, Lin Cao, Xingkai Zhang (2020). *Big Data Analytics for Cyber-Physical Systems*. DOI: [10.1007/978-3-030-43494-6_10](10.1007/978-3-030-43494-6_10)  
**Sitasi Pendukung:** Vladimir Orekhov, Vladimir Bobkov, Maksim Dli (2024). *Studies in Systems, Decision and Control*. DOI: [10.1007/978-3-031-67911-7_13](10.1007/978-3-031-67911-7_13)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hui Zhao, Lin Cao, Xingkai Zhang (2020) dalam jurnal *Big Data Analytics for Cyber-Physical Systems* (DOI: 10.1007/978-3-030-43494-6_10) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vladimir Orekhov, Vladimir Bobkov, Maksim Dli (2024) yang dipublikasikan dalam *Studies in Systems, Decision and Control* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
