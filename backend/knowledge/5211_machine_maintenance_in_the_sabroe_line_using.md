# 5211 — Maintenance Engineering & Asset Life Cycle: Machine Maintenance in the Sabroe Line Using Reliability Centered Maintenance (RCM) and Maintenance Value Stream Mapping (MVSM) Methods

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Machine Maintenance in the Sabroe Line Using Reliability Centered Maintenance (RCM) and Maintenance Value Stream Mapping (MVSM) Methods  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2023). *Nusantara Science and Technology Proceedings*. DOI: [10.11594/nstp.2023.3630](10.11594/nstp.2023.3630)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Conference on Marine Engineering and its Application*. DOI: [10.33863/cmea.v8i1.3981](10.33863/cmea.v8i1.3981)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2023) dalam jurnal *Nusantara Science and Technology Proceedings* (DOI: 10.11594/nstp.2023.3630) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2025) yang dipublikasikan dalam *Conference on Marine Engineering and its Application* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
