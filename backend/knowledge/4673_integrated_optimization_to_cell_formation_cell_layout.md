# 4673 — Manufacturing Systems & Cyber-Physical Production: Integrated Optimization to Cell Formation, Cell Layout, and Group Scheduling for Dynamic Cellular Manufacturing System

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Integrated Optimization to Cell Formation, Cell Layout, and Group Scheduling for Dynamic Cellular Manufacturing System  
**Jurnal & Sitasi Utama:** Jiawen Liu, Baigang Du (2025). *2025 8th International Conference on Advanced Algorithms and Control Engineering (ICAACE)*. DOI: [10.1109/icaace65325.2025.11019393](10.1109/icaace65325.2025.11019393)  
**Sitasi Pendukung:** Kamran Forghani, S.M.T. Fatemi Ghomi (2020). *Applied Soft Computing*. DOI: [10.1016/j.asoc.2020.106719](10.1016/j.asoc.2020.106719)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiawen Liu, Baigang Du (2025) dalam jurnal *2025 8th International Conference on Advanced Algorithms and Control Engineering (ICAACE)* (DOI: 10.1109/icaace65325.2025.11019393) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kamran Forghani, S.M.T. Fatemi Ghomi (2020) yang dipublikasikan dalam *Applied Soft Computing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
