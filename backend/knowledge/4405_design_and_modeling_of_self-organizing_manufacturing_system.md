# 4405 — Manufacturing Systems & Cyber-Physical Production: Design and modeling of self-organizing manufacturing system in digital twin shop-floor

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Design and modeling of self-organizing manufacturing system in digital twin shop-floor  
**Jurnal & Sitasi Utama:** Jiaye Song, Zequn Zhang, Dunbing Tang (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-2058715/v1](10.21203/rs.3.rs-2058715/v1)  
**Sitasi Pendukung:** Murali Krishna Pasupuleti (2024). *Digital Twin Technology in Manufacturing: Tools for Real-Time Process Optimization*. DOI: [10.62311/nesx/905773](10.62311/nesx/905773)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiaye Song, Zequn Zhang, Dunbing Tang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-2058715/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Murali Krishna Pasupuleti (2024) yang dipublikasikan dalam *Digital Twin Technology in Manufacturing: Tools for Real-Time Process Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
