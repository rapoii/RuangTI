# 3650 — Applied Statistics & Stochastic Modeling: Network modeling using graph neural networks

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Network modeling using graph neural networks  
**Jurnal & Sitasi Utama:** Miquel Ferriol-Galmés (2024). *Peer-Reviewed Academic Journal*. DOI: [10.5821/dissertation-2117-422057](10.5821/dissertation-2117-422057)  
**Sitasi Pendukung:** Dr. Pankaj Jha (2026). *Journal of Electronics Computer Networking and Applied Mathematics*. DOI: [10.55529/jecnam.61.13.23](10.55529/jecnam.61.13.23)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Miquel Ferriol-Galmés (2024) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.5821/dissertation-2117-422057) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
