# Modul Komprehensif: Computer-Aided Manufacturing (CAM) & G-Code/M-Code CNC Programming
**Nomor Modul:** [371]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *CNC Programming Handbook (Peter Smid), International Journal of Machine Tools and Manufacture (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Computer-Aided Manufacturing (CAM) & G-Code/M-Code CNC Programming**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Struktur Program G-Code ISO 6983 (G00 Rapid, G01 Linear, G02/G03 Circular Interpolation), M-Code (M03 Spindle ON, M08 Coolant ON), Cutter Radius Compensation (G41/G42), Feed Rate ($f$) & Cutting Speed ($V_c$) Optimization.
...
```python
# Algoritma Solusi Terapan untuk Computer-Aided Manufacturing (CAM) & G-Code/M-Code CNC Programming
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Optimasi Toolpath Pemesinan CNC Milling 5-Axis Sudu Turbin Gas Titanium.
...
1. CNC Programming Handbook (Peter Smid), International Journal of Machine Tools and Manufacture (2024).
