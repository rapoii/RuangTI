# 4281 — Industrial Energy Management & Decarbonization: Reinforcement learning based adaptive power pinch analysis for energy management of stand-alone hybrid energy storage systems considering uncertainty

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Reinforcement learning based adaptive power pinch analysis for energy management of stand-alone hybrid energy storage systems considering uncertainty  
**Jurnal & Sitasi Utama:** Bassey Etim Nyong-Bassey, Damian Giaouris, Charalampos Patsios (2019). *Energy*. DOI: [10.1016/j.energy.2019.116622](10.1016/j.energy.2019.116622)  
**Sitasi Pendukung:** Yasmina Abdelouadoud, Edward Lucas, Pierre Krummenacher (2019). *Energy*. DOI: [10.1016/j.energy.2019.06.180](10.1016/j.energy.2019.06.180)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bassey Etim Nyong-Bassey, Damian Giaouris, Charalampos Patsios (2019) dalam jurnal *Energy* (DOI: 10.1016/j.energy.2019.116622) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yasmina Abdelouadoud, Edward Lucas, Pierre Krummenacher (2019) yang dipublikasikan dalam *Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
