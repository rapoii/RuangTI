# 4046 — Facilities Planning & Material Handling: Research on Cell Layout of Injection Workshop Based on Improved SLP-G A

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Research on Cell Layout of Injection Workshop Based on Improved SLP-G A  
**Jurnal & Sitasi Utama:** Man Zhao, Xing Wei (2020). *Journal of Physics Conference Series*. DOI: [10.1088/1742-6596/1486/7/072079](10.1088/1742-6596/1486/7/072079)  
**Sitasi Pendukung:** Iksan Adiasa, Rianti Indah Lestari, Dian Dwi Wahyudi (2026). *JURNAL INDUSTRI & TEKNOLOGI SAMAWA*. DOI: [10.36761/jitsa.v7i1.7264](10.36761/jitsa.v7i1.7264)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Man Zhao, Xing Wei (2020) dalam jurnal *Journal of Physics Conference Series* (DOI: 10.1088/1742-6596/1486/7/072079) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract According to the background of multi-varieties and small-batch market demands, the layout of the injection workshop is reformed by cell layout. The mathematical model of the injection workshop cell layout is constructed to minimum logistics cost, and the model is solved by using MATLAB. By using the systematic layout planning (SLP), three groups of initial solutions are generated, which are used as part of the chromosomes in the initial population of the improved genetic algorithm (GA). In this way the subjectivity and complexity of the traditional SLP method are avoided, the global and local search capability of the algorithm is enhanced, and the optimal solution can be quickly searched. Finally, the cell layout of an injection workshop is completed through the algorithm."

Penelitian pendukung oleh Iksan Adiasa, Rianti Indah Lestari, Dian Dwi Wahyudi (2026) yang dipublikasikan dalam *JURNAL INDUSTRI & TEKNOLOGI SAMAWA* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
