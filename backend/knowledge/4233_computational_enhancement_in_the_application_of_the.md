# 4233 — Operations Research & Large-Scale Optimization: Computational Enhancement in the Application of the Branch and Bound Method for Linear Integer Programs and Related Models

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Computational Enhancement in the Application of the Branch and Bound Method for Linear Integer Programs and Related Models  
**Jurnal & Sitasi Utama:** Masar Al-Rabeeah, Elias Munapo, Ali Al-Hasani (2019). *International Journal of Mathematical Engineering and Management Sciences*. DOI: [10.33889/ijmems.2019.4.5-090](10.33889/ijmems.2019.4.5-090)  
**Sitasi Pendukung:** Tamás Bányai, Péter Tamás, Béla Illés (2019). *International Journal of Environmental Research and Public Health*. DOI: [10.3390/ijerph16040634](10.3390/ijerph16040634)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Masar Al-Rabeeah, Elias Munapo, Ali Al-Hasani (2019) dalam jurnal *International Journal of Mathematical Engineering and Management Sciences* (DOI: 10.33889/ijmems.2019.4.5-090) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
