# 6261 — Operations Research & Large-Scale Optimization: Multi-objective Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multi-objective Integer Linear Programming  
**Jurnal & Sitasi Utama:** Jacques Teghem (2025). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_420-1](10.1007/978-3-030-54621-2_420-1)  
**Sitasi Pendukung:** E. Di Marino, R. Su, F. Basile (2020). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2021.04.073](10.1016/j.ifacol.2021.04.073)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jacques Teghem (2025) dalam jurnal *Encyclopedia of Optimization* (DOI: 10.1007/978-3-030-54621-2_420-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh E. Di Marino, R. Su, F. Basile (2020) yang dipublikasikan dalam *IFAC-PapersOnLine* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
