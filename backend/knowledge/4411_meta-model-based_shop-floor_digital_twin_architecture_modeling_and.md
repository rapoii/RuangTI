# 4411 — Manufacturing Systems & Cyber-Physical Production: Meta-model-based shop-floor digital twin architecture, modeling and application

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Meta-model-based shop-floor digital twin architecture, modeling and application  
**Jurnal & Sitasi Utama:** Xiaolang Yang, Xuemei Liu, Heng Zhang (2023). *Robotics and Computer-Integrated Manufacturing*. DOI: [10.1016/j.rcim.2023.102595](10.1016/j.rcim.2023.102595)  
**Sitasi Pendukung:** Xixing Li, Lei Wang, Chuanjun Zhu (2021). *Journal of Manufacturing Systems*. DOI: [10.1016/j.jmsy.2020.08.003](10.1016/j.jmsy.2020.08.003)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xiaolang Yang, Xuemei Liu, Heng Zhang (2023) dalam jurnal *Robotics and Computer-Integrated Manufacturing* (DOI: 10.1016/j.rcim.2023.102595) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xixing Li, Lei Wang, Chuanjun Zhu (2021) yang dipublikasikan dalam *Journal of Manufacturing Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
