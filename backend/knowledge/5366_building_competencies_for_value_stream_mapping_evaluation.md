# 5366 — Continuous Improvement & Lean Six Sigma: Building Competencies for Value Stream Mapping – Evaluation of a Virtual Learning Scenario

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Building Competencies for Value Stream Mapping – Evaluation of a Virtual Learning Scenario  
**Jurnal & Sitasi Utama:** Thomas Riemann, Joachim Metternich (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4074052](10.2139/ssrn.4074052)  
**Sitasi Pendukung:** Lead Industrial Researchers (2022). *Nusantara Science and Technology Proceedings*. DOI: [10.11594/nstp.2022.2904](10.11594/nstp.2022.2904)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thomas Riemann, Joachim Metternich (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4074052) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
