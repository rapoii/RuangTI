# 3384 — Quality Engineering & Reliability Systems: Evaluation of the Diagnostic Coverage for safety-relevant components in automated drive systems for mobile construction machinery

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Evaluation of the Diagnostic Coverage for safety-relevant components in automated drive systems for mobile construction machinery  
**Jurnal & Sitasi Utama:** Christa Düsing (2022). *Peer-Reviewed Academic Journal*. DOI: [10.25368/2024.1](10.25368/2024.1)  
**Sitasi Pendukung:** Ünal Yildirim, Felician Campean, Amad Uddin (2026). *Design Science*. DOI: [10.1017/dsj.2026.10056](10.1017/dsj.2026.10056)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Christa Düsing (2022) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.25368/2024.1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The need for safety components in safety-related control systems arises in developing basic principles for preventing mechanical accidents and protecting safety for humans and machines, especially in the development of automated drive systems for mobile construction machinery. An important parameter when using safety-relevant components respectively safety devices of automation technology -according to E DIN EN ISO 13849-1:2020-08 [1] in mobile machinery is the Diagnostic Coverage (DC). The DC measures the effectiveness of the diagnosis as the ratio of the failure rate of noticed dangerous failures and failure rate of total dangerous failures. Because single-and dual-channel safety circuits from the Safety Related Parts of Control Systems (SRP/CS) might fail or get defective, a known level of Diagnostic Coverage helps to design such systems."

Penelitian pendukung oleh Ünal Yildirim, Felician Campean, Amad Uddin (2026) yang dipublikasikan dalam *Design Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
