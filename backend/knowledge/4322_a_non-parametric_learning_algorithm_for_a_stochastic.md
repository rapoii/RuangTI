# 4322 — Supply Chain Management & Logistics Engineering: A Non-Parametric Learning Algorithm for a Stochastic Multi-Echelon Inventory Problem

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A Non-Parametric Learning Algorithm for a Stochastic Multi-Echelon Inventory Problem  
**Jurnal & Sitasi Utama:** Cong Yang, Woonghee Tim Huh (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4348606](10.2139/ssrn.4348606)  
**Sitasi Pendukung:** Kairen Zhang, Xiangyu Gao, Zhanyue Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3859856](10.2139/ssrn.3859856)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Cong Yang, Woonghee Tim Huh (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4348606) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kairen Zhang, Xiangyu Gao, Zhanyue Wang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
