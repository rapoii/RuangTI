# 3683 — Simulation Modeling & Digital Twins: Application of digital twin using discrete event simulation in intralogistics processes

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Application of digital twin using discrete event simulation in intralogistics processes  
**Jurnal & Sitasi Utama:** M. Dobrzańska, Paweł Dobrzański (2025). *Acta Tecnología*. DOI: [10.22306/atec.v11i2.279](10.22306/atec.v11i2.279)  
**Sitasi Pendukung:** Shih‐Hsien Tseng, Oey Aldi Winata (2025). *SIMULATION*. DOI: [10.1177/00375497251326918](10.1177/00375497251326918)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. Dobrzańska, Paweł Dobrzański (2025) dalam jurnal *Acta Tecnología* (DOI: 10.22306/atec.v11i2.279) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "As technology advances, companies are increasingly using technologies such as computer simulations and digital twins. These technologies enable monitoring, analyzing and optimizing the performance of processes in real time. They are also very useful in testing new ideas. This article presents the concept of using discrete event simulation as an integral part of the digital twin in the design and analysis of intralogistics processes. The authors propose using the Enterprise Dynamics discrete event simulator to create a digital twin of the AMR vehicle. For this purpose, they assessed the available technologies and the possibilities of their cooperation within the proposed digital twin."

Penelitian pendukung oleh Shih‐Hsien Tseng, Oey Aldi Winata (2025) yang dipublikasikan dalam *SIMULATION* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
