# 5725 — Operations Research & Large-Scale Optimization: A copula-based chance-constrained programming framework for BMPs spatial configuration planning

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A copula-based chance-constrained programming framework for BMPs spatial configuration planning  
**Jurnal & Sitasi Utama:** Wenlu Ding, Chen Hu (2024). *Peer-Reviewed Journal*. DOI: [10.5194/egusphere-egu26-5498](10.5194/egusphere-egu26-5498)  
**Sitasi Pendukung:** Yuang Chen, Beste Basciftci, Valerie Thomas (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4356282](10.2139/ssrn.4356282)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wenlu Ding, Chen Hu (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.5194/egusphere-egu26-5498) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
