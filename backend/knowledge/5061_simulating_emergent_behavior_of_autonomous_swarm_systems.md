# 5061 — Simulation Modeling & Digital Twins: Simulating emergent behavior of autonomous swarm systems using agent-based modeling

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulating emergent behavior of autonomous swarm systems using agent-based modeling  
**Jurnal & Sitasi Utama:** Bong Gumahad, Andrew J Collins (2025). *SIMULATION*. DOI: [10.1177/00375497251349538](10.1177/00375497251349538)  
**Sitasi Pendukung:** Islam El-Nakib (2026). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2026.100225](10.1016/j.sca.2026.100225)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bong Gumahad, Andrew J Collins (2025) dalam jurnal *SIMULATION* (DOI: 10.1177/00375497251349538) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Islam El-Nakib (2026) yang dipublikasikan dalam *Supply Chain Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
