# 4755 — Human Factors & Cognitive Ergonomics: Evaluation of mental workload using the NASA task load index (NASA-TLX) method on production department employees

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Evaluation of mental workload using the NASA task load index (NASA-TLX) method on production department employees  
**Jurnal & Sitasi Utama:** Nurul Iman, Nunung Agus Firmansyah, Ade Ima Himayati (2025). *SAINTEKS : Jurnal Sain dan Teknik*. DOI: [10.37577/sainteks.v7i01.858](10.37577/sainteks.v7i01.858)  
**Sitasi Pendukung:** Caesar Rifqi Ardana, Irwan Iftadi (2025). *Teknoin*. DOI: [10.20885/teknoin.vol30.iss1.art4](10.20885/teknoin.vol30.iss1.art4)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nurul Iman, Nunung Agus Firmansyah, Ade Ima Himayati (2025) dalam jurnal *SAINTEKS : Jurnal Sain dan Teknik* (DOI: 10.37577/sainteks.v7i01.858) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Caesar Rifqi Ardana, Irwan Iftadi (2025) yang dipublikasikan dalam *Teknoin* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
