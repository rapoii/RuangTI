# 5440 — Operations Research & Large-Scale Optimization: General Variable Neighborhood Search for Electric Vehicle Routing Problem with Time-Dependent Speeds and Soft Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** General Variable Neighborhood Search for Electric Vehicle Routing Problem with Time-Dependent Speeds and Soft Time Windows  
**Jurnal & Sitasi Utama:** Luka Matijević (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4173510](10.2139/ssrn.4173510)  
**Sitasi Pendukung:** Dominique Feillet (2024). *Peer-Reviewed Journal*. DOI: [10.52843/cassyni.jr3yf8](10.52843/cassyni.jr3yf8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Luka Matijević (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4173510) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
