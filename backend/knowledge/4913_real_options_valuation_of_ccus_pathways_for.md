# 4913 — Engineering Economics & Cost Optimization: Real Options Valuation of CCUS Pathways for Zero-Carbon Mines under Carbon Price Uncertainty: Optimal Investment Timing and Policy–Technology Sensitivities

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Real Options Valuation of CCUS Pathways for Zero-Carbon Mines under Carbon Price Uncertainty: Optimal Investment Timing and Policy–Technology Sensitivities  
**Jurnal & Sitasi Utama:** You Zhou, Yumeng Zhu, Yuan Li (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6193502](10.2139/ssrn.6193502)  
**Sitasi Pendukung:** Lead Industrial Researchers (2022). *Valuation of the Liability Structure by Real Options*. DOI: [10.1002/9781119988311.oth1](10.1002/9781119988311.oth1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari You Zhou, Yumeng Zhu, Yuan Li (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6193502) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study develops a trinomial-lattice real options framework to value coalfield CCUS pathways and determine optimal investment timing under carbon price uncertainty. The analysis is motivated by the need for decision-relevant evidence on when and how CCUS can become economically viable in coal mining regions and in zero-carbon mine demonstration settings where investment is capital intensive and strongly exposed to policy and market risks. Two pathways are assessed under a consistent accounting boundary: CO2 storage in deep saline aquifers and CO2-enhanced coalbed methane (ECBM) with associated storage. Parameters are calibrated using project-relevant data from Ordos (saline aquifer storage) and the Qinshui Basin (CO2-ECBM). Results show a meaningful deferral window over 2023–2030, with immediate investment becoming optimal from 2031 onward. Along an increasing carbon-price trajectory, positive NPV emerges from 2029 for saline aquifer storage and from 2030 for ECBM. The critical carbon price is approximately 394.64 CNY/t for saline aquifer storage and 530.79 CNY/t for ECBM, indicating earlier viability for the saline aquifer pathway. Sensitivity results identify the upfront capital subsidy rate [[EQUATION]]as the primary determinant of the upper bound of investment value, while capture-rate improvements yield higher marginal gains in option-adjusted value; the CBM production subsidy has limited leverage. These findings inform pathway selection and targeted policy–technology"

Penelitian pendukung oleh Lead Industrial Researchers (2022) yang dipublikasikan dalam *Valuation of the Liability Structure by Real Options* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
