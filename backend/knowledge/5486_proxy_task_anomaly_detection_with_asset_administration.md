# 5486 — Manufacturing Systems & Cyber-Physical Production: Proxy Task Anomaly Detection with Asset Administration Shell Integration for Predictive Maintenance

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Proxy Task Anomaly Detection with Asset Administration Shell Integration for Predictive Maintenance  
**Jurnal & Sitasi Utama:** Zhengjie Mu, Thomas Rauschenbach (2025). *2025 International Conference on Cyber-Enabled Distributed Computing and Knowledge Discovery (CyberC)*. DOI: [10.1109/cyberc66434.2025.00044](10.1109/cyberc66434.2025.00044)  
**Sitasi Pendukung:** Akshay Narla, Daniel Dittler, Nasser Jazdi (2025). *2025 IEEE 8th International Conference on Industrial Cyber-Physical Systems (ICPS)*. DOI: [10.1109/icps65515.2025.11087876](10.1109/icps65515.2025.11087876)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zhengjie Mu, Thomas Rauschenbach (2025) dalam jurnal *2025 International Conference on Cyber-Enabled Distributed Computing and Knowledge Discovery (CyberC)* (DOI: 10.1109/cyberc66434.2025.00044) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Akshay Narla, Daniel Dittler, Nasser Jazdi (2025) yang dipublikasikan dalam *2025 IEEE 8th International Conference on Industrial Cyber-Physical Systems (ICPS)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
