# 4420 — Manufacturing Systems & Cyber-Physical Production: TAD-Net: An approach for real-time action detection based on temporal convolution network and graph convolution network in digital twin shop-floor
...
**Jurnal & Sitasi Utama:** Qing Hong, Yifeng Sun, Tingyu Liu (2024). *Digital Twin*. DOI: [10.12688/digitaltwin.17408.1](10.12688/digitaltwin.17408.1)  
**Sitasi Pendukung:** Steve Albert (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6823822](10.2139/ssrn.6823822)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Qing Hong, Yifeng Sun, Tingyu Liu (2024) dalam jurnal *Digital Twin* (DOI: 10.12688/digitaltwin.17408.1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Steve Albert (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
