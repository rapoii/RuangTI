# 6283 — Operations Research & Large-Scale Optimization: Active Distribution Network Voltage Profile Optimization Using Mixed Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Active Distribution Network Voltage Profile Optimization Using Mixed Integer Linear Programming  
**Jurnal & Sitasi Utama:** Damir Jakus, Josko Novakovic, Josip Vasilj (2022). *2022 International Conference on Smart Systems and Technologies (SST)*. DOI: [10.1109/sst55530.2022.9954722](10.1109/sst55530.2022.9954722)  
...
Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Damir Jakus, Josko Novakovic, Josip Vasilj (2022) dalam jurnal *2022 International Conference on Smart Systems and Technologies (SST)* (DOI: 10.1109/sst55530.2022.9954722) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
