# 3328 — Manufacturing Systems & Cyber-Physical Production: An approach for leveraging Digital Twins in agent-based production systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** An approach for leveraging Digital Twins in agent-based production systems  
**Jurnal & Sitasi Utama:** Birgit Vogel‐Heuser, Felix Ocker, Tobias Scheuer (2021). *at - Automatisierungstechnik*. DOI: [10.1515/auto-2021-0081](10.1515/auto-2021-0081)  
**Sitasi Pendukung:** L. A. Dobrzański, Lech B. Dobrzański (2020). *Processes*. DOI: [10.3390/pr8050525](10.3390/pr8050525)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Birgit Vogel‐Heuser, Felix Ocker, Tobias Scheuer (2021) dalam jurnal *at - Automatisierungstechnik* (DOI: 10.1515/auto-2021-0081) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh L. A. Dobrzański, Lech B. Dobrzański (2020) yang dipublikasikan dalam *Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
