# 4325 — Supply Chain Management & Logistics Engineering: A Stochastic Optimization Model for a Multi-Echelon Inventory System with Direct Demand that Consists of Two Commodities

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A Stochastic Optimization Model for a Multi-Echelon Inventory System with Direct Demand that Consists of Two Commodities  
**Jurnal & Sitasi Utama:** PRABAHARAN K, VIRUMANDI C, BAKTHAVACHALAM R (2025). *Statistics, Optimization &amp; Information Computing*. DOI: [10.19139/soic-2310-5070-2969](10.19139/soic-2310-5070-2969)  
**Sitasi Pendukung:** Yufei Zhao, Xiangyu Gao, Zhanyue Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4962163](10.2139/ssrn.4962163)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari PRABAHARAN K, VIRUMANDI C, BAKTHAVACHALAM R (2025) dalam jurnal *Statistics, Optimization &amp; Information Computing* (DOI: 10.19139/soic-2310-5070-2969) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yufei Zhao, Xiangyu Gao, Zhanyue Wang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
