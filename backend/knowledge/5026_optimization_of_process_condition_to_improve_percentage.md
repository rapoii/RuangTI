# 5026 — Applied Statistics & Stochastic Modeling: Optimization of process condition to improve percentage purity of aloe emodin from aloe vera by extraction using response surface methodology with the central composite design tool

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Optimization of process condition to improve percentage purity of aloe emodin from aloe vera by extraction using response surface methodology with the central composite design tool  
**Jurnal & Sitasi Utama:** Sandeep B. Mundhe, Suyogkumar V. Taralkar (2022). *International journal of health sciences*. DOI: [10.53730/ijhs.v6ns2.7951](10.53730/ijhs.v6ns2.7951)  
**Sitasi Pendukung:** Ebtesam W. Elsayed, Maha F. Emam (2024). *Journal of Pharmaceutical Sciences*. DOI: [10.1016/j.xphs.2024.03.012](10.1016/j.xphs.2024.03.012)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sandeep B. Mundhe, Suyogkumar V. Taralkar (2022) dalam jurnal *International journal of health sciences* (DOI: 10.53730/ijhs.v6ns2.7951) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ebtesam W. Elsayed, Maha F. Emam (2024) yang dipublikasikan dalam *Journal of Pharmaceutical Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
