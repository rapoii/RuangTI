# 4824 — Production Planning & Inventory Control: A column generation heuristic for simultaneous lot-sizing and scheduling problems with secondary resources and setup carryovers

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** A column generation heuristic for simultaneous lot-sizing and scheduling problems with secondary resources and setup carryovers  
**Jurnal & Sitasi Utama:** Cevdet Utku Şafak, Erinç Albey, Görkem Yılmaz (2025). *Computers &amp; Operations Research*. DOI: [10.1016/j.cor.2024.106962](10.1016/j.cor.2024.106962)  
**Sitasi Pendukung:** Peerayuth Charnsethikul, Warut Boonphakdee (2021). *International Journal of Mathematics in Operational Research*. DOI: [10.1504/ijmor.2021.10043656](10.1504/ijmor.2021.10043656)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Cevdet Utku Şafak, Erinç Albey, Görkem Yılmaz (2025) dalam jurnal *Computers &amp; Operations Research* (DOI: 10.1016/j.cor.2024.106962) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Peerayuth Charnsethikul, Warut Boonphakdee (2021) yang dipublikasikan dalam *International Journal of Mathematics in Operational Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
