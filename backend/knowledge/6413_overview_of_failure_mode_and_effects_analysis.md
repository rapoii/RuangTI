# 6413 — Quality Engineering & Reliability Systems: Overview of Failure Mode and Effects Analysis (FMEA): A Patient Safety Tool

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Overview of Failure Mode and Effects Analysis (FMEA): A Patient Safety Tool  
**Jurnal & Sitasi Utama:** Shaymaa M. M. El-Awady (2023). *Global Journal on Quality and Safety in Healthcare*. DOI: [10.36401/jqsh-23-x2](10.36401/jqsh-23-x2)  
**Sitasi Pendukung:** Mellyani Nurmaya Fauzizah, Hendi Herlambang, Setiawan `Setiawan (2026). *Journal La Multiapp*. DOI: [10.37899/journallamultiapp.v7i3.3328](10.37899/journallamultiapp.v7i3.3328)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shaymaa M. M. El-Awady (2023) dalam jurnal *Global Journal on Quality and Safety in Healthcare* (DOI: 10.36401/jqsh-23-x2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mellyani Nurmaya Fauzizah, Hendi Herlambang, Setiawan `Setiawan (2026) yang dipublikasikan dalam *Journal La Multiapp* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
