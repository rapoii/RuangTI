# 4437 — Manufacturing Systems & Cyber-Physical Production: A Modeling and Adaptive Evolution Method for Simulation Parameters of Digital Twin Shop Floor

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** A Modeling and Adaptive Evolution Method for Simulation Parameters of Digital Twin Shop Floor  
**Jurnal & Sitasi Utama:** Litong Zhang, Yu Guo, Shengbo Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4773870](10.2139/ssrn.4773870)  
**Sitasi Pendukung:** Francesco Biondani, Luigi Capogrosso, Francesco Tosoni (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202607.2268.v1](10.20944/preprints202607.2268.v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Litong Zhang, Yu Guo, Shengbo Wang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4773870) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Francesco Biondani, Luigi Capogrosso, Francesco Tosoni (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
