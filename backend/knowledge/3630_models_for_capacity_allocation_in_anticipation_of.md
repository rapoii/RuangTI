# 3630 — Applied Statistics & Stochastic Modeling: Models for Capacity Allocation in Anticipation of Time-Varying Demand

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Models for Capacity Allocation in Anticipation of Time-Varying Demand  
**Jurnal & Sitasi Utama:** Evghenii S. Furman (2020). *YorkSpace (York University)*. DOI: [10.openalex/w3115541065](10.openalex/w3115541065)  
**Sitasi Pendukung:** Erhun Özkan, Geert‐Jan van Houtum (2023). *Operations Research*. DOI: [10.1287/opre.2023.2459](10.1287/opre.2023.2459)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Evghenii S. Furman (2020) dalam jurnal *YorkSpace (York University)* (DOI: 10.openalex/w3115541065) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
