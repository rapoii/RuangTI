# 3318 — Manufacturing Systems & Cyber-Physical Production: Industry 4.0 Readiness Assessment Method Based on RAMI 4.0 Standards

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Industry 4.0 Readiness Assessment Method Based on RAMI 4.0 Standards  
**Jurnal & Sitasi Utama:** Alan Bastos, Mauren Louise Sguario Coelho de Andrade, Rui Tadashi Yoshino (2021). *IEEE Access*. DOI: [10.1109/access.2021.3105456](10.1109/access.2021.3105456)  
**Sitasi Pendukung:** Leonhard Faubel, Klaus Schmid, Holger Eichelberger (2023). *SN Computer Science*. DOI: [10.1007/s42979-023-02282-2](10.1007/s42979-023-02282-2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alan Bastos, Mauren Louise Sguario Coelho de Andrade, Rui Tadashi Yoshino (2021) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2021.3105456) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The Industry 4.0 concept inception definitively provided a disruptive glimpse in terms of possibilities in a multidisciplinary spectrum. The convergence and synergy from technologies generated quite high expectations. In terms of advancements, the efficiency increase is one of the key factors. Smart factories must be capable of producing more and in an ecologically cleaner manner, by benefiting from less environmentally impacting energy sources. The present moment is for digital transformation in the diverse enabling transverse areas. For that to be feasible, the next steps are towards standardization, which brings viability to expand and integrate the assorted devices and processes, bringing intelligence closer to all the involved equipment by capitalization. The gap that this research aims to explore is in the assessment of the ongoing industries, focusing on the current status of the operational plants technologically. In other words, by mapping the present, as-is, situation, the stakeholders obtain a valuable guidance resource to go through the journey upon permeating the Industry 4.0 status, the greater objective. Undoubtedly, a path of considerable length, but with well-proportioned outcomes. The solution’s ambition is to rate, grade, and calculate the readiness and maturity levels of the institution accordingly to that scope. To achieve that, methods will be developed and applied to gather information and subsequently threaten it. Finally, the results will be confronte"

Penelitian pendukung oleh Leonhard Faubel, Klaus Schmid, Holger Eichelberger (2023) yang dipublikasikan dalam *SN Computer Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
