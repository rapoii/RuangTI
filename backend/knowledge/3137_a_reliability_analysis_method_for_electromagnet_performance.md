# 3137 — Quality Engineering & Reliability Systems: A reliability analysis method for electromagnet performance degradation based on FMEA and fuzzy inference system

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** A reliability analysis method for electromagnet performance degradation based on FMEA and fuzzy inference system  
**Jurnal & Sitasi Utama:** Jihong Pang, Jinkun Dai, Xinze Lian (2024). *Quality and Reliability Engineering International*. DOI: [10.1002/qre.3602](10.1002/qre.3602)  
**Sitasi Pendukung:** Aleksandr Korsunovs, Aleksandr Doikin, Felician Campean (2022). *Proceedings of the Design Society*. DOI: [10.1017/pds.2022.193](10.1017/pds.2022.193)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jihong Pang, Jinkun Dai, Xinze Lian (2024) dalam jurnal *Quality and Reliability Engineering International* (DOI: 10.1002/qre.3602) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
