# 3253 — Operations Research & Large-Scale Optimization: A genetic algorithm model for optimizing vehicle routing problems with perishable products under time-window and quality requirements

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A genetic algorithm model for optimizing vehicle routing problems with perishable products under time-window and quality requirements  
**Jurnal & Sitasi Utama:** Anil Kumar Agrawal, Susheel Yadav, Amit Ambar Gupta (2022). *Decision Analytics Journal*. DOI: [10.1016/j.dajour.2022.100139](10.1016/j.dajour.2022.100139)  
**Sitasi Pendukung:** Navid Zarbakhshnia, Devika Kannan, Reza Kiani Mavi (2020). *Annals of Operations Research*. DOI: [10.1007/s10479-020-03744-z](10.1007/s10479-020-03744-z)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anil Kumar Agrawal, Susheel Yadav, Amit Ambar Gupta (2022) dalam jurnal *Decision Analytics Journal* (DOI: 10.1016/j.dajour.2022.100139) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Navid Zarbakhshnia, Devika Kannan, Reza Kiani Mavi (2020) yang dipublikasikan dalam *Annals of Operations Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
