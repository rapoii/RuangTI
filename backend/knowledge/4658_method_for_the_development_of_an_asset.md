# 4658 — Manufacturing Systems & Cyber-Physical Production: Method for the development of an Asset Administration Shell in a product-driven modular production – realizing an active digital object memory

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Method for the development of an Asset Administration Shell in a product-driven modular production – realizing an active digital object memory  
**Jurnal & Sitasi Utama:** Max Birtel, William Motsch, Jens Popper (2020). *2020 IEEE Conference on Industrial Cyberphysical Systems (ICPS)*. DOI: [10.1109/icps48405.2020.9274753](10.1109/icps48405.2020.9274753)  
**Sitasi Pendukung:** Adithya Thaduri, Ajit Kumar Verma, Uday Kumar (2020). *Asset Analytics*. DOI: [10.1007/978-981-15-3643-4_41](10.1007/978-981-15-3643-4_41)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Max Birtel, William Motsch, Jens Popper (2020) dalam jurnal *2020 IEEE Conference on Industrial Cyberphysical Systems (ICPS)* (DOI: 10.1109/icps48405.2020.9274753) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Adithya Thaduri, Ajit Kumar Verma, Uday Kumar (2020) yang dipublikasikan dalam *Asset Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
