# 3907 — Continuous Improvement & Lean Six Sigma: An Improved Value Stream Mapping to Prioritize Lean Optimization Scenarios Using Simulation and Multiple-Attribute Decision-Making Method

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** An Improved Value Stream Mapping to Prioritize Lean Optimization Scenarios Using Simulation and Multiple-Attribute Decision-Making Method  
**Jurnal & Sitasi Utama:** Qingqi Liu, Hualong Yang (2020). *IEEE Access*. DOI: [10.1109/access.2020.3037660](10.1109/access.2020.3037660)  
**Sitasi Pendukung:** Aditya Patil, Mrunali V Pisal, Chandrakant T. Suryavanshi (2021). *Journal of Applied Research and Technology*. DOI: [10.22201/icat.24486736e.2021.19.1.1488](10.22201/icat.24486736e.2021.19.1.1488)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Qingqi Liu, Hualong Yang (2020) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2020.3037660) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
