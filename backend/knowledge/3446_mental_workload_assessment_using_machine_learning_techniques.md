# 3446 — Human Factors & Cognitive Ergonomics: Mental Workload Assessment Using Machine Learning Techniques Based on EEG and Eye Tracking Data

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Mental Workload Assessment Using Machine Learning Techniques Based on EEG and Eye Tracking Data  
**Jurnal & Sitasi Utama:** Şeniz Harputlu Aksu, Erman Çakıt, Metin Dağdeviren (2024). *Applied Sciences*. DOI: [10.3390/app14062282](10.3390/app14062282)  
**Sitasi Pendukung:** Yunbiao Wang, Chenyang Zhang, Chenglin Liu (2024). *Human Factors and Ergonomics in Manufacturing & Service Industries*. DOI: [10.1002/hfm.21053](10.1002/hfm.21053)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Şeniz Harputlu Aksu, Erman Çakıt, Metin Dağdeviren (2024) dalam jurnal *Applied Sciences* (DOI: 10.3390/app14062282) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yunbiao Wang, Chenyang Zhang, Chenglin Liu (2024) yang dipublikasikan dalam *Human Factors and Ergonomics in Manufacturing & Service Industries* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
