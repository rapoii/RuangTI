# 5735 — Operations Research & Large-Scale Optimization: Research on Optimal Configuration of Pumped Storage Power Station Capacity Considering the Peak Regulation Capacity Ratio of Microgrid System - Based on Chance Constrained Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Research on Optimal Configuration of Pumped Storage Power Station Capacity Considering the Peak Regulation Capacity Ratio of Microgrid System - Based on Chance Constrained Programming  
**Jurnal & Sitasi Utama:** Jin  Peng Liu, Kai Huang, Lan Wu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3968768](10.2139/ssrn.3968768)  
**Sitasi Pendukung:** Mariana Arriz-Jorquiera, Jorge A. Acuna Melo, Jose L. Zayas-Castro (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5383004](10.2139/ssrn.5383004)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jin  Peng Liu, Kai Huang, Lan Wu (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.3968768) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "As an important energy storage method, pumped storage can ensure the stable operation of the power system. It has the advantages of larger capacity, maturer technology and lower cost. Therefore, it is very important to determine the optimal capacity and optimal pumping and generating capacity of a pumped storage power station, at the same time, it is of great significance to dig deep into such optimization problems how to deal with the uncertainty caused by the power supply demand and the natural characteristics of renewable energy. This paper comprehensively considers the boundary conditions such as the peak shaving capacity ratio of the system and constructs the capacity configuration model of the pumped storage power station in the wind-fire-pumped storage system. The article uses &lt;i&gt;JuMPChance&lt;/i&gt; software package in Julia to transform random optimization into deterministic optimization for simulation, and utilized the influence of the selection of confidence interval and load forecast variance on power station capacity configuration based on the simulation results, exploring the differences in capacity configuration optimization under different scenarios. The research results can provide strong support for the optimization of the capacity configuration of energy storage equipment such as pumped-storage power stations.&lt;br&gt;"

Penelitian pendukung oleh Mariana Arriz-Jorquiera, Jorge A. Acuna Melo, Jose L. Zayas-Castro (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
