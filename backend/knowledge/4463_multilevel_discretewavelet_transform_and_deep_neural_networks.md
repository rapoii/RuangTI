# 4463 — Maintenance Engineering & Asset Life Cycle: Multilevel DiscreteWavelet Transform and Deep Neural Networks for Predicting Remaining Useful Life of a Machine Asset

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Multilevel DiscreteWavelet Transform and Deep Neural Networks for Predicting Remaining Useful Life of a Machine Asset  
**Jurnal & Sitasi Utama:** Shivam Bhardwaj, Prashant Kartikeya, Ramesh Kumar (2022). *2022 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm53196.2022.9815670](10.1109/icphm53196.2022.9815670)  
**Sitasi Pendukung:** Qiyao Wang, Ahmed Farahat, Chetan Gupta (2020). *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm49022.2020.9187047](10.1109/icphm49022.2020.9187047)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shivam Bhardwaj, Prashant Kartikeya, Ramesh Kumar (2022) dalam jurnal *2022 IEEE International Conference on Prognostics and Health Management (ICPHM)* (DOI: 10.1109/icphm53196.2022.9815670) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qiyao Wang, Ahmed Farahat, Chetan Gupta (2020) yang dipublikasikan dalam *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
