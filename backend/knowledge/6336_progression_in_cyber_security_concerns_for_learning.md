# 6336 — Manufacturing Systems & Cyber-Physical Production: Progression in Cyber Security
                  Concerns for Learning Management Systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Progression in Cyber Security
                  Concerns for Learning Management Systems  
**Jurnal & Sitasi Utama:** Tejaswini Apte, Sarika Sharma (2021). *Cyber-Physical, IoT, and Autonomous Systems in Industry 4.0*. DOI: [10.1201/9781003146711-8](10.1201/9781003146711-8)  
**Sitasi Pendukung:** Nicolaus Klein, Johannes Gerner, Anni Wang (2024). *2024 14th International Electric Drives Production Conference (EDPC)*. DOI: [10.1109/edpc63771.2024.10932846](10.1109/edpc63771.2024.10932846)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tejaswini Apte, Sarika Sharma (2021) dalam jurnal *Cyber-Physical, IoT, and Autonomous Systems in Industry 4.0* (DOI: 10.1201/9781003146711-8) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
