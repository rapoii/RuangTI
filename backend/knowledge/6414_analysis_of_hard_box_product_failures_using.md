# 6414 — Quality Engineering & Reliability Systems: Analysis of Hard Box Product Failures Using Failure Mode and Effects Analysis (FMEA) and DMAIC Methods at PT XYZ

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Analysis of Hard Box Product Failures Using Failure Mode and Effects Analysis (FMEA) and DMAIC Methods at PT XYZ  
**Jurnal & Sitasi Utama:** Mellyani Nurmaya Fauzizah, Hendi Herlambang, Setiawan `Setiawan (2026). *Journal La Multiapp*. DOI: [10.37899/journallamultiapp.v7i3.3328](10.37899/journallamultiapp.v7i3.3328)  
**Sitasi Pendukung:** Siti Arifah Nuraini, Joumil Aidil Saifuddin, Yekti Condro Winursito (2025). *Rabit : Jurnal Teknologi dan Sistem Informasi Univrab*. DOI: [10.36341/rabit.v10i2.6036](10.36341/rabit.v10i2.6036)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mellyani Nurmaya Fauzizah, Hendi Herlambang, Setiawan `Setiawan (2026) dalam jurnal *Journal La Multiapp* (DOI: 10.37899/journallamultiapp.v7i3.3328) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
