# 2971 — Operations Research & Large-Scale Optimization: A Review of Stochastic Programming Methods for Optimization of Process Systems Under Uncertainty

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Review of Stochastic Programming Methods for Optimization of Process Systems Under Uncertainty  
**Jurnal & Sitasi Utama:** Can Li, Ignacio E. Grossmann (2021). *Frontiers in Chemical Engineering*. DOI: [10.3389/fceng.2020.622241](10.3389/fceng.2020.622241)  
**Sitasi Pendukung:** Vinod Nair, Sergey Bartunov, Felix Gimeno (2020). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2012.13349](10.48550/arxiv.2012.13349)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Can Li, Ignacio E. Grossmann (2021) dalam jurnal *Frontiers in Chemical Engineering* (DOI: 10.3389/fceng.2020.622241) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vinod Nair, Sergey Bartunov, Felix Gimeno (2020) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
