# 4341 — Supply Chain Management & Logistics Engineering: Balancing Cost and Service Performance: A Multi Objective Inventory Planning Approach for Multi Echelon Supply Chains

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Balancing Cost and Service Performance: A Multi Objective Inventory Planning Approach for Multi Echelon Supply Chains  
**Jurnal & Sitasi Utama:** Joaquim Jorge Vicente (2026). *Systems*. DOI: [10.3390/systems14060664](10.3390/systems14060664)  
**Sitasi Pendukung:** Xiaoqing Wu (2026). *Lecture Notes in Electrical Engineering*. DOI: [10.1007/978-981-92-1030-5_7](10.1007/978-981-92-1030-5_7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Joaquim Jorge Vicente (2026) dalam jurnal *Systems* (DOI: 10.3390/systems14060664) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xiaoqing Wu (2026) yang dipublikasikan dalam *Lecture Notes in Electrical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
