# 4646 — Human Factors & Cognitive Ergonomics: Work Posture Analysis Using the Cornell Musculoskeletal Doscomfort Questionnaires (Cmdq), Rapid Upper Limb Assessment (Rula) and Rapid Entire Body Assessment (Reba) Methods

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Work Posture Analysis Using the Cornell Musculoskeletal Doscomfort Questionnaires (Cmdq), Rapid Upper Limb Assessment (Rula) and Rapid Entire Body Assessment (Reba) Methods  
**Jurnal & Sitasi Utama:** Siti Wachidatul Bahiyyah, Boy Isma Putra (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.4272](10.21070/ups.4272)  
