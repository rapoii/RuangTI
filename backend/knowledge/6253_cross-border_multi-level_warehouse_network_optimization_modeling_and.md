# 6253 — Operations Research & Large-Scale Optimization: Cross-border multi-level warehouse network optimization: Modeling and application based on mixed-integer linear programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Cross-border multi-level warehouse network optimization: Modeling and application based on mixed-integer linear programming  
**Jurnal & Sitasi Utama:** Yun Gu (2025). *Operations Research Perspectives*. DOI: [10.1016/j.orp.2025.100366](10.1016/j.orp.2025.100366)  
**Sitasi Pendukung:** Lead Industrial Researchers (2023). *Information Sciences Letters*. DOI: [10.18576/isl/120902](10.18576/isl/120902)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yun Gu (2025) dalam jurnal *Operations Research Perspectives* (DOI: 10.1016/j.orp.2025.100366) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
