# 5044 — Simulation Modeling & Digital Twins: Implementation of Industry 4.0 and Digital Manufacturing Practices in Indian Manufacturing Industries Using Discrete Event Simulation (DES)

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Implementation of Industry 4.0 and Digital Manufacturing Practices in Indian Manufacturing Industries Using Discrete Event Simulation (DES)  
**Jurnal & Sitasi Utama:** Y. Y. More (2024). *Panamerican Mathematical Journal*. DOI: [10.52783/pmj.v33.i3.883](10.52783/pmj.v33.i3.883)  
**Sitasi Pendukung:** Giovanni Lugaresi, Andrea Matta (2024). *SSRN Electronic Journal*. DOI: [10.2139/ssrn.3857933](10.2139/ssrn.3857933)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Y. Y. More (2024) dalam jurnal *Panamerican Mathematical Journal* (DOI: 10.52783/pmj.v33.i3.883) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
