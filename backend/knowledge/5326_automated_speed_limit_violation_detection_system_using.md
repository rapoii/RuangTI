# 5326 — Industrial Artificial Intelligence & Data Analytics: Automated Speed Limit Violation Detection System Using Computer Vision and Deep Learning

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Automated Speed Limit Violation Detection System Using Computer Vision and Deep Learning  
**Jurnal & Sitasi Utama:** A.K.B. Nanayakkara, G.U. Ganegoda (2025). *2025 10th International Conference on Information Technology Research (ICITR)*. DOI: [10.1109/icitr69413.2025.11353737](10.1109/icitr69413.2025.11353737)  
**Sitasi Pendukung:** Weicheng Wang, Lixin He, Jie Li (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637830](10.1109/cvidl70130.2026.11637830)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari A.K.B. Nanayakkara, G.U. Ganegoda (2025) dalam jurnal *2025 10th International Conference on Information Technology Research (ICITR)* (DOI: 10.1109/icitr69413.2025.11353737) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Weicheng Wang, Lixin He, Jie Li (2026) yang dipublikasikan dalam *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
