# 5746 — Operations Research & Large-Scale Optimization: A hybrid fuzzy-stochastic multi-criteria ABC inventory classification using possibilistic chance-constrained programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A hybrid fuzzy-stochastic multi-criteria ABC inventory classification using possibilistic chance-constrained programming  
**Jurnal & Sitasi Utama:** Seyed Hossein Razavi Hajiagha, Maryam Daneshvar, Jurgita Antucheviciene (2021). *Soft Computing*. DOI: [10.1007/s00500-020-05204-z](10.1007/s00500-020-05204-z)  
**Sitasi Pendukung:** Bismark Singh (2023). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_784-1](10.1007/978-3-030-54621-2_784-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Seyed Hossein Razavi Hajiagha, Maryam Daneshvar, Jurgita Antucheviciene (2021) dalam jurnal *Soft Computing* (DOI: 10.1007/s00500-020-05204-z) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Bismark Singh (2023) yang dipublikasikan dalam *Encyclopedia of Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
