# 3502 — Production Planning & Inventory Control: Exploring Applications and Practical Examples by Streamlining Material Requirements Planning (MRP) with Python

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Exploring Applications and Practical Examples by Streamlining Material Requirements Planning (MRP) with Python  
**Jurnal & Sitasi Utama:** Jo�ão Reis (2023). *Logistics*. DOI: [10.3390/logistics7040091](10.3390/logistics7040091)  
**Sitasi Pendukung:** Ahlam Azzamouri, Pierre Baptiste, Guillaume Dessevre (2021). *Journal of Industrial Engineering and Management*. DOI: [10.3926/jiem.3331](10.3926/jiem.3331)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jo�ão Reis (2023) dalam jurnal *Logistics* (DOI: 10.3390/logistics7040091) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ahlam Azzamouri, Pierre Baptiste, Guillaume Dessevre (2021) yang dipublikasikan dalam *Journal of Industrial Engineering and Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
