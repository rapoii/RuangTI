# 4531 — Quality Engineering & Reliability Systems: Multivariate control charts for monitoring a bivariate correlated count process with application to meningococcal disease

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Multivariate control charts for monitoring a bivariate correlated count process with application to meningococcal disease  
**Jurnal & Sitasi Utama:** Hanhan Li, Cong Li (2023). *Statistical Methods in Medical Research*. DOI: [10.1177/09622802231206476](10.1177/09622802231206476)  
**Sitasi Pendukung:** Dina Putri Lestari, IZZATI RAHMI HG, YUDIANTRI ASDI (2023). *Jurnal Matematika UNAND*. DOI: [10.25077/jmua.12.1.78-85.2023](10.25077/jmua.12.1.78-85.2023)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hanhan Li, Cong Li (2023) dalam jurnal *Statistical Methods in Medical Research* (DOI: 10.1177/09622802231206476) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Dina Putri Lestari, IZZATI RAHMI HG, YUDIANTRI ASDI (2023) yang dipublikasikan dalam *Jurnal Matematika UNAND* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
