# 3889 — Industrial Artificial Intelligence & Data Analytics: GINNs: Graph-Informed Neural Networks for multiscale physics

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** GINNs: Graph-Informed Neural Networks for multiscale physics  
**Jurnal & Sitasi Utama:** Eric Joseph Hall, Søren Taverniers, Markos A. Katsoulakis (2021). *Journal of Computational Physics*. DOI: [10.1016/j.jcp.2021.110192](10.1016/j.jcp.2021.110192)  
**Sitasi Pendukung:** Gyouho Cho, Di Zhu, Jeffrey Joseph Campbell (2022). *IEEE Access*. DOI: [10.1109/access.2022.3208103](10.1109/access.2022.3208103)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eric Joseph Hall, Søren Taverniers, Markos A. Katsoulakis (2021) dalam jurnal *Journal of Computational Physics* (DOI: 10.1016/j.jcp.2021.110192) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Gyouho Cho, Di Zhu, Jeffrey Joseph Campbell (2022) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
