# 4786 — Production Planning & Inventory Control: Dynamic Lot Sizing in a Self-organizing Production

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Dynamic Lot Sizing in a Self-organizing Production  
**Jurnal & Sitasi Utama:** Martin Krockert, Marvin Matthes, Torsten Munkelt (2021). *Proceedings of the 13th International Conference on Agents and Artificial Intelligence*. DOI: [10.5220/0010300803610367](10.5220/0010300803610367)  
**Sitasi Pendukung:** Henri Ponda, Nur Fadilah Fatma (2023). *Heuristic*. DOI: [10.30996/heuristic.v20i2.10162](10.30996/heuristic.v20i2.10162)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Martin Krockert, Marvin Matthes, Torsten Munkelt (2021) dalam jurnal *Proceedings of the 13th International Conference on Agents and Artificial Intelligence* (DOI: 10.5220/0010300803610367) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Henri Ponda, Nur Fadilah Fatma (2023) yang dipublikasikan dalam *Heuristic* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
