# 5282 — Industrial Artificial Intelligence & Data Analytics: Application of Physics-Informed Neural Network (PINN) for Understanding Vortex-Induced Vibration with Tunable Stiffness

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Application of Physics-Informed Neural Network (PINN) for Understanding Vortex-Induced Vibration with Tunable Stiffness  
**Jurnal & Sitasi Utama:** Mujahid Khan (2024). *Peer-Reviewed Journal*. DOI: [10.31219/osf.io/9bhk7](10.31219/osf.io/9bhk7)  
**Sitasi Pendukung:** Jain M Francis, Rakesh Kumar, Chandhini G (2025). *Physica Scripta*. DOI: [10.1088/1402-4896/ae2391](10.1088/1402-4896/ae2391)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mujahid Khan (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.31219/osf.io/9bhk7) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Application of Physics-Informed Neural Network (PINN) for UnderstandingVortex-Induced Vibration with Tunable Stiffness"

Penelitian pendukung oleh Jain M Francis, Rakesh Kumar, Chandhini G (2025) yang dipublikasikan dalam *Physica Scripta* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
