# 6295 — Supply Chain Management & Logistics Engineering: Game Decision of a Closed-loop Supply Chain with components remanufacturing

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Game Decision of a Closed-loop Supply Chain with components remanufacturing  
**Jurnal & Sitasi Utama:** Yang Li, Zhihui Fan, Xiaomin Zhao (2021). *2021 IEEE International Conference on Recent Advances in Systems Science and Engineering (RASSE)*. DOI: [10.1109/rasse53195.2021.9686926](10.1109/rasse53195.2021.9686926)  
**Sitasi Pendukung:** Adel A. Alamri (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202305.0820.v1](10.20944/preprints202305.0820.v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yang Li, Zhihui Fan, Xiaomin Zhao (2021) dalam jurnal *2021 IEEE International Conference on Recent Advances in Systems Science and Engineering (RASSE)* (DOI: 10.1109/rasse53195.2021.9686926) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Adel A. Alamri (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
