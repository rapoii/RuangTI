# 3162 — Quality Engineering & Reliability Systems: Machine Vision Supported Quality Control Applications in Rotary Switch Production by Using Both Process FMEA and Design FMEA

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Machine Vision Supported Quality Control Applications in Rotary Switch Production by Using Both Process FMEA and Design FMEA  
**Jurnal & Sitasi Utama:** Ismet Karacan, Inanc Erdogan, Mustafa İĞDİL (2021). *Natural and Applied Sciences Journal*. DOI: [10.38061/idunas.850545](10.38061/idunas.850545)  
**Sitasi Pendukung:** Matthew Barsalou (2022). *Management and Production Engineering Review*. DOI: [10.24425/mper.2022.142395](10.24425/mper.2022.142395)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ismet Karacan, Inanc Erdogan, Mustafa İĞDİL (2021) dalam jurnal *Natural and Applied Sciences Journal* (DOI: 10.38061/idunas.850545) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Matthew Barsalou (2022) yang dipublikasikan dalam *Management and Production Engineering Review* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
