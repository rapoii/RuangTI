# 4663 — Manufacturing Systems & Cyber-Physical Production: Events-Based Semantic Services Composition in Industry 4.0 Using Asset Administration Shell Meta-Model for Digital Twins

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Events-Based Semantic Services Composition in Industry 4.0 Using Asset Administration Shell Meta-Model for Digital Twins  
**Jurnal & Sitasi Utama:** Thierry Louge, Sina Namaki Aragh, Arkopaul Sarkar (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4963640](10.2139/ssrn.4963640)  
**Sitasi Pendukung:** Sima Das, Ajay Kumar Balmiki, Kaushik Mazumdar (2022). *Intelligent Cyber-Physical Systems Security for Industry 4.0*. DOI: [10.1201/9781003241348-11](10.1201/9781003241348-11)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thierry Louge, Sina Namaki Aragh, Arkopaul Sarkar (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4963640) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sima Das, Ajay Kumar Balmiki, Kaushik Mazumdar (2022) yang dipublikasikan dalam *Intelligent Cyber-Physical Systems Security for Industry 4.0* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
