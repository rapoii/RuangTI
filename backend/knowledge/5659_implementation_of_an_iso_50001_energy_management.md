# 5659 — Industrial Energy Management & Decarbonization: Implementation of an ISO 50001 energy management system using Lean Six Sigma in an Irish dairy: a case study

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Implementation of an ISO 50001 energy management system using Lean Six Sigma in an Irish dairy: a case study  
**Jurnal & Sitasi Utama:** Anna Trubetskaya, Olivia McDermott, Seamus McGovern (2023). *The TQM Journal*. DOI: [10.1108/tqm-08-2022-0252](10.1108/tqm-08-2022-0252)  
**Sitasi Pendukung:** Glenn Baxter (2022). *International Journal of Environment, Agriculture and Biotechnology*. DOI: [10.22161/ijeab.76.10](10.22161/ijeab.76.10)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anna Trubetskaya, Olivia McDermott, Seamus McGovern (2023) dalam jurnal *The TQM Journal* (DOI: 10.1108/tqm-08-2022-0252) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Purpose
                    ...
                    Findings
                      ...
                      The replacement of heavy oil with liquid natural gas in combination with the new design of steam boilers led to a CO
                      2
                      footprint reduction of almost 50%.
                    ...
                    Originality/value
                    The novelty of this study is the application of LSS in the dairy sector as an enabler of a greater energy-efficient facility, as well as the testing of the DMAIC approach to meet a"

Penelitian pendukung oleh Glenn Baxter (2022) yang dipublikasikan dalam *International Journal of Environment, Agriculture and Biotechnology* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
