# 4542 — Quality Engineering & Reliability Systems: Quality Control Analysis Using Six Sigma Method with DMAIC Approach to Improve the Quality of Granite Products

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Quality Control Analysis Using Six Sigma Method with DMAIC Approach to Improve the Quality of Granite Products  
**Jurnal & Sitasi Utama:** Danu Pratama Putra, Atikha Sidhi Cahyana (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.9432](10.21070/ups.9432)  
**Sitasi Pendukung:** Mohammad H. Al-Rifai (2024). *Lean Six Sigma*. DOI: [10.4324/9781032688343-1](10.4324/9781032688343-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Danu Pratama Putra, Atikha Sidhi Cahyana (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21070/ups.9432) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mohammad H. Al-Rifai (2024) yang dipublikasikan dalam *Lean Six Sigma* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
