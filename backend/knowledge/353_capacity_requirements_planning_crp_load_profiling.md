# Modul Komprehensif: Capacity Requirements Planning (CRP) & Load Profiling Stasiun Kerja Lantai Pabrik
**Nomor Modul:** [353]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Operations Management: Processes and Supply Chains (Krajewski et al.), Production and Operations Management (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Capacity Requirements Planning (CRP) & Load Profiling Stasiun Kerja Lantai Pabrik**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Routings, Run Time, Setup Time, Work Center Load Profiling, Under-Capacity vs Over-Capacity Smoothing, Overtime vs Subcontracting.
...
```python
# Algoritma Solusi Terapan untuk Capacity Requirements Planning (CRP) & Load Profiling Stasiun Kerja Lantai Pabrik
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penyeimbangan Beban Kerja (Load Leveling) 18 Mesin Bubut CNC Stasiun Pemesinan Presisi.
...
1. Operations Management: Processes and Supply Chains (Krajewski et al.), Production and Operations Management (2024).
