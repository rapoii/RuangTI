# 5917 — Applied Statistics & Stochastic Modeling: Modeling the Dynamics of Propagated Flight Delay: A case study of the United States National Aviation System

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Modeling the Dynamics of Propagated Flight Delay: A case study of the United States National Aviation System  
**Jurnal & Sitasi Utama:** Richard Termaat (2018). *Research Repository (Delft University of Technology)*. DOI: [10.openalex/w2794167736](10.openalex/w2794167736)  
**Sitasi Pendukung:** N.J. Starreveld (2019). *UvA-DARE (University of Amsterdam)*. DOI: [10.openalex/w2922180668](10.openalex/w2922180668)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Richard Termaat (2018) dalam jurnal *Research Repository (Delft University of Technology)* (DOI: 10.openalex/w2794167736) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
