# 5463 — Supply Chain Management & Logistics Engineering: Supply Chain System Analysis in Single Vendor and Multi Retailer to Reduce Bullwhip Effect Using Vendor Managed Inventory (VMI) Method at Company X

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Supply Chain System Analysis in Single Vendor and Multi Retailer to Reduce Bullwhip Effect Using Vendor Managed Inventory (VMI) Method at Company X  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2023). *Nusantara Science and Technology Proceedings*. DOI: [10.11594/nstp.2023.3638](10.11594/nstp.2023.3638)  
**Sitasi Pendukung:** R. Fokouop, Z. Jemai, E. Sahin (2022). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2022.10.187](10.1016/j.ifacol.2022.10.187)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2023) dalam jurnal *Nusantara Science and Technology Proceedings* (DOI: 10.11594/nstp.2023.3638) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh R. Fokouop, Z. Jemai, E. Sahin (2022) yang dipublikasikan dalam *IFAC-PapersOnLine* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
