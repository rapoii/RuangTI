# 4321 — Supply Chain Management & Logistics Engineering: Deep Reinforcement Learning toward Robust Multi-echelon Supply Chain Inventory Optimization

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Deep Reinforcement Learning toward Robust Multi-echelon Supply Chain Inventory Optimization  
**Jurnal & Sitasi Utama:** Ibrahim El Shar, Wenhuan Sun, Haiyan Wang (2022). *2022 IEEE 18th International Conference on Automation Science and Engineering (CASE)*. DOI: [10.1109/case49997.2022.9926659](10.1109/case49997.2022.9926659)  
**Sitasi Pendukung:** Cong Yang, Woonghee Tim Huh (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4348606](10.2139/ssrn.4348606)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ibrahim El Shar, Wenhuan Sun, Haiyan Wang (2022) dalam jurnal *2022 IEEE 18th International Conference on Automation Science and Engineering (CASE)* (DOI: 10.1109/case49997.2022.9926659) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Cong Yang, Woonghee Tim Huh (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
