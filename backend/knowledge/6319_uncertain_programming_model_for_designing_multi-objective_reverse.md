# 6319 — Supply Chain Management & Logistics Engineering: Uncertain programming model for designing multi-objective reverse logistics networks

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Uncertain programming model for designing multi-objective reverse logistics networks  
**Jurnal & Sitasi Utama:** Hanbing Xia, Zhiyuan Chen, Jelena Milisavljevic-Syed (2024). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2024.100155](10.1016/j.clscn.2024.100155)  
**Sitasi Pendukung:** Qiran Wu (2025). *Advances in Economics, Management and Political Sciences*. DOI: [10.54254/2754-1169/2025.bl29405](10.54254/2754-1169/2025.bl29405)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hanbing Xia, Zhiyuan Chen, Jelena Milisavljevic-Syed (2024) dalam jurnal *Cleaner Logistics and Supply Chain* (DOI: 10.1016/j.clscn.2024.100155) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qiran Wu (2025) yang dipublikasikan dalam *Advances in Economics, Management and Political Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
