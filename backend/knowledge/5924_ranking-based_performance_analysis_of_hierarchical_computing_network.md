# 5924 — Applied Statistics & Stochastic Modeling: Ranking-Based performance Analysis of Hierarchical Computing Network under Task Impatience

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Ranking-Based performance Analysis of Hierarchical Computing Network under Task Impatience  
**Jurnal & Sitasi Utama:** Sachin R. Gurnule, P. Pranay, V.N. Rama Devi (2026). *International Journal of Artificial Intelligence and Machine Learning*. DOI: [10.51483/ijaiml.6.4s.2026.160-180](10.51483/ijaiml.6.4s.2026.160-180)  
**Sitasi Pendukung:** Balakrishna Prabhu (2023). *HAL (Le Centre pour la Communication Scientifique Directe)*. DOI: [10.openalex/w4406353241](10.openalex/w4406353241)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sachin R. Gurnule, P. Pranay, V.N. Rama Devi (2026) dalam jurnal *International Journal of Artificial Intelligence and Machine Learning* (DOI: 10.51483/ijaiml.6.4s.2026.160-180) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
