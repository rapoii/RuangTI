# 4423 — Manufacturing Systems & Cyber-Physical Production: Edge computing-based real-time scheduling for digital twin flexible job shop with variable time window

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Edge computing-based real-time scheduling for digital twin flexible job shop with variable time window  
**Jurnal & Sitasi Utama:** Jin Wang, Yang Liu, Shan Ren (2023). *Robotics and Computer-Integrated Manufacturing*. DOI: [10.1016/j.rcim.2022.102435](10.1016/j.rcim.2022.102435)  
**Sitasi Pendukung:** Cathal Hoare, Andrew Parnell, Denis Dowling (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4680266](10.2139/ssrn.4680266)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jin Wang, Yang Liu, Shan Ren (2023) dalam jurnal *Robotics and Computer-Integrated Manufacturing* (DOI: 10.1016/j.rcim.2022.102435) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Cathal Hoare, Andrew Parnell, Denis Dowling (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
