# 5285 — Industrial Artificial Intelligence & Data Analytics: NAS-PINN: Neural architecture search-guided physics-informed neural network for solving PDEs

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** NAS-PINN: Neural architecture search-guided physics-informed neural network for solving PDEs  
**Jurnal & Sitasi Utama:** Yifan Wang, Linlin Zhong (2024). *Journal of Computational Physics*. DOI: [10.1016/j.jcp.2023.112603](10.1016/j.jcp.2023.112603)  
**Sitasi Pendukung:** Xiaodong Zhang, Daobo Sun, Ting Liu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5357487](10.2139/ssrn.5357487)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yifan Wang, Linlin Zhong (2024) dalam jurnal *Journal of Computational Physics* (DOI: 10.1016/j.jcp.2023.112603) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xiaodong Zhang, Daobo Sun, Ting Liu (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
