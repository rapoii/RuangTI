# 4339 — Supply Chain Management & Logistics Engineering: An inventory analysis in a multi-echelon supply chain system under asymmetry fuzzy demand: a fmincon optimization

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** An inventory analysis in a multi-echelon supply chain system under asymmetry fuzzy demand: a fmincon optimization  
**Jurnal & Sitasi Utama:** B. Karthick (2023). *Journal of Management Analytics*. DOI: [10.1080/23270012.2023.2239818](10.1080/23270012.2023.2239818)  
**Sitasi Pendukung:** Paras Shingadiya, Chetansinh Vaghela, Santanu Roy (2025). *2025 International Conference on Recent Innovation in Science Engineering and Technology (ICRISET)*. DOI: [10.1109/icriset64803.2025.11252123](10.1109/icriset64803.2025.11252123)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari B. Karthick (2023) dalam jurnal *Journal of Management Analytics* (DOI: 10.1080/23270012.2023.2239818) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Paras Shingadiya, Chetansinh Vaghela, Santanu Roy (2025) yang dipublikasikan dalam *2025 International Conference on Recent Innovation in Science Engineering and Technology (ICRISET)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
