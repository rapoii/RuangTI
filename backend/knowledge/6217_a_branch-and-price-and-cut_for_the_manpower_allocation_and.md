# 6217 — Operations Research & Large-Scale Optimization: A Branch-and-Price-and-Cut for the Manpower Allocation and Vehicle Routing Problem with Limited Staff Resources and Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Branch-and-Price-and-Cut for the Manpower Allocation and Vehicle Routing Problem with Limited Staff Resources and Time Windows  
**Jurnal & Sitasi Utama:** XINXIN SU (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4025847](10.2139/ssrn.4025847)  
**Sitasi Pendukung:** Maurizio Bruglieri, Massimo Paolucci, Ornella Pisacane (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4110443](10.2139/ssrn.4110443)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari XINXIN SU (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4025847) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "In the context of the non-emergency ambulance transfer service in Hong Kong public hospitals, we study a manpower allocation and vehicle routing problem with limited staff resources and time windows (MAVRP-SRTW), a new variant of the manpower allocation and vehicle routing problem. The MAVRP-SRTW allocates staff to vehicles and plans vehicle routes to transport elderly or disabled patients scattered in different locations to a hospital. The objective is to minimize the outsourcing costs of unfilled patient requests and the travel costs of vehicles. We formulate this problem as an arc-flow model and a set-packing model, where the latter is solved exactly by a branch-and-price-and-cut (BPC) algorithm. To accelerate the column generation process in the BPC framework, we apply the bounded bidirectional search and decremental state-space relaxation techniques for the pricing subproblem. Meanwhile, the subset-row inequalities are utilized to tighten the master problem. Numerical results based on the well-known Solomon’s benchmark instances show that our BPC algorithm significantly outperforms CPLEX in terms of the number of optimally solved instances and the computing time. Results also suggest that the BPC can solve most instances within 40 requests to optimality in an acceptable time frame. Sensitivity analyses show that the performance of the BPC is closely related to the numbers of vehicles and staff members."

Penelitian pendukung oleh Maurizio Bruglieri, Massimo Paolucci, Ornella Pisacane (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
