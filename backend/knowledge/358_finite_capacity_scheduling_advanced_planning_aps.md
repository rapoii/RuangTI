# Modul Komprehensif: Finite Capacity Scheduling & Advanced Planning and Scheduling (APS) Systems
**Nomor Modul:** [358]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Real-Time Supply Chain Orchestration (Springer), Computers in Industry (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Finite Capacity Scheduling & Advanced Planning and Scheduling (APS) Systems**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Finite vs Infinite Capacity Loading, Constraint Programming, Genetic Algorithm APS Solvers, Dynamic Rescheduling under Machine Breakdowns.
...
```python
# Algoritma Solusi Terapan untuk Finite Capacity Scheduling & Advanced Planning and Scheduling (APS) Systems
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penjadwalan Multi-Plant APS 12 Pabrik Tekstil Terpadu dengan Algoritma Constraint Propagation.
...
1. Real-Time Supply Chain Orchestration (Springer), Computers in Industry (2024).
