# 4793 — Production Planning & Inventory Control: Trade credit policies in dynamic lot-sizing with cash-to-cash cycle financing costs: Model, analysis, and a dynamic programming algorithm

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Trade credit policies in dynamic lot-sizing with cash-to-cash cycle financing costs: Model, analysis, and a dynamic programming algorithm  
**Jurnal & Sitasi Utama:** Oussama Kajjoune, Tarik Aouam (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6624082](10.2139/ssrn.6624082)  
**Sitasi Pendukung:** Satriya Dwi Santoso, Dwi Sukma Donoriyanto, Handoyo Handoyo (2020). *JUMINTEN*. DOI: [10.33005/juminten.v1i4.6](10.33005/juminten.v1i4.6)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Oussama Kajjoune, Tarik Aouam (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6624082) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper studies Trade Credit (TC) options in dynamic lot-sizing (DLS) with cash-to-cash (C2C) cycle financing costs, a problem which has not been addressed in the literature. We consider a manufacturer facing time-varying demand and procuring raw materials from suppliers offering multiple TC options. The objective is to jointly determine the optimal production plan and TC policy that maximize the net present value of cash flows. We present a new model that unifies common TC payment-term structures and derives optimal upstream TC decisions as a function of production decisions, the C2C cycle, the discount factor, and financing interest rates. We further show that the zero-inventory-ordering property remains valid and develop a dynamic programming algorithm to solve the integrated problem efficiently. Extensive computational experiments on newly constructed 69,120 test instances demonstrate the economic value of integrating lot-sizing and TC decisions. On average, the integrated model improves the objective value by 5.24% relative to an intermediate benchmark that accounts for working capital financing costs but ignores TC options, and by 6.91% relative to the classical DLS model, with positive gains observed in 84.37% and 99.82% of instances, respectively."

Penelitian pendukung oleh Satriya Dwi Santoso, Dwi Sukma Donoriyanto, Handoyo Handoyo (2020) yang dipublikasikan dalam *JUMINTEN* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
