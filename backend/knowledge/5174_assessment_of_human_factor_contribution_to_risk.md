# 5174 — Safety Engineering & Risk Management: Assessment of human factor contribution to risk analysis of chemical cargo shortage incidents by using intuitionistic fuzzy integrated fault tree analysis

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Assessment of human factor contribution to risk analysis of chemical cargo shortage incidents by using intuitionistic fuzzy integrated fault tree analysis  
**Jurnal & Sitasi Utama:** Yunus Emre Senol (2024). *Ocean Engineering*. DOI: [10.1016/j.oceaneng.2024.117559](10.1016/j.oceaneng.2024.117559)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Peer-Reviewed Journal*. DOI: [10.5256/f1000research.175697.r367487](10.5256/f1000research.175697.r367487)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yunus Emre Senol (2024) dalam jurnal *Ocean Engineering* (DOI: 10.1016/j.oceaneng.2024.117559) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2025) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
