# 5409 — Operations Research & Large-Scale Optimization: An asynchronous parallel benders decomposition method for stochastic network design problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** An asynchronous parallel benders decomposition method for stochastic network design problems  
**Jurnal & Sitasi Utama:** Ragheb Rahmaniani, Teodor Gabriel Crainic, Michel Gendreau (2024). *Computers &amp; Operations Research*. DOI: [10.1016/j.cor.2023.106459](10.1016/j.cor.2023.106459)  
**Sitasi Pendukung:** Ehsan Mirzaei, Ehsan Nikbakhsh, Ali Husseinzadeh Kashan (2025). *Computers &amp; Industrial Engineering*. DOI: [10.1016/j.cie.2025.111234](10.1016/j.cie.2025.111234)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ragheb Rahmaniani, Teodor Gabriel Crainic, Michel Gendreau (2024) dalam jurnal *Computers &amp; Operations Research* (DOI: 10.1016/j.cor.2023.106459) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ehsan Mirzaei, Ehsan Nikbakhsh, Ali Husseinzadeh Kashan (2025) yang dipublikasikan dalam *Computers &amp; Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
