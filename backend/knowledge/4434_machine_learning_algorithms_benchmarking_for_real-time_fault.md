# 4434 — Manufacturing Systems & Cyber-Physical Production: Machine learning algorithms benchmarking for real-time fault predictable scheduling on a shop floor

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Machine learning algorithms benchmarking for real-time fault predictable scheduling on a shop floor  
**Jurnal & Sitasi Utama:** Wenda Wu, Wei Ji, Lihui Wang (2021). *International Journal of Manufacturing Research*. DOI: [10.1504/ijmr.2021.114006](10.1504/ijmr.2021.114006)  
**Sitasi Pendukung:** Lead Industrial Researchers (2023). *Journal of Mechanical Engineering*. DOI: [10.3901/jme.2023.12.062](10.3901/jme.2023.12.062)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wenda Wu, Wei Ji, Lihui Wang (2021) dalam jurnal *International Journal of Manufacturing Research* (DOI: 10.1504/ijmr.2021.114006) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2023) yang dipublikasikan dalam *Journal of Mechanical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
