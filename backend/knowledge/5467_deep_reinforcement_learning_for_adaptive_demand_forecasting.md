# 5467 — Supply Chain Management & Logistics Engineering: Deep Reinforcement Learning for Adaptive Demand Forecasting and Perishable Inventory Optimization in Multi-Echelon Supply Chain

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Deep Reinforcement Learning for Adaptive Demand Forecasting and Perishable Inventory Optimization in Multi-Echelon Supply Chain  
**Jurnal & Sitasi Utama:** R. Dhivya, G.Thailambal (2025). *2025 9th International Conference on Electronics, Communication and Aerospace Technology (ICECA)*. DOI: [10.1109/iceca66444.2025.11382835](10.1109/iceca66444.2025.11382835)  
...
Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari R. Dhivya, G.Thailambal (2025) dalam jurnal *2025 9th International Conference on Electronics, Communication and Aerospace Technology (ICECA)* (DOI: 10.1109/iceca66444.2025.11382835) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
