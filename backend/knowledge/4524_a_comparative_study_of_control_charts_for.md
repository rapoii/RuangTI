# 4524 — Quality Engineering & Reliability Systems: A comparative study of control charts for covariance shift detection using hotelling
                    <i>T</i>
                    -squared, generalized variance, and autoencoder

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** A comparative study of control charts for covariance shift detection using hotelling
                    <i>T</i>
                    -squared, generalized variance, and autoencoder  
**Jurnal & Sitasi Utama:** Sungim Lee (2025). *Communications for Statistical Applications and Methods*. DOI: [10.29220/csam.2025.32.6.757](10.29220/csam.2025.32.6.757)  
**Sitasi Pendukung:** Markos V. Koutras, Ioannis S. Triantafyllou (2020). *Distribution-Free Methods for Statistical Process Monitoring and Control*. DOI: [10.1007/978-3-030-25081-2_1](10.1007/978-3-030-25081-2_1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sungim Lee (2025) dalam jurnal *Communications for Statistical Applications and Methods* (DOI: 10.29220/csam.2025.32.6.757) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
