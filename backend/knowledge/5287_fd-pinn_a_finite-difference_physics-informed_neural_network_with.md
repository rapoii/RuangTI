# 5287 — Industrial Artificial Intelligence & Data Analytics: FD-PINN: A Finite-Difference Physics-Informed Neural Network with Adaptive Residual Point Selection for Seismic Inversion Improving PINNs with Finite-Difference Derivatives and Adaptive Residual Sampling FD-PINN for Seismic Inversion

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** FD-PINN: A Finite-Difference Physics-Informed Neural Network with Adaptive Residual Point Selection for Seismic Inversion Improving PINNs with Finite-Difference Derivatives and Adaptive Residual Sampling FD-PINN for Seismic Inversion  
**Jurnal & Sitasi Utama:** Zekai Guo, Ye Li (2025). *Proceedings of the 2025 2nd Symposium on Big Data, Neural Networks, and Deep Learning*. DOI: [10.1145/3784013.3784074](10.1145/3784013.3784074)  
**Sitasi Pendukung:** Sahar Hemmati, Mohammadreza Babaei, John Hedengren (2026). *Systems and Control Transactions*. DOI: [10.69997/sct.135132](10.69997/sct.135132)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zekai Guo, Ye Li (2025) dalam jurnal *Proceedings of the 2025 2nd Symposium on Big Data, Neural Networks, and Deep Learning* (DOI: 10.1145/3784013.3784074) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sahar Hemmati, Mohammadreza Babaei, John Hedengren (2026) yang dipublikasikan dalam *Systems and Control Transactions* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
