# 3900 — Industrial Artificial Intelligence & Data Analytics: Physics-Informed Neural Networks (PINNs) for Improving a Thermal Model in Stereolithography Applications

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-Informed Neural Networks (PINNs) for Improving a Thermal Model in Stereolithography Applications  
**Jurnal & Sitasi Utama:** Georges Tod, Agusmian Partogi Ompusunggu, Gunther Struyf (2021). *Procedia CIRP*. DOI: [10.1016/j.procir.2021.11.263](10.1016/j.procir.2021.11.263)  
**Sitasi Pendukung:** Chenyu Xue, Bo Jiang, Jiangong Zhu (2023). *Batteries*. DOI: [10.3390/batteries9100511](10.3390/batteries9100511)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Georges Tod, Agusmian Partogi Ompusunggu, Gunther Struyf (2021) dalam jurnal *Procedia CIRP* (DOI: 10.1016/j.procir.2021.11.263) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chenyu Xue, Bo Jiang, Jiangong Zhu (2023) yang dipublikasikan dalam *Batteries* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
