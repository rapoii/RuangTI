# 4562 — Operations Research & Large-Scale Optimization: A Mixed Integer Linear Programming Formulation for Subway Timetable Optimization Problems with Passenger Waiting  and Energy Saving Objectives

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Mixed Integer Linear Programming Formulation for Subway Timetable Optimization Problems with Passenger Waiting  and Energy Saving Objectives  
**Jurnal & Sitasi Utama:** Anbang Liu, Xi Chen (2024). *Peer-Reviewed Journal*. DOI: [10.36227/techrxiv.22302682](10.36227/techrxiv.22302682)  
**Sitasi Pendukung:** Miguel Gonzalez-Salazar, Julia KLOSSEK, Pascal DUBUCQ (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4157118](10.2139/ssrn.4157118)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anbang Liu, Xi Chen (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.36227/techrxiv.22302682) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
