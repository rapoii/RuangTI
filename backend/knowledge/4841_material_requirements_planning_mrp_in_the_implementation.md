# 4841 — Production Planning & Inventory Control: Material Requirements Planning (MRP) in the Implementation of Minimarket Inventory Stock Control

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Material Requirements Planning (MRP) in the Implementation of Minimarket Inventory Stock Control  
**Jurnal & Sitasi Utama:** Rila Fauziah, Muhammad Nandy Pinto, Lusiana Lusiana (2026). *Jurnal Manajemen dan Profesional*. DOI: [10.32815/jpro.v7i2.3052](10.32815/jpro.v7i2.3052)  
**Sitasi Pendukung:** Astabraq Mohammed Jawad Hassan, Asfad Murtada Said, Hakeem Imad Mhaibes (2026). *F1000Research*. DOI: [10.12688/f1000research.175679.1](10.12688/f1000research.175679.1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rila Fauziah, Muhammad Nandy Pinto, Lusiana Lusiana (2026) dalam jurnal *Jurnal Manajemen dan Profesional* (DOI: 10.32815/jpro.v7i2.3052) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Inventory control is a key to operational success in minimarket retail. This study examines the effectiveness of the Material Requirements Planning (MRP) method adapted from manufacturing to retail inventory systems. Through quantitative simulation, the Master Production Schedule was adjusted into a Master Procurement Schedule based on Point of Sale data. MRP computation proved effective in balancing shelf inventory on a Just-in-Time basis. Results indicate a reduction in stockouts to below 2%, an increase in inventory turnover, and holding cost efficiencies of up to 35%. This implementation successfully optimizes minimarket working capital turnover efficiently."

Penelitian pendukung oleh Astabraq Mohammed Jawad Hassan, Asfad Murtada Said, Hakeem Imad Mhaibes (2026) yang dipublikasikan dalam *F1000Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
