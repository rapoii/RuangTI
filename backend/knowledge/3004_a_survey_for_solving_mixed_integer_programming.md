# 3004 — Operations Research & Large-Scale Optimization: A Survey for Solving Mixed Integer Programming via Machine Learning

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Survey for Solving Mixed Integer Programming via Machine Learning  
**Jurnal & Sitasi Utama:** Jiayi Zhang, Chang Liu, Junchi Yan (2022). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2203.02878](10.48550/arxiv.2203.02878)  
**Sitasi Pendukung:** Miten Mistry, Dimitrios Letsios, G. Krennrich (2020). *INFORMS journal on computing*. DOI: [10.1287/ijoc.2020.0993](10.1287/ijoc.2020.0993)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiayi Zhang, Chang Liu, Junchi Yan (2022) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2203.02878) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
