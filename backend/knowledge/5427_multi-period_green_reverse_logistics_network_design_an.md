# 5427 — Operations Research & Large-Scale Optimization: Multi-period green reverse logistics network design: An improved Benders-decomposition-based heuristic approach

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multi-period green reverse logistics network design: An improved Benders-decomposition-based heuristic approach  
**Jurnal & Sitasi Utama:** K. Nageswara Reddy, Akhilesh Kumar, Alok Choudhary (2022). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2022.03.014](10.1016/j.ejor.2022.03.014)  
**Sitasi Pendukung:** Rasul Esmaeilbeigi, Richard Middleton, Rodolfo García-Flores (2025). *Annals of Operations Research*. DOI: [10.1007/s10479-021-04309-4](10.1007/s10479-021-04309-4)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari K. Nageswara Reddy, Akhilesh Kumar, Alok Choudhary (2022) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2022.03.014) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Rasul Esmaeilbeigi, Richard Middleton, Rodolfo García-Flores (2025) yang dipublikasikan dalam *Annals of Operations Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
