# 3725 — Industrial Energy Management & Decarbonization: Improved design of heat-pump extractive distillation based on the process optimization and multi-criteria sustainability analysis

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Improved design of heat-pump extractive distillation based on the process optimization and multi-criteria sustainability analysis  
**Jurnal & Sitasi Utama:** Tao Shi, Yue Liu, Haoshui Yu (2021). *Computers & Chemical Engineering*. DOI: [10.1016/j.compchemeng.2021.107552](10.1016/j.compchemeng.2021.107552)  
**Sitasi Pendukung:** Guillermo Martínez-Rodríguez, Amanda L. Fuentes–Silva, Daniel Velázquez-Torres (2021). *Energy*. DOI: [10.1016/j.energy.2021.122332](10.1016/j.energy.2021.122332)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tao Shi, Yue Liu, Haoshui Yu (2021) dalam jurnal *Computers & Chemical Engineering* (DOI: 10.1016/j.compchemeng.2021.107552) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Guillermo Martínez-Rodríguez, Amanda L. Fuentes–Silva, Daniel Velázquez-Torres (2021) yang dipublikasikan dalam *Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
