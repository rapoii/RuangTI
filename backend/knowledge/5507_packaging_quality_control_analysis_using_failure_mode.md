# 5507 — Quality Engineering & Reliability Systems: Packaging Quality Control Analysis Using Failure Mode And Effect Analysis (FMEA) And Fault Tree Analysis (FTA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Packaging Quality Control Analysis Using Failure Mode And Effect Analysis (FMEA) And Fault Tree Analysis (FTA)  
**Jurnal & Sitasi Utama:** Muhammad Rizki Kurniawan, Atikha Sidhi Cahyana (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.3388](10.21070/ups.3388)  
