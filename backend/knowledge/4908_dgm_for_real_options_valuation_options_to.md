# 4908 — Engineering Economics & Cost Optimization: DGM for real options valuation: Options to change operating scale

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** DGM for real options valuation: Options to change operating scale  
**Jurnal & Sitasi Utama:** Jiří Hozman, Tomáš Tichý (2023). *Programs and Algorithms of Numerical Mathematics 21*. DOI: [10.21136/panm.2022.08](10.21136/panm.2022.08)  
**Sitasi Pendukung:** Roberto Moro-Visconti (2025). *Patent Valuation*. DOI: [10.1007/978-3-031-88443-6_9](10.1007/978-3-031-88443-6_9)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiří Hozman, Tomáš Tichý (2023) dalam jurnal *Programs and Algorithms of Numerical Mathematics 21* (DOI: 10.21136/panm.2022.08) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Roberto Moro-Visconti (2025) yang dipublikasikan dalam *Patent Valuation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
