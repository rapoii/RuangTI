# 3893 — Industrial Artificial Intelligence & Data Analytics: Physics-Informed Neural Networks for the Condition Monitoring of Rotating Shafts

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-Informed Neural Networks for the Condition Monitoring of Rotating Shafts  
**Jurnal & Sitasi Utama:** Marc Parziale, Luca Lomazzi, Marco Giglio (2023). *Sensors*. DOI: [10.3390/s24010207](10.3390/s24010207)  
**Sitasi Pendukung:** Elijah Hao Wei Ang, Guangjian Wang, Bing Feng Ng (2023). *Energies*. DOI: [10.3390/en16124558](10.3390/en16124558)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marc Parziale, Luca Lomazzi, Marco Giglio (2023) dalam jurnal *Sensors* (DOI: 10.3390/s24010207) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
