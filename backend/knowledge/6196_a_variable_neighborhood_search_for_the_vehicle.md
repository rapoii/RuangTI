# 6196 — Operations Research & Large-Scale Optimization: A Variable Neighborhood Search for the Vehicle Routing Problem with Occasional Drivers and Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Variable Neighborhood Search for the Vehicle Routing Problem with Occasional Drivers and Time Windows  
**Jurnal & Sitasi Utama:** Giusy Macrina, Luigi Pugliese, Francesca Guerriero (2020). *Proceedings of the 9th International Conference on Operations Research and Enterprise Systems*. DOI: [10.5220/0009193302700277](10.5220/0009193302700277)  
**Sitasi Pendukung:** Zhihao Jiang, Fuguang Bao, Ning Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4263893](10.2139/ssrn.4263893)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Giusy Macrina, Luigi Pugliese, Francesca Guerriero (2020) dalam jurnal *Proceedings of the 9th International Conference on Operations Research and Enterprise Systems* (DOI: 10.5220/0009193302700277) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Zhihao Jiang, Fuguang Bao, Ning Wang (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
