# 4183 — Applied Statistics & Stochastic Modeling: Explicit Steady-State Approximations for Parallel Server Systems with Heterogeneous Servers

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Explicit Steady-State Approximations for Parallel Server Systems with Heterogeneous Servers  
**Jurnal & Sitasi Utama:** Yaosheng Xu (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2406.04203](10.48550/arxiv.2406.04203)  
**Sitasi Pendukung:** Pedro R. D'Argenio, Arnd Hartmanns, Annabell Petri (2026). *arXiv (Cornell University)*. DOI: [10.openalex/w7167290492](10.openalex/w7167290492)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yaosheng Xu (2024) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2406.04203) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Pedro R. D'Argenio, Arnd Hartmanns, Annabell Petri (2026) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
