# 3080 — Manufacturing Systems & Cyber-Physical Production: Digital twin and the asset administration shell

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Digital twin and the asset administration shell  
**Jurnal & Sitasi Utama:** Jingxi Zhang, Carsten Ellwein, Malte Heithoff (2025). *Software & Systems Modeling*. DOI: [10.1007/s10270-024-01255-0](10.1007/s10270-024-01255-0)  
**Sitasi Pendukung:** Salvatore Cavalieri, Marco Giuseppe Salafia (2020). *IEEE Access*. DOI: [10.1109/access.2020.3013890](10.1109/access.2020.3013890)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jingxi Zhang, Carsten Ellwein, Malte Heithoff (2025) dalam jurnal *Software & Systems Modeling* (DOI: 10.1007/s10270-024-01255-0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Salvatore Cavalieri, Marco Giuseppe Salafia (2020) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
