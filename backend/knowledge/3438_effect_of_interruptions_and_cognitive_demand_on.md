# 3438 — Human Factors & Cognitive Ergonomics: Effect of Interruptions and Cognitive Demand on Mental Workload: A Critical Review

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Effect of Interruptions and Cognitive Demand on Mental Workload: A Critical Review  
**Jurnal & Sitasi Utama:** Nitin Koundal, Abdualrhman Abdalhadi, Maged S. Al-Quraishi (2024). *IEEE Access*. DOI: [10.1109/access.2024.3383142](10.1109/access.2024.3383142)  
**Sitasi Pendukung:** Tong Xue, Abdallah El Ali, Tianyi Zhang (2021). *IEEE Transactions on Multimedia*. DOI: [10.1109/tmm.2021.3124080](10.1109/tmm.2021.3124080)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nitin Koundal, Abdualrhman Abdalhadi, Maged S. Al-Quraishi (2024) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2024.3383142) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tong Xue, Abdallah El Ali, Tianyi Zhang (2021) yang dipublikasikan dalam *IEEE Transactions on Multimedia* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
