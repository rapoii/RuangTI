# 5014 — Applied Statistics & Stochastic Modeling: Treatment of Pulp Black Liquor with an Ionic Liquid: Modeling and Optimization by Using Response Surface Methodology and Central Composite Design

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Treatment of Pulp Black Liquor with an Ionic Liquid: Modeling and Optimization by Using Response Surface Methodology and Central Composite Design  
**Jurnal & Sitasi Utama:** Nicolas Papaiconomou, Jean‐Pierre Magnin, Isabelle Billard (2023). *ChemPlusChem*. DOI: [10.1002/cplu.202200348](10.1002/cplu.202200348)  
**Sitasi Pendukung:** Nur Dinie Syahirah Sanusi, Fadhlina Che Ros, Haira Rizan Mokhtar (2024). *Journal of Advanced Research Design*. DOI: [10.37934/ard.122.1.249268](10.37934/ard.122.1.249268)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nicolas Papaiconomou, Jean‐Pierre Magnin, Isabelle Billard (2023) dalam jurnal *ChemPlusChem* (DOI: 10.1002/cplu.202200348) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nur Dinie Syahirah Sanusi, Fadhlina Che Ros, Haira Rizan Mokhtar (2024) yang dipublikasikan dalam *Journal of Advanced Research Design* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
