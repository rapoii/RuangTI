# 4782 — Production Planning & Inventory Control: Comparative Evaluation of Wagner-Whitin and Silver-Meal Lot Sizing Methods for Inventory Optimization in a Paper-Based Manufacturing Case Study

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Comparative Evaluation of Wagner-Whitin and Silver-Meal Lot Sizing Methods for Inventory Optimization in a Paper-Based Manufacturing Case Study  
**Jurnal & Sitasi Utama:** Gabriel Emiliano Martinez-Luna, Susana Casy Téllez-Ballesteros (2026). *Procedia Computer Science*. DOI: [10.1016/j.procs.2026.02.418](10.1016/j.procs.2026.02.418)  
**Sitasi Pendukung:** Anders Segerstedt, Beatriz Abdul-Jalbar, Björn Samuelsson (2023). *Axioms*. DOI: [10.3390/axioms12070661](10.3390/axioms12070661)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gabriel Emiliano Martinez-Luna, Susana Casy Téllez-Ballesteros (2026) dalam jurnal *Procedia Computer Science* (DOI: 10.1016/j.procs.2026.02.418) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Anders Segerstedt, Beatriz Abdul-Jalbar, Björn Samuelsson (2023) yang dipublikasikan dalam *Axioms* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
