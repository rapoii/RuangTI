# 4336 — Supply Chain Management & Logistics Engineering: Transformer-Based Demand Forecasting and Inventory Optimization in Multi-Echelon Supply Chain Networks

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Transformer-Based Demand Forecasting and Inventory Optimization in Multi-Echelon Supply Chain Networks  
**Jurnal & Sitasi Utama:** Xuguang Zhang, Tiejiang Sun, Xu Han (2025). *Journal of Banking and Financial Dynamics*. DOI: [10.55220/2576-6821.v9.796](10.55220/2576-6821.v9.796)  
**Sitasi Pendukung:** Tianjiao Sun, Ziheng Huang, Dengnan Wu (2024). *2024 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem62345.2024.10857144](10.1109/ieem62345.2024.10857144)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xuguang Zhang, Tiejiang Sun, Xu Han (2025) dalam jurnal *Journal of Banking and Financial Dynamics* (DOI: 10.55220/2576-6821.v9.796) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
