# 4395 — Safety Engineering & Risk Management: Graph Neural Networks and Fault Tree Analysis for Runtime Dynamic Risk Assessment of Autonomous Systems

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Graph Neural Networks and Fault Tree Analysis for Runtime Dynamic Risk Assessment of Autonomous Systems  
**Jurnal & Sitasi Utama:** Joachim Grimstad, Andrey Morozov (2025). *2025 Annual Reliability and Maintainability Symposium (RAMS)*. DOI: [10.1109/rams48127.2025.10935019](10.1109/rams48127.2025.10935019)  
**Sitasi Pendukung:** Ma liang, Wang long, yang li yuan (2023). *The Proceedings of the International Conference on Nuclear Engineering (ICONE)*. DOI: [10.1299/jsmeicone.2023.30.1930](10.1299/jsmeicone.2023.30.1930)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Joachim Grimstad, Andrey Morozov (2025) dalam jurnal *2025 Annual Reliability and Maintainability Symposium (RAMS)* (DOI: 10.1109/rams48127.2025.10935019) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Ma liang, Wang long, yang li yuan (2023) yang dipublikasikan dalam *The Proceedings of the International Conference on Nuclear Engineering (ICONE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
