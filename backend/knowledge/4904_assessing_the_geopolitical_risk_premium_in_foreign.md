# 4904 — Engineering Economics & Cost Optimization: Assessing the Geopolitical Risk Premium in Foreign Direct Investment: Capital Budgeting, Asymmetric Network Exposure, and Cross-Border Valuation in Global Sports Assets

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** Assessing the Geopolitical Risk Premium in Foreign Direct Investment: Capital Budgeting, Asymmetric Network Exposure, and Cross-Border Valuation in Global Sports Assets  
**Jurnal & Sitasi Utama:** Anany Khare (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7292398](10.2139/ssrn.7292398)  
**Sitasi Pendukung:** Ruben Xavier De Freitas (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6999598](10.2139/ssrn.6999598)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anany Khare (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7292398) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Standard asset valuation models in cross-border corporate finance—most notably the Capital Asset Pricing Model (CAPM) and weighted average cost of capital metrics—rely on aggregate, country-level risk adjustments that prove inadequate when evaluating targeted geopolitical vulnerabilities. As modern statecraft increasingly leverages weaponized economic networks, statutory investment screening gateways, and transnational clearing channels, political risk ceases to be a uniform background hazard affecting all industries equally within a given sovereign border. To resolve this methodological gap, this study develops a specialized pricing architecture termed the Geopolitical Insulation Capital Pricing Model (GICPM). Rather than applying broad country risk premiums, the GICPM integrates firm-level structural exposure coefficients designed to measure susceptibility to panoptic regulatory monitoring and coercive chokepoint isolation. Drawing upon the multi-billion-euro professional football ecosystem as a primary empirical laboratory, we analyze how transnational capital allocations executed by sovereign wealth funds, private equity syndicates, and multi-club ownership (MCO) conglomerates navigate stringent regulatory screening, multi-jurisdictional compliance friction, and sudden liquidity interruptions. Utilizing a qualitative Most Different Systems Design (MDSD), three distinct asset structures are evaluated: state-backed acquisitions of elite European sports entities, decentraliz"

Penelitian pendukung oleh Ruben Xavier De Freitas (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
