# 5347 — Continuous Improvement & Lean Six Sigma: Minimizing Waste to Reduce Lead Time Delivery at PT. X Through Value Stream Mapping Method

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Minimizing Waste to Reduce Lead Time Delivery at PT. X Through Value Stream Mapping Method  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2022). *Jurnal Akuntansi, Manajemen dan Ekonomi*. DOI: [10.32424/1.jame.2022.24.3.7267](10.32424/1.jame.2022.24.3.7267)  
**Sitasi Pendukung:** Dyah Istiningrum, Rita Ambarwati Sukmono (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.5437](10.21070/ups.5437)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2022) dalam jurnal *Jurnal Akuntansi, Manajemen dan Ekonomi* (DOI: 10.32424/1.jame.2022.24.3.7267) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The purpose of this study is to minimize waste in order to reduce lead time delivery at PT X. The method that the author uses in this research is a quantitative method with data analysis techniques using value stream mapping and seven waste analysis. The data collection technique that the author uses is interviews, observations, and company documents. The results of this study succeeded in reducing the lead time from 11 days, 31 hours 35 minutes, to 10 days, 23 hours 35 minutes if the operational unit is on standby. Furthermore, if the operational unit is on standby after 17 days 28 hours 35 minutes, it becomes 10 days 29 hours 35 minutes."

Penelitian pendukung oleh Dyah Istiningrum, Rita Ambarwati Sukmono (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
