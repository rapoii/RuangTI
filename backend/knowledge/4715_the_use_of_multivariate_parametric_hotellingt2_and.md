# 4715 — Quality Engineering & Reliability Systems: The Use of Multivariate Parametric Hotelling–T2 and Nonparametric Bootstrap Charts in Quality Control Using Simulation

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** The Use of Multivariate Parametric Hotelling–T2 and Nonparametric Bootstrap Charts in Quality Control Using Simulation  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2020). *The Muthanna Journal of Administrative and Economics Sciences*. DOI: [10.52113/6/2020-10-3/8-22](10.52113/6/2020-10-3/8-22)  
**Sitasi Pendukung:** Lead Industrial Researchers (2020). *Introduction to Statistical Process Control*. DOI: [10.1002/9781119528425.ch8](10.1002/9781119528425.ch8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2020) dalam jurnal *The Muthanna Journal of Administrative and Economics Sciences* (DOI: 10.52113/6/2020-10-3/8-22) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2020) yang dipublikasikan dalam *Introduction to Statistical Process Control* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
