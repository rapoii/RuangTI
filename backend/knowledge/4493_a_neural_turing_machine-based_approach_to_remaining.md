# 4493 — Maintenance Engineering & Asset Life Cycle: A Neural Turing Machine-based approach to Remaining Useful Life Estimation

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** A Neural Turing Machine-based approach to Remaining Useful Life Estimation  
**Jurnal & Sitasi Utama:** Alex Falcon, Giovanni D'Agostino, Giuseppe Serra (2020). *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm49022.2020.9187043](10.1109/icphm49022.2020.9187043)  
**Sitasi Pendukung:** Wantong Xu, Yingshun Li, Bin Yang (2024). *2024 Prognostics and System Health Management Conference (PHM)*. DOI: [10.1109/phm61473.2024.00013](10.1109/phm61473.2024.00013)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alex Falcon, Giovanni D'Agostino, Giuseppe Serra (2020) dalam jurnal *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)* (DOI: 10.1109/icphm49022.2020.9187043) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wantong Xu, Yingshun Li, Bin Yang (2024) yang dipublikasikan dalam *2024 Prognostics and System Health Management Conference (PHM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
