# 5305 — Industrial Artificial Intelligence & Data Analytics: A review on computer vision and machine learning techniques for automated road surface defect and distress detection

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A review on computer vision and machine learning techniques for automated road surface defect and distress detection  
**Jurnal & Sitasi Utama:** Xuejing Chen, Sira Yongchareon, Martin Knoche (2023). *Journal of Smart Cities and Society*. DOI: [10.3233/scs-230001](10.3233/scs-230001)  
**Sitasi Pendukung:** Shichun Wang (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637601](10.1109/cvidl70130.2026.11637601)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xuejing Chen, Sira Yongchareon, Martin Knoche (2023) dalam jurnal *Journal of Smart Cities and Society* (DOI: 10.3233/scs-230001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shichun Wang (2026) yang dipublikasikan dalam *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
