# 6386 — Quality Engineering & Reliability Systems: Integrasi Failure Mode and Effects Analysis (FMEA) dalam Manajemen Risiko Penanganan Radiofarmaka: Kajian Literatur Naratif

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Integrasi Failure Mode and Effects Analysis (FMEA) dalam Manajemen Risiko Penanganan Radiofarmaka: Kajian Literatur Naratif  
**Jurnal & Sitasi Utama:** Aditya Pratama Putra (2026). *Jurnal Pengawasan Tenaga Nuklir*. DOI: [10.53862/jupeten.v6i1.006](10.53862/jupeten.v6i1.006)  
**Sitasi Pendukung:** Yuda Purwalaksana, Kardiman, Deni Hidayat (2025). *Jurnal Pendidikan Teknik Mesin Undiksha*. DOI: [10.23887/jptm.v13i2.93291](10.23887/jptm.v13i2.93291)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Aditya Pratama Putra (2026) dalam jurnal *Jurnal Pengawasan Tenaga Nuklir* (DOI: 10.53862/jupeten.v6i1.006) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Radiopharmaceutical handling is a complex process involving both pharmaceutical risks and radiation exposure throughout the healthcare workflow. Therefore, an effective risk management approach is required to systematically identify potential failures before they compromise patient and staff safety. This study reviews the application of Failure Mode and Effects Analysis (FMEA) in radiopharmaceutical risk management through a narrative literature review. Scopus-indexed articles published between 2016 and 2026 were analyzed, with the final literature search conducted in June 2026. The review included studies on radiopharmacy, nuclear medicine, radiotherapy, and healthcare quality management. The findings indicate that FMEA effectively identifies and prioritizes failure modes using the Risk Priority Number (RPN). Major risks include patient misidentification, radiolabeling errors, dose calculation errors, and human and communication factors. The reviewed studies demonstrate that FMEA improves patient safety, strengthens quality management systems, and promotes a safety culture through integration with Fault Tree Analysis (FTA) and incident learning systems. However, further standardization of risk assessment methods and prospective multi-institutional studies are needed to strengthen FMEA implementation in radiopharmaceutical therapy. FMEA is recommended as an integral component of quality management and radiation safety systems to improve the quality of radiopharmaceutical serv"

Penelitian pendukung oleh Yuda Purwalaksana, Kardiman, Deni Hidayat (2025) yang dipublikasikan dalam *Jurnal Pendidikan Teknik Mesin Undiksha* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
