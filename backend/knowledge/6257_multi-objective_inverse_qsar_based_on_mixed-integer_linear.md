# 6257 — Operations Research & Large-Scale Optimization: Multi-Objective Inverse QSAR Based on Mixed-Integer Linear Programming and Machine Learning

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Multi-Objective Inverse QSAR Based on Mixed-Integer Linear Programming and Machine Learning  
**Jurnal & Sitasi Utama:** Bowen Song, Hiroto Saigo (2024). *Peer-Reviewed Journal*. DOI: [10.26434/chemrxiv.15001462/v1](10.26434/chemrxiv.15001462/v1)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Process Optimization*. DOI: [10.1515/9783111342283-006](10.1515/9783111342283-006)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bowen Song, Hiroto Saigo (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.26434/chemrxiv.15001462/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This work extends the mol-infer framework for inverse QSAR/QSPR to better support multi-criteria molecular design through improved molecular representation and MILP-based inverse inference. We explicitly incorporate several chemically meaningful structural quantities, including ROTB, HBA/HBD, TPSA, and aromaticity-related proxies, as derived descriptors and optimization objectives. To enable their multi-objective control in Stage 4, we introduce an additional constraint block (C3) that translates the rules of these environment-dependent properties into linear inequalities. We also extend the baseline 2L+CC descriptor set by introducing atomic environment configurations (AECs), which encode atom-centered local chemical contexts. These descriptor extensions are designed not only to improve prediction performance in Stage 3, but also to provide a convenient foundation for MILP-based multi-objective control in Stage 4. Experiments show that, compared to the baseline 2L+CC results reported in [20], the proposed descriptors achieve higher ML scores in the selected data sets. Moreover, in our experiments, the multi-objective MILP formulation finds feasible solutions within a 10-minute time limit and enables explicit control over several chemically meaningful structural properties. This controlled generation also leads to molecules with improved drug-likeness and synthetic accessibility."

Penelitian pendukung oleh Lead Industrial Researchers (2025) yang dipublikasikan dalam *Process Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
