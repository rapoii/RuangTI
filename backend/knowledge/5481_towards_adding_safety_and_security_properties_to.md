# 5481 — Manufacturing Systems & Cyber-Physical Production: Towards Adding Safety and Security Properties to the Industry 4.0 Asset Administration Shell

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Towards Adding Safety and Security Properties to the Industry 4.0 Asset Administration Shell  
**Jurnal & Sitasi Utama:** Ali Mohammad Hosseini, Thilo Sauter, Wolfgang Kastner (2021). *2021 17th IEEE International Conference on Factory Communication Systems (WFCS)*. DOI: [10.1109/wfcs46889.2021.9483606](10.1109/wfcs46889.2021.9483606)  
**Sitasi Pendukung:** Sebastian Thiede (2022). *Lecture Notes in Energy*. DOI: [10.1007/978-3-030-86215-2_8](10.1007/978-3-030-86215-2_8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ali Mohammad Hosseini, Thilo Sauter, Wolfgang Kastner (2021) dalam jurnal *2021 17th IEEE International Conference on Factory Communication Systems (WFCS)* (DOI: 10.1109/wfcs46889.2021.9483606) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sebastian Thiede (2022) yang dipublikasikan dalam *Lecture Notes in Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
