# 4495 — Maintenance Engineering & Asset Life Cycle: A deep learning-based conditional system health index method to reduce the uncertainty of remaining useful life prediction

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** A deep learning-based conditional system health index method to reduce the uncertainty of remaining useful life prediction  
**Jurnal & Sitasi Utama:** Jaeyeon Jang (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-1588424/v1](10.21203/rs.3.rs-1588424/v1)  
**Sitasi Pendukung:** Theodoros Loutas, Athanasios Oikonomou, Nick Eleftheroglou (2022). *International Journal of Prognostics and Health Management*. DOI: [10.36001/ijphm.2022.v13i1.3072](10.36001/ijphm.2022.v13i1.3072)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jaeyeon Jang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-1588424/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
