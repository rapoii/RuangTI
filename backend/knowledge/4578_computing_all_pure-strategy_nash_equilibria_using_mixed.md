# 4578 — Operations Research & Large-Scale Optimization: Computing all pure-strategy Nash equilibria using mixed 0–1 linear programming approach

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Computing all pure-strategy Nash equilibria using mixed 0–1 linear programming approach  
**Jurnal & Sitasi Utama:** Zhengtian Wu (2023). *Integer Optimization and its Computation in Emergency Management*. DOI: [10.1016/b978-0-32-395203-3.00007-1](10.1016/b978-0-32-395203-3.00007-1)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Hands-On Mathematical Optimization with Python*. DOI: [10.1017/9781009493512.004](10.1017/9781009493512.004)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Zhengtian Wu (2023) dalam jurnal *Integer Optimization and its Computation in Emergency Management* (DOI: 10.1016/b978-0-32-395203-3.00007-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2025) yang dipublikasikan dalam *Hands-On Mathematical Optimization with Python* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
