# 4947 — Applied Statistics & Stochastic Modeling: Decision letter for "The social processes that emergency nurses use to achieve sustainability: A constructivist grounded theory"

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Decision letter for "The social processes that emergency nurses use to achieve sustainability: A constructivist grounded theory"  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2023). *Peer-Reviewed Journal*. DOI: [10.1111/jan.16297/v1/decision1](10.1111/jan.16297/v1/decision1)  
**Sitasi Pendukung:** A. E. Kyprianou, V. Rivero (2026). *Queueing Systems*. DOI: [10.1007/s11134-025-09963-0](10.1007/s11134-025-09963-0)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2023) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.1111/jan.16297/v1/decision1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh A. E. Kyprianou, V. Rivero (2026) yang dipublikasikan dalam *Queueing Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
