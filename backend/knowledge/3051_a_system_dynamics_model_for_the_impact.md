# 3051 — Supply Chain Management & Logistics Engineering: A system dynamics model for the impact of capacity limits on the Bullwhip effect (BWE) in a closed-loop system with remanufacturing

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A system dynamics model for the impact of capacity limits on the Bullwhip effect (BWE) in a closed-loop system with remanufacturing  
**Jurnal & Sitasi Utama:** Linda Tombido, Louis Louw, Joubert van Eeden (2021). *Journal of remanufacturing*. DOI: [10.1007/s13243-021-00100-7](10.1007/s13243-021-00100-7)  
**Sitasi Pendukung:** D. G. Mogale, Arijit De, Abhijeet Ghadge (2022). *Computers & Industrial Engineering*. DOI: [10.1016/j.cie.2022.108105](10.1016/j.cie.2022.108105)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Linda Tombido, Louis Louw, Joubert van Eeden (2021) dalam jurnal *Journal of remanufacturing* (DOI: 10.1007/s13243-021-00100-7) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh D. G. Mogale, Arijit De, Abhijeet Ghadge (2022) yang dipublikasikan dalam *Computers & Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
