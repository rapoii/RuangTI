# 4557 — Operations Research & Large-Scale Optimization: Energy System Optimization Using (Mixed Integer) Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Energy System Optimization Using (Mixed Integer) Linear Programming  
**Jurnal & Sitasi Utama:** Andreas Hanel, Sebastian Miehling, Jerry Lambert (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4489223](10.2139/ssrn.4489223)  
**Sitasi Pendukung:** Katerina P. Papalexandri (2025). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_391-1](10.1007/978-3-030-54621-2_391-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Andreas Hanel, Sebastian Miehling, Jerry Lambert (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4489223) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Katerina P. Papalexandri (2025) yang dipublikasikan dalam *Encyclopedia of Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
