# Modul Komprehensif: Additive Manufacturing & 3D Printing (FDM, SLA, SLS) dalam Rapid Prototyping
**Nomor Modul:** [374]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Additive Manufacturing Technologies (Ian Gibson, David Rosen, Brent Stucker), Additive Manufacturing Journal (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Additive Manufacturing & 3D Printing (FDM, SLA, SLS) dalam Rapid Prototyping**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Klasifikasi ASTM F42 (Material Extrusion FDM, Vat Photopolymerization SLA, Powder Bed Fusion SLS/SLM), Slicing G-code Layer Generation, Support Structure Optimization, Anisotropi Kekuatan Tarik.
...
```python
# Algoritma Solusi Terapan untuk Additive Manufacturing & 3D Printing (FDM, SLA, SLS) dalam Rapid Prototyping
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Rapid Prototyping Jigs & Fixtures Pabrik Otomotif dengan 3D Printing SLS Menghemat 85% Biaya Tooling.
...
1. Additive Manufacturing Technologies (Ian Gibson, David Rosen, Brent Stucker), Additive Manufacturing Journal (2024).
