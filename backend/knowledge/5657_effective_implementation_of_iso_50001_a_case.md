# 5657 — Industrial Energy Management & Decarbonization: Effective implementation of ISO 50001: A case study on energy management for heating load reduction for a social building stock in Northern Italy

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Effective implementation of ISO 50001: A case study on energy management for heating load reduction for a social building stock in Northern Italy  
**Jurnal & Sitasi Utama:** Giuliano Dall'O', Simone Ferrari, Elisa Bruni (2020). *Energy and Buildings*. DOI: [10.1016/j.enbuild.2020.110029](10.1016/j.enbuild.2020.110029)  
**Sitasi Pendukung:** Salma El Majaty, Abdellatif Touzani, Youssef Kasseh (2023). *Materials Today: Proceedings*. DOI: [10.1016/j.matpr.2022.07.094](10.1016/j.matpr.2022.07.094)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Giuliano Dall'O', Simone Ferrari, Elisa Bruni (2020) dalam jurnal *Energy and Buildings* (DOI: 10.1016/j.enbuild.2020.110029) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
