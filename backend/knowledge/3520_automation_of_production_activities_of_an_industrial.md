# 3520 — Production Planning & Inventory Control: Automation of Production Activities of an Industrial Enterprise based on the ERP System

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Automation of Production Activities of an Industrial Enterprise based on the ERP System  
**Jurnal & Sitasi Utama:** Nelli Vladimirovna Syreyshchikova, Danil Yurievich Pimenov, Tadeusz Mikołajczyk (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.03.075](10.1016/j.promfg.2020.03.075)  
**Sitasi Pendukung:** Ashokkumar P Rathod (2020). *International Journal of Advanced Academic Studies*. DOI: [10.33545/27068919.2020.v2.i2a.81](10.33545/27068919.2020.v2.i2a.81)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nelli Vladimirovna Syreyshchikova, Danil Yurievich Pimenov, Tadeusz Mikołajczyk (2020) dalam jurnal *Procedia Manufacturing* (DOI: 10.1016/j.promfg.2020.03.075) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The article reflects the results of the research on the improvement of the production activities of a machine-building enterprise by automating the production planning process. It analyzes the enterprise’s state of affairs in the planning process, reveals the main problems of the enterprise; gives an analysis and comparison of the existing automated systems, selects an ERP-system for the enterprise’s conditions; develops an automated production planning process and a methodology for automating the production planning process in the SAPERP system for the enterprise’s conditions. The authors experimentally verify the efficiency of the developed methodology. The research results include: establishment of effective control and planning of business processes; reducing the labor intensity of process management; increasing their stability; increasing the maneuverability of the enterprise’s actions and quick response to the changing market conditions; reducing the costs for external and internal failures."

Penelitian pendukung oleh Ashokkumar P Rathod (2020) yang dipublikasikan dalam *International Journal of Advanced Academic Studies* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
