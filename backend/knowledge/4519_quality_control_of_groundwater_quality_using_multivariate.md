# 4519 — Quality Engineering & Reliability Systems: Quality control of groundwater quality using multivariate control charts to improve water management

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Quality control of groundwater quality using multivariate control charts to improve water management  
**Jurnal & Sitasi Utama:** Hichul Chung (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7117683](10.2139/ssrn.7117683)  
**Sitasi Pendukung:** Fausto Galetto (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202511.0444.v1](10.20944/preprints202511.0444.v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hichul Chung (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7117683) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study proposes a Hotelling’s T² multivariate control chart framework for monitoring patterns in water quality characteristics of Türkiye’s groundwater. To satisfy the underlying assumption of normality required by the T² method, non-normally distributed water quality variables were first transformed using Johnson Transformation and three characteristics Gamma transformation. Pearson correlation analysis was employed to identify pairs of strongly correlated characteristics suitable for constructing two- characteristics T² multivariate control charts. In addition, hierarchical clustering techniques were used to group multiple water quality characteristics, facilitating the development of multivariate control charts with higher dimensions specifically, with three, five, and seven characteristics. These charts were used to detect behaviour patterns and identify out-of-control points in the water quality data. The results demonstrate the use of the Hotelling’s T² control chart as a robust tool for multivariate monitoring of groundwater quality. Among the characteristics analysed, magnesium and calcium emerged as the most influential contributors to the detection of out-of-control conditions."

Penelitian pendukung oleh Fausto Galetto (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
