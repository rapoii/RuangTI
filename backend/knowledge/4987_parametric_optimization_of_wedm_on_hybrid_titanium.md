# 4987 — Applied Statistics & Stochastic Modeling: Parametric optimization of WEDM on hybrid titanium matrix composite using response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Parametric optimization of WEDM on hybrid titanium matrix composite using response surface methodology  
**Jurnal & Sitasi Utama:** Soutrik Bose, Titas Nandi (2021). *Multiscale and Multidisciplinary Modeling, Experiments and Design*. DOI: [10.1007/s41939-020-00088-w](10.1007/s41939-020-00088-w)  
**Sitasi Pendukung:** J. Rahmani, M. M. Mohamamdi, R. Khamedi (2023). *Scientia Iranica*. DOI: [10.24200/sci.2023.59618.6339](10.24200/sci.2023.59618.6339)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Soutrik Bose, Titas Nandi (2021) dalam jurnal *Multiscale and Multidisciplinary Modeling, Experiments and Design* (DOI: 10.1007/s41939-020-00088-w) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh J. Rahmani, M. M. Mohamamdi, R. Khamedi (2023) yang dipublikasikan dalam *Scientia Iranica* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
