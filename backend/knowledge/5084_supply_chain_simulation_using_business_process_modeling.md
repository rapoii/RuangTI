# 5084 — Simulation Modeling & Digital Twins: Supply Chain Simulation using Business Process Modeling in Service Oriented Architecture

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Supply Chain Simulation using Business Process Modeling in Service Oriented Architecture  
**Jurnal & Sitasi Utama:** Taejong Yoo (2020). *Supply Chain and Logistics Management*. DOI: [10.4018/978-1-7998-0945-6.ch040](10.4018/978-1-7998-0945-6.ch040)  
**Sitasi Pendukung:** Chibin Zhang, Paolo Gaudiano (2024). *Peer-Reviewed Journal*. DOI: [10.20944/preprints202605.1593.v1](10.20944/preprints202605.1593.v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Taejong Yoo (2020) dalam jurnal *Supply Chain and Logistics Management* (DOI: 10.4018/978-1-7998-0945-6.ch040) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Chibin Zhang, Paolo Gaudiano (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
