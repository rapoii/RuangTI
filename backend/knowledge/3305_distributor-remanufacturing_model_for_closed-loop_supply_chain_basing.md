# 3305 — Supply Chain Management & Logistics Engineering: Distributor-Remanufacturing Model for Closed-Loop Supply Chain: Basing on Stackelberg Game Model

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Distributor-Remanufacturing Model for Closed-Loop Supply Chain: Basing on Stackelberg Game Model  
**Jurnal & Sitasi Utama:** Ruiqi Xu, Kai Wang, Wei Yan (2020). *Dynamic Systems and Applications*. DOI: [10.46719/dsa20202962](10.46719/dsa20202962)  
**Sitasi Pendukung:** Roya Anvari (2023). *Journal of Business &amp; Management*. DOI: [10.47747/jbm.v1i1.956](10.47747/jbm.v1i1.956)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ruiqi Xu, Kai Wang, Wei Yan (2020) dalam jurnal *Dynamic Systems and Applications* (DOI: 10.46719/dsa20202962) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Roya Anvari (2023) yang dipublikasikan dalam *Journal of Business &amp; Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
