# 5029 — Applied Statistics & Stochastic Modeling: Time Series Analysis of Electricity Demand Forecasting Using Seasonal ARIMA and an Exponential Smoothing Model

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Time Series Analysis of Electricity Demand Forecasting Using Seasonal ARIMA and an Exponential Smoothing Model  
**Jurnal & Sitasi Utama:** Ranju Kumari Shiwakoti, Chalie Charoenlarpnopparut, Kamal Chapagain (2023). *2023 International Conference on Power and Renewable Energy Engineering (PREE)*. DOI: [10.1109/pree57903.2023.10370319](10.1109/pree57903.2023.10370319)  
**Sitasi Pendukung:** Rizky Ilman Nugraha, Agussalim (2024). *Information Technology International Journal*. DOI: [10.33005/itij.v2i2.23](10.33005/itij.v2i2.23)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ranju Kumari Shiwakoti, Chalie Charoenlarpnopparut, Kamal Chapagain (2023) dalam jurnal *2023 International Conference on Power and Renewable Energy Engineering (PREE)* (DOI: 10.1109/pree57903.2023.10370319) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Rizky Ilman Nugraha, Agussalim (2024) yang dipublikasikan dalam *Information Technology International Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
