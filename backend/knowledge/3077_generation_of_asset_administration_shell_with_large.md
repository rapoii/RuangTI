# 3077 — Manufacturing Systems & Cyber-Physical Production: Generation of Asset Administration Shell With Large Language Model Agents: Toward Semantic Interoperability in Digital Twins in the Context of Industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Generation of Asset Administration Shell With Large Language Model Agents: Toward Semantic Interoperability in Digital Twins in the Context of Industry 4.0  
**Jurnal & Sitasi Utama:** Yuchen Xia, Zhewen Xiao, Nasser Jazdi (2024). *IEEE Access*. DOI: [10.1109/access.2024.3415470](10.1109/access.2024.3415470)  
**Sitasi Pendukung:** Lucas Sakurada, Paulo Leitão (2020). *Peer-Reviewed Academic Journal*. DOI: [10.1109/icps48405.2020.9274745](10.1109/icps48405.2020.9274745)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuchen Xia, Zhewen Xiao, Nasser Jazdi (2024) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2024.3415470) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lucas Sakurada, Paulo Leitão (2020) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
