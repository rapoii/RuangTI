# 3160 — Quality Engineering & Reliability Systems: Integrating the Failure Mode Analysis Tool and Effect on Risk Reduction into an APQP Management Process in a Medium-Sized Company in the National Automotive Sector

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Integrating the Failure Mode Analysis Tool and Effect on Risk Reduction into an APQP Management Process in a Medium-Sized Company in the National Automotive Sector  
**Jurnal & Sitasi Utama:** Flávio Roberto Néris Oliveira (2024). *International Journal of Management Research and Economics*. DOI: [10.51483/ijmre.4.1.2024.27-36](10.51483/ijmre.4.1.2024.27-36)  
**Sitasi Pendukung:** Jacopo Sini, M. Violante (2020). *Microelectronics Reliability*. DOI: [10.1016/j.microrel.2020.113661](10.1016/j.microrel.2020.113661)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Flávio Roberto Néris Oliveira (2024) dalam jurnal *International Journal of Management Research and Economics* (DOI: 10.51483/ijmre.4.1.2024.27-36) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The research investigates the use of the Failure Mode and Effects Analysis (FMEA) methodology in the context of Advanced Product Quality Management (APQP) in the automotive industry. It explores how FMEA is used to detect, assess and reduce risks in projects, highlighting its positive impact on preventing failures and mitigating damage. The research analyzes the role of multidisciplinary teams in preparing the FMEA, highlighting how different perspectives enrich the analyses. Furthermore, it examines the adaptation of FMEA criteria for project management and the classification of risks by priority. The paper highlights how FMEA improves feasibility and risk assessment, promoting informed decisions and improved quality, while also evaluating your compliance with the IATF 16949 standard and your commitment to quality."

Penelitian pendukung oleh Jacopo Sini, M. Violante (2020) yang dipublikasikan dalam *Microelectronics Reliability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
