# 5989 — Maintenance Engineering & Asset Life Cycle: Reliability Centered Maintenance Practices in Food Industry

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Reliability Centered Maintenance Practices in Food Industry  
**Jurnal & Sitasi Utama:** Oğuzhan Yavuz, Ersin Doğan, Ergün Carus (2019). *Procedia Computer Science*. DOI: [10.1016/j.procs.2019.09.046](10.1016/j.procs.2019.09.046)  
**Sitasi Pendukung:** Siti Hajar Salim, Saiful Amri Mazlan, Siti Aisyah Salim (2019). *MATEC Web of Conferences*. DOI: [10.1051/matecconf/201926602011](10.1051/matecconf/201926602011)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Oğuzhan Yavuz, Ersin Doğan, Ergün Carus (2019) dalam jurnal *Procedia Computer Science* (DOI: 10.1016/j.procs.2019.09.046) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The discipline of maintenance in industries has changed more than other management disciplines. This change due to the increase in the number and variety of physical assets, the development of technology, the emergence of new maintenance techniques, and the change in the perspective of maintenance. Maintenance teams in the enterprise generally apply time-based methods to maintain of the physical assets. However, maintenance practices do not always provide the overall equipment efficiency (OEE) expected from the equipment. Reliability centered maintenance (RCM) is an approach that determines what the equipment is able to fully perform its tasks in the present process. In this study, the application of RCM approach on packaging machines and its effect on OEE are explained."

Penelitian pendukung oleh Siti Hajar Salim, Saiful Amri Mazlan, Siti Aisyah Salim (2019) yang dipublikasikan dalam *MATEC Web of Conferences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
