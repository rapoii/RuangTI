# 5050 — Simulation Modeling & Digital Twins: Generation of synthetic manufacturing datasets for machine learning using discrete-event simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Generation of synthetic manufacturing datasets for machine learning using discrete-event simulation  
**Jurnal & Sitasi Utama:** K. C. Chan, Marsel Rabaev, Handy Pratama (2022). *Production &amp; Manufacturing Research*. DOI: [10.1080/21693277.2022.2086642](10.1080/21693277.2022.2086642)  
**Sitasi Pendukung:** K. Agalianos, S.T. Ponis, E. Aretoulaki (2020). *Procedia Manufacturing*. DOI: [10.1016/j.promfg.2020.10.228](10.1016/j.promfg.2020.10.228)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari K. C. Chan, Marsel Rabaev, Handy Pratama (2022) dalam jurnal *Production &amp; Manufacturing Research* (DOI: 10.1080/21693277.2022.2086642) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh K. Agalianos, S.T. Ponis, E. Aretoulaki (2020) yang dipublikasikan dalam *Procedia Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
