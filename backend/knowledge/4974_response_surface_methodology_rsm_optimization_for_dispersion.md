# 4974 — Applied Statistics & Stochastic Modeling: Response Surface Methodology (RSM) Optimization for Dispersion Stability of SnO2 nanodispersions using Plackett Burman and Central Composite Design Method

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Response Surface Methodology (RSM) Optimization for Dispersion Stability of SnO2 nanodispersions using Plackett Burman and Central Composite Design Method  
**Jurnal & Sitasi Utama:** Chinkhai Ong, Wengnam Lee, Patrik Ohberg (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-3972031/v1](10.21203/rs.3.rs-3972031/v1)  
**Sitasi Pendukung:** Daniel Mwangi Muriithi -, Dennis K. Muriithi -, Fidelis Ngugi - (2023). *International Journal For Multidisciplinary Research*. DOI: [10.36948/ijfmr.2023.v05i05.7677](10.36948/ijfmr.2023.v05i05.7677)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chinkhai Ong, Wengnam Lee, Patrik Ohberg (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-3972031/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract
        This study delves into optimizing the dispersion stability of SnO2 nanoparticles using Response Surface Methodology in two different solvents—deionized water and N-Methyl-2-pyrrolidone. The critical factors influencing SnO2 dispersion stability, specifically the concentration of nanoparticles, sonication time, and the addition of a surfactant, were considered. The respond surface methodology optimization process involved two stages: a Plackett Burman Design and a Central Composite Design. The Plackett Burman Design identified significant factors impacting the dispersion stability, while the Central Composite Design optimized these factors and quantified their effects. The results demonstrate that, under optimized conditions, SnO2 exhibits better dispersion stability in N-Methyl-2-pyrrolidone compared to deionized water. Zeta potential measurements further support this, with SnO2 in deionized water showing − 13.5 mV (threshold of agglomeration) and SnO2 in N-Methyl-2-pyrrolidone showing − 30.5 mV (moderate stability). This research not only enhances our understanding of the impact of sonication time and the addition of the surfactant in nanoparticle dispersion but also highlights the effectiveness of respond surface methodology in tailoring conditions for stability. The insights gained have broad applications in materials science, paving the way for improved optimization strategies in nanoparticle dispersion studies."

Penelitian pendukung oleh Daniel Mwangi Muriithi -, Dennis K. Muriithi -, Fidelis Ngugi - (2023) yang dipublikasikan dalam *International Journal For Multidisciplinary Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
