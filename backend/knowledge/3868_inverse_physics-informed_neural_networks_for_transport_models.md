# 3868 — Industrial Artificial Intelligence & Data Analytics: Inverse Physics-Informed Neural Networks for transport models in porous materials

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Inverse Physics-Informed Neural Networks for transport models in porous materials  
**Jurnal & Sitasi Utama:** Marco Berardi, Fabio V. Difonzo, Matteo Icardi (2024). *Computer Methods in Applied Mechanics and Engineering*. DOI: [10.1016/j.cma.2024.117628](10.1016/j.cma.2024.117628)  
**Sitasi Pendukung:** E. Hosseini, Pooriya Scheel, O. Müller (2023). *Computer Methods in Applied Mechanics and Engineering*. DOI: [10.1016/j.cma.2023.116019](10.1016/j.cma.2023.116019)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marco Berardi, Fabio V. Difonzo, Matteo Icardi (2024) dalam jurnal *Computer Methods in Applied Mechanics and Engineering* (DOI: 10.1016/j.cma.2024.117628) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh E. Hosseini, Pooriya Scheel, O. Müller (2023) yang dipublikasikan dalam *Computer Methods in Applied Mechanics and Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
