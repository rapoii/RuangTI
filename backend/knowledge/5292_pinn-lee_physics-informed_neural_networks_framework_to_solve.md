# 5292 — Industrial Artificial Intelligence & Data Analytics: PINN-LEE: Physics-Informed Neural Networks Framework to Solve Linearized Euler Equations for Aeroacoustic Predictions

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** PINN-LEE: Physics-Informed Neural Networks Framework to Solve Linearized Euler Equations for Aeroacoustic Predictions  
**Jurnal & Sitasi Utama:** Levent Ugur, Shubham B. Karpe, Po-Han Huang (2025). *AIAA AVIATION FORUM AND ASCEND 2025*. DOI: [10.2514/6.2025-3219](10.2514/6.2025-3219)  
**Sitasi Pendukung:** Uğur Karaca, Toygar Akgün (2026). *Proceedings of the 21st International Conference on Computer Vision Theory and Applications*. DOI: [10.5220/0014244200004084](10.5220/0014244200004084)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Levent Ugur, Shubham B. Karpe, Po-Han Huang (2025) dalam jurnal *AIAA AVIATION FORUM AND ASCEND 2025* (DOI: 10.2514/6.2025-3219) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
