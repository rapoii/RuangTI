# 5147 — Industrial Energy Management & Decarbonization: ISO 50001 based energy management system: a bibliometric perspective

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** ISO 50001 based energy management system: a bibliometric perspective  
**Jurnal & Sitasi Utama:** Marlina Pandin, Sik Sumaedi, Aris Yaman (2024). *International Journal of Energy Sector Management*. DOI: [10.1108/ijesm-08-2023-0001](10.1108/ijesm-08-2023-0001)  
**Sitasi Pendukung:** Mary Saniya Stephen, Shibu Arkkakadavil Valsalan (2025). *Cleaner Energy Systems*. DOI: [10.1016/j.cles.2025.100173](10.1016/j.cles.2025.100173)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marlina Pandin, Sik Sumaedi, Aris Yaman (2024) dalam jurnal *International Journal of Energy Sector Management* (DOI: 10.1108/ijesm-08-2023-0001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Purpose
                    ...
                    This research gave several implications for researchers, practitioners and public policymakers. For researchers, the bibliometric analysis provides several research issues that can be followed up by future research. For practitioners, the bibliometric analysis showed that applied tools and methods that can assist the implementation of ISO 50001-based energy management have been developed. For public policymakers, the bibliometric analysis offered the knowl"

Penelitian pendukung oleh Mary Saniya Stephen, Shibu Arkkakadavil Valsalan (2025) yang dipublikasikan dalam *Cleaner Energy Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
