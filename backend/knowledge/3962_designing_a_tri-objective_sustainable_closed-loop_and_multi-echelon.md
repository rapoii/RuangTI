# 3962 — Supply Chain Management & Logistics Engineering: Designing a Tri-Objective, Sustainable, Closed-Loop, and Multi-Echelon Supply Chain During the COVID-19 and Lockdowns

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Designing a Tri-Objective, Sustainable, Closed-Loop, and Multi-Echelon Supply Chain During the COVID-19 and Lockdowns  
**Jurnal & Sitasi Utama:** Sina Abbasi, Maryam Daneshmand-Mehr, Armin Ghane Kanafi (2023). *Foundations of Computing and Decision Sciences*. DOI: [10.2478/fcds-2023-0011](10.2478/fcds-2023-0011)  
**Sitasi Pendukung:** Feng Ming Tsai, Tat‐Dat Bui, Ming‐Lang Tseng (2021). *Resources Conservation and Recycling*. DOI: [10.1016/j.resconrec.2021.105421](10.1016/j.resconrec.2021.105421)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sina Abbasi, Maryam Daneshmand-Mehr, Armin Ghane Kanafi (2023) dalam jurnal *Foundations of Computing and Decision Sciences* (DOI: 10.2478/fcds-2023-0011) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Feng Ming Tsai, Tat‐Dat Bui, Ming‐Lang Tseng (2021) yang dipublikasikan dalam *Resources Conservation and Recycling* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
