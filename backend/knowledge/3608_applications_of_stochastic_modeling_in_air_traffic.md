# 3608 — Applied Statistics & Stochastic Modeling: Applications of stochastic modeling in air traffic management: Methods, challenges and opportunities for solving air traffic problems under uncertainty

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Applications of stochastic modeling in air traffic management: Methods, challenges and opportunities for solving air traffic problems under uncertainty  
**Jurnal & Sitasi Utama:** Rob Shone, K. D. Glazebrook, Konstantinos G. Zografos (2020). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2020.10.039](10.1016/j.ejor.2020.10.039)  
**Sitasi Pendukung:** Loe Schlicher, Marco Slikker, Willem van Jaarsveld (2020). *Mathematics of Operations Research*. DOI: [10.1287/moor.2019.1038](10.1287/moor.2019.1038)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rob Shone, K. D. Glazebrook, Konstantinos G. Zografos (2020) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2020.10.039) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Loe Schlicher, Marco Slikker, Willem van Jaarsveld (2020) yang dipublikasikan dalam *Mathematics of Operations Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
