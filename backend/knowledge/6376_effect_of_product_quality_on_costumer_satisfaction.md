# 6376 — Quality Engineering & Reliability Systems: Effect of Product Quality on Costumer Satisfaction Using the Lean  Six Sigma (LSS) Method and the Failure Mode Effect Analysis (FMEA)  Method

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Effect of Product Quality on Costumer Satisfaction Using the Lean  Six Sigma (LSS) Method and the Failure Mode Effect Analysis (FMEA)  Method  
**Jurnal & Sitasi Utama:** Syahrul Hidayat, Wiwik Sulistiyowati (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.2818](10.21070/ups.2818)  
**Sitasi Pendukung:** AMELIA Amel (2025). *JETMI : JURNAL ILMIAH ERGONOMI, TEKNIK DAN MANAJEMEN INDUSTRI*. DOI: [10.31848/jetmi.v1i1.4107](10.31848/jetmi.v1i1.4107)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Syahrul Hidayat, Wiwik Sulistiyowati (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21070/ups.2818) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
