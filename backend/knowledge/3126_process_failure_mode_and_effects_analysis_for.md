# 3126 — Quality Engineering & Reliability Systems: Process failure mode and effects analysis for external beam radiotherapy: Introducing a literature-based template and a novel action priority

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Process failure mode and effects analysis for external beam radiotherapy: Introducing a literature-based template and a novel action priority  
**Jurnal & Sitasi Utama:** Dominik Kornek, Christoph Bert (2024). *Zeitschrift für Medizinische Physik*. DOI: [10.1016/j.zemedi.2024.02.002](10.1016/j.zemedi.2024.02.002)  
**Sitasi Pendukung:** Lina Naciri, Safae Merzouk, Maryam Gallab (2025). *Research Square*. DOI: [10.21203/rs.3.rs-6423322/v1](10.21203/rs.3.rs-6423322/v1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dominik Kornek, Christoph Bert (2024) dalam jurnal *Zeitschrift für Medizinische Physik* (DOI: 10.1016/j.zemedi.2024.02.002) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lina Naciri, Safae Merzouk, Maryam Gallab (2025) yang dipublikasikan dalam *Research Square* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
