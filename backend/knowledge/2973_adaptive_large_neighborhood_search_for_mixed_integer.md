# 2973 — Operations Research & Large-Scale Optimization: Adaptive large neighborhood search for mixed integer programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Adaptive large neighborhood search for mixed integer programming  
**Jurnal & Sitasi Utama:** Gregor Hendel (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-021-00209-7](10.1007/s12532-021-00209-7)  
**Sitasi Pendukung:** Ahmed Abdelmoumene Kadri, Romain Perrouault, Mouna Kchaou Boujelben (2020). *Computers & Operations Research*. DOI: [10.1016/j.cor.2020.104888](10.1016/j.cor.2020.104888)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gregor Hendel (2021) dalam jurnal *Mathematical Programming Computation* (DOI: 10.1007/s12532-021-00209-7) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
