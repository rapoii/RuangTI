# 5332 — Industrial Artificial Intelligence & Data Analytics: Defect detection of solar cells based on deep convolutional generative adversarial networks

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Defect detection of solar cells based on deep convolutional generative adversarial networks  
**Jurnal & Sitasi Utama:** Xinyu Liu, Song Jiang, Maopu Wu (2024). *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl62147.2024.10603543](10.1109/cvidl62147.2024.10603543)  
**Sitasi Pendukung:** R. Santhosh Kumar, Bachu Hemanth, Anagani Sai Deepthi (2026). *2026 International Conference on Signal, Systems, and Computing for Next-Gen Automation (ICSSCNA)*. DOI: [10.1109/icsscna68616.2026.11546804](10.1109/icsscna68616.2026.11546804)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Xinyu Liu, Song Jiang, Maopu Wu (2024) dalam jurnal *2024 5th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl62147.2024.10603543) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh R. Santhosh Kumar, Bachu Hemanth, Anagani Sai Deepthi (2026) yang dipublikasikan dalam *2026 International Conference on Signal, Systems, and Computing for Next-Gen Automation (ICSSCNA)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
