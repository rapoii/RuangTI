# 5359 — Continuous Improvement & Lean Six Sigma: IMPLEMENTASI METODE VALUE STREAM MAPPING UNTUK MENGURANGI LEAD TIME PRODUKSI PADA PT. TENARIS HYDRIL BATAM

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** IMPLEMENTASI METODE VALUE STREAM MAPPING UNTUK MENGURANGI LEAD TIME PRODUKSI PADA PT. TENARIS HYDRIL BATAM  
**Jurnal & Sitasi Utama:** Praona Rada Fortuna, Fandy Bestario Harlan (2022). *Jurnal Bisnis Mahasiswa*. DOI: [10.60036/jbm.v2i3.53](10.60036/jbm.v2i3.53)  
**Sitasi Pendukung:** Brendan P. Sullivan, Poorya Ghafoorpoor Yazdi, Akshay Suresh (2022). *Procedia CIRP*. DOI: [10.1016/j.procir.2022.05.129](10.1016/j.procir.2022.05.129)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Praona Rada Fortuna, Fandy Bestario Harlan (2022) dalam jurnal *Jurnal Bisnis Mahasiswa* (DOI: 10.60036/jbm.v2i3.53) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Tujuan penelitian ini adalah untuk mengetahui bagaimana Implementasi dan Pengaruh metode Value Stream Mapping (VSM) terhadap pengurangan lead time produksi pada PT Tenaris Hydril Batam. Teknik Analisis data yang digunakan yaitu teknik analisis data deskriptif dengan metode Value Stream Mapping. Hasil dari penelitian ini menunjukan bagaimana implementasi dari metode Value Stream Mapping dapat berpengaruh besar terhadap pengurangan lead time produksi pada PT tenaris Hydril Batam. Hal Ini, dapat dilihat dari waktu rata-rata yang didapatkan. Dimana, sebelumnya rata-rata lead time produksi pada PT Tenaris Hydril Batam berjumlah 12 Hari. Dengan adanya penerapan metode ini, rata-rata lead time produksi menjadi 9 hari. Keterbatasan dalam penelitian ini yaitu peneliti hanya meneliti satu jenis produk (Accessories) pada satu pelanggan (Hal Completion Pte Ltd) saja sehingga untuk penelitian selanjutnya bisa menggunakan pelanggan dan jenis produk lain."

Penelitian pendukung oleh Brendan P. Sullivan, Poorya Ghafoorpoor Yazdi, Akshay Suresh (2022) yang dipublikasikan dalam *Procedia CIRP* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
