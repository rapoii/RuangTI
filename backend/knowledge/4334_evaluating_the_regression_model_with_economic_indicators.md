# 4334 — Supply Chain Management & Logistics Engineering: Evaluating the regression model with economic indicators for inventory minimization against the performance of multi-echelon inventory optimization for materials forecasting

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Evaluating the regression model with economic indicators for inventory minimization against the performance of multi-echelon inventory optimization for materials forecasting  
**Jurnal & Sitasi Utama:** T. Sathish, M. Prakash Reddy, S. Jothi Arunachalam (2025). *AIP Conference Proceedings*. DOI: [10.1063/5.0277196](10.1063/5.0277196)  
**Sitasi Pendukung:** Marjia Haque, M. Ahsan Akhtar Hasin (2021). *International Journal of Supply Chain and Inventory Management*. DOI: [10.1504/ijscim.2021.114720](10.1504/ijscim.2021.114720)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari T. Sathish, M. Prakash Reddy, S. Jothi Arunachalam (2025) dalam jurnal *AIP Conference Proceedings* (DOI: 10.1063/5.0277196) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Marjia Haque, M. Ahsan Akhtar Hasin (2021) yang dipublikasikan dalam *International Journal of Supply Chain and Inventory Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
