# 4583 — Operations Research & Large-Scale Optimization: A cut-based mixed integer programming formulation for the hop-constrained cheapest path problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A cut-based mixed integer programming formulation for the hop-constrained cheapest path problem  
**Jurnal & Sitasi Utama:** Pedro Vieira Rocha, Hamidreza Validi (2026). *Optimization Letters*. DOI: [10.1007/s11590-026-02300-1](10.1007/s11590-026-02300-1)  
**Sitasi Pendukung:** Mahdi Roozbeh, Saman Babaie–Kafaki, Zohre Aminifard (2021). *Journal of Industrial &amp; Management Optimization*. DOI: [10.3934/jimo.2020128](10.3934/jimo.2020128)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Pedro Vieira Rocha, Hamidreza Validi (2026) dalam jurnal *Optimization Letters* (DOI: 10.1007/s11590-026-02300-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract
                    ...
                    , the hop-constrained cheapest path problem (
                    ...
                    h
                    hops with the cheapest cost. This paper proposes a cut-based mixed integer programming (MIP) formulation, which has only one set of constraints that capture connectivity and hop constraints simultaneously, to solve the
                    
                      $$\operatorname {HCCPP}$$
                    
                    when edge costs are nonnegative. As the only set of constraints of the formulation has exponentially many constraints, we show that their corresponding fractional separation problem is easy for
                    
                      $$h \in \{2,3\}$$
             "

Penelitian pendukung oleh Mahdi Roozbeh, Saman Babaie–Kafaki, Zohre Aminifard (2021) yang dipublikasikan dalam *Journal of Industrial &amp; Management Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
