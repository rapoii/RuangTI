# 5002 — Applied Statistics & Stochastic Modeling: On Markov-dependent reflected autoregressive processes and related models

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** On Markov-dependent reflected autoregressive processes and related models  
**Jurnal & Sitasi Utama:** Ioannis Dimitriou (2025). *Queueing Systems*. DOI: [10.1007/s11134-025-09948-z](10.1007/s11134-025-09948-z)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Partially Observed Markov Decision Processes*. DOI: [10.1017/9781009449441.031](10.1017/9781009449441.031)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ioannis Dimitriou (2025) dalam jurnal *Queueing Systems* (DOI: 10.1007/s11134-025-09948-z) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
