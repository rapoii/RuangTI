# 5405 — Operations Research & Large-Scale Optimization: Variational Autoencoder-Assisted Accelerated Benders Decomposition for Resilient Stochastic Air Transport Network Reconfiguration under Airspace Disruptions

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Variational Autoencoder-Assisted Accelerated Benders Decomposition for Resilient Stochastic Air Transport Network Reconfiguration under Airspace Disruptions  
**Jurnal & Sitasi Utama:** Iman Rahimi (2024). *Peer-Reviewed Journal*. DOI: [10.21203/rs.3.rs-9673076/v1](10.21203/rs.3.rs-9673076/v1)  
**Sitasi Pendukung:** A. Hamidieh, B. Akhgari (2024). *Scientia Iranica*. DOI: [10.24200/sci.2024.61889.7541](10.24200/sci.2024.61889.7541)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Iman Rahimi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21203/rs.3.rs-9673076/v1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
