# 4804 — Production Planning & Inventory Control: Glucose Supply Control Using Silver Meal Heuristic Method at PT. XM Sidoarjo

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Glucose Supply Control Using Silver Meal Heuristic Method at PT. XM Sidoarjo  
**Jurnal & Sitasi Utama:** Titik Koesdijati, Djoko Adi Waluyo (2022). *Tibuana*. DOI: [10.36456/tibuana.5.2.5940.135-140](10.36456/tibuana.5.2.5940.135-140)  
**Sitasi Pendukung:** Xiyuan Ma, Roberto Rossi, Thomas Welsh Archibald (2026). *International Journal of Production Economics*. DOI: [10.1016/j.ijpe.2026.110112](10.1016/j.ijpe.2026.110112)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Titik Koesdijati, Djoko Adi Waluyo (2022) dalam jurnal *Tibuana* (DOI: 10.36456/tibuana.5.2.5940.135-140) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract
Inefficient supply of glucose is a problem for PT XM Sidoarjo, where too much raw material inventory can result in high storage costs, or too little inventory causes the production process to stop. The research uses the Silver Meal Heuristic method which is based on future demand, so that the purchase of raw materials can be determined precisely.
The company calculates the cost of raw materials and storage for a year using the Company's Real Method is around Rp. 16,465,582,200. If using the Heuristic Silver Meal method, the number of orders for glucose by predicting the optimal number of orders for raw materials to meet the inventory needs every month is 1,050.62 tons at a cost of Rp. 1,261,094,000. so the total cost from January to December 2020 will be Rp 15,133,128,000.
Thus the savings that can be made from January to December 2020 is Rp. 1,332,454,200 with an efficiency of 8.09%.
Keywords: Inventory Control, Silver Meal Heuristic Method, Glucose Raw Material."

Penelitian pendukung oleh Xiyuan Ma, Roberto Rossi, Thomas Welsh Archibald (2026) yang dipublikasikan dalam *International Journal of Production Economics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
