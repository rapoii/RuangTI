# 5514 — Quality Engineering & Reliability Systems: rbcc: Risk-Based Control Charts

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** rbcc: Risk-Based Control Charts  
**Jurnal & Sitasi Utama:** Aamir Saghir, Attila Imre Katona, Zsolt Tibor Kosztyan (2023). *CRAN: Contributed Packages*. DOI: [10.32614/cran.package.rbcc](10.32614/cran.package.rbcc)  
...
Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Aamir Saghir, Attila Imre Katona, Zsolt Tibor Kosztyan (2023) dalam jurnal *CRAN: Contributed Packages* (DOI: 10.32614/cran.package.rbcc) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
