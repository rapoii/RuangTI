# 4323 — Supply Chain Management & Logistics Engineering: Sampling-Based Approximation for Serial Multi-Echelon Inventory System

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Sampling-Based Approximation for Serial Multi-Echelon Inventory System  
**Jurnal & Sitasi Utama:** Kairen Zhang, Xiangyu Gao, Zhanyue Wang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3859856](10.2139/ssrn.3859856)  
**Sitasi Pendukung:** Alvaro Maggiar, Irene Song, Alp Muharremoglu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4154780](10.2139/ssrn.4154780)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kairen Zhang, Xiangyu Gao, Zhanyue Wang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.3859856) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
