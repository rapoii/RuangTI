# 3275 — Supply Chain Management & Logistics Engineering: System Dynamics Analysis of Reverse Logistics in Closed-loop Supply Chain under Enterprise's Self-operated Mode

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** System Dynamics Analysis of Reverse Logistics in Closed-loop Supply Chain under Enterprise's Self-operated Mode  
**Jurnal & Sitasi Utama:** Haoyu Zhang (2026). *Proceedings of the 2026 9th International Conference on Computers in Management and Business*. DOI: [10.1145/3802463.3802483](10.1145/3802463.3802483)  
**Sitasi Pendukung:** Arindam Garai, Biswajit Sarkar (2022). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2021.129977](10.1016/j.jclepro.2021.129977)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Haoyu Zhang (2026) dalam jurnal *Proceedings of the 2026 9th International Conference on Computers in Management and Business* (DOI: 10.1145/3802463.3802483) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Arindam Garai, Biswajit Sarkar (2022) yang dipublikasikan dalam *Journal of Cleaner Production* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
