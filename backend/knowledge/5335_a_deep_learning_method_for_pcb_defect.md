# 5335 — Industrial Artificial Intelligence & Data Analytics: A Deep Learning Method for PCB Defect Detection Based on Improved Yolov8

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A Deep Learning Method for PCB Defect Detection Based on Improved Yolov8  
**Jurnal & Sitasi Utama:** Panke Zhu, Yiwen Cai, Fen Li (2024). *Proceedings of the International Conference on Computer Vision and Deep Learning*. DOI: [10.1145/3653781.3653830](10.1145/3653781.3653830)  
**Sitasi Pendukung:** Shih-Yu Chen, Fong-Ji Tsai (2023). *Automated Visual Inspection and Machine Vision V*. DOI: [10.1117/12.2675020](10.1117/12.2675020)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Panke Zhu, Yiwen Cai, Fen Li (2024) dalam jurnal *Proceedings of the International Conference on Computer Vision and Deep Learning* (DOI: 10.1145/3653781.3653830) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shih-Yu Chen, Fong-Ji Tsai (2023) yang dipublikasikan dalam *Automated Visual Inspection and Machine Vision V* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
