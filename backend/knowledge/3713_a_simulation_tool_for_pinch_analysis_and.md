# 3713 — Industrial Energy Management & Decarbonization: A simulation tool for pinch analysis and heat exchanger/heat pump integration in industrial processes: Development and application in challenge-based learning

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** A simulation tool for pinch analysis and heat exchanger/heat pump integration in industrial processes: Development and application in challenge-based learning  
**Jurnal & Sitasi Utama:** J.C. Atuonwu (2025). *Education for Chemical Engineers*. DOI: [10.1016/j.ece.2025.04.001](10.1016/j.ece.2025.04.001)  
**Sitasi Pendukung:** Leonid M. Ulyev, Maxim V. Kanischev, Roman E. Chibisov (2021). *Energies*. DOI: [10.3390/en14133839](10.3390/en14133839)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari J.C. Atuonwu (2025) dalam jurnal *Education for Chemical Engineers* (DOI: 10.1016/j.ece.2025.04.001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
