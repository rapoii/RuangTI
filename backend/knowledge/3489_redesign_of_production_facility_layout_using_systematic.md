# 3489 — Facilities Planning & Material Handling: Redesign of Production Facility Layout Using Systematic Layout Planning (SLP) Method to Improve Operational Efficiency at PT. XYZ

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Redesign of Production Facility Layout Using Systematic Layout Planning (SLP) Method to Improve Operational Efficiency at PT. XYZ  
**Jurnal & Sitasi Utama:** Hadi Achmad, Sugeng Santoso (2025). *International Journal of Business and Applied Economics*. DOI: [10.55927/ijbae.v4i5.419](10.55927/ijbae.v4i5.419)  
**Sitasi Pendukung:** Ferdy Kusumawardana, Arfan Bakhtiar, Singgih Saptadi (2023). *World Journal of Advanced Research and Reviews*. DOI: [10.30574/wjarr.2023.19.3.1876](10.30574/wjarr.2023.19.3.1876)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hadi Achmad, Sugeng Santoso (2025) dalam jurnal *International Journal of Business and Applied Economics* (DOI: 10.55927/ijbae.v4i5.419) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study aims to redesign the layout of production facilities at PT XYZ using the Systematic Layout Planning (SLP) method to improve operational efficiency. The research method used is a descriptive quantitative approach with the analysis of material displacement distance and material displacement moment. The results showed that the alternative layout Plan A (U-Flow) was able to reduce the total transport work from 5,956.39 units to 4,118.57 units or experienced an increase in efficiency of 30.86%. These findings confirm that the SLP method is effective in improving material flow, reducing material handling costs, and improving work safety aspects. Theoretically, this study enriches the literature on the application of SLP in the manufacturing industry, while practically providing guidance on layout improvements that can increase the Company's productivity and competitiveness."

Penelitian pendukung oleh Ferdy Kusumawardana, Arfan Bakhtiar, Singgih Saptadi (2023) yang dipublikasikan dalam *World Journal of Advanced Research and Reviews* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
