# 3023 — Supply Chain Management & Logistics Engineering: Multi-objective mixed-integer linear optimization model for sustainable closed-loop supply chain network: a case study on remanufacturing steering column

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Multi-objective mixed-integer linear optimization model for sustainable closed-loop supply chain network: a case study on remanufacturing steering column  
**Jurnal & Sitasi Utama:** Sonu Rajak, K. E. K. Vimal, Sricharan Arumugam (2021). *Environment Development and Sustainability*. DOI: [10.1007/s10668-021-01713-5](10.1007/s10668-021-01713-5)  
**Sitasi Pendukung:** Mahya Seyedan, Fereshteh Mafakheri (2020). *Journal Of Big Data*. DOI: [10.1186/s40537-020-00329-2](10.1186/s40537-020-00329-2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sonu Rajak, K. E. K. Vimal, Sricharan Arumugam (2021) dalam jurnal *Environment Development and Sustainability* (DOI: 10.1007/s10668-021-01713-5) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mahya Seyedan, Fereshteh Mafakheri (2020) yang dipublikasikan dalam *Journal Of Big Data* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
