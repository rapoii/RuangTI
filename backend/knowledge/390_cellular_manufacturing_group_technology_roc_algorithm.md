# Modul Komprehensif: Cellular Manufacturing & Group Technology: Rank Order Clustering (ROC Algorithm)
**Nomor Modul:** [390]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Group Technology and Cellular Manufacturing (Reza A. Malakooti), Journal of Manufacturing Systems (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Cellular Manufacturing & Group Technology: Rank Order Clustering (ROC Algorithm)**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Machine-Part Incidence Matrix, Rank Order Clustering (ROC 1 & ROC 2 King), Direct Clustering Algorithm (DCA), Exceptional Elements, Grouping Efficiency $\eta$.
...
```python
# Algoritma Solusi Terapan untuk Cellular Manufacturing & Group Technology: Rank Order Clustering (ROC Algorithm)
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Rekonfigurasi Tata Letak Fungsional Menjadi 6 Sel Manufaktur Mandiri Pabrik Katup Pipa.
...
1. Group Technology and Cellular Manufacturing (Reza A. Malakooti), Journal of Manufacturing Systems (2024).
