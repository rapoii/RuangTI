# 4001 — Facilities Planning & Material Handling: Research on layout planning of disinfection tableware distribution center based on SLP method

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Research on layout planning of disinfection tableware distribution center based on SLP method  
**Jurnal & Sitasi Utama:** Yuqing Li (2020). *MATEC Web of Conferences*. DOI: [10.1051/matecconf/202032503004](10.1051/matecconf/202032503004)  
**Sitasi Pendukung:** Alessandra Cantini, Filippo De Carlo, Mario Tucci (2020). *Sustainability*. DOI: [10.3390/su12218949](10.3390/su12218949)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuqing Li (2020) dalam jurnal *MATEC Web of Conferences* (DOI: 10.1051/matecconf/202032503004) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This paper is taking Kangjie disinfecting tableware distribution center as an example. First of all, analyze the basic operation processes and the whole area is divided into eight parts. Use SLP method to analyze the correlation between logistics and non-logistics, the combination of these two can get a comprehensive correlativity. And determine the extent of distance correlation between regions and to determine the location of each operation area. The goal of this paper is to relatively optimize the design of the spatial layout and area of the Kangjie disinfection tableware distribution center, and further improve the rationality of the distribution center."

Penelitian pendukung oleh Alessandra Cantini, Filippo De Carlo, Mario Tucci (2020) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
