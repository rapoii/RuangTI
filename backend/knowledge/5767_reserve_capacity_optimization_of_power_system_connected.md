# 5767 — Operations Research & Large-Scale Optimization: Reserve Capacity Optimization of Power System Connected to Large-Scale Wind Farm Based on Chance Constrained Objective Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Reserve Capacity Optimization of Power System Connected to Large-Scale Wind Farm Based on Chance Constrained Objective Programming  
**Jurnal & Sitasi Utama:** Rui Zhang, Yun Teng, Zhe Chen (2024). *2024 IEEE 8th Conference on Energy Internet and Energy System Integration (EI2)*. DOI: [10.1109/ei264398.2024.10991581](10.1109/ei264398.2024.10991581)  
**Sitasi Pendukung:** Jan Lorenz Svensen, Xiaodong Chen, Sjoerd Boersma (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4571002](10.2139/ssrn.4571002)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rui Zhang, Yun Teng, Zhe Chen (2024) dalam jurnal *2024 IEEE 8th Conference on Energy Internet and Energy System Integration (EI2)* (DOI: 10.1109/ei264398.2024.10991581) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
