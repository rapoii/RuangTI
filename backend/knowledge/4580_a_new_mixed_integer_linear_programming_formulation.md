# 4580 — Operations Research & Large-Scale Optimization: A New Mixed Integer Linear Programming Formulation for Dynamic Facility Layout Problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A New Mixed Integer Linear Programming Formulation for Dynamic Facility Layout Problem  
**Jurnal & Sitasi Utama:** R. Matai, S.P. Singh (2021). *2021 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem50564.2021.9673000](10.1109/ieem50564.2021.9673000)  
**Sitasi Pendukung:** Shamisa Shoja, Daniel Arnstrom, Daniel Axehill (2022). *2022 IEEE 61st Conference on Decision and Control (CDC)*. DOI: [10.1109/cdc51059.2022.9992451](10.1109/cdc51059.2022.9992451)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari R. Matai, S.P. Singh (2021) dalam jurnal *2021 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)* (DOI: 10.1109/ieem50564.2021.9673000) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shamisa Shoja, Daniel Arnstrom, Daniel Axehill (2022) yang dipublikasikan dalam *2022 IEEE 61st Conference on Decision and Control (CDC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
