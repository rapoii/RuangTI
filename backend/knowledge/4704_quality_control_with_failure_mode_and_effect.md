# 4704 — Quality Engineering & Reliability Systems: Quality Control with Failure Mode and Effect Analysis (FMEA) And Fault Tree Analysis (FTA) Methods: Case Study Japanese Multinational Automotive Corporation

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Quality Control with Failure Mode and Effect Analysis (FMEA) And Fault Tree Analysis (FTA) Methods: Case Study Japanese Multinational Automotive Corporation  
**Jurnal & Sitasi Utama:** Jakfat Haekal (2022). *International Journal Of Scientific Advances*. DOI: [10.51542/ijscia.v3i2.14](10.51542/ijscia.v3i2.14)  
