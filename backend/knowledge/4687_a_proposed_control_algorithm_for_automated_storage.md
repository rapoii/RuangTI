# 4687 — Facilities Planning & Material Handling: A Proposed Control Algorithm for Automated Storage and Retrieval System m (ASRS)

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** A Proposed Control Algorithm for Automated Storage and Retrieval System m (ASRS)  
**Jurnal & Sitasi Utama:** Ali R. Hameed, Osama F. Abdulateef (2024). *Al-Khwarizmi Engineering Journal*. DOI: [10.22153/kej.2024.09.002](10.22153/kej.2024.09.002)  
**Sitasi Pendukung:** Anuradha S. Parab, P. N. Gore (2020). *Asian Review of Mechanical Engineering*. DOI: [10.51983/arme-2020.9.2.2483](10.51983/arme-2020.9.2.2483)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ali R. Hameed, Osama F. Abdulateef (2024) dalam jurnal *Al-Khwarizmi Engineering Journal* (DOI: 10.22153/kej.2024.09.002) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "تقدم هذه الورقة البحثية خوارزمية مبتكرة تهدف إلى تحسين أداء نظام حركة المحرك الخطوي الذي يعمل بنظام الحلقة المفتوحة من خلال إغلاق الحلقة باستخدام اجهزة ذات كلفة معقولة ، تحقق الخوارزمية المقترحة مستوى أعلى من المرونة من حيث السرعة ومدى الاوزان المسموح بها لأجهزة S / R. تم تصميم الخوارزمية للعمل ضمن نظام تحكم موزع (DCS) ، حيث تعمل وحدات تحكم متعددة معًا لتلبية متطلبات المستخدم. من خلال تقليل متطلبات الأجهزة ، وقوة المعالجة، والتوقف المحتمل بسبب الاعطال والتكاليف ، توفر الخوارزمية المقترحة حلاً سهل الاستخدام وفعال من حيث التكلفة. بالإضافة إلى ذلك ، تعالج الخوارزمية النسبة بين عزم الدوران / السرعة  للتعويض عن مشاكل الوزن الزائد المحتملة واستهلاك الطاقة في آلات S / R ، وبالتالي تحسين كفاءتها الإجمالية. بفضل ميزاتها الفريدة ، تتمتع هذه الخوارزمية بإمكانية إحداث ثورة في طريقة عمل أنظمة الحركة ذات المحركات الخطوية ذات الحلقة المفتوحة ، مما يجعلها أكثر كفاءة وفعالية من حيث التكلفة."

Penelitian pendukung oleh Anuradha S. Parab, P. N. Gore (2020) yang dipublikasikan dalam *Asian Review of Mechanical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
