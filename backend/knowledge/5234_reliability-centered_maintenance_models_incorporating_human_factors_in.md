# 5234 — Maintenance Engineering & Asset Life Cycle: Reliability-Centered Maintenance Models Incorporating Human Factors in African Critical Infrastructure

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Reliability-Centered Maintenance Models Incorporating Human Factors in African Critical Infrastructure  
**Jurnal & Sitasi Utama:** Biliaminu Rokeeb (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5981295](10.2139/ssrn.5981295)  
**Sitasi Pendukung:** Fauzan Muhammad, Faizah Suryani, Tolu Tamalika (2023). *JIeTri : Journal of Industrial Engineering Tridinanti*. DOI: [10.52333/jietri.v1i02.421](10.52333/jietri.v1i02.421)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Biliaminu Rokeeb (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5981295) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Reliability-centered maintenance (RCM) has become a dominant strategy for ensuring asset availability, safety, and lifecycle optimization in critical infrastructure systems. However, in many African industrial contexts, persistent failures, safety incidents, and premature asset degradation continue to occur despite the adoption of RCM-based frameworks. This study examines the extent to which existing RCM models adequately incorporate human factors and organizational realities within African critical infrastructure systems. Using a structured synthesis of peer-reviewed literature, industrial case studies, and conceptual frameworks, the study evaluates both classical and advanced RCM models, including digital and RCM 4.0 approaches. The findings reveal that most RCM implementations in Africa remain technically driven, with limited integration of human reliability, skill readiness, and organizational culture. Evidence across energy, aviation, healthcare, and oil and gas sectors indicates that human factors significantly influence maintenance effectiveness and system reliability. The study concludes that hybrid RCM models that explicitly integrate human factors engineering are essential for improving reliability outcomes and asset sustainability in African critical infrastructure. Practical recommendations for policy, industry, and future research are proposed."

Penelitian pendukung oleh Fauzan Muhammad, Faizah Suryani, Tolu Tamalika (2023) yang dipublikasikan dalam *JIeTri : Journal of Industrial Engineering Tridinanti* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
