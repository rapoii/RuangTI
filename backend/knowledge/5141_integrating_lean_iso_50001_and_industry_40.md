# 5141 — Industrial Energy Management & Decarbonization: Integrating Lean, ISO 50001, and Industry 4.0 Analytics for Industrial Energy Management: A Systematic Review of KPIs, Governance, and Implementation Factors

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Integrating Lean, ISO 50001, and Industry 4.0 Analytics for Industrial Energy Management: A Systematic Review of KPIs, Governance, and Implementation Factors  
**Jurnal & Sitasi Utama:** FRANCIS IKECHUKWU ODINAKA (2026). *Journal of Energy Research and Reviews*. DOI: [10.9734/jenrr/2026/v18i7522](10.9734/jenrr/2026/v18i7522)  
**Sitasi Pendukung:** Robi Kurniawan, Agung Feinnudin (2021). *Indonesian Journal of Energy*. DOI: [10.33116/ije.v4i2.125](10.33116/ije.v4i2.125)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari FRANCIS IKECHUKWU ODINAKA (2026) dalam jurnal *Journal of Energy Research and Reviews* (DOI: 10.9734/jenrr/2026/v18i7522) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Results: A framework-based data extraction approach was used to capture Lean/LSS practices, ISO 50001 PDCA elements, analytics capability types and KPI measurement structures. The synthesis produced three main outputs: (i) an integration taxonomy linking AI/Industry 4.0 analytics capabilities with PDCA governance processes and Lean execution m"

Penelitian pendukung oleh Robi Kurniawan, Agung Feinnudin (2021) yang dipublikasikan dalam *Indonesian Journal of Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
