# 3860 — Industrial Artificial Intelligence & Data Analytics: Physics-Informed Neural Networks for Solving Forward and Inverse Problems in Complex Beam Systems

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-Informed Neural Networks for Solving Forward and Inverse Problems in Complex Beam Systems  
**Jurnal & Sitasi Utama:** Taniya Kapoor, Hongrui Wang, Alfredo Núñez (2023). *IEEE Transactions on Neural Networks and Learning Systems*. DOI: [10.1109/tnnls.2023.3310585](10.1109/tnnls.2023.3310585)  
**Sitasi Pendukung:** Guofei Pang, Marta D’Elia, Michael L. Parks (2020). *Journal of Computational Physics*. DOI: [10.1016/j.jcp.2020.109760](10.1016/j.jcp.2020.109760)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Taniya Kapoor, Hongrui Wang, Alfredo Núñez (2023) dalam jurnal *IEEE Transactions on Neural Networks and Learning Systems* (DOI: 10.1109/tnnls.2023.3310585) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Guofei Pang, Marta D’Elia, Michael L. Parks (2020) yang dipublikasikan dalam *Journal of Computational Physics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
