# 4219 — Operations Research & Large-Scale Optimization: Operational optimization of industrial steam systems under uncertainty using data‐ D riven adaptive robust optimization

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Operational optimization of industrial steam systems under uncertainty using data‐ D riven adaptive robust optimization  
**Jurnal & Sitasi Utama:** Liang Zhao, Chao Ning, Fengqi You (2018). *AIChE Journal*. DOI: [10.1002/aic.16500](10.1002/aic.16500)  
**Sitasi Pendukung:** R. Lamedica, Ezio Santini, Alessandro Ruvio (2018). *Energy*. DOI: [10.1016/j.energy.2018.09.087](10.1016/j.energy.2018.09.087)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Liang Zhao, Chao Ning, Fengqi You (2018) dalam jurnal *AIChE Journal* (DOI: 10.1002/aic.16500) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh R. Lamedica, Ezio Santini, Alessandro Ruvio (2018) yang dipublikasikan dalam *Energy* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
