# 3972 — Supply Chain Management & Logistics Engineering: Analysis of Reverse Logistics System using COPRAS MCDM Method

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Analysis of Reverse Logistics System using COPRAS MCDM Method  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2022). *REST Journal on Banking Accounting and Business*. DOI: [10.46632/jbab/1/4/5](10.46632/jbab/1/4/5)  
**Sitasi Pendukung:** Tommaso Calzolari, Andrea Genovese, Andrew Brint (2021). *Environmental and Sustainability Indicators*. DOI: [10.1016/j.indic.2021.100160](10.1016/j.indic.2021.100160)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2022) dalam jurnal *REST Journal on Banking Accounting and Business* (DOI: 10.46632/jbab/1/4/5) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
