# 4794 — Production Planning & Inventory Control: OPTIMALISASI LOT SIZE PEMESANAN BAHAN BAKU ROKOK FILTER UNTUK MEMINIMASI TOTAL BIAYA PERSEDIAAN MENGGUNAKAN METODE WAGNER WHITIN ALGORITHM PADA CV. XYZ

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** OPTIMALISASI LOT SIZE PEMESANAN BAHAN BAKU ROKOK FILTER UNTUK MEMINIMASI TOTAL BIAYA PERSEDIAAN MENGGUNAKAN METODE WAGNER WHITIN ALGORITHM PADA CV. XYZ  
**Jurnal & Sitasi Utama:** Satriya Dwi Santoso, Dwi Sukma Donoriyanto, Handoyo Handoyo (2020). *JUMINTEN*. DOI: [10.33005/juminten.v1i4.6](10.33005/juminten.v1i4.6)  
**Sitasi Pendukung:** Fuying Jing, Xiangrui Chao (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4068687](10.2139/ssrn.4068687)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Satriya Dwi Santoso, Dwi Sukma Donoriyanto, Handoyo Handoyo (2020) dalam jurnal *JUMINTEN* (DOI: 10.33005/juminten.v1i4.6) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
