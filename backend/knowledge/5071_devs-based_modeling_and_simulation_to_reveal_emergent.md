# 5071 — Simulation Modeling & Digital Twins: DEVS-Based Modeling and Simulation to Reveal Emergent Behaviors of IoT Devices

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** DEVS-Based Modeling and Simulation to Reveal Emergent Behaviors of IoT Devices  
**Jurnal & Sitasi Utama:** Moath Jarrah, Omar Al-Jarrah (2022). *Emergent Behavior in System of Systems Engineering*. DOI: [10.1201/9781003160816-9](10.1201/9781003160816-9)  
**Sitasi Pendukung:** Islam El-Nakib (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7110138](10.2139/ssrn.7110138)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Moath Jarrah, Omar Al-Jarrah (2022) dalam jurnal *Emergent Behavior in System of Systems Engineering* (DOI: 10.1201/9781003160816-9) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Islam El-Nakib (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
