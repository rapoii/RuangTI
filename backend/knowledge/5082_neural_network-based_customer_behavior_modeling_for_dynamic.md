# 5082 — Simulation Modeling & Digital Twins: Neural Network-Based Customer Behavior Modeling for Dynamic Conversion Funnel Optimization in Digital Retail

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Neural Network-Based Customer Behavior Modeling for Dynamic Conversion Funnel Optimization in Digital Retail  
**Jurnal & Sitasi Utama:** Anirudh Reddy Pathe (2024). *Journal of Marketing &amp; Supply Chain Management*. DOI: [10.47363/jmscm/2024(3)e123](10.47363/jmscm/2024(3)e123)  
**Sitasi Pendukung:** Lead Industrial Researchers (2024). *Proceedings of the 26th International Conference on Harbor, Maritime and Multimodal Logistic Modeling &amp; Simulation*. DOI: [10.46354/i3m.2024.hms.013](10.46354/i3m.2024.hms.013)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anirudh Reddy Pathe (2024) dalam jurnal *Journal of Marketing &amp; Supply Chain Management* (DOI: 10.47363/jmscm/2024(3)e123) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
