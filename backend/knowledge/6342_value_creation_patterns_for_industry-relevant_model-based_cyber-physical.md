# 6342 — Manufacturing Systems & Cyber-Physical Production: Value Creation Patterns for Industry-relevant Model-based Cyber-Physical Systems

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Value Creation Patterns for Industry-relevant Model-based Cyber-Physical Systems  
**Jurnal & Sitasi Utama:** Nicolas Egger, Emanuele Laurenzi (2022). *Proceedings of the 10th International Conference on Model-Driven Engineering and Software Development*. DOI: [10.5220/0010984400003119](10.5220/0010984400003119)  
**Sitasi Pendukung:** Gennady Vinogradov, Alexey Prokhorov, Georgy Shepelev (2021). *Studies in Systems, Decision and Control*. DOI: [10.1007/978-3-030-66081-9_1](10.1007/978-3-030-66081-9_1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nicolas Egger, Emanuele Laurenzi (2022) dalam jurnal *Proceedings of the 10th International Conference on Model-Driven Engineering and Software Development* (DOI: 10.5220/0010984400003119) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Gennady Vinogradov, Alexey Prokhorov, Georgy Shepelev (2021) yang dipublikasikan dalam *Studies in Systems, Decision and Control* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
