# 2960 — Operations Research & Large-Scale Optimization: MIPLIB 2017: data-driven compilation of the 6th mixed-integer programming library

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** MIPLIB 2017: data-driven compilation of the 6th mixed-integer programming library  
**Jurnal & Sitasi Utama:** Ambros Gleixner, Gregor Hendel, Gerald Gamrath (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00194-3](10.1007/s12532-020-00194-3)  
**Sitasi Pendukung:** Alberto Del Pia, Volker Kaibel (2023). *Lecture notes in computer science*. DOI: [10.1007/978-3-031-32726-1](10.1007/978-3-031-32726-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ambros Gleixner, Gregor Hendel, Gerald Gamrath (2021) dalam jurnal *Mathematical Programming Computation* (DOI: 10.1007/s12532-020-00194-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Alberto Del Pia, Volker Kaibel (2023) yang dipublikasikan dalam *Lecture notes in computer science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
