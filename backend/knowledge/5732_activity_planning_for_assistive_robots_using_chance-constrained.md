# 5732 — Operations Research & Large-Scale Optimization: Activity Planning for Assistive Robots Using Chance-Constrained Stochastic Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Activity Planning for Assistive Robots Using Chance-Constrained Stochastic Programming  
**Jurnal & Sitasi Utama:** Paolo Bevilacqua, Marco Frego, Luigi Palopoli (2021). *IEEE Transactions on Industrial Informatics*. DOI: [10.1109/tii.2020.3012094](10.1109/tii.2020.3012094)  
**Sitasi Pendukung:** Bingtuan Gao, Yuanmei Li (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5352186](10.2139/ssrn.5352186)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Paolo Bevilacqua, Marco Frego, Luigi Palopoli (2021) dalam jurnal *IEEE Transactions on Industrial Informatics* (DOI: 10.1109/tii.2020.3012094) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Bingtuan Gao, Yuanmei Li (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
