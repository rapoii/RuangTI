# 3885 — Industrial Artificial Intelligence & Data Analytics: Physics-Informed Neural Network (PINN) for Solving Frictional Contact Temperature and Inversely Evaluating Relevant Input Parameters

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Physics-Informed Neural Network (PINN) for Solving Frictional Contact Temperature and Inversely Evaluating Relevant Input Parameters  
**Jurnal & Sitasi Utama:** Yichun Xia, Yonggang Meng (2024). *Lubricants*. DOI: [10.3390/lubricants12020062](10.3390/lubricants12020062)  
**Sitasi Pendukung:** Sergiy Plankovskyy, Yevgen Tsegelnyk, Nataliіa Shyshko (2025). *Mathematics*. DOI: [10.3390/math13203289](10.3390/math13203289)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yichun Xia, Yonggang Meng (2024) dalam jurnal *Lubricants* (DOI: 10.3390/lubricants12020062) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
