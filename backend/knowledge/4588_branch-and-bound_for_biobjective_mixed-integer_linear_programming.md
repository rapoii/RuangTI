# 4588 — Operations Research & Large-Scale Optimization: Branch-and-Bound for Biobjective Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Branch-and-Bound for Biobjective Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Nathan Adelgren, Akshay Gupte (2022). *INFORMS Journal on Computing*. DOI: [10.1287/ijoc.2021.1092](10.1287/ijoc.2021.1092)  
**Sitasi Pendukung:** J. Song (2026). *Advanced Electromagnetics*. DOI: [10.7716/aem.v15i3.3891](10.7716/aem.v15i3.3891)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nathan Adelgren, Akshay Gupte (2022) dalam jurnal *INFORMS Journal on Computing* (DOI: 10.1287/ijoc.2021.1092) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
