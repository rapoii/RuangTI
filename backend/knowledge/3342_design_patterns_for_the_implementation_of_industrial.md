# 3342 — Manufacturing Systems & Cyber-Physical Production: Design patterns for the implementation of Industrial Agent-based AASs

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Design patterns for the implementation of Industrial Agent-based AASs  
**Jurnal & Sitasi Utama:** Alejandro López, Oskar Casquero, Marga Marcos (2021). *Peer-Reviewed Academic Journal*. DOI: [10.1109/icps49255.2021.9468129](10.1109/icps49255.2021.9468129)  
**Sitasi Pendukung:** Simon Komesker, William Motsch, Jens Popper (2022). *Procedia CIRP*. DOI: [10.1016/j.procir.2022.05.097](10.1016/j.procir.2022.05.097)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alejandro López, Oskar Casquero, Marga Marcos (2021) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.1109/icps49255.2021.9468129) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The I4.0 component is a key concept in RAMI 4.0 reference architecture that can be understood as a Cyber Physical Systems, where the asset corresponds to the physical part and the Asset Administration Shell (AAS) corresponds to the cyber part. The implementation of the AAS has received an increasing attention in the last few years. Industrial agents have become a common solution for this issue because their features fulfil several of the requirements for the development of AASs. However, the lack of design methodologies and design development tools can explain the little adoption of these systems in industry. In this context, this work contributes a pattern for the implementation of AASs based on industrial agents from which agent templates for different applications can be derived. In order to assess the applicability of the proposed pattern, it is applied in the implementation of AAS for manufacturing resources as well as for the logical representation of product assets, covering the production phase of the I4.0 component."

Penelitian pendukung oleh Simon Komesker, William Motsch, Jens Popper (2022) yang dipublikasikan dalam *Procedia CIRP* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
