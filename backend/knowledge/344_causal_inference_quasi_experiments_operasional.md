# Modul Komprehensif: Causal Inference & Quasi-Experiments untuk Evaluasi Kebijakan Operasional
**Nomor Modul:** [344]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Causal Inference: The Mixtape (Scott Cunningham), Management Science (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Causal Inference & Quasi-Experiments untuk Evaluasi Kebijakan Operasional**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Potential Outcomes Framework (Rubin), Difference-in-Differences (DiD), Propensity Score Matching (PSM), Regression Discontinuity Design (RDD).
...
```python
# Algoritma Solusi Terapan untuk Causal Inference & Quasi-Experiments untuk Evaluasi Kebijakan Operasional
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Evaluasi Kausalitas Dampak Pelatihan Ergonomi Operator terhadap Penurunan Tingkat Cacat Pabrik.
...
1. Causal Inference: The Mixtape (Scott Cunningham), Management Science (2024).
