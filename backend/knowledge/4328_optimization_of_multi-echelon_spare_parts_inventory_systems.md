# 4328 — Supply Chain Management & Logistics Engineering: Optimization of multi-echelon spare parts inventory systems using multi-agent deep reinforcement learning

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Optimization of multi-echelon spare parts inventory systems using multi-agent deep reinforcement learning  
**Jurnal & Sitasi Utama:** Yifan Zhou, Kai Guo, Cheng Yu (2024). *Applied Mathematical Modelling*. DOI: [10.1016/j.apm.2023.10.039](10.1016/j.apm.2023.10.039)  
**Sitasi Pendukung:** Kevin H. Shang, Jing-Sheng Jeannette Song, Sean X. Zhou (2023). *Research Handbook on Inventory ManagemenT*. DOI: [10.4337/9781800377103.00012](10.4337/9781800377103.00012)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yifan Zhou, Kai Guo, Cheng Yu (2024) dalam jurnal *Applied Mathematical Modelling* (DOI: 10.1016/j.apm.2023.10.039) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kevin H. Shang, Jing-Sheng Jeannette Song, Sean X. Zhou (2023) yang dipublikasikan dalam *Research Handbook on Inventory ManagemenT* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
