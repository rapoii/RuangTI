# 6335 — Manufacturing Systems & Cyber-Physical Production: Secure Data Aggregation Using Cyber-Physical Systems for Environment Monitoring

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Secure Data Aggregation Using Cyber-Physical Systems for Environment Monitoring  
**Jurnal & Sitasi Utama:** M. K. Sandhya, K. Murugan, S. Prasidh (2021). *Cyber-Physical Systems and Industry 4.0*. DOI: [10.1201/9781003129790-6](10.1201/9781003129790-6)  
**Sitasi Pendukung:** Tejaswini Apte, Sarika Sharma (2021). *Cyber-Physical, IoT, and Autonomous Systems in Industry 4.0*. DOI: [10.1201/9781003146711-8](10.1201/9781003146711-8)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. K. Sandhya, K. Murugan, S. Prasidh (2021) dalam jurnal *Cyber-Physical Systems and Industry 4.0* (DOI: 10.1201/9781003129790-6) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tejaswini Apte, Sarika Sharma (2021) yang dipublikasikan dalam *Cyber-Physical, IoT, and Autonomous Systems in Industry 4.0* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
