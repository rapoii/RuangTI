# 6229 — Operations Research & Large-Scale Optimization: Real-time collaborative feeder vehicle routing problem with flexible time windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Real-time collaborative feeder vehicle routing problem with flexible time windows  
**Jurnal & Sitasi Utama:** M. Salehi Sarbijan, J. Behnamian (2022). *Swarm and Evolutionary Computation*. DOI: [10.1016/j.swevo.2022.101201](10.1016/j.swevo.2022.101201)  
**Sitasi Pendukung:** Toygar Emre, Rizvan Erol (2025). *Mathematics*. DOI: [10.3390/math13050876](10.3390/math13050876)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. Salehi Sarbijan, J. Behnamian (2022) dalam jurnal *Swarm and Evolutionary Computation* (DOI: 10.1016/j.swevo.2022.101201) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Toygar Emre, Rizvan Erol (2025) yang dipublikasikan dalam *Mathematics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
