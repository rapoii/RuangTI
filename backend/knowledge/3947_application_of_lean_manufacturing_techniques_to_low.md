# 3947 — Continuous Improvement & Lean Six Sigma: Application of Lean Manufacturing Techniques to Low Density Polyethylene Recycling Processes: A Value Stream Mapping Approach

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Application of Lean Manufacturing Techniques to Low Density Polyethylene Recycling Processes: A Value Stream Mapping Approach  
**Jurnal & Sitasi Utama:** Emre Can Temiz, Emel Yontar (2025). *Verimlilik dergisi*. DOI: [10.51551/verimlilik.1684673](10.51551/verimlilik.1684673)  
**Sitasi Pendukung:** Sivaraman Parthasarathi, M. K. Prabhu, J. Krishanamani (2021). *Industrial Engineering*. DOI: [10.11648/j.ie.20210501.11](10.11648/j.ie.20210501.11)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Emre Can Temiz, Emel Yontar (2025) dalam jurnal *Verimlilik dergisi* (DOI: 10.51551/verimlilik.1684673) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Purpose: The aim of this study is reducing waste and improve process efficiency in the recycling of low-density polyethylene (LDPE) by applying lean manufacturing principles. Method: Main stages in the production process Preliminary Preparation Line, Granule Extrusion Line, Film Extrusion Line, and Film Cutting Machine were examined. The current state was mapped using the Value Stream Mapping (VSM) technique. Identified wastes were addressed with lean tools, and a future state map was developed accordingly. Findings: The analysis showed types of waste including waiting periods, unnecessary transportation, and overproduction. Improvement efforts led to reduced cycle time, fewer bottlenecks, and more efficient use of resources. The comparison between current and future states demonstrated a notable increase in overall performance and productivity. Originality: This study offers a unique and sector-specific approach by implementing the VSM technique, which is rarely used in the plastic recycling industry. Its originality lies in adapting lean principles to recycling. Moreover, practical improvement suggestions based on actual field data provide guidance for similar businesses aiming to enhance operational effectiveness."

Penelitian pendukung oleh Sivaraman Parthasarathi, M. K. Prabhu, J. Krishanamani (2021) yang dipublikasikan dalam *Industrial Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
