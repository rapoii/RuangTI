# 3618 — Applied Statistics & Stochastic Modeling: Markovian phase-type single working vacation queue with breakdown and standby server

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Markovian phase-type single working vacation queue with breakdown and standby server  
**Jurnal & Sitasi Utama:** K. Baby Saroja, V. Suvitha (2024). *Mathematics in Applied Sciences and Engineering*. DOI: [10.5206/mase/17434](10.5206/mase/17434)  
**Sitasi Pendukung:** Corentin Briat, Mustafa Khammash (2020). *SIAM Journal on Applied Dynamical Systems*. DOI: [10.1137/19m1286219](10.1137/19m1286219)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari K. Baby Saroja, V. Suvitha (2024) dalam jurnal *Mathematics in Applied Sciences and Engineering* (DOI: 10.5206/mase/17434) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
