# 3369 — Quality Engineering & Reliability Systems: Integrated Systems Ontology (ISOnto): Integrating Engineering Design and Operational Feedback for Dependable Systems

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Integrated Systems Ontology (ISOnto): Integrating Engineering Design and Operational Feedback for Dependable Systems  
**Jurnal & Sitasi Utama:** Haytham Younus, Felician Campean, Sohag Kabir (2025). *Computers*. DOI: [10.3390/computers14110451](10.3390/computers14110451)  
**Sitasi Pendukung:** Imane Elmouden, Bouchra Lotfi (2023). *Peer-Reviewed Academic Journal*. DOI: [10.46254/eu6.20230304](10.46254/eu6.20230304)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Haytham Younus, Felician Campean, Sohag Kabir (2025) dalam jurnal *Computers* (DOI: 10.3390/computers14110451) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Imane Elmouden, Bouchra Lotfi (2023) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
