# 5800 — Human Factors & Cognitive Ergonomics: Mental Workload Assessment Using Deep Learning Models From EEG Signals: A Systematic Review

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Mental Workload Assessment Using Deep Learning Models From EEG Signals: A Systematic Review  
**Jurnal & Sitasi Utama:** Kunjira Kingphai, Yashar Moshfeghi (2024). *IEEE Transactions on Cognitive and Developmental Systems*. DOI: [10.1109/tcds.2024.3460750](10.1109/tcds.2024.3460750)  
**Sitasi Pendukung:** Dario Fenoglio, Daniel Josifovski, Alessandro Gobbetti (2023). *Peer-Reviewed Academic Journal*. DOI: [10.1145/3626705.3627783](10.1145/3626705.3627783)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kunjira Kingphai, Yashar Moshfeghi (2024) dalam jurnal *IEEE Transactions on Cognitive and Developmental Systems* (DOI: 10.1109/tcds.2024.3460750) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Dario Fenoglio, Daniel Josifovski, Alessandro Gobbetti (2023) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
