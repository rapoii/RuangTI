# 3254 — Operations Research & Large-Scale Optimization: A novel sustainable multi-objective optimization model for forward and reverse logistics system under demand uncertainty

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A novel sustainable multi-objective optimization model for forward and reverse logistics system under demand uncertainty  
**Jurnal & Sitasi Utama:** Navid Zarbakhshnia, Devika Kannan, Reza Kiani Mavi (2020). *Annals of Operations Research*. DOI: [10.1007/s10479-020-03744-z](10.1007/s10479-020-03744-z)  
**Sitasi Pendukung:** Canan G. Corlu, Rocío de la Torre, Adrián Serrano-Hernández (2020). *Energies*. DOI: [10.3390/en13051115](10.3390/en13051115)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Navid Zarbakhshnia, Devika Kannan, Reza Kiani Mavi (2020) dalam jurnal *Annals of Operations Research* (DOI: 10.1007/s10479-020-03744-z) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
