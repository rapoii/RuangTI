# 3011 — Operations Research & Large-Scale Optimization: Optimized Scenario Reduction: Solving Large-Scale Stochastic Programs with Quality Guarantees

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimized Scenario Reduction: Solving Large-Scale Stochastic Programs with Quality Guarantees  
**Jurnal & Sitasi Utama:** Wei Zhang, Kai Wang, Alexandre Jacquillat (2023). *INFORMS journal on computing*. DOI: [10.1287/ijoc.2023.1295](10.1287/ijoc.2023.1295)  
**Sitasi Pendukung:** Yuxi Wang, Jingxin Wang, Jamie L. Schuler (2020). *Energy*. DOI: [10.1016/j.energy.2020.117260](10.1016/j.energy.2020.117260)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wei Zhang, Kai Wang, Alexandre Jacquillat (2023) dalam jurnal *INFORMS journal on computing* (DOI: 10.1287/ijoc.2023.1295) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
