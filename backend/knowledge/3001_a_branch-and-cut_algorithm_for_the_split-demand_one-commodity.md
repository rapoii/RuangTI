# 3001 — Operations Research & Large-Scale Optimization: A Branch-and-cut algorithm for the split-demand one-commodity pickup-and-delivery travelling salesman problem

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Branch-and-cut algorithm for the split-demand one-commodity pickup-and-delivery travelling salesman problem  
**Jurnal & Sitasi Utama:** Hipólito Hernández–Pérez, Juan‐José Salazar‐González (2021). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.05.040](10.1016/j.ejor.2021.05.040)  
**Sitasi Pendukung:** Leilei Meng, Yaping Ren, Biao Zhang (2020). *IEEE Access*. DOI: [10.1109/access.2020.3032548](10.1109/access.2020.3032548)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hipólito Hernández–Pérez, Juan‐José Salazar‐González (2021) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2021.05.040) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Leilei Meng, Yaping Ren, Biao Zhang (2020) yang dipublikasikan dalam *IEEE Access* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
