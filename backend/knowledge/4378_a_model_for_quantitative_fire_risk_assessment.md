# 4378 — Safety Engineering & Risk Management: A model for quantitative fire risk assessment integrating agent-based model with automatic event tree analysis

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** A model for quantitative fire risk assessment integrating agent-based model with automatic event tree analysis  
**Jurnal & Sitasi Utama:** Farid Wajdi Akashah, Rachid Ouache, Jianping Zhang (2020). *Handbook of Probabilistic Models*. DOI: [10.1016/b978-0-12-816514-0.00004-7](10.1016/b978-0-12-816514-0.00004-7)  
**Sitasi Pendukung:** D.A. Lee, J.M. Browne (2022). *Probabilistic Risk and Hazard Assessment*. DOI: [10.1201/9780203742037-18](10.1201/9780203742037-18)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Farid Wajdi Akashah, Rachid Ouache, Jianping Zhang (2020) dalam jurnal *Handbook of Probabilistic Models* (DOI: 10.1016/b978-0-12-816514-0.00004-7) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh D.A. Lee, J.M. Browne (2022) yang dipublikasikan dalam *Probabilistic Risk and Hazard Assessment* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
