# 4552 — Operations Research & Large-Scale Optimization: Integrated Production and Energy Supply Planning on an Industrial Site by Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Integrated Production and Energy Supply Planning on an Industrial Site by Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Ruiwen Liao, Céline Gicquel (2023). *Proceedings of the 12th International Conference on Operations Research and Enterprise Systems*. DOI: [10.5220/0011602900003396](10.5220/0011602900003396)  
**Sitasi Pendukung:** Christian Reintjes (2022). *Algorithm-Driven Truss Topology Optimization for Additive Manufacturing*. DOI: [10.1007/978-3-658-36211-9_5](10.1007/978-3-658-36211-9_5)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ruiwen Liao, Céline Gicquel (2023) dalam jurnal *Proceedings of the 12th International Conference on Operations Research and Enterprise Systems* (DOI: 10.5220/0011602900003396) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Christian Reintjes (2022) yang dipublikasikan dalam *Algorithm-Driven Truss Topology Optimization for Additive Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
