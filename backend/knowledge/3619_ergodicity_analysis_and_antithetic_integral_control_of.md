# 3619 — Applied Statistics & Stochastic Modeling: Ergodicity Analysis and Antithetic Integral Control of a Class of Stochastic Reaction Networks with Delays

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Ergodicity Analysis and Antithetic Integral Control of a Class of Stochastic Reaction Networks with Delays  
**Jurnal & Sitasi Utama:** Corentin Briat, Mustafa Khammash (2020). *SIAM Journal on Applied Dynamical Systems*. DOI: [10.1137/19m1286219](10.1137/19m1286219)  
**Sitasi Pendukung:** A. Kantarbayeva, Almaz Mustafin (2020). *Mathematical Modelling and Analysis*. DOI: [10.3846/mma.2020.10801](10.3846/mma.2020.10801)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Corentin Briat, Mustafa Khammash (2020) dalam jurnal *SIAM Journal on Applied Dynamical Systems* (DOI: 10.1137/19m1286219) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
