# 5339 — Industrial Artificial Intelligence & Data Analytics: Deep Learning-Based Automated Industrial Surface Defect Classification

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Deep Learning-Based Automated Industrial Surface Defect Classification  
**Jurnal & Sitasi Utama:** Rana Alrayes, Atta Rahman (2026). *Computers*. DOI: [10.3390/computers15070417](10.3390/computers15070417)  
**Sitasi Pendukung:** Yuqian Wang, Junyan Wang (2024). *2024 8th International Conference on Electrical, Mechanical and Computer Engineering (ICEMCE)*. DOI: [10.1109/icemce64157.2024.10862601](10.1109/icemce64157.2024.10862601)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rana Alrayes, Atta Rahman (2026) dalam jurnal *Computers* (DOI: 10.3390/computers15070417) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yuqian Wang, Junyan Wang (2024) yang dipublikasikan dalam *2024 8th International Conference on Electrical, Mechanical and Computer Engineering (ICEMCE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
