# 5452 — Supply Chain Management & Logistics Engineering: Sourcing and Inventory Optimization in Multi-Echelon, Multi-Modal, and Multi-Commodity Supply Chain Networks

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Sourcing and Inventory Optimization in Multi-Echelon, Multi-Modal, and Multi-Commodity Supply Chain Networks  
**Jurnal & Sitasi Utama:** Juan Carlos Pina Pardo, Milena Janjevic (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5912352](10.2139/ssrn.5912352)  
**Sitasi Pendukung:** Qingze Zhu (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5407306](10.2139/ssrn.5407306)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Juan Carlos Pina Pardo, Milena Janjevic (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5912352) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qingze Zhu (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
