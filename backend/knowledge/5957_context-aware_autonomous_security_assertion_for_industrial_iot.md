# 5957 — Safety Engineering & Risk Management: Context-Aware Autonomous Security Assertion for Industrial IoT

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Context-Aware Autonomous Security Assertion for Industrial IoT  
**Jurnal & Sitasi Utama:** Usman Tariq, Ahmad O. Aseeri, Mohammed Saeed Alkatheiri (2020). *IEEE Access*. DOI: [10.1109/access.2020.3032436](10.1109/access.2020.3032436)  
**Sitasi Pendukung:** Mona Emami, Bijan Hejazi, Mehdi Karimi (2022). *Results in Engineering*. DOI: [10.1016/j.rineng.2022.100566](10.1016/j.rineng.2022.100566)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Usman Tariq, Ahmad O. Aseeri, Mohammed Saeed Alkatheiri (2020) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2020.3032436) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
