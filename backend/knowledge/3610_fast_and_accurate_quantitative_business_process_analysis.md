# 3610 — Applied Statistics & Stochastic Modeling: Fast and accurate quantitative business process analysis using feature complete queueing models

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Fast and accurate quantitative business process analysis using feature complete queueing models  
**Jurnal & Sitasi Utama:** Sander Peters, Yoav Kerner, Remco Dijkman (2021). *Information Systems*. DOI: [10.1016/j.is.2021.101892](10.1016/j.is.2021.101892)  
**Sitasi Pendukung:** Shirin Ghasemi, Fateme Taghipour, Amir Aghsami (2023). *Scientia Iranica*. DOI: [10.24200/sci.2023.60803.6999](10.24200/sci.2023.60803.6999)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sander Peters, Yoav Kerner, Remco Dijkman (2021) dalam jurnal *Information Systems* (DOI: 10.1016/j.is.2021.101892) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shirin Ghasemi, Fateme Taghipour, Amir Aghsami (2023) yang dipublikasikan dalam *Scientia Iranica* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
