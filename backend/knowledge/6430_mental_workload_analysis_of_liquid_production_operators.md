# 6430 — Human Factors & Cognitive Ergonomics: Mental Workload Analysis of Liquid Production Operators of Manufacturing Companies Using the National Aeronautics Space Administration Task Load Index (NASA-TLX) and Rating Scale Mental Effort (RSME) Methods (Case Study: PT. XYZ)

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Mental Workload Analysis of Liquid Production Operators of Manufacturing Companies Using the National Aeronautics Space Administration Task Load Index (NASA-TLX) and Rating Scale Mental Effort (RSME) Methods (Case Study: PT. XYZ)  
**Jurnal & Sitasi Utama:** Azyumardi Arrozikiy Afator, Hazim Hazim (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.7818](10.21070/ups.7818)  
**Sitasi Pendukung:** Shinji Miyake*, Hiroyuki Kuraoka**, Chikamune Wada** (2021). *AHFE International*. DOI: [10.54941/ahfe100642](10.54941/ahfe100642)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Azyumardi Arrozikiy Afator, Hazim Hazim (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.21070/ups.7818) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shinji Miyake*, Hiroyuki Kuraoka**, Chikamune Wada** (2021) yang dipublikasikan dalam *AHFE International* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
