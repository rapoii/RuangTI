# 3386 — Quality Engineering & Reliability Systems: FURTHER CRITERIA FOR FMEA PRIORITIZATION

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** FURTHER CRITERIA FOR FMEA PRIORITIZATION  
**Jurnal & Sitasi Utama:** Matthew Barsalou (2026). *Proceedings on Engineering Sciences*. DOI: [10.24874/pes08.02.017](10.24874/pes08.02.017)  
**Sitasi Pendukung:** Saif ul Islam, Mahender Kumar, Carsten Maple (2026). *Peer-Reviewed Academic Journal*. DOI: [10.1109/icce67443.2026.11449595](10.1109/icce67443.2026.11449595)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Matthew Barsalou (2026) dalam jurnal *Proceedings on Engineering Sciences* (DOI: 10.24874/pes08.02.017) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Failure Modes and Effects Analysis is performed to identify and mitigate risks in the production and development of products.A Failure Modes and Effects Analysis created according to the AIAG/VDA FMEA Handbook uses Action Priority to prioritize optimization actions to reduce the occurrence of the failure cause, or to detect the failure cause or failure mode.However, there are only three possible categories of Action Priority, consisting of high, medium, and low, in place of the traditional Risk Priority Number, which could complicate prioritization when there are many items with the same Action Priority.This paper evaluates a method for prioritizing within one Action Priority.Three methods were used to evaluate additional prioritization criteria based on prioritizing first by Action Priority, then criticality, consisting of severity times occurrence, and then by occurrence.The highest possible Risk Priority Numbers were compared to the highest possible criticalities and Action Priority.The results were evaluated using three columns consisting of 1,000 simulated randomized values from which a sample was taken to make comparisons.An evaluation was also performed using a real Failure Modes and Effects Analysis.This study found that prioritization based on Action Priority can be supplemented by prioritization based on criticality within the highest Action Priority.This study provides organization with criteria that can reduce a high number items within one Action Priority to a mo"

Penelitian pendukung oleh Saif ul Islam, Mahender Kumar, Carsten Maple (2026) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
