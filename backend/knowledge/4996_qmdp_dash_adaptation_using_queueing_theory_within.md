# 4996 — Applied Statistics & Stochastic Modeling: qMDP: DASH Adaptation using Queueing Theory within a Markov Decision Process

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** qMDP: DASH Adaptation using Queueing Theory within a Markov Decision Process  
**Jurnal & Sitasi Utama:** Kevin Gatimu, Ben Lee (2021). *2021 IEEE 18th Annual Consumer Communications &amp; Networking Conference (CCNC)*. DOI: [10.1109/ccnc49032.2021.9369481](10.1109/ccnc49032.2021.9369481)  
**Sitasi Pendukung:** Lead Industrial Researchers (2025). *Partially Observed Markov Decision Processes*. DOI: [10.1017/9781009449441.010](10.1017/9781009449441.010)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Kevin Gatimu, Ben Lee (2021) dalam jurnal *2021 IEEE 18th Annual Consumer Communications &amp; Networking Conference (CCNC)* (DOI: 10.1109/ccnc49032.2021.9369481) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2025) yang dipublikasikan dalam *Partially Observed Markov Decision Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
