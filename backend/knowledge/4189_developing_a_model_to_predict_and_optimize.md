# 4189 — Applied Statistics & Stochastic Modeling: Developing a model to predict and optimize the flexural and impact properties of jute/kenaf fiber nano-composite using response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Developing a model to predict and optimize the flexural and impact properties of jute/kenaf fiber nano-composite using response surface methodology  
**Jurnal & Sitasi Utama:** Sathish Thanikodi, Saravanan Rathinasamy, Jothi Arunachalam Solairaju (2024). *The International Journal of Advanced Manufacturing Technology*. DOI: [10.1007/s00170-024-13975-0](10.1007/s00170-024-13975-0)  
**Sitasi Pendukung:** Shuaishuai Xin, Guocheng Liu, Xiaohan Ma (2020). *Applied Catalysis B: Environmental*. DOI: [10.1016/j.apcatb.2020.119386](10.1016/j.apcatb.2020.119386)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sathish Thanikodi, Saravanan Rathinasamy, Jothi Arunachalam Solairaju (2024) dalam jurnal *The International Journal of Advanced Manufacturing Technology* (DOI: 10.1007/s00170-024-13975-0) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shuaishuai Xin, Guocheng Liu, Xiaohan Ma (2020) yang dipublikasikan dalam *Applied Catalysis B: Environmental* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
