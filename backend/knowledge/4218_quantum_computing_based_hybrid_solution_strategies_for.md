# 4218 — Operations Research & Large-Scale Optimization: Quantum computing based hybrid solution strategies for large-scale discrete-continuous optimization problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Quantum computing based hybrid solution strategies for large-scale discrete-continuous optimization problems  
**Jurnal & Sitasi Utama:** Akshay Ajagekar, Travis S. Humble, Fengqi You (2019). *Computers & Chemical Engineering*. DOI: [10.1016/j.compchemeng.2019.106630](10.1016/j.compchemeng.2019.106630)  
**Sitasi Pendukung:** Liang Zhao, Chao Ning, Fengqi You (2018). *AIChE Journal*. DOI: [10.1002/aic.16500](10.1002/aic.16500)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Akshay Ajagekar, Travis S. Humble, Fengqi You (2019) dalam jurnal *Computers & Chemical Engineering* (DOI: 10.1016/j.compchemeng.2019.106630) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Liang Zhao, Chao Ning, Fengqi You (2018) yang dipublikasikan dalam *AIChE Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
