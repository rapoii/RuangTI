# 3802 — Maintenance Engineering & Asset Life Cycle: An RCM approach for assessing reliability challenges and maintenance needs of unmanned cargo ships

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** An RCM approach for assessing reliability challenges and maintenance needs of unmanned cargo ships  
**Jurnal & Sitasi Utama:** Stig Eriksen, Ingrid Bouwer Utne, Marie Lützen (2021). *Reliability Engineering & System Safety*. DOI: [10.1016/j.ress.2021.107550](10.1016/j.ress.2021.107550)  
**Sitasi Pendukung:** Mounia Achouch, Mariya Dimitrova, Khaled Ziane (2022). *Applied Sciences*. DOI: [10.3390/app12168081](10.3390/app12168081)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Stig Eriksen, Ingrid Bouwer Utne, Marie Lützen (2021) dalam jurnal *Reliability Engineering & System Safety* (DOI: 10.1016/j.ress.2021.107550) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mounia Achouch, Mariya Dimitrova, Khaled Ziane (2022) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
