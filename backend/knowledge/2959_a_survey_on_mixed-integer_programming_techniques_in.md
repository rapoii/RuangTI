# 2959 — Operations Research & Large-Scale Optimization: A Survey on Mixed-Integer Programming Techniques in Bilevel Optimization

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Survey on Mixed-Integer Programming Techniques in Bilevel Optimization  
**Jurnal & Sitasi Utama:** Thomas Kleinert, Martine Labbé, Ivana Ljubić (2021). *EURO Journal on Computational Optimization*. DOI: [10.1016/j.ejco.2021.100007](10.1016/j.ejco.2021.100007)  
**Sitasi Pendukung:** Ambros Gleixner, Gregor Hendel, Gerald Gamrath (2021). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00194-3](10.1007/s12532-020-00194-3)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Thomas Kleinert, Martine Labbé, Ivana Ljubić (2021) dalam jurnal *EURO Journal on Computational Optimization* (DOI: 10.1016/j.ejco.2021.100007) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
