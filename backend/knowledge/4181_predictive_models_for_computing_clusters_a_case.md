# 4181 — Applied Statistics & Stochastic Modeling: Predictive models for computing clusters: a case study based on Ilifu

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Predictive models for computing clusters: a case study based on Ilifu  
**Jurnal & Sitasi Utama:** Jacobus Marthinus Cloete (2026). *Open University of Cape Town (University of Cape Town)*. DOI: [10.openalex/w7170233720](10.openalex/w7170233720)  
**Sitasi Pendukung:** Li, Haoran (2021). *Open Scholarship Institutional Repository (Washington University in St. Louis)*. DOI: [10.7936/06gn-cx93](10.7936/06gn-cx93)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jacobus Marthinus Cloete (2026) dalam jurnal *Open University of Cape Town (University of Cape Town)* (DOI: 10.openalex/w7170233720) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Li, Haoran (2021) yang dipublikasikan dalam *Open Scholarship Institutional Repository (Washington University in St. Louis)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
