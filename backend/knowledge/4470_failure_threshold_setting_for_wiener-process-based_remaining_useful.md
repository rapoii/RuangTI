# 4470 — Maintenance Engineering & Asset Life Cycle: Failure Threshold Setting for Wiener-process-based Remaining Useful Life Estimation

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Failure Threshold Setting for Wiener-process-based Remaining Useful Life Estimation  
**Jurnal & Sitasi Utama:** Liu Xingzhi, Fumio Machida (2021). *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)*. DOI: [10.1109/phm-nanjing52125.2021.9613018](10.1109/phm-nanjing52125.2021.9613018)  
**Sitasi Pendukung:** Tiantian Xu, Guangjie Han, Hongbo Zhu (2023). *2023 Global Reliability and Prognostics and Health Management Conference (PHM-Hangzhou)*. DOI: [10.1109/phm-hangzhou58797.2023.10482659](10.1109/phm-hangzhou58797.2023.10482659)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Liu Xingzhi, Fumio Machida (2021) dalam jurnal *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)* (DOI: 10.1109/phm-nanjing52125.2021.9613018) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tiantian Xu, Guangjie Han, Hongbo Zhu (2023) yang dipublikasikan dalam *2023 Global Reliability and Prognostics and Health Management Conference (PHM-Hangzhou)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
