# 5059 — Simulation Modeling & Digital Twins: AI-assisted Intelligent Discrete Event Simulation Platform for Manufacturing Systems

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** AI-assisted Intelligent Discrete Event Simulation Platform for Manufacturing Systems  
**Jurnal & Sitasi Utama:** Yiyun Fei, Mulang Song, Roger J. Jiao (2025). *Proceedings of the International Conference on Industrial Engineering and Operations Management*. DOI: [10.46254/an15.20250432](10.46254/an15.20250432)  
**Sitasi Pendukung:** Udo W. Pooch, James A. Wall (2024). *Discrete Event Simulation*. DOI: [10.1201/9781003575054-13](10.1201/9781003575054-13)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yiyun Fei, Mulang Song, Roger J. Jiao (2025) dalam jurnal *Proceedings of the International Conference on Industrial Engineering and Operations Management* (DOI: 10.46254/an15.20250432) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
