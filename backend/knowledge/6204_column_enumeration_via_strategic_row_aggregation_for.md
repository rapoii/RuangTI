# 6204 — Operations Research & Large-Scale Optimization: Column Enumeration via Strategic Row Aggregation for Split Delivery Vehicle Routing with Time Windows

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Column Enumeration via Strategic Row Aggregation for Split Delivery Vehicle Routing with Time Windows  
**Jurnal & Sitasi Utama:** Ying Yang, Xiaodeng Hao, Silong Zhang (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7353998](10.2139/ssrn.7353998)  
**Sitasi Pendukung:** Willem Feijen, Guido Schäfer, Koen Dekker (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4988874](10.2139/ssrn.4988874)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ying Yang, Xiaodeng Hao, Silong Zhang (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7353998) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
