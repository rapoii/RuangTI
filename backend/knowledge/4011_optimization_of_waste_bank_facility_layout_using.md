# 4011 — Facilities Planning & Material Handling: Optimization of Waste Bank Facility Layout Using a Systematic Layout Planning Approach and the BLOCPLAN Algorithm

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Optimization of Waste Bank Facility Layout Using a Systematic Layout Planning Approach and the BLOCPLAN Algorithm  
**Jurnal & Sitasi Utama:** Susmitha Canny, B A Ramadhan, Kinanti Dwi Handayani (2026). *Journal of Integrated System*. DOI: [10.28932/jis.v9i1.15370](10.28932/jis.v9i1.15370)  
**Sitasi Pendukung:** Roland Y. H. Silitonga, Nathaniel Nicholas (2026). *Journal of Integrated System*. DOI: [10.28932/jis.v9i1.15669](10.28932/jis.v9i1.15669)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Susmitha Canny, B A Ramadhan, Kinanti Dwi Handayani (2026) dalam jurnal *Journal of Integrated System* (DOI: 10.28932/jis.v9i1.15370) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
