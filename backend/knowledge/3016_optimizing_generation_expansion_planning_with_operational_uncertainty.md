# 3016 — Operations Research & Large-Scale Optimization: Optimizing generation expansion planning with operational uncertainty: A multistage adaptive robust approach

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimizing generation expansion planning with operational uncertainty: A multistage adaptive robust approach  
**Jurnal & Sitasi Utama:** Adam Abdin, Aakil M. Caunhye, Enrico Zio (2021). *Applied Energy*. DOI: [10.1016/j.apenergy.2021.118032](10.1016/j.apenergy.2021.118032)  
**Sitasi Pendukung:** Lars Schewe, Martin Schmidt, Dieter Weninger (2020). *Operations Research Letters*. DOI: [10.1016/j.orl.2020.02.006](10.1016/j.orl.2020.02.006)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Adam Abdin, Aakil M. Caunhye, Enrico Zio (2021) dalam jurnal *Applied Energy* (DOI: 10.1016/j.apenergy.2021.118032) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lars Schewe, Martin Schmidt, Dieter Weninger (2020) yang dipublikasikan dalam *Operations Research Letters* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
