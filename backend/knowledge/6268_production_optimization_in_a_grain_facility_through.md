# 6268 — Operations Research & Large-Scale Optimization: Production Optimization in a Grain Facility through Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Production Optimization in a Grain Facility through Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Gabriel Bayá, Eduardo Canale, Sergio Nesmachnow (2022). *Applied Sciences*. DOI: [10.3390/app12168212](10.3390/app12168212)  
**Sitasi Pendukung:** Yixin Tian, Xinyi Wu (2026). *Highlights in Business, Economics and Management*. DOI: [10.54097/rmfadk95](10.54097/rmfadk95)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gabriel Bayá, Eduardo Canale, Sergio Nesmachnow (2022) dalam jurnal *Applied Sciences* (DOI: 10.3390/app12168212) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yixin Tian, Xinyi Wu (2026) yang dipublikasikan dalam *Highlights in Business, Economics and Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
