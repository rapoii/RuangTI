# 5776 — Simulation Modeling & Digital Twins: Quality safety of agricultural products in supply chain-computer simulation based on multi-agent system

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Quality safety of agricultural products in supply chain-computer simulation based on multi-agent system  
**Jurnal & Sitasi Utama:** Wei Zhou, Maha Saad Metawea (2021). *Journal of Intelligent &amp; Fuzzy Systems*. DOI: [10.3233/jifs-189822](10.3233/jifs-189822)  
**Sitasi Pendukung:** Wei Zhou, Maha Saad Metawea (2021). *Journal of Intelligent &amp; Fuzzy Systems*. DOI: [10.3233/jifs-189822](10.3233/jifs-189822)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wei Zhou, Maha Saad Metawea (2021) dalam jurnal *Journal of Intelligent &amp; Fuzzy Systems* (DOI: 10.3233/jifs-189822) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wei Zhou, Maha Saad Metawea (2021) yang dipublikasikan dalam *Journal of Intelligent &amp; Fuzzy Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
