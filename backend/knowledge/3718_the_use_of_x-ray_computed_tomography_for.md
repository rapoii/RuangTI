# 3718 — Industrial Energy Management & Decarbonization: The use of X-ray computed tomography for design and process modeling of aerospace composites: A review

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** The use of X-ray computed tomography for design and process modeling of aerospace composites: A review  
**Jurnal & Sitasi Utama:** K. Naresh, Kamran A. Khan, Rehan Umer (2020). *Materials & Design*. DOI: [10.1016/j.matdes.2020.108553](10.1016/j.matdes.2020.108553)  
**Sitasi Pendukung:** Yaxian Zhao, Yingjie Zhao, Yi Huang (2022). *Processes*. DOI: [10.3390/pr10091879](10.3390/pr10091879)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari K. Naresh, Kamran A. Khan, Rehan Umer (2020) dalam jurnal *Materials & Design* (DOI: 10.1016/j.matdes.2020.108553) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yaxian Zhao, Yingjie Zhao, Yi Huang (2022) yang dipublikasikan dalam *Processes* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
