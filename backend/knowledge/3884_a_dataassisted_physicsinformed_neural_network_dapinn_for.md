# 3884 — Industrial Artificial Intelligence & Data Analytics: A data‐assisted physics‐informed neural network (DA‐PINN) for fretting fatigue lifetime prediction

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A data‐assisted physics‐informed neural network (DA‐PINN) for fretting fatigue lifetime prediction  
**Jurnal & Sitasi Utama:** Can Wang, Qiqi Xiao, Zhikun Zhou (2024). *International journal of mechanical system dynamics*. DOI: [10.1002/msd2.12127](10.1002/msd2.12127)  
**Sitasi Pendukung:** Yichun Xia, Yonggang Meng (2024). *Lubricants*. DOI: [10.3390/lubricants12020062](10.3390/lubricants12020062)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Can Wang, Qiqi Xiao, Zhikun Zhou (2024) dalam jurnal *International journal of mechanical system dynamics* (DOI: 10.1002/msd2.12127) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
