# 4887 — Engineering Economics & Cost Optimization: REAL OPTIONS VALUATION OF RFID TECHNOLOGY INVESTMENTS IN MANUFACTURING: A DECISION SUPPORT FRAMEWORK WITH SENSITIVITY ANALYSIS

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** REAL OPTIONS VALUATION OF RFID TECHNOLOGY INVESTMENTS IN MANUFACTURING: A DECISION SUPPORT FRAMEWORK WITH SENSITIVITY ANALYSIS  
**Jurnal & Sitasi Utama:** Ramazan  Murat Tabanlı, Hatice Turhan Yazgan, Umut Elbir (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.7075239](10.2139/ssrn.7075239)  
**Sitasi Pendukung:** S. Aro-Gordon, M. Al-Salmi, G. Chinnasamy (2023). *Sustainable Education and Development – Sustainable Industrialization and Innovation*. DOI: [10.1007/978-3-031-25998-2_27](10.1007/978-3-031-25998-2_27)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ramazan  Murat Tabanlı, Hatice Turhan Yazgan, Umut Elbir (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.7075239) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Sustainable growth is becoming a necessity for manufacturing companies to survive in the current global market. RFID (radio frequency identification) investments attract attention, as this technology provides an opportunity for sustainable growth. However, investment decision is hard due to high initial costs. Hence it is important to valuate an RFID investment with respect to feasibility. Traditional methods such as NPV (net present value) cannot fully reflect the inherent flexibility of these investments. RFID projects typically require high initial costs, are irreversible, and carry economic and technical uncertainties. These characteristics make the real options method a suitable tool for RFID investment evaluations. This study provides a decision support tool for a textile company&amp;apos;s RFID system investment using the real options approach. First, the company&amp;apos;s existing barcode-based tracking system and the problems encountered are examined. Then, the functions and potential benefits of the developed RFID system are explained. The investment is evaluated comparatively with the classical NPV method and the real options method. The analysis uses a combination of Black-Scholes and Binomial models, and the effect of model parameters on investment value is examined through sensitivity analysis. The findings show that the investment is applicable over a wide range of risk-free interest rates and investment costs, independent of changes in volatility and option d"

Penelitian pendukung oleh S. Aro-Gordon, M. Al-Salmi, G. Chinnasamy (2023) yang dipublikasikan dalam *Sustainable Education and Development – Sustainable Industrialization and Innovation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
