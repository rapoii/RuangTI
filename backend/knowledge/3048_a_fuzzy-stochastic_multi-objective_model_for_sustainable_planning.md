# 3048 — Supply Chain Management & Logistics Engineering: A fuzzy-stochastic multi-objective model for sustainable planning of a closed-loop supply chain considering mixed uncertainty and network flexibility

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** A fuzzy-stochastic multi-objective model for sustainable planning of a closed-loop supply chain considering mixed uncertainty and network flexibility  
**Jurnal & Sitasi Utama:** Hao Yu, Wei Deng Solvang (2020). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2020.121702](10.1016/j.jclepro.2020.121702)  
**Sitasi Pendukung:** Lingdi Liu, Wenyan Song, Yang Liu (2023). *Computers & Industrial Engineering*. DOI: [10.1016/j.cie.2023.109113](10.1016/j.cie.2023.109113)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hao Yu, Wei Deng Solvang (2020) dalam jurnal *Journal of Cleaner Production* (DOI: 10.1016/j.jclepro.2020.121702) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
