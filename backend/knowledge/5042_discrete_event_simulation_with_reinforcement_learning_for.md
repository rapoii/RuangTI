# 5042 — Simulation Modeling & Digital Twins: DISCRETE EVENT SIMULATION WITH REINFORCEMENT LEARNING FOR ADVANCED MANUFACTURING DECISION-MAKING

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** DISCRETE EVENT SIMULATION WITH REINFORCEMENT LEARNING FOR ADVANCED MANUFACTURING DECISION-MAKING  
**Jurnal & Sitasi Utama:** , Cansu Kandemir, Marco Franchino (2025). *12th Simulation Workshop (SW25) Proceedings*. DOI: [10.36819/sw25.031](10.36819/sw25.031)  
**Sitasi Pendukung:** Eugénio M. Rocha, Maria J. Lopes (2022). *Procedia Computer Science*. DOI: [10.1016/j.procs.2022.01.314](10.1016/j.procs.2022.01.314)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari , Cansu Kandemir, Marco Franchino (2025) dalam jurnal *12th Simulation Workshop (SW25) Proceedings* (DOI: 10.36819/sw25.031) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "In recent years, the integration of Artificial Intelligence (AI) to support decision-making in the manufacturing sector has grown significantly. Discrete Event Simulation (DES) offers a powerful method for training AI agents to make rapid decisions in manufacturing process flows. This study explores advancements in combining DES with Reinforcement Learning (RL), addressing data scarcity and integration challenges. A literature review highlights the increasing adoption of RL, particularly Deep Q-Network (DQN) and Proximal Policy Optimization (PPO), for complex tasks like job shop scheduling. The research introduces an AGV-based job shop scheduling use case modelled in Siemens Plant Simulation to test various RL algorithms under different complexities. An integration pipeline using Python and MQTT ensures seamless AI-DES communication, enabling dynamic decision-making. Future work will include developing DQN and PPO algorithms and expand this framework to incorporate real-world factors, refining AI's role in adaptive and efficient manufacturing solutions."

Penelitian pendukung oleh Eugénio M. Rocha, Maria J. Lopes (2022) yang dipublikasikan dalam *Procedia Computer Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
