# 6389 — Quality Engineering & Reliability Systems: Failure mode and effects analysis–analytic hierarchy process (FMEA-AHP) model in supplier risk management

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Failure mode and effects analysis–analytic hierarchy process (FMEA-AHP) model in supplier risk management  
**Jurnal & Sitasi Utama:** Marija Panić, Que Xiaojun (2025). *The Journal of Risk Model Validation*. DOI: [10.21314/jrmv.2025.009](10.21314/jrmv.2025.009)  
**Sitasi Pendukung:** Tauseef Aized, Muhammad Ahmad, Muhammad Haris Jamal (2020). *International Journal of Engineering Business Management*. DOI: [10.1177/1847979020942438](10.1177/1847979020942438)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marija Panić, Que Xiaojun (2025) dalam jurnal *The Journal of Risk Model Validation* (DOI: 10.21314/jrmv.2025.009) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Tauseef Aized, Muhammad Ahmad, Muhammad Haris Jamal (2020) yang dipublikasikan dalam *International Journal of Engineering Business Management* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
