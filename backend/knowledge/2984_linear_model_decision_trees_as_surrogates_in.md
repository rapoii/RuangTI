# 2984 — Operations Research & Large-Scale Optimization: Linear model decision trees as surrogates in optimization of engineering applications

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Linear model decision trees as surrogates in optimization of engineering applications  
**Jurnal & Sitasi Utama:** Bashar Ammari, Emma S. Johnson, Georgia Stinchfield (2023). *Computers & Chemical Engineering*. DOI: [10.1016/j.compchemeng.2023.108347](10.1016/j.compchemeng.2023.108347)  
**Sitasi Pendukung:** Hamed Rahimian, Sanjay Mehrotra (2022). *Open Journal of Mathematical Optimization*. DOI: [10.5802/ojmo.15](10.5802/ojmo.15)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Bashar Ammari, Emma S. Johnson, Georgia Stinchfield (2023) dalam jurnal *Computers & Chemical Engineering* (DOI: 10.1016/j.compchemeng.2023.108347) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hamed Rahimian, Sanjay Mehrotra (2022) yang dipublikasikan dalam *Open Journal of Mathematical Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
