# 5433 — Operations Research & Large-Scale Optimization: Benders decomposition for the distributionally robust optimization of pricing and reverse logistics network design in remanufacturing systems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Benders decomposition for the distributionally robust optimization of pricing and reverse logistics network design in remanufacturing systems  
**Jurnal & Sitasi Utama:** Hailei Gong, Zhi-Hai Zhang (2022). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.04.039](10.1016/j.ejor.2021.04.039)  
**Sitasi Pendukung:** Mahan Fakouri Fard, Farhad Elyasichamazkoti, Armin Fooladi Savadkouhi (2021). *2021 IEEE Electrical Power and Energy Conference (EPEC)*. DOI: [10.1109/epec52095.2021.9621351](10.1109/epec52095.2021.9621351)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hailei Gong, Zhi-Hai Zhang (2022) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2021.04.039) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
