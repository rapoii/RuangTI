# 3067 — Supply Chain Management & Logistics Engineering: The optimal combination between blockchain and sales format in an internet platform-based closed-loop supply chain

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** The optimal combination between blockchain and sales format in an internet platform-based closed-loop supply chain  
**Jurnal & Sitasi Utama:** Deqing Ma, Jinsong Hu (2022). *International Journal of Production Economics*. DOI: [10.1016/j.ijpe.2022.108633](10.1016/j.ijpe.2022.108633)  
**Sitasi Pendukung:** Laura Visintainer Lerman, Guilherme Brittes Benitez, Julian M. Müller (2022). *Supply Chain Management An International Journal*. DOI: [10.1108/scm-02-2022-0059](10.1108/scm-02-2022-0059)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Deqing Ma, Jinsong Hu (2022) dalam jurnal *International Journal of Production Economics* (DOI: 10.1016/j.ijpe.2022.108633) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
