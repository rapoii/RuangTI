# 4479 — Maintenance Engineering & Asset Life Cycle: Uncertainty-Aware Remaining Useful Life Prediction with Bayesian Deep Learning: A Function-Space Variational Inference Approach

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Uncertainty-Aware Remaining Useful Life Prediction with Bayesian Deep Learning: A Function-Space Variational Inference Approach  
**Jurnal & Sitasi Utama:** Wei Wang, Zhiqiang Cai, Han Wang (2025). *2025 Global Reliability and Prognostics and Health Management Conference (PHM-Xian)*. DOI: [10.1109/phm-xian66756.2025.11427830](10.1109/phm-xian66756.2025.11427830)  
**Sitasi Pendukung:** Shoog Nimri, Sara Kohtz (2025). *2025 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm65385.2025.11062026](10.1109/icphm65385.2025.11062026)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Wei Wang, Zhiqiang Cai, Han Wang (2025) dalam jurnal *2025 Global Reliability and Prognostics and Health Management Conference (PHM-Xian)* (DOI: 10.1109/phm-xian66756.2025.11427830) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shoog Nimri, Sara Kohtz (2025) yang dipublikasikan dalam *2025 IEEE International Conference on Prognostics and Health Management (ICPHM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
