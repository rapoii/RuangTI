# 5318 — Industrial Artificial Intelligence & Data Analytics: Improved Photovoltaic Panel Defect Detection Algorithm Based on YOLOv11

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Improved Photovoltaic Panel Defect Detection Algorithm Based on YOLOv11  
**Jurnal & Sitasi Utama:** Junjie Feng, Zuxing Chen (2026). *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)*. DOI: [10.1109/cvidl70130.2026.11637783](10.1109/cvidl70130.2026.11637783)  
**Sitasi Pendukung:** Yuan-Fu Yang, Min Sun (2022). *2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)*. DOI: [10.1109/cvpr52688.2022.00236](10.1109/cvpr52688.2022.00236)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Junjie Feng, Zuxing Chen (2026) dalam jurnal *2026 7th International Conference on Computer Vision, Image and Deep Learning (CVIDL)* (DOI: 10.1109/cvidl70130.2026.11637783) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Yuan-Fu Yang, Min Sun (2022) yang dipublikasikan dalam *2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
