# 6337 — Manufacturing Systems & Cyber-Physical Production: Implementation of an Information Model for Electric Motor Production Using the Asset Administration Shell

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Implementation of an Information Model for Electric Motor Production Using the Asset Administration Shell  
**Jurnal & Sitasi Utama:** Nicolaus Klein, Johannes Gerner, Anni Wang (2024). *2024 14th International Electric Drives Production Conference (EDPC)*. DOI: [10.1109/edpc63771.2024.10932846](10.1109/edpc63771.2024.10932846)  
**Sitasi Pendukung:** Elvis Hozdić (2020). *Advances in Business Information Systems and Analytics*. DOI: [10.4018/978-1-7998-2725-2.ch013](10.4018/978-1-7998-2725-2.ch013)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nicolaus Klein, Johannes Gerner, Anni Wang (2024) dalam jurnal *2024 14th International Electric Drives Production Conference (EDPC)* (DOI: 10.1109/edpc63771.2024.10932846) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Elvis Hozdić (2020) yang dipublikasikan dalam *Advances in Business Information Systems and Analytics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
