# 5334 — Industrial Artificial Intelligence & Data Analytics: DR-DETR: Dynamic Receptive DETR for Casting Defect Detection

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** DR-DETR: Dynamic Receptive DETR for Casting Defect Detection  
**Jurnal & Sitasi Utama:** Hanbing Zhang, Dejun Cheng (2024). *Proceedings of the International Conference on Computer Vision and Deep Learning*. DOI: [10.1145/3653781.3653820](10.1145/3653781.3653820)  
**Sitasi Pendukung:** Panke Zhu, Yiwen Cai, Fen Li (2024). *Proceedings of the International Conference on Computer Vision and Deep Learning*. DOI: [10.1145/3653781.3653830](10.1145/3653781.3653830)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hanbing Zhang, Dejun Cheng (2024) dalam jurnal *Proceedings of the International Conference on Computer Vision and Deep Learning* (DOI: 10.1145/3653781.3653820) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Panke Zhu, Yiwen Cai, Fen Li (2024) yang dipublikasikan dalam *Proceedings of the International Conference on Computer Vision and Deep Learning* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
