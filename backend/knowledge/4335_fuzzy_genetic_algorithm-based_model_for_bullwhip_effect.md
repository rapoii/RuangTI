# 4335 — Supply Chain Management & Logistics Engineering: Fuzzy genetic algorithm-based model for bullwhip effect reduction in a multi-stage supply chain

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Fuzzy genetic algorithm-based model for bullwhip effect reduction in a multi-stage supply chain  
**Jurnal & Sitasi Utama:** Marjia Haque, M. Ahsan Akhtar Hasin (2021). *International Journal of Supply Chain and Inventory Management*. DOI: [10.1504/ijscim.2021.114720](10.1504/ijscim.2021.114720)  
**Sitasi Pendukung:** Xuguang Zhang, Tiejiang Sun, Xu Han (2025). *Journal of Banking and Financial Dynamics*. DOI: [10.55220/2576-6821.v9.796](10.55220/2576-6821.v9.796)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marjia Haque, M. Ahsan Akhtar Hasin (2021) dalam jurnal *International Journal of Supply Chain and Inventory Management* (DOI: 10.1504/ijscim.2021.114720) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xuguang Zhang, Tiejiang Sun, Xu Han (2025) yang dipublikasikan dalam *Journal of Banking and Financial Dynamics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
