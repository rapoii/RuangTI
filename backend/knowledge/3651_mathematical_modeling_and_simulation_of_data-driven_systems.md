# 3651 — Applied Statistics & Stochastic Modeling: Mathematical modeling and simulation of data-driven systems for efficient network performance optimization

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Mathematical modeling and simulation of data-driven systems for efficient network performance optimization  
**Jurnal & Sitasi Utama:** Dr. Pankaj Jha (2026). *Journal of Electronics Computer Networking and Applied Mathematics*. DOI: [10.55529/jecnam.61.13.23](10.55529/jecnam.61.13.23)  
**Sitasi Pendukung:** Sachin R. Gurnule, P. Pranay, V.N. Rama Devi (2026). *International Journal of Artificial Intelligence and Machine Learning*. DOI: [10.51483/ijaiml.6.4s.2026.160-180](10.51483/ijaiml.6.4s.2026.160-180)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dr. Pankaj Jha (2026) dalam jurnal *Journal of Electronics Computer Networking and Applied Mathematics* (DOI: 10.55529/jecnam.61.13.23) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sachin R. Gurnule, P. Pranay, V.N. Rama Devi (2026) yang dipublikasikan dalam *International Journal of Artificial Intelligence and Machine Learning* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
