# 4779 — Human Factors & Cognitive Ergonomics: Reducing Fatigue in Industrial Workplaces: A Motorized Chairless Chair Exoskeleton Approach

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Reducing Fatigue in Industrial Workplaces: A Motorized Chairless Chair Exoskeleton Approach  
**Jurnal & Sitasi Utama:** Danish Abdullah (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6674283](10.2139/ssrn.6674283)  
**Sitasi Pendukung:** Danish Abdullah (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6674283](10.2139/ssrn.6674283)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Danish Abdullah (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6674283) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Work-related musculoskeletal disorders (WRMSDs) remain a major challenge in Industry 4.0 workplaces where prolonged standing, squatting, and repetitive sit-to-stand transitions are common. Passive chairless chairs have been introduced to alleviate fatigue, but their reliance on manual locking mechanisms limits adaptability. This paper presents the design and evaluation of a motorized lower-limb exoskeleton-the Chairless Chair-that integrates electric linear actuators with force-sensing-resistors (FSRs) for intent detection. A finite state machine embedded in a custom PCB enables automated transitions between standing, walking, and semi-sitting postures. Structural safety was validated through finite element analysis, with the mild iron frame sustaining user loads up to 100 kg at FoS ≈ 3, and reducing to ≈ 1.8 under worst-case 120 kg loading. Three iterative prototypes demonstrated reproducible sit-to-stand support, progressively improving structural strength, sensing accuracy, and wearability. Preliminary ergonomic assessment with five subjects (𝑛=5) indicated measurable benefits: Borg CR10 scores decreased from 6.2 to 3.8 (≈ 39 % reduction in subjective fatigue), musculoskeletal effort during a 10-minute squatting task was reduced by ≈ 22 %, and task duration increased by ≈ 45 % in semi-sitting postures. Usability scores averaged 72, reflecting good acceptance but highlighting areas for improvement such as device mass and actuator duty cycle. By combining active actuation, p"

Penelitian pendukung oleh Danish Abdullah (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
