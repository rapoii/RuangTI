# 4789 — Production Planning & Inventory Control: Joint Optimization of Dynamic Lot-sizing and Condition-based Maintenance

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Joint Optimization of Dynamic Lot-sizing and Condition-based Maintenance  
**Jurnal & Sitasi Utama:** Alp Darendeliler, Dieter Claeys, Abdelhakim Khatab (2020). *Proceedings of the 9th International Conference on Operations Research and Enterprise Systems*. DOI: [10.5220/0008941601510158](10.5220/0008941601510158)  
**Sitasi Pendukung:** Dirk Briskorn, Thomas Wensing (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4551195](10.2139/ssrn.4551195)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alp Darendeliler, Dieter Claeys, Abdelhakim Khatab (2020) dalam jurnal *Proceedings of the 9th International Conference on Operations Research and Enterprise Systems* (DOI: 10.5220/0008941601510158) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Dirk Briskorn, Thomas Wensing (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
