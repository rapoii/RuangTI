# 3806 — Maintenance Engineering & Asset Life Cycle: Optimization and Selection of Maintenance Policies in an Electrical Gas Turbine Generator Based on the Hybrid Reliability-Centered Maintenance (RCM) Model

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Optimization and Selection of Maintenance Policies in an Electrical Gas Turbine Generator Based on the Hybrid Reliability-Centered Maintenance (RCM) Model  
**Jurnal & Sitasi Utama:** Moath Alrifaey, Tang Sai Hong, Azizan As’arry (2020). *Processes*. DOI: [10.3390/pr8060670](10.3390/pr8060670)  
**Sitasi Pendukung:** Renan Favarão da Silva, Arthur Henrique de Andrade Melani, Miguel Ângelo de Carvalho Michalski (2023). *Applied Sciences*. DOI: [10.3390/app131910605](10.3390/app131910605)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Moath Alrifaey, Tang Sai Hong, Azizan As’arry (2020) dalam jurnal *Processes* (DOI: 10.3390/pr8060670) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Renan Favarão da Silva, Arthur Henrique de Andrade Melani, Miguel Ângelo de Carvalho Michalski (2023) yang dipublikasikan dalam *Applied Sciences* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
