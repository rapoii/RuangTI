# Modul Komprehensif: Available-to-Promise (ATP) & Capable-to-Promise (CTP) Calculation Mechanisms
**Nomor Modul:** [362]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Supply Chain Management (Sunil Chopra), Production Planning & Control (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Available-to-Promise (ATP) & Capable-to-Promise (CTP) Calculation Mechanisms**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Discrete ATP, Cumulative ATP with Look-Ahead, Capable-to-Promise (CTP) with Free Machine Capacity & Component Lead Times, Real-Time Order Quoting.
...
```python
# Algoritma Solusi Terapan untuk Available-to-Promise (ATP) & Capable-to-Promise (CTP) Calculation Mechanisms
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Implementasi Real-Time ATP/CTP Web Portal untuk Janji Kirim Pesanan B2B Baja Kustom.
...
1. Supply Chain Management (Sunil Chopra), Production Planning & Control (2024).
