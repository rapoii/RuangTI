# 4800 — Production Planning & Inventory Control: A Particle Swarm Optimization method based on cost modification heuristic for the Multi Level Lot Sizing Problem

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** A Particle Swarm Optimization method based on cost modification heuristic for the Multi Level Lot Sizing Problem  
**Jurnal & Sitasi Utama:** Arnaud. Laurent, David. Lemoine (2022). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2022.09.560](10.1016/j.ifacol.2022.09.560)  
**Sitasi Pendukung:** Lead Industrial Researchers (2022). *Nusantara Science and Technology Proceedings*. DOI: [10.11594/nstp.2022.2727](10.11594/nstp.2022.2727)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Arnaud. Laurent, David. Lemoine (2022) dalam jurnal *IFAC-PapersOnLine* (DOI: 10.1016/j.ifacol.2022.09.560) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
