# 5129 — Industrial Energy Management & Decarbonization: Decarbonizing industrial distillation: A generalized design framework for heat pump integration and techno-economic analysis

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Decarbonizing industrial distillation: A generalized design framework for heat pump integration and techno-economic analysis  
**Jurnal & Sitasi Utama:** Jie-Yu Chen, Pin-Hsuan Chen, Zhen-Yi Du (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6712251](10.2139/ssrn.6712251)  
**Sitasi Pendukung:** Timothy Gordon Walmsley (2026). *Process Integration and Optimization for Sustainability*. DOI: [10.1007/s41660-026-00729-6](10.1007/s41660-026-00729-6)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jie-Yu Chen, Pin-Hsuan Chen, Zhen-Yi Du (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6712251) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Given the rapid expansion of renewable energy sources, process electrification has emerged as a highly promising pathway for industrial decarbonization. Among available technologies, heat pump-assisted distillation (HPAD) has proven highly effective in improving energy efficiency and reducing emissions. However, most existing HPAD designs are strictly case-dependent, requiring new processes to be synthesized from scratch. This reliance on time-consuming, trial-and-error approaches significantly limits the broader industrial implementation of HPAD. To overcome this technical barrier, this study proposes a systematic design framework that serves as a foundation for developing optimal HPAD configurations, accelerating the sector’s transition toward net-zero emissions. To demonstrate its practicality and robustness, the framework was applied to two distinct case studies—methanol/water and propylene/propane separations—evaluated under varying feed conditions. Results demonstrate that HPAD integration achieves remarkable energy savings (up to 86.2%) and carbon emission reductions (up to 92.6%) compared to conventional distillation. Furthermore, when compared to non-framework alternatives, the framework-guided designs consistently identify the true optimal configurations, delivering additional maximum improvements of 10.8% in energy savings, 8.2% in decarbonization, and 62.2% in economic feasibility (i.e., shortened payback periods)."

Penelitian pendukung oleh Timothy Gordon Walmsley (2026) yang dipublikasikan dalam *Process Integration and Optimization for Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
