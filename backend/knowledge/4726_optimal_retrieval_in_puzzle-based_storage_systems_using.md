# 4726 — Facilities Planning & Material Handling: Optimal Retrieval in Puzzle-Based Storage Systems Using Automated Mobile Robots

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Optimal Retrieval in Puzzle-Based Storage Systems Using Automated Mobile Robots  
**Jurnal & Sitasi Utama:** Tal Raviv, Yossi Bukchin, René de Koster (2023). *Transportation Science*. DOI: [10.1287/trsc.2022.1169](10.1287/trsc.2022.1169)  
**Sitasi Pendukung:** Simon Hoeg (2024). *Peer-Reviewed Journal*. DOI: [10.22541/essoar.15004335/v2](10.22541/essoar.15004335/v2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Tal Raviv, Yossi Bukchin, René de Koster (2023) dalam jurnal *Transportation Science* (DOI: 10.1287/trsc.2022.1169) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
