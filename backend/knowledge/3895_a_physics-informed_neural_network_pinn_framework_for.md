# 3895 — Industrial Artificial Intelligence & Data Analytics: A Physics-Informed Neural Network (PINN) framework for generic bioreactor modelling

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A Physics-Informed Neural Network (PINN) framework for generic bioreactor modelling  
**Jurnal & Sitasi Utama:** Monesh kumar Thirugnanasambandam, José M. Pinto, Ekaterina Moskovkina (2025). *Computers & Chemical Engineering*. DOI: [10.1016/j.compchemeng.2025.109354](10.1016/j.compchemeng.2025.109354)  
**Sitasi Pendukung:** Lizhong Zhao, Xueying Ding, B. Aditya Prakash (2023). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2307.11833](10.48550/arxiv.2307.11833)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Monesh kumar Thirugnanasambandam, José M. Pinto, Ekaterina Moskovkina (2025) dalam jurnal *Computers & Chemical Engineering* (DOI: 10.1016/j.compchemeng.2025.109354) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lizhong Zhao, Xueying Ding, B. Aditya Prakash (2023) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
