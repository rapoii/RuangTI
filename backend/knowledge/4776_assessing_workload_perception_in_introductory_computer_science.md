# 4776 — Human Factors & Cognitive Ergonomics: Assessing Workload Perception in Introductory Computer Science Projects using NASA-TLX

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Assessing Workload Perception in Introductory Computer Science Projects using NASA-TLX  
**Jurnal & Sitasi Utama:** Naser Al Madi, Siyuan Peng, Tamsin Rogers (2022). *Proceedings of the 53rd ACM Technical Symposium on Computer Science Education*. DOI: [10.1145/3478431.3499406](10.1145/3478431.3499406)  
**Sitasi Pendukung:** Aida Vidal-Balea, Paula Fraga-Lamas, Tiago M. Fernández-Caramés (2024). *2024 IEEE Gaming, Entertainment, and Media Conference (GEM)*. DOI: [10.1109/gem61861.2024.10585425](10.1109/gem61861.2024.10585425)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Naser Al Madi, Siyuan Peng, Tamsin Rogers (2022) dalam jurnal *Proceedings of the 53rd ACM Technical Symposium on Computer Science Education* (DOI: 10.1145/3478431.3499406) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Aida Vidal-Balea, Paula Fraga-Lamas, Tiago M. Fernández-Caramés (2024) yang dipublikasikan dalam *2024 IEEE Gaming, Entertainment, and Media Conference (GEM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
