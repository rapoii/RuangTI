# 6259 — Operations Research & Large-Scale Optimization: Learning Efficient Branch-and-Bound for Solving Mixed Integer Linear Programs

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Learning Efficient Branch-and-Bound for Solving Mixed Integer Linear Programs  
**Jurnal & Sitasi Utama:** Shuhan Du, Junbo Tong, Wenhui Fan (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4944657](10.2139/ssrn.4944657)  
**Sitasi Pendukung:** Shamisa Shoja, Daniel Axehill (2023). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2023.10.624](10.1016/j.ifacol.2023.10.624)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shuhan Du, Junbo Tong, Wenhui Fan (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4944657) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shamisa Shoja, Daniel Axehill (2023) yang dipublikasikan dalam *IFAC-PapersOnLine* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
