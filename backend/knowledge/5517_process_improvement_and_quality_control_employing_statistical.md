# 5517 — Quality Engineering & Reliability Systems: Process Improvement and Quality Control: Employing Statistical Process Control Charts to Monitor Call Center Data

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Process Improvement and Quality Control: Employing Statistical Process Control Charts to Monitor Call Center Data  
**Jurnal & Sitasi Utama:** Hubert Setzler (2024). *Peer-Reviewed Journal*. DOI: [10.4135/9781071974506](10.4135/9781071974506)  
**Sitasi Pendukung:** Hubert Setzler (2024). *Peer-Reviewed Journal*. DOI: [10.4135/9781071974506](10.4135/9781071974506)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hubert Setzler (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.4135/9781071974506) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hubert Setzler (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
