# 5065 — Simulation Modeling & Digital Twins: An agent-based simulation and logistics optimization model for managing uncertain demand in forest supply chains

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** An agent-based simulation and logistics optimization model for managing uncertain demand in forest supply chains  
**Jurnal & Sitasi Utama:** Petri Helo, Javad Rouzafzoon (2023). *Supply Chain Analytics*. DOI: [10.1016/j.sca.2023.100042](10.1016/j.sca.2023.100042)  
**Sitasi Pendukung:** H. Chung (2025). *Proceedings of the 15th International Conference on Simulation and Modeling Methodologies, Technologies and Applications*. DOI: [10.5220/0013569200003970](10.5220/0013569200003970)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Petri Helo, Javad Rouzafzoon (2023) dalam jurnal *Supply Chain Analytics* (DOI: 10.1016/j.sca.2023.100042) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
