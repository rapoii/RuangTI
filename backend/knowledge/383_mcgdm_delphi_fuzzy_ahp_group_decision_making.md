# Modul Komprehensif: Multi-Criteria Group Decision Making (MCGDM) & Delphi-Fuzzy AHP Consensus
**Nomor Modul:** [383]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Fuzzy Multi-Criteria Decision Making (Cengiz Kahraman), Applied Soft Computing (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Multi-Criteria Group Decision Making (MCGDM) & Delphi-Fuzzy AHP Consensus**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Triangular Fuzzy Numbers (TFN), Fuzzy Extent Analysis (Chang), Delphi Consensus Iterations, Group Consistency Ratio Aggregation (WGMM).
...
```python
# Algoritma Solusi Terapan untuk Multi-Criteria Group Decision Making (MCGDM) & Delphi-Fuzzy AHP Consensus
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Pemilihan Lokasi Pabrik Baterai EV Baru di Kawasan Industri ASEAN oleh Dewan Direksi.
...
1. Fuzzy Multi-Criteria Decision Making (Cengiz Kahraman), Applied Soft Computing (2024).
