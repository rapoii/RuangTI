# 3323 — Manufacturing Systems & Cyber-Physical Production: A novel bi-anomaly-based intrusion detection system approach for industry 4.0

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** A novel bi-anomaly-based intrusion detection system approach for industry 4.0  
**Jurnal & Sitasi Utama:** Salwa Alem, David Espès, Laurent Nana (2023). *Future Generation Computer Systems*. DOI: [10.1016/j.future.2023.03.024](10.1016/j.future.2023.03.024)  
**Sitasi Pendukung:** Paulo Leitão, Flávia Pires, Stamatis Karnouskos (2020). *IEEE Open Journal of the Industrial Electronics Society*. DOI: [10.1109/ojies.2020.3031660](10.1109/ojies.2020.3031660)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Salwa Alem, David Espès, Laurent Nana (2023) dalam jurnal *Future Generation Computer Systems* (DOI: 10.1016/j.future.2023.03.024) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
