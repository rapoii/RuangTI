# Modul Komprehensif: Perhitungan Safety Stock under Stochastic Lead Time & Variable Demand
**Nomor Modul:** [360]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Inventory Management and Production Planning and Scheduling (Silver, Pyke, Peterson), Naval Research Logistics (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Perhitungan Safety Stock under Stochastic Lead Time & Variable Demand**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Combined Variance of Demand and Lead Time, Service Level $Z_{\alpha}$ (Cycle Service Level vs Fill Rate $\beta$), Non-Normal Demand Approximations.
...
```python
# Algoritma Solusi Terapan untuk Perhitungan Safety Stock under Stochastic Lead Time & Variable Demand
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Optimasi Safety Stock 18.000 SKU Bahan Kimia Menghadapi Keterlambatan Pengapalan Impor.
...
1. Inventory Management and Production Planning and Scheduling (Silver, Pyke, Peterson), Naval Research Logistics (2024).
