# 2961 — Operations Research & Large-Scale Optimization: Integer Programming and Combinatorial Optimization

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Integer Programming and Combinatorial Optimization  
**Jurnal & Sitasi Utama:** Alberto Del Pia, Volker Kaibel (2023). *Lecture notes in computer science*. DOI: [10.1007/978-3-031-32726-1](10.1007/978-3-031-32726-1)  
**Sitasi Pendukung:** Aidan P. Thompson, Hasan Metin Aktulga, Richard A. Berger (2021). *Computer Physics Communications*. DOI: [10.1016/j.cpc.2021.108171](10.1016/j.cpc.2021.108171)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alberto Del Pia, Volker Kaibel (2023) dalam jurnal *Lecture notes in computer science* (DOI: 10.1007/978-3-031-32726-1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Aidan P. Thompson, Hasan Metin Aktulga, Richard A. Berger (2021) yang dipublikasikan dalam *Computer Physics Communications* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
