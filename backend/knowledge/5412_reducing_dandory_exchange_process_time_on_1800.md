# 5412 — Continuous Improvement & Lean Six Sigma: Reducing Dandory Exchange Process Time on 1800 Ton Injection Molding Machine Using the Single Minute Exchange of Dies (Smed) Method at PT Takagi Sari Multi Utama

**Domain:** Continuous Improvement & Lean Six Sigma  
**Topik Spesifik:** Reducing Dandory Exchange Process Time on 1800 Ton Injection Molding Machine Using the Single Minute Exchange of Dies (Smed) Method at PT Takagi Sari Multi Utama  
**Jurnal & Sitasi Utama:** Emi Rusmiati, Senda Will Hiden Zealotous (2024). *International Journal of Advanced Technology and Social Sciences*. DOI: [10.59890/ijatss.v2i3.1503](10.59890/ijatss.v2i3.1503)  
**Sitasi Pendukung:** Neilinda Novita Aisa, Rahayu Budi Prahara, Eduardus Dimas Arya Sadewa (2023). *Jurnal Optimalisasi*. DOI: [10.35308/jopt.v9i2.7475](10.35308/jopt.v9i2.7475)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Continuous Improvement & Lean Six Sigma memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Emi Rusmiati, Senda Will Hiden Zealotous (2024) dalam jurnal *International Journal of Advanced Technology and Social Sciences* (DOI: 10.59890/ijatss.v2i3.1503) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Takagi Sari Multi Utama is an automotive company engaged in injection molding, producing automotive products such as motor vehicle parts, car interiors, and exteriors. One of the main influences of the prolonged dandory process is the distance between the mold parking area and the machine, resulting in a total process time of 48.95 minutes, while the company's standard is set at 40 minutes. Minimizing the time can cause the dandory process of mold change using the Single Minute Exchange of Dies (SMED) method by converting the time of internal setup activities into external setup activities. The improvement results using the Single Minute Exchange of Dies (SMED) method reduced the time to 27.67 minutes or equivalent to 1,660.13 seconds. The reduction in dandory mold change process time on the 1800T injection molding machine is 21.29 minutes or equivalent to 1,277.16 seconds, with a percentage decrease of 44%"

Penelitian pendukung oleh Neilinda Novita Aisa, Rahayu Budi Prahara, Eduardus Dimas Arya Sadewa (2023) yang dipublikasikan dalam *Jurnal Optimalisasi* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
