# Modul Komprehensif: Cooperative Game Theory: Shapley Value & Alokasi Biaya Logistik Bersama
**Nomor Modul:** [387]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Cooperative Microeconomics (Hervé Moulin), Transportation Research Part B: Methodological (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Cooperative Game Theory: Shapley Value & Alokasi Biaya Logistik Bersama**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Karakteristik Fungsi Nilai Koalisi $v(S)$, Properti Fair Allocation (Efisiensi, Simetri, Dummy Player, Additivity), Shapley Value, Core of the Game, Nucleolus.
...
```python
# Algoritma Solusi Terapan untuk Cooperative Game Theory: Shapley Value & Alokasi Biaya Logistik Bersama
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Alokasi Penghematan Biaya Pengiriman Gabungan Multi-Vendor FMCG ke Supermarket Jawa Barat.
...
1. Cooperative Microeconomics (Hervé Moulin), Transportation Research Part B: Methodological (2024).
