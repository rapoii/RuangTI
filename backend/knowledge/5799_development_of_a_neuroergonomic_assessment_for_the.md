# 5799 — Human Factors & Cognitive Ergonomics: Development of a Neuroergonomic Assessment for the Evaluation of Mental Workload in an Industrial Human–Robot Interaction Assembly Task: A Comparative Case Study

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Development of a Neuroergonomic Assessment for the Evaluation of Mental Workload in an Industrial Human–Robot Interaction Assembly Task: A Comparative Case Study  
**Jurnal & Sitasi Utama:** Carlo Caiazzo, Marija Savković, Miloš Pušica (2023). *Machines*. DOI: [10.3390/machines11110995](10.3390/machines11110995)  
**Sitasi Pendukung:** Kunjira Kingphai, Yashar Moshfeghi (2024). *IEEE Transactions on Cognitive and Developmental Systems*. DOI: [10.1109/tcds.2024.3460750](10.1109/tcds.2024.3460750)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Carlo Caiazzo, Marija Savković, Miloš Pušica (2023) dalam jurnal *Machines* (DOI: 10.3390/machines11110995) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Kunjira Kingphai, Yashar Moshfeghi (2024) yang dipublikasikan dalam *IEEE Transactions on Cognitive and Developmental Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
