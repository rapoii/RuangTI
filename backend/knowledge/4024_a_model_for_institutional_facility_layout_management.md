# 4024 — Facilities Planning & Material Handling: A Model for Institutional Facility Layout Management in a Growing Manufacturing Company

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** A Model for Institutional Facility Layout Management in a Growing Manufacturing Company  
**Jurnal & Sitasi Utama:** Liccy Félix Espinoza, Arnulfo Aurelio Naranjo Flores, Javier Portugal Vásquez (2025). *International Journal of Latest Research in Engineering and Management (IJLREM)*. DOI: [10.56581/ijlrem.9.6.10-21](10.56581/ijlrem.9.6.10-21)  
**Sitasi Pendukung:** Enrica Salsa Diwianti, Rekha Trya Larasati, Tiaradia Ihsan (2026). *Jurnal Teknik Industri Terintegrasi*. DOI: [10.31004/jutin.v9i1.54207](10.31004/jutin.v9i1.54207)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Liccy Félix Espinoza, Arnulfo Aurelio Naranjo Flores, Javier Portugal Vásquez (2025) dalam jurnal *International Journal of Latest Research in Engineering and Management (IJLREM)* (DOI: 10.56581/ijlrem.9.6.10-21) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The accelerated expansion of the manufacturing sector in Mexico, driven by nearshoring dynamics and the growth of the aerospace industry in Sonora, has increased the need for strategic management of productive floor space.This study proposes an institutional model for layout management in a growing manufacturing company to standardize processes, strengthen internal coordination, and improve decision-making related to physical infrastructure.The methodology was structured into four stages.First, an initial diagnostic-based on document analysis, surveys, and onsite assessments-identified gaps in information control, role definition, space utilization, and interdepartmental communication.Second, an institutional framework was established to formalize governance principles, guidelines, and responsibilities.Third, a management model was developed, integrating operational workflows, documentation repositories, and a system of layout performance indicators (CG, PAU, and FLF).Finally, the model was implemented in a pilot area, validating its applicability and enhancing standardization and traceability of layout changes.The results confirm that the model provides a robust and replicable tool for strategic layout management in manufacturing environments undergoing growth or reconfiguration."

Penelitian pendukung oleh Enrica Salsa Diwianti, Rekha Trya Larasati, Tiaradia Ihsan (2026) yang dipublikasikan dalam *Jurnal Teknik Industri Terintegrasi* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
