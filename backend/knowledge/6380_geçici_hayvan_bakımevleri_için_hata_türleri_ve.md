# 6380 — Quality Engineering & Reliability Systems: Geçici Hayvan Bakımevleri İçin Hata Türleri ve Etkileri Analizi (FMEA) Örneği

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Geçici Hayvan Bakımevleri İçin Hata Türleri ve Etkileri Analizi (FMEA) Örneği  
**Jurnal & Sitasi Utama:** Evren ÇAĞLARER, Filiz ARICAK (2023). *Journal of Anatolian Environmental and Animal Sciences*. DOI: [10.35229/jaes.1308490](10.35229/jaes.1308490)  
**Sitasi Pendukung:** M. Chusnul Chuluq, Wiwik Sulistiyowati (2024). *Peer-Reviewed Journal*. DOI: [10.21070/ups.11465](10.21070/ups.11465)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Evren ÇAĞLARER, Filiz ARICAK (2023) dalam jurnal *Journal of Anatolian Environmental and Animal Sciences* (DOI: 10.35229/jaes.1308490) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Kısırlaştırma işlemi hayvanların üremesini kalıcı bir şekilde durdurmak için yapılan cerrahi bir müdahaledir. Ülkemizde sahipsiz sokak hayvan sayısı milyonlarla, buna karşılık kısırlaştırılan sokak hayvan sayısı binli sayılarla ifade edilmektedir (Tarım ve Orman Bakanlığı,2022). Sokakta yaşayan, başıboş kedi köpek gibi evcil hayvanların popülasyonundaki kontrolsüz büyümenin önüne geçmek için kısırlaştırma işlemleri yerel belediyelere ait geçici hayvan bakımevlerinde yapılır. Kısırlaştırma işlemi anestezi eşliğinde yapılan basit bir operasyon olarak görünse de alt süreçlerine bakıldığında olası hataların oluşturacağı tehlike ve risklerle göz ardı edilmemesi gereken bir süreçtir. Bu konuda potansiyel tehlikelerin belirlenmesi ve sonuçlarının analizini yapılması risk değerlendirmeleri ile mümkün olur. FMEA (Hata Tür ve Etkileri Analizi Risk Analizi), basitliği ve görünürlüğü göz önüne alındığında başta sağlık hizmetleri olmak üzere çoğu alanda kalite iyileştirme çalışmaları için sıklıkla kullanılan bir yöntemdir. Uygulaması kolay ve maliyeti düşüktür. Bu yöntemle yüksek riskli süreçlerde oluşabilecek hatalar önceden tespit edilerek, hastaya ulaşmadan önce önlem alınabilir ve böylece hataların oluşma sıklığı düşürülebilir.
İş sağlığı ve güvenliği kapsamında yapılan risk değerlendirme çalışmaları çalışanın ve çalışma ortamının risklerini değerlendirmek için yapılır.  Çalışmamızda gerçekleştirilen risk analizi ile geçici hayvan barınakları ve burada kısırlaştırılan hayvanların sağ"

Penelitian pendukung oleh M. Chusnul Chuluq, Wiwik Sulistiyowati (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
