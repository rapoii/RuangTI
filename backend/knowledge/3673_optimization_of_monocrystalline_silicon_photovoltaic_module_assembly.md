# 3673 — Simulation Modeling & Digital Twins: Optimization of monocrystalline silicon photovoltaic module assembly lines based on simulation model

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Optimization of monocrystalline silicon photovoltaic module assembly lines based on simulation model  
**Jurnal & Sitasi Utama:** Yuxiang Liu, Xuefeng Xia, Jing-yang Zhang (2025). *PLoS ONE*. DOI: [10.1371/journal.pone.0325152](10.1371/journal.pone.0325152)  
**Sitasi Pendukung:** Aytek Güngör, Yalçın Ünsan, Barış Barlas (2023). *Brodogradnja*. DOI: [10.21278/brod74402](10.21278/brod74402)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuxiang Liu, Xuefeng Xia, Jing-yang Zhang (2025) dalam jurnal *PLoS ONE* (DOI: 10.1371/journal.pone.0325152) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
