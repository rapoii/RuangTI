# 3155 — Quality Engineering & Reliability Systems: Safety Function-Failure Mode and Effect Analysis a Novel Approach of FMEA for Safety Application in Mobile Working Machinery

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Safety Function-Failure Mode and Effect Analysis a Novel Approach of FMEA for Safety Application in Mobile Working Machinery  
**Jurnal & Sitasi Utama:** Christa Düsing, Frank Will (2025). *Lecture notes in mechanical engineering*. DOI: [10.1007/978-3-031-84505-5_11](10.1007/978-3-031-84505-5_11)  
**Sitasi Pendukung:** L. Petrescu, Maria-Cătălina Petrescu, Cătălin Constantinescu (2026). *Machines*. DOI: [10.3390/machines14040422](10.3390/machines14040422)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Christa Düsing, Frank Will (2025) dalam jurnal *Lecture notes in mechanical engineering* (DOI: 10.1007/978-3-031-84505-5_11) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract The Safety Function-FMEA (SF-FMEA) is an established process in the automotive industry, while mobile machines are produced as special-purpose vehicles in small series for on- and off-road applications. On-road vehicles comply with ISO 26262 for functional safety, while off-road machines follow ISO 13849. Safety architectures (CAT 2, 3 & 4) in mobile machinery often require more process-related data, which complicates their integration into traditional FMEA structures. This paper presents methods to include critical safety architectures, identify relevant process data, and integrate solutions into FMEA structures and software tools. The focus is on evaluating failure modes and embedding SF-FMEA results into machine simulation models to validate safety system behaviour before the first machine prototypes are built. The new SF-FMEA process and software tool guide developers intuitively and support automatic verification and documentation of results in FMEDA (Failure Mode Effects and Diagnostic Analyses). It includes calculation tools for safety-relevant parameters such as the Probability of dangerous Failure per Hour (PFH D ), Mean Time to dangerous Failure (MTTF D ), Diagnostic Coverage (DC), and Performance Levels (PLs), enhancing failure mode evaluation. Since machine-specific PLs are not defined in current standards, the method efficiently compares the actual achievement with the required Performance Level (PLr). The effectiveness of the new SF-FMEA process and the"

Penelitian pendukung oleh L. Petrescu, Maria-Cătălina Petrescu, Cătălin Constantinescu (2026) yang dipublikasikan dalam *Machines* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
