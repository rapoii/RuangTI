# 3020 — Supply Chain Management & Logistics Engineering: Internet of Things research in supply chain management and logistics: A bibliometric analysis

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Internet of Things research in supply chain management and logistics: A bibliometric analysis  
**Jurnal & Sitasi Utama:** Abderahman Rejeb, Steve Simske, Karim Rejeb (2020). *Internet of Things*. DOI: [10.1016/j.iot.2020.100318](10.1016/j.iot.2020.100318)  
**Sitasi Pendukung:** Mehran Ullah (2023). *Journal of Cleaner Production*. DOI: [10.1016/j.jclepro.2023.136370](10.1016/j.jclepro.2023.136370)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Abderahman Rejeb, Steve Simske, Karim Rejeb (2020) dalam jurnal *Internet of Things* (DOI: 10.1016/j.iot.2020.100318) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mehran Ullah (2023) yang dipublikasikan dalam *Journal of Cleaner Production* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
