# 4816 — Production Planning & Inventory Control: Dynamic Lot Sizing Model for Perishable Products in Animal Pharmaceutical Industry with Quality Deterioration

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Dynamic Lot Sizing Model for Perishable Products in Animal Pharmaceutical Industry with Quality Deterioration  
**Jurnal & Sitasi Utama:** Dira Aulia, Niniet Indah Arvitrida (2023). *Proceedings of the International Conference on Industrial Engineering and Operations Management*. DOI: [10.46254/an13.20230085](10.46254/an13.20230085)  
**Sitasi Pendukung:** Selvia Antinah (2024). *Journal of Industrial and Engineering System*. DOI: [10.31599/1vggd716](10.31599/1vggd716)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dira Aulia, Niniet Indah Arvitrida (2023) dalam jurnal *Proceedings of the International Conference on Industrial Engineering and Operations Management* (DOI: 10.46254/an13.20230085) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Selvia Antinah (2024) yang dipublikasikan dalam *Journal of Industrial and Engineering System* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
