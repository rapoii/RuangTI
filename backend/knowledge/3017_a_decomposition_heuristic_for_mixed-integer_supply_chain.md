# 3017 — Operations Research & Large-Scale Optimization: A decomposition heuristic for mixed-integer supply chain problems

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A decomposition heuristic for mixed-integer supply chain problems  
**Jurnal & Sitasi Utama:** Lars Schewe, Martin Schmidt, Dieter Weninger (2020). *Operations Research Letters*. DOI: [10.1016/j.orl.2020.02.006](10.1016/j.orl.2020.02.006)  
**Sitasi Pendukung:** Alberto Ceselli, Ángel Felipe, M. Teresa Ortuño (2021). *Operations Research Forum*. DOI: [10.1007/s43069-020-00052-x](10.1007/s43069-020-00052-x)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lars Schewe, Martin Schmidt, Dieter Weninger (2020) dalam jurnal *Operations Research Letters* (DOI: 10.1016/j.orl.2020.02.006) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Alberto Ceselli, Ángel Felipe, M. Teresa Ortuño (2021) yang dipublikasikan dalam *Operations Research Forum* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
