# 5766 — Operations Research & Large-Scale Optimization: Development of a Chance-Constrained Stochastic Programming Strategy for Optimal Design of Building Integrated Energy Systems Under Multiple Uncertainties for Nearly Zero-Energy Buildings

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Development of a Chance-Constrained Stochastic Programming Strategy for Optimal Design of Building Integrated Energy Systems Under Multiple Uncertainties for Nearly Zero-Energy Buildings  
**Jurnal & Sitasi Utama:** Debin Zhang, Wenye Lin, Qingyao Qiao (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6000539](10.2139/ssrn.6000539)  
**Sitasi Pendukung:** Rui Zhang, Yun Teng, Zhe Chen (2024). *2024 IEEE 8th Conference on Energy Internet and Energy System Integration (EI2)*. DOI: [10.1109/ei264398.2024.10991581](10.1109/ei264398.2024.10991581)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Debin Zhang, Wenye Lin, Qingyao Qiao (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.6000539) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Rui Zhang, Yun Teng, Zhe Chen (2024) yang dipublikasikan dalam *2024 IEEE 8th Conference on Energy Internet and Energy System Integration (EI2)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
