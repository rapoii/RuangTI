# 5104 — Industrial Energy Management & Decarbonization: Blockchain-based concept for total site heat integration: A pinch-based smart contract energy management in industrial symbiosis

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Blockchain-based concept for total site heat integration: A pinch-based smart contract energy management in industrial symbiosis  
**Jurnal & Sitasi Utama:** Hon Huin Chin, Petar Sabev Varbanov, Sharifah Rafidah Wan Alwi (2024). *Energy*. DOI: [10.1016/j.energy.2024.132261](10.1016/j.energy.2024.132261)  
**Sitasi Pendukung:** Xuexiu Jia (2023). *Handbook of Process Integration (PI)*. DOI: [10.1016/b978-0-12-823850-9.00002-5](10.1016/b978-0-12-823850-9.00002-5)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Hon Huin Chin, Petar Sabev Varbanov, Sharifah Rafidah Wan Alwi (2024) dalam jurnal *Energy* (DOI: 10.1016/j.energy.2024.132261) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Xuexiu Jia (2023) yang dipublikasikan dalam *Handbook of Process Integration (PI)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
