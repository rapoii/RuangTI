# 4795 — Production Planning & Inventory Control: A Class of Two-Level Dynamic Lot Sizing Problems with Complementary Components: The Infinite Horizon Case

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** A Class of Two-Level Dynamic Lot Sizing Problems with Complementary Components: The Infinite Horizon Case  
**Jurnal & Sitasi Utama:** Fuying Jing, Xiangrui Chao (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4068687](10.2139/ssrn.4068687)  
**Sitasi Pendukung:** Liong Irena, I Gede Agus Widyadana (2023). *Lecture Notes in Networks and Systems*. DOI: [10.1007/978-3-031-50151-7_4](10.1007/978-3-031-50151-7_4)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fuying Jing, Xiangrui Chao (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4068687) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study investigates a two-level dynamic lot sizing problem, the first level of which has two  complementary components  and the second level has one finished product. Two types of models under complementary components and finished products are formulated, that is, the demand backlogging and stockouts of the finished product at Level 2 are permitted. For the two types of the model, dynamic programming algorithms are developed to solve the problem based on several properties of the optimal solution. Furthermore, the sufficient conditions to obtain forecast horizons are provided by establishing the regeneration sets for the two levels by using the method of marginal costs. In addition, we determine the effects of the number of components, backlogging costs and stockout costs on forecast horizons via numerical experiments."

Penelitian pendukung oleh Liong Irena, I Gede Agus Widyadana (2023) yang dipublikasikan dalam *Lecture Notes in Networks and Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
