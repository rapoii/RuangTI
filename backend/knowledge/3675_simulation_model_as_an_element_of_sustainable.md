# 3675 — Simulation Modeling & Digital Twins: Simulation Model as an Element of Sustainable Autonomous Mobile Robot Fleet Management

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simulation Model as an Element of Sustainable Autonomous Mobile Robot Fleet Management  
**Jurnal & Sitasi Utama:** M. Dobrzańska, Paweł Dobrzański (2025). *Energies*. DOI: [10.3390/en18081894](10.3390/en18081894)  
**Sitasi Pendukung:** Tanat Ngaorungsi, Parames Chutima (2024). *Engineering Journal*. DOI: [10.4186/ej.2024.28.2.29](10.4186/ej.2024.28.2.29)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari M. Dobrzańska, Paweł Dobrzański (2025) dalam jurnal *Energies* (DOI: 10.3390/en18081894) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
