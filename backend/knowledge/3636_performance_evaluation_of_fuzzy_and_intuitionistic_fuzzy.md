# 3636 — Applied Statistics & Stochastic Modeling: Performance evaluation of Fuzzy and Intuitionistic fuzzy M/M/1 Jackson-Type Network Queue under Uncertain Parameters

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Performance evaluation of Fuzzy and Intuitionistic fuzzy M/M/1 Jackson-Type Network Queue under Uncertain Parameters  
**Jurnal & Sitasi Utama:** Sachin R. Gurnule (2026). *Journal of Intelligent Decision Making and Information Science*. DOI: [10.59543/jidmis.v3.1028](10.59543/jidmis.v3.1028)  
**Sitasi Pendukung:** Anthony Ebert (2020). *Queensland University of Technology*. DOI: [10.5204/thesis.eprints.180771](10.5204/thesis.eprints.180771)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sachin R. Gurnule (2026) dalam jurnal *Journal of Intelligent Decision Making and Information Science* (DOI: 10.59543/jidmis.v3.1028) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
