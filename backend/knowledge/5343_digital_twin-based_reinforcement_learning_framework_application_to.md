# 5343 — Industrial Artificial Intelligence & Data Analytics: Digital twin-based reinforcement learning framework: application to autonomous mobile robot dispatching

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Digital twin-based reinforcement learning framework: application to autonomous mobile robot dispatching  
**Jurnal & Sitasi Utama:** Amel Jaoua, Samar Masmoudi, Elisa Negri (2024). *International Journal of Computer Integrated Manufacturing*. DOI: [10.1080/0951192x.2024.2314787](10.1080/0951192x.2024.2314787)  
...
Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amel Jaoua, Samar Masmoudi, Elisa Negri (2024) dalam jurnal *International Journal of Computer Integrated Manufacturing* (DOI: 10.1080/0951192x.2024.2314787) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
