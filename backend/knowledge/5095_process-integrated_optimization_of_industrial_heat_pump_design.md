# 5095 — Industrial Energy Management & Decarbonization: Process-Integrated Optimization of Industrial Heat Pump Design and Operation using Generic Grand Composite Curves for Drying Processes

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Process-Integrated Optimization of Industrial Heat Pump Design and Operation using Generic Grand Composite Curves for Drying Processes  
**Jurnal & Sitasi Utama:** Lukas Knorr, Nils Horstmann, Stephen Braun (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.5825146](10.2139/ssrn.5825146)  
**Sitasi Pendukung:** Lead Industrial Researchers (2023). *Sustainable Process Integration and Intensification*. DOI: [10.1515/9783110782981-005](10.1515/9783110782981-005)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lukas Knorr, Nils Horstmann, Stephen Braun (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.5825146) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
