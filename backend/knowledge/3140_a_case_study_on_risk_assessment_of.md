# 3140 — Quality Engineering & Reliability Systems: A Case Study on Risk Assessment of Lane Keep Assist SW Function Using Integrated FMEA and FUSA Techniques

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** A Case Study on Risk Assessment of Lane Keep Assist SW Function Using Integrated FMEA and FUSA Techniques  
**Jurnal & Sitasi Utama:** Mahesh Kumar, Praveen Somabathula, K S V Angu Bala Ganesh (2024). *Peer-Reviewed Academic Journal*. DOI: [10.1109/icsrs63046.2024.10927494](10.1109/icsrs63046.2024.10927494)  
**Sitasi Pendukung:** Yingwei Tang, Dequn Zhou, Shichao Zhu (2024). *Quality and Reliability Engineering International*. DOI: [10.1002/qre.3657](10.1002/qre.3657)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mahesh Kumar, Praveen Somabathula, K S V Angu Bala Ganesh (2024) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.1109/icsrs63046.2024.10927494) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This manuscript describes integration of established risk assessment techniques such as FMEA with contemporary safety standards such as ISO 26262. Part 1 of the manuscript focuses on applying FMEA on the steering system utilized in the commercial vehicle industry, how the risk was found in the system, and what efforts were taken to mitigate the risk that was found. Within the ZF environment failure mode and effective analysis was applied. which is one of the conventional problem-solving approaches, in accordance with the AIAG / VDA 1st edition 2019 FMEA (failure mode and effects analysis) guidebook to identify the risk in the system. By using this method, we were able to identify all the system's functionality as well as that of its subsystems, assemblies, subassemblies, components, and child-level parts from the Product Design team. The severity of the top-level failures were discussed and their effects with the assistance of a cross-functional team made up of system engineers and test engineers, who helped identify all potential failures to perform functional and failure netting (Bottom to Top approach inductive analysis) by providing appropriate preventive measures and test cases to be implemented and validated in bench or vehicle tests, where we identified all likely test conditions. Part2 describes integration of the Occurrence & detection ratings from the FMEA to map the overall system effect with a Hazard / safety goal identified in the HARA (Hazard and risk analysis),"

Penelitian pendukung oleh Yingwei Tang, Dequn Zhou, Shichao Zhu (2024) yang dipublikasikan dalam *Quality and Reliability Engineering International* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
