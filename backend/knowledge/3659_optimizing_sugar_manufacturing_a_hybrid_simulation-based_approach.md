# 3659 — Simulation Modeling & Digital Twins: Optimizing Sugar Manufacturing: A Hybrid Simulation-Based Approach and MCDM for Efficient Decision Making

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Optimizing Sugar Manufacturing: A Hybrid Simulation-Based Approach and MCDM for Efficient Decision Making  
**Jurnal & Sitasi Utama:** Salahuddin Iskanderani, Omer Bafail, Mohammed Alamoudi (2023). *Axioms*. DOI: [10.3390/axioms12100975](10.3390/axioms12100975)  
**Sitasi Pendukung:** Sarah Bodenstein, Isabelina Nahmens, Terrence R. Tiersch (2022). *Journal of Shellfish Research*. DOI: [10.2983/035.041.0206](10.2983/035.041.0206)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Salahuddin Iskanderani, Omer Bafail, Mohammed Alamoudi (2023) dalam jurnal *Axioms* (DOI: 10.3390/axioms12100975) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Sarah Bodenstein, Isabelina Nahmens, Terrence R. Tiersch (2022) yang dipublikasikan dalam *Journal of Shellfish Research* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
