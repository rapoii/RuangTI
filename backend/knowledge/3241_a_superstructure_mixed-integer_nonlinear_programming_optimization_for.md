# 3241 — Operations Research & Large-Scale Optimization: A Superstructure Mixed-Integer Nonlinear Programming Optimization for the Optimal Processing Pathway Selection of Sludge-to-Energy Technologies

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Superstructure Mixed-Integer Nonlinear Programming Optimization for the Optimal Processing Pathway Selection of Sludge-to-Energy Technologies  
**Jurnal & Sitasi Utama:** Omar Morsy, Farzad Hourfar, Qinqin Zhu (2023). *Sustainability*. DOI: [10.3390/su15054023](10.3390/su15054023)  
**Sitasi Pendukung:** Laurent Alfandari, Ivana Ljubić, Marcos de Melo da Silva (2021). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.06.048](10.1016/j.ejor.2021.06.048)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Omar Morsy, Farzad Hourfar, Qinqin Zhu (2023) dalam jurnal *Sustainability* (DOI: 10.3390/su15054023) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
