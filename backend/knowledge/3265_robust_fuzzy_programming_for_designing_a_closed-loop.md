# 3265 — Supply Chain Management & Logistics Engineering: Robust fuzzy programming for designing a closed-loop supply chain under uncertainty and flexible constraints

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Robust fuzzy programming for designing a closed-loop supply chain under uncertainty and flexible constraints  
**Jurnal & Sitasi Utama:** Seyyed Jalaladdin Hosseini Dehshiri, Maghsoud Amiri (2025). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2025.100209](10.1016/j.clscn.2025.100209)  
**Sitasi Pendukung:** Umangi Pathak, Ravi Kant, Ravi Shankar (2022). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2022.100064](10.1016/j.clscn.2022.100064)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Seyyed Jalaladdin Hosseini Dehshiri, Maghsoud Amiri (2025) dalam jurnal *Cleaner Logistics and Supply Chain* (DOI: 10.1016/j.clscn.2025.100209) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Umangi Pathak, Ravi Kant, Ravi Shankar (2022) yang dipublikasikan dalam *Cleaner Logistics and Supply Chain* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
