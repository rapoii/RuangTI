# 4213 — Applied Statistics & Stochastic Modeling: Numerical investigation and sensitivity analysis on bioconvective tangent hyperbolic nanofluid flow towards stretching surface by response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Numerical investigation and sensitivity analysis on bioconvective tangent hyperbolic nanofluid flow towards stretching surface by response surface methodology  
**Jurnal & Sitasi Utama:** Anum Shafiq, Tabassum Naz Sindhu, Chaudry Masood Khalique (2020). *Alexandria Engineering Journal*. DOI: [10.1016/j.aej.2020.08.007](10.1016/j.aej.2020.08.007)  
**Sitasi Pendukung:** Suyun Zhang, Qiang Zhuang, Miao Zhang (2020). *Chemical Society Reviews*. DOI: [10.1039/c8cs00938d](10.1039/c8cs00938d)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anum Shafiq, Tabassum Naz Sindhu, Chaudry Masood Khalique (2020) dalam jurnal *Alexandria Engineering Journal* (DOI: 10.1016/j.aej.2020.08.007) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Suyun Zhang, Qiang Zhuang, Miao Zhang (2020) yang dipublikasikan dalam *Chemical Society Reviews* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
