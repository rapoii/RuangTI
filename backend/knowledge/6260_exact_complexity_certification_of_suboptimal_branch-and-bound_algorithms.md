# 6260 — Operations Research & Large-Scale Optimization: Exact Complexity Certification of Suboptimal Branch-and-Bound Algorithms for Mixed-Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Exact Complexity Certification of Suboptimal Branch-and-Bound Algorithms for Mixed-Integer Linear Programming  
**Jurnal & Sitasi Utama:** Shamisa Shoja, Daniel Axehill (2023). *IFAC-PapersOnLine*. DOI: [10.1016/j.ifacol.2023.10.624](10.1016/j.ifacol.2023.10.624)  
**Sitasi Pendukung:** Jacques Teghem (2025). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_420-1](10.1007/978-3-030-54621-2_420-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shamisa Shoja, Daniel Axehill (2023) dalam jurnal *IFAC-PapersOnLine* (DOI: 10.1016/j.ifacol.2023.10.624) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jacques Teghem (2025) yang dipublikasikan dalam *Encyclopedia of Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
