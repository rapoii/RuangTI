# 5727 — Operations Research & Large-Scale Optimization: HVAC Operation Planning for Electric Bus Trips Based on Chance-Constrained Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** HVAC Operation Planning for Electric Bus Trips Based on Chance-Constrained Programming  
**Jurnal & Sitasi Utama:** Yiming Bie, Yajun Liu, Shiwu Li (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.3990181](10.2139/ssrn.3990181)  
**Sitasi Pendukung:** Yuang Chen, Beste Basciftci, Valerie Thomas (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4197654](10.2139/ssrn.4197654)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yiming Bie, Yajun Liu, Shiwu Li (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.3990181) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
