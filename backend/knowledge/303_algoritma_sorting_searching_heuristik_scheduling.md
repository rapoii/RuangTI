# Modul Komprehensif: Algoritma Pencarian, Sorting, & Heuristik Penjadwalan Produksi
**Nomor Modul:** [303]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Planning and Scheduling in Manufacturing and Services (Michael L. Pinedo), European Journal of Operational Research (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Algoritma Pencarian, Sorting, & Heuristik Penjadwalan Produksi**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Klasifikasi Tiga Medan Graham (alpha | beta | gamma), SPT Rule, EDD Rule Jackson, WSPT, ATC Heuristic, Simulated Annealing Makespan Flow Shop.
...
```python
# Algoritma Solusi Terapan untuk Algoritma Pencarian, Sorting, & Heuristik Penjadwalan Produksi
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penjadwalan Lini Stamping Bodi Mobil (Reduksi Makespan 26%, efisiensi 38.5 jam/minggu).
...
1. Planning and Scheduling in Manufacturing and Services (Michael L. Pinedo), European Journal of Operational Research (2024).
