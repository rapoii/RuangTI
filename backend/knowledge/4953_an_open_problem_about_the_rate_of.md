# 4953 — Applied Statistics & Stochastic Modeling: An open problem about the rate of convergence in Erlang-Sevastyanov’s model

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** An open problem about the rate of convergence in Erlang-Sevastyanov’s model  
**Jurnal & Sitasi Utama:** Alexander Veretennikov (2022). *Queueing Systems*. DOI: [10.1007/s11134-022-09791-6](10.1007/s11134-022-09791-6)  
**Sitasi Pendukung:** Vassil Sgurev, Stanislav Drangajov (2020). *Proceedings of the 21st International Conference on Computer Systems and Technologies*. DOI: [10.1145/3407982.3408015](10.1145/3407982.3408015)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alexander Veretennikov (2022) dalam jurnal *Queueing Systems* (DOI: 10.1007/s11134-022-09791-6) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Vassil Sgurev, Stanislav Drangajov (2020) yang dipublikasikan dalam *Proceedings of the 21st International Conference on Computer Systems and Technologies* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
