# 5902 — Simulation Modeling & Digital Twins: A novel application of pre-signals to improve the performance of signalized intersections: evaluation through simulation

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** A novel application of pre-signals to improve the performance of signalized intersections: evaluation through simulation  
**Jurnal & Sitasi Utama:** António Vieira, Luís M. S. Dias, Guilherme Pereira (2019). *Peer-Reviewed Academic Journal*. DOI: [10.46354/i3m.2019.emss.027](10.46354/i3m.2019.emss.027)  
**Sitasi Pendukung:** I. V. Revina, G N Boyarkin (2018). *Proceedings of the International Conference "Actual Issues of Mechanical Engineering" (AIME 2018)*. DOI: [10.2991/aime-18.2018.101](10.2991/aime-18.2018.101)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari António Vieira, Luís M. S. Dias, Guilherme Pereira (2019) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.46354/i3m.2019.emss.027) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh I. V. Revina, G N Boyarkin (2018) yang dipublikasikan dalam *Proceedings of the International Conference "Actual Issues of Mechanical Engineering" (AIME 2018)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
