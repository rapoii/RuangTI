# 4043 — Facilities Planning & Material Handling: Reconfigurable process-aware factory layout planning: a human-centric multi-objective optimization approach

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Reconfigurable process-aware factory layout planning: a human-centric multi-objective optimization approach  
**Jurnal & Sitasi Utama:** Andreas Lind, Sunith Bandaru, Lars Hanson (2026). *Engineering Optimization*. DOI: [10.1080/0305215x.2026.2718913](10.1080/0305215x.2026.2718913)  
**Sitasi Pendukung:** Charlie Edmonson (2020). *Peer-Reviewed Academic Journal*. DOI: [10.18260/1-2--21552](10.18260/1-2--21552)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Andreas Lind, Sunith Bandaru, Lars Hanson (2026) dalam jurnal *Engineering Optimization* (DOI: 10.1080/0305215x.2026.2718913) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Charlie Edmonson (2020) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
