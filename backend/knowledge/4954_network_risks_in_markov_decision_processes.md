# 4954 — Applied Statistics & Stochastic Modeling: Network Risks in Markov Decision Processes

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Network Risks in Markov Decision Processes  
**Jurnal & Sitasi Utama:** Vassil Sgurev, Stanislav Drangajov (2020). *Proceedings of the 21st International Conference on Computer Systems and Technologies*. DOI: [10.1145/3407982.3408015](10.1145/3407982.3408015)  
**Sitasi Pendukung:** Nadezhda Bakhareva, Veniamin Tarasov (2021). *2021 IEEE 8th International Conference on Problems of Infocommunications, Science and Technology (PIC S&amp;T)*. DOI: [10.1109/picst54195.2021.9772114](10.1109/picst54195.2021.9772114)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Vassil Sgurev, Stanislav Drangajov (2020) dalam jurnal *Proceedings of the 21st International Conference on Computer Systems and Technologies* (DOI: 10.1145/3407982.3408015) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Nadezhda Bakhareva, Veniamin Tarasov (2021) yang dipublikasikan dalam *2021 IEEE 8th International Conference on Problems of Infocommunications, Science and Technology (PIC S&amp;T)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
