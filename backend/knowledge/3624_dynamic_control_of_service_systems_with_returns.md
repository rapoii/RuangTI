# 3624 — Applied Statistics & Stochastic Modeling: Dynamic Control of Service Systems with Returns: Application to Design of Post-Discharge Hospital Readmission Prevention Programs

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Dynamic Control of Service Systems with Returns: Application to Design of Post-Discharge Hospital Readmission Prevention Programs  
**Jurnal & Sitasi Utama:** Timothy C. Y. Chan, Simon Huang, Vahid Sarhangian (2022). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2203.00093](10.48550/arxiv.2203.00093)  
**Sitasi Pendukung:** Andrew Daw, Antonio Castellanos, Yom-Tov, Galit B. (2020). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2004.07861](10.48550/arxiv.2004.07861)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Timothy C. Y. Chan, Simon Huang, Vahid Sarhangian (2022) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2203.00093) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Andrew Daw, Antonio Castellanos, Yom-Tov, Galit B. (2020) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
