# 3811 — Maintenance Engineering & Asset Life Cycle: Applying Reliability Centered Maintenance (RCM) to Sampling Subsystem in Continuous Emission Monitoring System

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Applying Reliability Centered Maintenance (RCM) to Sampling Subsystem in Continuous Emission Monitoring System  
**Jurnal & Sitasi Utama:** Yuan‐Jian Yang, Xin-Yin Zhang, Zhi-Jie Zhao (2020). *IEEE Access*. DOI: [10.1109/access.2020.2980630](10.1109/access.2020.2980630)  
**Sitasi Pendukung:** Solarin Adebayo Samuel, Joseph Nnaemeka Chukwunweike (2023). *International Journal of Science and Research Archive*. DOI: [10.30574/ijsra.2023.8.1.0136](10.30574/ijsra.2023.8.1.0136)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yuan‐Jian Yang, Xin-Yin Zhang, Zhi-Jie Zhao (2020) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2020.2980630) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Solarin Adebayo Samuel, Joseph Nnaemeka Chukwunweike (2023) yang dipublikasikan dalam *International Journal of Science and Research Archive* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
