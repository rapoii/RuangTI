# 5395 — Operations Research & Large-Scale Optimization: A branch-and-cut algorithm for mixed integer bilevel linear optimization problems and its implementation

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A branch-and-cut algorithm for mixed integer bilevel linear optimization problems and its implementation  
**Jurnal & Sitasi Utama:** Sahar Tahernejad, Ted K. Ralphs, Scott T. DeNegre (2020). *Mathematical Programming Computation*. DOI: [10.1007/s12532-020-00183-6](10.1007/s12532-020-00183-6)  
**Sitasi Pendukung:** John E. Mitchell (2024). *Encyclopedia of Optimization*. DOI: [10.1007/978-3-030-54621-2_287-1](10.1007/978-3-030-54621-2_287-1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sahar Tahernejad, Ted K. Ralphs, Scott T. DeNegre (2020) dalam jurnal *Mathematical Programming Computation* (DOI: 10.1007/s12532-020-00183-6) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh John E. Mitchell (2024) yang dipublikasikan dalam *Encyclopedia of Optimization* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
