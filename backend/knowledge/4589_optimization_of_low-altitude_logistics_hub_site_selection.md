# 4589 — Operations Research & Large-Scale Optimization: Optimization of Low-Altitude Logistics Hub Site Selection and Capacity Allocation Based on Mixed Integer Linear Programming (MILP)

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimization of Low-Altitude Logistics Hub Site Selection and Capacity Allocation Based on Mixed Integer Linear Programming (MILP)  
**Jurnal & Sitasi Utama:** J. Song (2026). *Advanced Electromagnetics*. DOI: [10.7716/aem.v15i3.3891](10.7716/aem.v15i3.3891)  
**Sitasi Pendukung:** Lead Industrial Researchers (2021). *Advanced Optimization for Process Systems Engineering*. DOI: [10.1017/9781108917834.007](10.1017/9781108917834.007)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari J. Song (2026) dalam jurnal *Advanced Electromagnetics* (DOI: 10.7716/aem.v15i3.3891) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
