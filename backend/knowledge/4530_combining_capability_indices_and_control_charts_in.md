# 4530 — Quality Engineering & Reliability Systems: Combining Capability Indices and Control Charts in the Process and Analytical Method Control Strategy

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Combining Capability Indices and Control Charts in the Process and Analytical Method Control Strategy  
**Jurnal & Sitasi Utama:** Alexis Oliva, Matías Llabrés (2021). *Quality Control - Intelligent Manufacturing, Robust Design and Charts*. DOI: [10.5772/intechopen.91354](10.5772/intechopen.91354)  
**Sitasi Pendukung:** Hanhan Li, Cong Li (2023). *Statistical Methods in Medical Research*. DOI: [10.1177/09622802231206476](10.1177/09622802231206476)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Alexis Oliva, Matías Llabrés (2021) dalam jurnal *Quality Control - Intelligent Manufacturing, Robust Design and Charts* (DOI: 10.5772/intechopen.91354) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
