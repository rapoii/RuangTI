# 4443 — Manufacturing Systems & Cyber-Physical Production: Digital twin–driven optimization of manufacturing operations using real-time sensor data

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Digital twin–driven optimization of manufacturing operations using real-time sensor data  
**Jurnal & Sitasi Utama:** Amit Kumar JAIN (2026). *Materials Research Proceedings*. DOI: [10.21741/9781644904312-10](10.21741/9781644904312-10)  
**Sitasi Pendukung:** Y. F. Zhang, Y. Q. Shao, J. F. Wang (2020). *2020 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem45057.2020.9309928](10.1109/ieem45057.2020.9309928)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Amit Kumar JAIN (2026) dalam jurnal *Materials Research Proceedings* (DOI: 10.21741/9781644904312-10) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Y. F. Zhang, Y. Q. Shao, J. F. Wang (2020) yang dipublikasikan dalam *2020 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
