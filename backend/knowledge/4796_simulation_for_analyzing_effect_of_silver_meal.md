# 4796 — Production Planning & Inventory Control: Simulation for Analyzing Effect of Silver Meal Lot Sizing Rules in Bullwhip Effect

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Simulation for Analyzing Effect of Silver Meal Lot Sizing Rules in Bullwhip Effect  
**Jurnal & Sitasi Utama:** Liong Irena, I Gede Agus Widyadana (2023). *Lecture Notes in Networks and Systems*. DOI: [10.1007/978-3-031-50151-7_4](10.1007/978-3-031-50151-7_4)  
**Sitasi Pendukung:** Hermanto Hermanto (2022). *Jurnal Syntax Transformation*. DOI: [10.46799/jst.v3i3.539](10.46799/jst.v3i3.539)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Liong Irena, I Gede Agus Widyadana (2023) dalam jurnal *Lecture Notes in Networks and Systems* (DOI: 10.1007/978-3-031-50151-7_4) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Hermanto Hermanto (2022) yang dipublikasikan dalam *Jurnal Syntax Transformation* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
