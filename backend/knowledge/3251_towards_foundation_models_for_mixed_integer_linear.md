# 3251 — Operations Research & Large-Scale Optimization: Towards Foundation Models for Mixed Integer Linear Programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Towards Foundation Models for Mixed Integer Linear Programming  
**Jurnal & Sitasi Utama:** Sirui Li, Janardhan Kulkarni, Ishai Menache (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2410.08288](10.48550/arxiv.2410.08288)  
**Sitasi Pendukung:** Bizhao Pang, Kin Huat Low, Chen Lv (2022). *Transportation Research Part C Emerging Technologies*. DOI: [10.1016/j.trc.2022.103666](10.1016/j.trc.2022.103666)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sirui Li, Janardhan Kulkarni, Ishai Menache (2024) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2410.08288) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
