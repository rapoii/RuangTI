# 3883 — Industrial Artificial Intelligence & Data Analytics: A Physics-Informed Machine Learning Approach for Estimating Lithium-Ion Battery Temperature

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A Physics-Informed Machine Learning Approach for Estimating Lithium-Ion Battery Temperature  
**Jurnal & Sitasi Utama:** Gyouho Cho, Mengqi Wang, Youngki Kim (2022). *IEEE Access*. DOI: [10.1109/access.2022.3199652](10.1109/access.2022.3199652)  
**Sitasi Pendukung:** Can Wang, Qiqi Xiao, Zhikun Zhou (2024). *International journal of mechanical system dynamics*. DOI: [10.1002/msd2.12127](10.1002/msd2.12127)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Gyouho Cho, Mengqi Wang, Youngki Kim (2022) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2022.3199652) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Can Wang, Qiqi Xiao, Zhikun Zhou (2024) yang dipublikasikan dalam *International journal of mechanical system dynamics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
