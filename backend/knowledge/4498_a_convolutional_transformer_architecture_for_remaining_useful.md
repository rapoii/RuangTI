# 4498 — Maintenance Engineering & Asset Life Cycle: A Convolutional Transformer Architecture for Remaining Useful Life Estimation

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** A Convolutional Transformer Architecture for Remaining Useful Life Estimation  
**Jurnal & Sitasi Utama:** Yifei Ding, Minping Jia (2021). *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)*. DOI: [10.1109/phm-nanjing52125.2021.9612814](10.1109/phm-nanjing52125.2021.9612814)  
...
Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yifei Ding, Minping Jia (2021) dalam jurnal *2021 Global Reliability and Prognostics and Health Management (PHM-Nanjing)* (DOI: 10.1109/phm-nanjing52125.2021.9612814) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
