# 3387 — Quality Engineering & Reliability Systems: Severity-First Risk Prioritization for AI Poisoning in Edge-Integrated Internet of Vehicles

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Severity-First Risk Prioritization for AI Poisoning in Edge-Integrated Internet of Vehicles  
**Jurnal & Sitasi Utama:** Saif ul Islam, Mahender Kumar, Carsten Maple (2026). *Peer-Reviewed Academic Journal*. DOI: [10.1109/icce67443.2026.11449595](10.1109/icce67443.2026.11449595)  
**Sitasi Pendukung:** Florian Niekiel, Jana Marie Meyer, Hanna Lewitz (2023). *Sensors*. DOI: [10.3390/s23125549](10.3390/s23125549)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Saif ul Islam, Mahender Kumar, Carsten Maple (2026) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.1109/icce67443.2026.11449595) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The integration of artificial intelligence (AI) and edge computing in the Internet of vehicles (IoV) enables real-time perception and decision-making, but also introduces new cybersecurity risks. Among these, data poisoning attacks can compromise training pipelines, sensor inputs, and model updates, leading to hazardous system behavior. Traditional failure modes and effects analysis (FMEA) based on risk priority number may under-prioritize rare but severe adversarial failures. This paper presents a severity-first risk prioritization framework that applies action priority (AP) logic using structured severity-occurrence-detection (S-O-D) scoring. We map poisoning attack vectors to failure modes and operational consequences in edge-integrated IoV. We assign S-O-D scores adapted from AIAG-VDA FMEA Handbook, using expert judgment informed by standards and literature, and derive AP via rule-based, severity-dominant decision logic. Our findings show that most poisoning-related failure modes require high-priority action, emphasizing the need for severity-led prioritization in safety-critical edge-AI-enabled IoV. Mitigation measures are aligned with automotive cybersecurity standards and regulations for secure updates, vehicle-to-everything communication and edge-AI pipeline integrity, supporting practical deployment in vehicular edge environments."

Penelitian pendukung oleh Florian Niekiel, Jana Marie Meyer, Hanna Lewitz (2023) yang dipublikasikan dalam *Sensors* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
