# 3539 — Production Planning & Inventory Control: Decentralized learning multi-agent system for online machine shop scheduling problem

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Decentralized learning multi-agent system for online machine shop scheduling problem  
**Jurnal & Sitasi Utama:** Jeroen B.H.C. Didden, Quang-Vinh Dang, Ivo Adan (2023). *Journal of Manufacturing Systems*. DOI: [10.1016/j.jmsy.2023.02.004](10.1016/j.jmsy.2023.02.004)  
**Sitasi Pendukung:** Lingye Tan, Tiong Lee Kong, Ziyang Zhang (2023). *Sustainability*. DOI: [10.3390/su15097600](10.3390/su15097600)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jeroen B.H.C. Didden, Quang-Vinh Dang, Ivo Adan (2023) dalam jurnal *Journal of Manufacturing Systems* (DOI: 10.1016/j.jmsy.2023.02.004) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lingye Tan, Tiong Lee Kong, Ziyang Zhang (2023) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
