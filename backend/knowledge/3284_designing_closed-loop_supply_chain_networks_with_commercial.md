# 3284 — Supply Chain Management & Logistics Engineering: Designing Closed-Loop Supply Chain Networks with Commercial Returns

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Designing Closed-Loop Supply Chain Networks with Commercial Returns  
**Jurnal & Sitasi Utama:** Subramanian Pazhani (2021). *Design and Analysis of Closed-Loop Supply Chain Networks*. DOI: [10.1201/9781003083191-2](10.1201/9781003083191-2)  
**Sitasi Pendukung:** Wakhid Ahmad Jauhari, Devina Nur Affifah, Pringgo Widyo Laksono (2024). *Cleaner Logistics and Supply Chain*. DOI: [10.1016/j.clscn.2024.100168](10.1016/j.clscn.2024.100168)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Subramanian Pazhani (2021) dalam jurnal *Design and Analysis of Closed-Loop Supply Chain Networks* (DOI: 10.1201/9781003083191-2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wakhid Ahmad Jauhari, Devina Nur Affifah, Pringgo Widyo Laksono (2024) yang dipublikasikan dalam *Cleaner Logistics and Supply Chain* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
