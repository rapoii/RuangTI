# 4381 — Safety Engineering & Risk Management: Risk Assessment of the Intake of Cryptosporidium in Drinking Water Treatment Plant Using a Combination of Predictive Models and Event Tree and Fault Tree Techniques

**Domain:** Safety Engineering & Risk Management  
**Topik Spesifik:** Risk Assessment of the Intake of Cryptosporidium in Drinking Water Treatment Plant Using a Combination of Predictive Models and Event Tree and Fault Tree Techniques  
**Jurnal & Sitasi Utama:** Eva Doménech, Sebastian Martorell, Gilver Odilon Mendel Kombo Mpindou (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4028242](10.2139/ssrn.4028242)  
**Sitasi Pendukung:** Shravan Kumar Akula, Hossein Salehfar (2026). *Electronics*. DOI: [10.3390/electronics15020433](10.3390/electronics15020433)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Safety Engineering & Risk Management memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eva Doménech, Sebastian Martorell, Gilver Odilon Mendel Kombo Mpindou (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4028242) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Risk-informed decision making permits a more effective water safety management. In this framework, this article introduces the rationale and proposes a new approach to carry out a quantitative risk assessment along the water chain, from river source to tap water, by integrating predictive modelling and event tree and fault tree techniques. The model developed with this approach allows to account not only for normal but also for abnormal process conditions in the water treatment plant, as well as to assess the real impact of applied safety controls, such as turbidity control. A sensitivity study was conducted to determine the effect of considering a typical drinking water treatment plant (DWTP), i.e. coagulation, sedimentation and filtration with two turbidity controls, performed at intake and after filtration, on the risk of infection due to exposure to  Cryptosporidium  in tap water. The results showed that, with the current effectiveness of turbidity reduction in the DWTP, the first control did not minimise the annual risk of  Cryptosporidium  infection (3.6E-04) and only controlling turbidity after filtration to below 0.01NTU provided a clear reduction in risk (7.7E-05), but at the cost of the water reprocessed after the control being around 60%. The lowest risk was found when turbidity reduction was set at 4 logs (8.48E-06), but this would mean that the effectiveness of turbidity reduction should be greatly improved. Thus, it was concluded that consideration to supplement"

Penelitian pendukung oleh Shravan Kumar Akula, Hossein Salehfar (2026) yang dipublikasikan dalam *Electronics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
