# 5888 — Facilities Planning & Material Handling: FACILITY LAYOUT IMPROVEMENT FOR ENHANCING PRODUCTIVITY: AN APPLICATION OF SYSTEMATIC PLANT LAYOUT

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** FACILITY LAYOUT IMPROVEMENT FOR ENHANCING PRODUCTIVITY: AN APPLICATION OF SYSTEMATIC PLANT LAYOUT  
**Jurnal & Sitasi Utama:** Chacko Pearly Saira, Paul Gritty Maria, Hareesh N. Ramanathan (2019). *Vallis Aurea (Journal of Sustainable Development and Innovation)*. DOI: [10.2507/ijva.5.2.1.62](10.2507/ijva.5.2.1.62)  
**Sitasi Pendukung:** Shien Zhang (2018). *Chemical engineering transactions*. DOI: [10.3303/cet1866243](10.3303/cet1866243)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chacko Pearly Saira, Paul Gritty Maria, Hareesh N. Ramanathan (2019) dalam jurnal *Vallis Aurea (Journal of Sustainable Development and Innovation)* (DOI: 10.2507/ijva.5.2.1.62) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "One of the major prerequisites for effective operations of a manufacturing plant depends on the sufficiency of a good facility layout. A wellplanned facility layout enables better utilization of resources and thereby better production control. The purpose of this research was to analyse the effectiveness of the layout improvement through systematic plant layout planning (SLP) method. Factors like relationship diagram/affinity chart, material flow, space requirements etc. were studied to propose a modified layout according to the SLP method."

Penelitian pendukung oleh Shien Zhang (2018) yang dipublikasikan dalam *Chemical engineering transactions* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
