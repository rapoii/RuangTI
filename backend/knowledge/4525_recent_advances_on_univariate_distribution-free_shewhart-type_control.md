# 4525 — Quality Engineering & Reliability Systems: Recent Advances on Univariate Distribution-Free Shewhart-Type Control Charts

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Recent Advances on Univariate Distribution-Free Shewhart-Type Control Charts  
**Jurnal & Sitasi Utama:** Markos V. Koutras, Ioannis S. Triantafyllou (2020). *Distribution-Free Methods for Statistical Process Monitoring and Control*. DOI: [10.1007/978-3-030-25081-2_1](10.1007/978-3-030-25081-2_1)  
**Sitasi Pendukung:** Lead Industrial Researchers (2024). *Peer-Reviewed Journal*. DOI: [10.1002/cem.3642/v2/review2](10.1002/cem.3642/v2/review2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Markos V. Koutras, Ioannis S. Triantafyllou (2020) dalam jurnal *Distribution-Free Methods for Statistical Process Monitoring and Control* (DOI: 10.1007/978-3-030-25081-2_1) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Lead Industrial Researchers (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
