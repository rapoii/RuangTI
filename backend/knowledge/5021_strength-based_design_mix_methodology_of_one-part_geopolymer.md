# 5021 — Applied Statistics & Stochastic Modeling: Strength-based design mix methodology of one-part geopolymer concrete using response surface methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Strength-based design mix methodology of one-part geopolymer concrete using response surface methodology  
**Jurnal & Sitasi Utama:** Divya Sharma, Ran Bir Singh (2025). *Multiscale and Multidisciplinary Modeling, Experiments and Design*. DOI: [10.1007/s41939-024-00713-y](10.1007/s41939-024-00713-y)  
**Sitasi Pendukung:** Lead Industrial Researchers (2020). *Peer-Reviewed Journal*. DOI: [10.1002/cem.3246/v1/review1](10.1002/cem.3246/v1/review1)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Divya Sharma, Ran Bir Singh (2025) dalam jurnal *Multiscale and Multidisciplinary Modeling, Experiments and Design* (DOI: 10.1007/s41939-024-00713-y) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
