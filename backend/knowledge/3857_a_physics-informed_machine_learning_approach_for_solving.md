# 3857 — Industrial Artificial Intelligence & Data Analytics: A physics-informed machine learning approach for solving heat transfer equation in advanced manufacturing and engineering applications

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** A physics-informed machine learning approach for solving heat transfer equation in advanced manufacturing and engineering applications  
**Jurnal & Sitasi Utama:** Navid Zobeiry, Keith D. Humfeld (2021). *Engineering Applications of Artificial Intelligence*. DOI: [10.1016/j.engappai.2021.104232](10.1016/j.engappai.2021.104232)  
**Sitasi Pendukung:** Wenqian Chen, Qian Wang, Jan S. Hesthaven (2021). *Journal of Computational Physics*. DOI: [10.1016/j.jcp.2021.110666](10.1016/j.jcp.2021.110666)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Navid Zobeiry, Keith D. Humfeld (2021) dalam jurnal *Engineering Applications of Artificial Intelligence* (DOI: 10.1016/j.engappai.2021.104232) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wenqian Chen, Qian Wang, Jan S. Hesthaven (2021) yang dipublikasikan dalam *Journal of Computational Physics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
