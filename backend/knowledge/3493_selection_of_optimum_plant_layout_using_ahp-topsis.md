# 3493 — Facilities Planning & Material Handling: Selection of optimum plant layout using AHP-TOPSIS and WASPAS approaches coupled with Entropy method

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Selection of optimum plant layout using AHP-TOPSIS and WASPAS approaches coupled with Entropy method  
**Jurnal & Sitasi Utama:** Anand S. Shivade, Sagar U. Sapkal (2022). *Decision Science Letters*. DOI: [10.5267/j.dsl.2022.5.002](10.5267/j.dsl.2022.5.002)  
**Sitasi Pendukung:** Jasmine Pradnya, Mahesti Layla Nursea, Regita Easter Bernanda (2022). *Peer-Reviewed Academic Journal*. DOI: [10.46254/bd05.20220274](10.46254/bd05.20220274)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anand S. Shivade, Sagar U. Sapkal (2022) dalam jurnal *Decision Science Letters* (DOI: 10.5267/j.dsl.2022.5.002) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jasmine Pradnya, Mahesti Layla Nursea, Regita Easter Bernanda (2022) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
