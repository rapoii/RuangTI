# 5730 — Operations Research & Large-Scale Optimization: Chance constrained stochastic programming in design of a frame structure

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Chance constrained stochastic programming in design of a frame structure  
**Jurnal & Sitasi Utama:** Eva Mrázková (2026). *Stavební obzor - Civil Engineering Journal*. DOI: [10.14311/cej.2025.01.0001](10.14311/cej.2025.01.0001)  
**Sitasi Pendukung:** Nazli Demir, Ozlem Cavus, Ayse  Selin Kocaman (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.6468691](10.2139/ssrn.6468691)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eva Mrázková (2026) dalam jurnal *Stavební obzor - Civil Engineering Journal* (DOI: 10.14311/cej.2025.01.0001) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Received:                                 14.05.2024
Received in revised form:      17.12.2024
Accepted:                                19.03.2025"

Penelitian pendukung oleh Nazli Demir, Ozlem Cavus, Ayse  Selin Kocaman (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
