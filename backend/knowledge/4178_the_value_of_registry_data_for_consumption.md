# 4178 — Engineering Economics & Cost Optimization: The value of registry data for consumption analysis: An application to health shocks

**Domain:** Engineering Economics & Cost Optimization  
**Topik Spesifik:** The value of registry data for consumption analysis: An application to health shocks  
**Jurnal & Sitasi Utama:** Jonas Kolsrud, Camille Landais, Johannes Spinnewijn (2019). *Journal of Public Economics*. DOI: [10.1016/j.jpubeco.2019.104088](10.1016/j.jpubeco.2019.104088)  
...
Dalam lanskap operasional modern, disiplin Engineering Economics & Cost Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jonas Kolsrud, Camille Landais, Johannes Spinnewijn (2019) dalam jurnal *Journal of Public Economics* (DOI: 10.1016/j.jpubeco.2019.104088) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
