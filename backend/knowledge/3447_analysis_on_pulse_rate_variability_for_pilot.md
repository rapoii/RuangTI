# 3447 — Human Factors & Cognitive Ergonomics: Analysis on pulse rate variability for pilot workload assessment based on wearable sensor

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Analysis on pulse rate variability for pilot workload assessment based on wearable sensor  
**Jurnal & Sitasi Utama:** Yunbiao Wang, Chenyang Zhang, Chenglin Liu (2024). *Human Factors and Ergonomics in Manufacturing & Service Industries*. DOI: [10.1002/hfm.21053](10.1002/hfm.21053)  
**Sitasi Pendukung:** Sabrina Iarlori, David Perpetuini, Michele Tritto (2024). *BioMedInformatics*. DOI: [10.3390/biomedinformatics4020064](10.3390/biomedinformatics4020064)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yunbiao Wang, Chenyang Zhang, Chenglin Liu (2024) dalam jurnal *Human Factors and Ergonomics in Manufacturing & Service Industries* (DOI: 10.1002/hfm.21053) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
