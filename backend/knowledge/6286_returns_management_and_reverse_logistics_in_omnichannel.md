# 6286 — Supply Chain Management & Logistics Engineering: Returns Management and Reverse Logistics in Omnichannel Supply Chain: A Systematic Review and Future Research Agenda from a Closed Loop Supply Chain Perspective

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Returns Management and Reverse Logistics in Omnichannel Supply Chain: A Systematic Review and Future Research Agenda from a Closed Loop Supply Chain Perspective  
**Jurnal & Sitasi Utama:** Anukesh Valase, Arshinder Kaur (2026). *Uncertainty and Operations Research*. DOI: [10.1007/978-981-95-2429-7_4](10.1007/978-981-95-2429-7_4)  
**Sitasi Pendukung:** Jose M. Framinan (2022). *Modelling Supply Chain Dynamics*. DOI: [10.1007/978-3-030-79189-6_7](10.1007/978-3-030-79189-6_7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anukesh Valase, Arshinder Kaur (2026) dalam jurnal *Uncertainty and Operations Research* (DOI: 10.1007/978-981-95-2429-7_4) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jose M. Framinan (2022) yang dipublikasikan dalam *Modelling Supply Chain Dynamics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
