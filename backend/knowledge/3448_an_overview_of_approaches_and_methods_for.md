# 3448 — Human Factors & Cognitive Ergonomics: An Overview of Approaches and Methods for the Cognitive Workload Estimation in Human–Machine Interaction Scenarios through Wearables Sensors

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** An Overview of Approaches and Methods for the Cognitive Workload Estimation in Human–Machine Interaction Scenarios through Wearables Sensors  
**Jurnal & Sitasi Utama:** Sabrina Iarlori, David Perpetuini, Michele Tritto (2024). *BioMedInformatics*. DOI: [10.3390/biomedinformatics4020064](10.3390/biomedinformatics4020064)  
**Sitasi Pendukung:** Anaïs Pontiggia, Danielle Gomez-Mérino, Michaël Quiquempoix (2024). *Frontiers in Physiology*. DOI: [10.3389/fphys.2024.1408242](10.3389/fphys.2024.1408242)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sabrina Iarlori, David Perpetuini, Michele Tritto (2024) dalam jurnal *BioMedInformatics* (DOI: 10.3390/biomedinformatics4020064) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
