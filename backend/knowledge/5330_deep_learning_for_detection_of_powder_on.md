# 5330 — Industrial Artificial Intelligence & Data Analytics: Deep learning for detection of powder on complex surfaces using computer vision

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Deep learning for detection of powder on complex surfaces using computer vision  
**Jurnal & Sitasi Utama:** Ali Ghandour, Samanta Piano, Mohammed A. Isa (2023). *Automated Visual Inspection and Machine Vision V*. DOI: [10.1117/12.2673692](10.1117/12.2673692)  
**Sitasi Pendukung:** Shika Rao, Nitya Mitnala (2023). *Machine Graphics and Vision*. DOI: [10.22630/mgv.2023.32.1.2](10.22630/mgv.2023.32.1.2)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Ali Ghandour, Samanta Piano, Mohammed A. Isa (2023) dalam jurnal *Automated Visual Inspection and Machine Vision V* (DOI: 10.1117/12.2673692) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Shika Rao, Nitya Mitnala (2023) yang dipublikasikan dalam *Machine Graphics and Vision* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
