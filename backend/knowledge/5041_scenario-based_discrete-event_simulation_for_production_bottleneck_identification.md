# 5041 — Simulation Modeling & Digital Twins: Scenario-based discrete-event simulation for production bottleneck identification and capacity optimization in garment small and medium enterprises

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Scenario-based discrete-event simulation for production bottleneck identification and capacity optimization in garment small and medium enterprises  
**Jurnal & Sitasi Utama:** Dwi Adi Purnama, Zelania In Haryanto (2026). *Journal Industrial Servicess*. DOI: [10.62870/jiss.v12i1.35532](10.62870/jiss.v12i1.35532)  
**Sitasi Pendukung:** , Cansu Kandemir, Marco Franchino (2025). *12th Simulation Workshop (SW25) Proceedings*. DOI: [10.36819/sw25.031](10.36819/sw25.031)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Dwi Adi Purnama, Zelania In Haryanto (2026) dalam jurnal *Journal Industrial Servicess* (DOI: 10.62870/jiss.v12i1.35532) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh , Cansu Kandemir, Marco Franchino (2025) yang dipublikasikan dalam *12th Simulation Workshop (SW25) Proceedings* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
