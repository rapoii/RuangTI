# 5471 — Manufacturing Systems & Cyber-Physical Production: Modelling Agents in Industry 4.0 Applications Using Asset Administration Shell

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Modelling Agents in Industry 4.0 Applications Using Asset Administration Shell  
**Jurnal & Sitasi Utama:** Nikoletta Nikolova, Sjoerd Rongen (2023). *Proceedings of the 15th International Conference on Agents and Artificial Intelligence*. DOI: [10.5220/0011746100003393](10.5220/0011746100003393)  
**Sitasi Pendukung:** Mario Angos-Mediavilla, Michael Gorenzweig, Gerome Pahnke (2024). *Proceedings of the 26th International Conference on Enterprise Information Systems*. DOI: [10.5220/0012632900003690](10.5220/0012632900003690)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Nikoletta Nikolova, Sjoerd Rongen (2023) dalam jurnal *Proceedings of the 15th International Conference on Agents and Artificial Intelligence* (DOI: 10.5220/0011746100003393) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Mario Angos-Mediavilla, Michael Gorenzweig, Gerome Pahnke (2024) yang dipublikasikan dalam *Proceedings of the 26th International Conference on Enterprise Information Systems* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
