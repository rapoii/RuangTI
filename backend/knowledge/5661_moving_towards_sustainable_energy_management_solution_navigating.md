# 5661 — Industrial Energy Management & Decarbonization: Moving Towards Sustainable Energy Management Solution: Navigating the Readiness of Bangladesh to Implement ISO 50001

**Domain:** Industrial Energy Management & Decarbonization  
**Topik Spesifik:** Moving Towards Sustainable Energy Management Solution: Navigating the Readiness of Bangladesh to Implement ISO 50001  
**Jurnal & Sitasi Utama:** Faria Haque Pushpo, Kutub Uddin (2024). *Revista de Gestão Social e Ambiental*. DOI: [10.24857/rgsa.v18n10-118](10.24857/rgsa.v18n10-118)  
**Sitasi Pendukung:** Saleh Alotaibi, Hani Alogaili, Khaled Alawwad (2025). *Sustainability*. DOI: [10.3390/su17115131](10.3390/su17115131)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Energy Management & Decarbonization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Faria Haque Pushpo, Kutub Uddin (2024) dalam jurnal *Revista de Gestão Social e Ambiental* (DOI: 10.24857/rgsa.v18n10-118) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Objective: As global energy demands rise and climate concerns intensify, sustainable energy management has become crucial in today’s competitive economic landscape.  While Bangladesh has made significant progress in economic development, it faces significant challenges due to resource constraints and climate change. To sustain its economic momentum, Bangladesh must address these challenges through effective energy management and the adoption of sustainable practices.  ISO 50001 is a widely recognized and effective energy management tool crucial for sustainable growth and resilience. However, Bangladesh has not yet adopted this standard.  Given this situation, the study intends to assess the readiness of Bangladesh in implementing ISO 50001.
 
Theoretical Framework: The application of gap analysis and questionnaire survey of this study demonstrates a methodological approach to understand the initial readiness of Bangladesh towards ISO 50001. Complementarily, this framework contributes to a comprehensive understanding of improvement required for energy management to mitigate climate challenges within the region.
 
Method: It involves a gap analysis using a checklist-based questionnaire survey aligned with ISO 50001 requirements.
 
Results and Discussion: The results indicate that Bangladesh has significant potential to implement this energy management system, with an overall readiness score of 74%.  However, improvements are needed in Leadership, Support, and Performance Evalua"

Penelitian pendukung oleh Saleh Alotaibi, Hani Alogaili, Khaled Alawwad (2025) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
