# 4240 — Operations Research & Large-Scale Optimization: Optimal logistics planning for modular construction using two-stage stochastic programming

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Optimal logistics planning for modular construction using two-stage stochastic programming  
**Jurnal & Sitasi Utama:** Pei-Yuan Hsu, Panagiotis Angeloudis, Marco Aurisicchio (2018). *Automation in Construction*. DOI: [10.1016/j.autcon.2018.05.029](10.1016/j.autcon.2018.05.029)  
