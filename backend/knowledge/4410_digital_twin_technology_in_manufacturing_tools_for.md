# 4410 — Manufacturing Systems & Cyber-Physical Production: Digital Twin Technology in Manufacturing: Tools for Real-Time Process Optimization

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** Digital Twin Technology in Manufacturing: Tools for Real-Time Process Optimization  
**Jurnal & Sitasi Utama:** Murali Krishna Pasupuleti (2024). *Peer-Reviewed Journal*. DOI: [10.62311/nesx/rb978-81-979057-7-3](10.62311/nesx/rb978-81-979057-7-3)  
**Sitasi Pendukung:** Xiaolang Yang, Xuemei Liu, Heng Zhang (2023). *Robotics and Computer-Integrated Manufacturing*. DOI: [10.1016/j.rcim.2023.102595](10.1016/j.rcim.2023.102595)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Murali Krishna Pasupuleti (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.62311/nesx/rb978-81-979057-7-3) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract:
This research book advances a rigorous framework for designing, validating, and scaling digital twin (DT) systems that deliver real-time process optimization in modern manufacturing. We formalize a taxonomy—descriptive, predictive, and prescriptive twins—and show how fidelity, refresh rate, and decision latency jointly determine operational utility. The argument integrates measurement theory with edge–cloud analytics, hybrid physics–ML modelling, and closed-loop control, translating plant telemetry into auditable, reversible decisions on scheduling, quality, energy, and maintenance. A unifying “digital thread” links product–process–resource data with bitemporal lineage and policy-as-code, enabling traceable interventions that satisfy safety and regulatory standards. Methods include uncertainty quantification, conformal prediction, robust/economic MPC, and reinforcement learning under guardrails, all embedded in DevSecOps/SRE practices for lifecycle stewardship. Comparative case studies from discrete, process, and hybrid sectors across multiple regions demonstrate repeatable gains in throughput, first-pass yield, and specific energy while preserving worker agency and legal compliance. The result is a portfolio-ready blueprint that aligns technical excellence with CFO-credible value, green-finance eligibility, and workforce transformation.

Keywords: digital twin, real-time optimization, model-predictive control, hybrid physics–ML, edge computing, IIoT, uncertainty qu"

Penelitian pendukung oleh Xiaolang Yang, Xuemei Liu, Heng Zhang (2023) yang dipublikasikan dalam *Robotics and Computer-Integrated Manufacturing* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
