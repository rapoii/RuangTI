# 3701 — Simulation Modeling & Digital Twins: Bridging the gap: A review of simulation approaches in multipurpose Shipyard integrating shipbuilding, repair, and recycling

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Bridging the gap: A review of simulation approaches in multipurpose Shipyard integrating shipbuilding, repair, and recycling  
**Jurnal & Sitasi Utama:** Mohammad Sholikhan Arif, Sefer Anil Gunbeyaz, Rafet Emek Kurt (2026). *Ocean Engineering*. DOI: [10.1016/j.oceaneng.2026.124303](10.1016/j.oceaneng.2026.124303)  
...
Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohammad Sholikhan Arif, Sefer Anil Gunbeyaz, Rafet Emek Kurt (2026) dalam jurnal *Ocean Engineering* (DOI: 10.1016/j.oceaneng.2026.124303) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
