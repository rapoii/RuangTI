# 3484 — Facilities Planning & Material Handling: Layout and material flow planning of a shipyard

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Layout and material flow planning of a shipyard  
**Jurnal & Sitasi Utama:** Valeriia Shablykova (2020). *Theseus (Ammattikorkeakoulujen)*. DOI: [10.openalex/w3160558266](10.openalex/w3160558266)  
**Sitasi Pendukung:** Juni Fransisca Onggani Winata, Lulu Afifa, M N Setiawan (2024). *Peer-Reviewed Academic Journal*. DOI: [10.46254/an14.20240496](10.46254/an14.20240496)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Valeriia Shablykova (2020) dalam jurnal *Theseus (Ammattikorkeakoulujen)* (DOI: 10.openalex/w3160558266) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The focus of this thesis is on development of layout and material flow plan specifically for shipyard operations. It appears that the available literature on this topic is rather limited and is missing direct shipyard layout planning instructions. The need for this thesis project is caused by the reduction of land and premises of the case shipyard and the need for updated layout plan, which in perspective would also enhance the efficiency of intralogistics and sufficiently facilitate the shipbuilding process of planned projects. Since the changes in core facilities setting are not affecting the core production process, the development project tis focused on optimization of allocation of storage areas. \n \nThe study was conducted based applied action and quantitative research and is performed in three rounds of data gathering. First of all, the first set of data was gathered during the current state analysis and examined the weak and strong points of logistics processes, current layout and material flow routing. Most importantly, the current state analysis included gathering of planned production data for further layout planning purposes, as the conceptual framework was built based on the type of available data. \n \nThe theoretical part of this thesis studies the existing practices of shipyard layout planning and material flow optimization in combination with similar practices in heavy industry, which are possible to be applied to highly constrained and regulated environment"

Penelitian pendukung oleh Juni Fransisca Onggani Winata, Lulu Afifa, M N Setiawan (2024) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
