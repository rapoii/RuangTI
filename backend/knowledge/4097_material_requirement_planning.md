# 4097 — Production Planning & Inventory Control: Material Requirement Planning

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Material Requirement Planning  
**Jurnal & Sitasi Utama:** Susmita Bandyopadhyay (2019). *Peer-Reviewed Academic Journal*. DOI: [10.1201/9781351113670-9](10.1201/9781351113670-9)  
**Sitasi Pendukung:** Norman Sadeh, David W. Hildum, Dag Kjenstad (2018). *Peer-Reviewed Academic Journal*. DOI: [10.1184/r1/6623357](10.1184/r1/6623357)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Susmita Bandyopadhyay (2019) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.1201/9781351113670-9) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This chapter is dedicated to material requirement planning (MRP). As the name indicates, MRP determines the requirements of materials during different periods of time. Along with defining various inputs of MRP, the method of MRP has also been discussed here. Different types of Bill-of-Material (BOM) as discussed in this chapter are manufacturing BOM, engineering BOM, service BOM, sales BOM, assembly BOM, production BOM, configurable BOM, maintenance BOM. Besides, the other varieties of BOM as discussed in this chapter are single-level BOM, multilevel BOM, summarized BOM, generic BOM. Various lot-sizing techniques discussed are—fixed order quantity, economic order quantity, lot-for-lot, periods of supply, period order quantity, least unit cost, least total cost, part period rule, Groff rule, and Silver-Meal rule. The other basic inputs of MRP are demand and master production schedule. In addition to the description of the basic MRP, various other MRP aspects have also been discussed in this chapter such as, cover time planning, line requirement planning, continuous MRP, stochastic and fuzzy MRP, and Manufacturing Resource Planning (MRP-II)."

Penelitian pendukung oleh Norman Sadeh, David W. Hildum, Dag Kjenstad (2018) yang dipublikasikan dalam *Peer-Reviewed Academic Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
