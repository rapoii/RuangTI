# 4215 — Applied Statistics & Stochastic Modeling: Designing the design of experiments (DOE) – An investigation on the influence of different factorial designs on the characterization of complex systems

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Designing the design of experiments (DOE) – An investigation on the influence of different factorial designs on the characterization of complex systems  
**Jurnal & Sitasi Utama:** A. Janković, Gaurav Chaudhary, Francesco Goia (2021). *Energy and Buildings*. DOI: [10.1016/j.enbuild.2021.111298](10.1016/j.enbuild.2021.111298)  
**Sitasi Pendukung:** A. Janković, Gaurav Chaudhary, Francesco Goia (2021). *Energy and Buildings*. DOI: [10.1016/j.enbuild.2021.111298](10.1016/j.enbuild.2021.111298)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari A. Janković, Gaurav Chaudhary, Francesco Goia (2021) dalam jurnal *Energy and Buildings* (DOI: 10.1016/j.enbuild.2021.111298) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
