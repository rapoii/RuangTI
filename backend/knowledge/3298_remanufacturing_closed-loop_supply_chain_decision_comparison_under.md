# 3298 — Supply Chain Management & Logistics Engineering: Remanufacturing closed-loop supply chain decision comparison under multiple carbon policies

**Domain:** Supply Chain Management & Logistics Engineering  
**Topik Spesifik:** Remanufacturing closed-loop supply chain decision comparison under multiple carbon policies  
**Jurnal & Sitasi Utama:** Yangang Feng, Xuemeng Li (2024). *Applied Mathematics and Nonlinear Sciences*. DOI: [10.2478/amns-2024-1052](10.2478/amns-2024-1052)  
**Sitasi Pendukung:** Ilkka Ritola, Harold Krikke, Marjolein Caniëls (2020). *Logistics*. DOI: [10.3390/logistics4020007](10.3390/logistics4020007)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Supply Chain Management & Logistics Engineering memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yangang Feng, Xuemeng Li (2024) dalam jurnal *Applied Mathematics and Nonlinear Sciences* (DOI: 10.2478/amns-2024-1052) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Abstract
                  This article constructs a closed-loop supply chain system including a single manufacturer and a single retailer and studies the optimal decision problem of enterprises under three different carbon reduction policies. Three supply chain game models were constructed to research the impact of different carbon reduction policies on the decisions of supply chain members. The results revealed that:(1) The carbon emission reduction level of the manufacturer is negatively correlated with the recycling price of used products and the abatement cost factor;(2) When the carbon trading price is equal to the tax rate, the carbon cap and trade policy is more conducive to promoting the manufacturer to improve the level of carbon emission reduction;(3) When the carbon trading price is low, mixed carbon policy is more favorable for the manufacturer to increase its carbon emission reduction. The research results of this study can provide certain suggestions for the government to implement a reasonable carbon reduction policy."

Penelitian pendukung oleh Ilkka Ritola, Harold Krikke, Marjolein Caniëls (2020) yang dipublikasikan dalam *Logistics* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
