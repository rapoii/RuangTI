# 5020 — Applied Statistics & Stochastic Modeling: OPTIMIZATION OF YELLOW OLEANDER BIODIESEL PRODUCTION PARAMETERS USING CENTRAL COMPOSITE DESIGN RESPONSE SURFACE METHODOLOGY

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** OPTIMIZATION OF YELLOW OLEANDER BIODIESEL PRODUCTION PARAMETERS USING CENTRAL COMPOSITE DESIGN RESPONSE SURFACE METHODOLOGY  
**Jurnal & Sitasi Utama:** , Abdullahi Madu YAMI (2024). *European Journal of Materials Science and Engineering*. DOI: [10.36868/ejmse.2024.09.02.135](10.36868/ejmse.2024.09.02.135)  
**Sitasi Pendukung:** Divya Sharma, Ran Bir Singh (2025). *Multiscale and Multidisciplinary Modeling, Experiments and Design*. DOI: [10.1007/s41939-024-00713-y](10.1007/s41939-024-00713-y)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari , Abdullahi Madu YAMI (2024) dalam jurnal *European Journal of Materials Science and Engineering* (DOI: 10.36868/ejmse.2024.09.02.135) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Divya Sharma, Ran Bir Singh (2025) yang dipublikasikan dalam *Multiscale and Multidisciplinary Modeling, Experiments and Design* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
