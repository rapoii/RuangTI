# 4982 — Applied Statistics & Stochastic Modeling: Optimization of Extraction of Polyphenol from <i>Panax Quinquefolius L</i>. Using Central Composite Design/Response Surface Methodology

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Optimization of Extraction of Polyphenol from <i>Panax Quinquefolius L</i>. Using Central Composite Design/Response Surface Methodology  
**Jurnal & Sitasi Utama:** Suying Zhu (2021). *Starch - Stärke*. DOI: [10.1002/star.202100020](10.1002/star.202100020)  
**Sitasi Pendukung:** Andrzej Czyrski, Hubert Jarzębski (2020). *Processes*. DOI: [10.3390/pr8040473](10.3390/pr8040473)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Suying Zhu (2021) dalam jurnal *Starch - Stärke* (DOI: 10.1002/star.202100020) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
