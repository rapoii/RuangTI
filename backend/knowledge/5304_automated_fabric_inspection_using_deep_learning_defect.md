# 5304 — Industrial Artificial Intelligence & Data Analytics: Automated fabric inspection using deep learning defect detection and removal in textile industries

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Automated fabric inspection using deep learning defect detection and removal in textile industries  
**Jurnal & Sitasi Utama:** Viacheslav Voronin, Roman Sizyakin, Evgeny A. Semenishchev (2023). *Automated Visual Inspection and Machine Vision V*. DOI: [10.1117/12.2678116](10.1117/12.2678116)  
**Sitasi Pendukung:** Xuejing Chen, Sira Yongchareon, Martin Knoche (2023). *Journal of Smart Cities and Society*. DOI: [10.3233/scs-230001](10.3233/scs-230001)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Viacheslav Voronin, Roman Sizyakin, Evgeny A. Semenishchev (2023) dalam jurnal *Automated Visual Inspection and Machine Vision V* (DOI: 10.1117/12.2678116) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
