# 4693 — Facilities Planning & Material Handling: Bi-objective operation optimization in multi-shuttle automated storage and retrieval systems to reduce travel time and energy consumption

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Bi-objective operation optimization in multi-shuttle automated storage and retrieval systems to reduce travel time and energy consumption  
**Jurnal & Sitasi Utama:** Peng Yang, Peiran Tao, Ping Xu (2023). *Engineering Optimization*. DOI: [10.1080/0305215x.2022.2096881](10.1080/0305215x.2022.2096881)  
**Sitasi Pendukung:** Andrea Ferrari, Canan Gunes Corlu (2024). *2024 Winter Simulation Conference (WSC)*. DOI: [10.1109/wsc63780.2024.10838838](10.1109/wsc63780.2024.10838838)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Peng Yang, Peiran Tao, Ping Xu (2023) dalam jurnal *Engineering Optimization* (DOI: 10.1080/0305215x.2022.2096881) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Andrea Ferrari, Canan Gunes Corlu (2024) yang dipublikasikan dalam *2024 Winter Simulation Conference (WSC)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
