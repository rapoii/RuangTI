# 3364 — Quality Engineering & Reliability Systems: Determining the quality control frequency of an MR‐linac using risk matrix (RM) analysis

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Determining the quality control frequency of an MR‐linac using risk matrix (RM) analysis  
**Jurnal & Sitasi Utama:** Min Ma, Hui Yan, Minghui Li (2023). *Journal of Applied Clinical Medical Physics*. DOI: [10.1002/acm2.13984](10.1002/acm2.13984)  
**Sitasi Pendukung:** Shalaleh Rismani, Renee Shelby, Andrew Smart (2023). *Peer-Reviewed Academic Journal*. DOI: [10.1145/3600211.3604685](10.1145/3600211.3604685)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Min Ma, Hui Yan, Minghui Li (2023) dalam jurnal *Journal of Applied Clinical Medical Physics* (DOI: 10.1002/acm2.13984) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
