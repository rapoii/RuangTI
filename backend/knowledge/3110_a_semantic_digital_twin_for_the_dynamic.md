# 3110 — Manufacturing Systems & Cyber-Physical Production: A Semantic Digital Twin for the Dynamic Scheduling of Industry 4.0-based Production of Precast Concrete Elements

**Domain:** Manufacturing Systems & Cyber-Physical Production  
**Topik Spesifik:** A Semantic Digital Twin for the Dynamic Scheduling of Industry 4.0-based Production of Precast Concrete Elements  
**Jurnal & Sitasi Utama:** Simon Kosse, Vincent Betker, Philipp Hagedorn (2024). *Advanced Engineering Informatics*. DOI: [10.1016/j.aei.2024.102677](10.1016/j.aei.2024.102677)  
**Sitasi Pendukung:** Shengjing Sun, Xiaochen Zheng, Javier Villalba-Díez (2020). *Sensors*. DOI: [10.3390/s20113046](10.3390/s20113046)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Manufacturing Systems & Cyber-Physical Production memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Simon Kosse, Vincent Betker, Philipp Hagedorn (2024) dalam jurnal *Advanced Engineering Informatics* (DOI: 10.1016/j.aei.2024.102677) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
