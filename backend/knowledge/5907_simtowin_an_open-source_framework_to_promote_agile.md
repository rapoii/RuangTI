# 5907 — Simulation Modeling & Digital Twins: Simtowin: an open-source framework to promote agile modelling and interoperability

**Domain:** Simulation Modeling & Digital Twins  
**Topik Spesifik:** Simtowin: an open-source framework to promote agile modelling and interoperability  
**Jurnal & Sitasi Utama:** D.S. Borges, Luis M. S. Dias, Ricardo J. Machado (2026). *Peer-Reviewed Academic Journal*. DOI: [10.7148/2026-0561](10.7148/2026-0561)  
**Sitasi Pendukung:** Antonio Grieco, Pierpaolo Caricato, Paolo Margiotta (2025). *Algorithms*. DOI: [10.3390/a18060340](10.3390/a18060340)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Simulation Modeling & Digital Twins memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari D.S. Borges, Luis M. S. Dias, Ricardo J. Machado (2026) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.7148/2026-0561) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Simulation is a technique which has been widely used to analyse and optimize complex systems. Yet high licensing costs often limit its adoption, especially among Small and Medium Enterprises (SMEs) and academic institutions. This paper presents SimToWin, an open-source discrete-event simulation (DES) framework, which combines SimPy library robustness, with a React graphical user interface. Users can model and run simulations through a drag-and-drop interface, without programming skills; while maintaining model transparency, flexibility, and cost-effectiveness. This is a relevant aspect as many simulation practitioners are typically not programmers, e.g., an industrial engineer elaborating the production planning and scheduling, or a chief medical assessing different work schedule solutions. SimToWin supports stochastic variables, experiment replication, real-time monitoring, and flexible data import and export. Metrics and logs allow model performance measurements, which allow model verification and validation, and ultimately unlock informed decision-making. Future work will explore parameter configuration, integration with ERP and MES systems, the use of machine learning to automate scenario generation, and 3D visualization and animation. SimToWin provides a practical, scalable solution for process optimization, operational planning, and informed decision making on several domains."

Penelitian pendukung oleh Antonio Grieco, Pierpaolo Caricato, Paolo Margiotta (2025) yang dipublikasikan dalam *Algorithms* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
