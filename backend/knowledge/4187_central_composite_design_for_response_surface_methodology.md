# 4187 — Applied Statistics & Stochastic Modeling: Central Composite Design for Response Surface Methodology and Its Application in Pharmacy

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Central Composite Design for Response Surface Methodology and Its Application in Pharmacy  
**Jurnal & Sitasi Utama:** Sankha Bhattacharya (2021). *IntechOpen eBooks*. DOI: [10.5772/intechopen.95835](10.5772/intechopen.95835)  
**Sitasi Pendukung:** Jonas Bayuo, Moses Abdullai Abukari, Kenneth Bayetimani Pelig-Ba (2020). *Applied Water Science*. DOI: [10.1007/s13201-020-01213-3](10.1007/s13201-020-01213-3)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Sankha Bhattacharya (2021) dalam jurnal *IntechOpen eBooks* (DOI: 10.5772/intechopen.95835) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Jonas Bayuo, Moses Abdullai Abukari, Kenneth Bayetimani Pelig-Ba (2020) yang dipublikasikan dalam *Applied Water Science* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
