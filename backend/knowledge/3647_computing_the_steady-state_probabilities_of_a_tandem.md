# 3647 — Applied Statistics & Stochastic Modeling: Computing the steady-state probabilities of a tandem queueing system, a Machine Learning approach

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Computing the steady-state probabilities of a tandem queueing system, a Machine Learning approach  
**Jurnal & Sitasi Utama:** Eliran Sherzer (2024). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2411.07599](10.48550/arxiv.2411.07599)  
**Sitasi Pendukung:** Fotios Petropoulos, Laporte, Gilbert, Emel Aktaş (2023). *arXiv (Cornell University)*. DOI: [10.48550/arxiv.2303.14217](10.48550/arxiv.2303.14217)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Eliran Sherzer (2024) dalam jurnal *arXiv (Cornell University)* (DOI: 10.48550/arxiv.2411.07599) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Fotios Petropoulos, Laporte, Gilbert, Emel Aktaş (2023) yang dipublikasikan dalam *arXiv (Cornell University)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
