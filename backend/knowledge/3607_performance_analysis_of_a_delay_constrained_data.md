# 3607 — Applied Statistics & Stochastic Modeling: Performance Analysis of a Delay Constrained Data Offloading Scheme in an Integrated Cloud-Fog-Edge Computing System

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Performance Analysis of a Delay Constrained Data Offloading Scheme in an Integrated Cloud-Fog-Edge Computing System  
**Jurnal & Sitasi Utama:** Romano Fantacci, Benedetta Picano (2020). *IEEE Transactions on Vehicular Technology*. DOI: [10.1109/tvt.2020.3008926](10.1109/tvt.2020.3008926)  
**Sitasi Pendukung:** Rob Shone, K. D. Glazebrook, Konstantinos G. Zografos (2020). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2020.10.039](10.1016/j.ejor.2020.10.039)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Romano Fantacci, Benedetta Picano (2020) dalam jurnal *IEEE Transactions on Vehicular Technology* (DOI: 10.1109/tvt.2020.3008926) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
