# 4179 — Applied Statistics & Stochastic Modeling: Identification of bottlenecks and optimization of throughput for manufacturing serial lines with limited buffers

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Identification of bottlenecks and optimization of throughput for manufacturing serial lines with limited buffers  
**Jurnal & Sitasi Utama:** Roque Calvo Iranzo (2026). *Archivo Digital UPM (Universidad Politécnica de Madrid)*. DOI: [10.openalex/w7163621385](10.openalex/w7163621385)  
**Sitasi Pendukung:** R. Kurnia, E. van Groesen (2021). *University of Twente Research Information*. DOI: [10.openalex/w7135744816](10.openalex/w7135744816)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Roque Calvo Iranzo (2026) dalam jurnal *Archivo Digital UPM (Universidad Politécnica de Madrid)* (DOI: 10.openalex/w7163621385) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
