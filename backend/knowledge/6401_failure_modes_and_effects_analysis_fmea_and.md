# 6401 — Quality Engineering & Reliability Systems: Failure modes and effects analysis (FMEA) and failure modes, effects and criticality analysis (FMECA)

**Domain:** Quality Engineering & Reliability Systems  
**Topik Spesifik:** Failure modes and effects analysis (FMEA) and failure modes, effects and criticality analysis (FMECA)  
**Jurnal & Sitasi Utama:** Frank Crawley (2020). *A Guide to Hazard Identification Methods*. DOI: [10.1016/b978-0-12-819543-7.00012-4](10.1016/b978-0-12-819543-7.00012-4)  
**Sitasi Pendukung:** Achmad Luqman Hakim, Wiwin Widiasih (2025). *PROZIMA (Productivity, Optimization and Manufacturing System Engineering)*. DOI: [10.21070/prozima.v9i2.1761](10.21070/prozima.v9i2.1761)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Quality Engineering & Reliability Systems memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Frank Crawley (2020) dalam jurnal *A Guide to Hazard Identification Methods* (DOI: 10.1016/b978-0-12-819543-7.00012-4) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
