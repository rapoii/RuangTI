# 3232 — Operations Research & Large-Scale Optimization: Branch-Price-and-Cut algorithms for the team orienteering problem with interval-varying profits

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Branch-Price-and-Cut algorithms for the team orienteering problem with interval-varying profits  
**Jurnal & Sitasi Utama:** Jiaojiao Li, Jianghan Zhu, Guansheng Peng (2024). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2024.07.015](10.1016/j.ejor.2024.07.015)  
**Sitasi Pendukung:** Qi Chen, Emma S. Johnson, David E. Bernal (2021). *Optimization and Engineering*. DOI: [10.1007/s11081-021-09601-7](10.1007/s11081-021-09601-7)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Jiaojiao Li, Jianghan Zhu, Guansheng Peng (2024) dalam jurnal *European Journal of Operational Research* (DOI: 10.1016/j.ejor.2024.07.015) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Qi Chen, Emma S. Johnson, David E. Bernal (2021) yang dipublikasikan dalam *Optimization and Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
