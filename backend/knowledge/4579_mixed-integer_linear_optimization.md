# 4579 — Operations Research & Large-Scale Optimization: Mixed-Integer Linear Optimization

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** Mixed-Integer Linear Optimization  
**Jurnal & Sitasi Utama:** Lead Industrial Researchers (2025). *Hands-On Mathematical Optimization with Python*. DOI: [10.1017/9781009493512.004](10.1017/9781009493512.004)  
**Sitasi Pendukung:** R. Matai, S.P. Singh (2021). *2021 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)*. DOI: [10.1109/ieem50564.2021.9673000](10.1109/ieem50564.2021.9673000)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Lead Industrial Researchers (2025) dalam jurnal *Hands-On Mathematical Optimization with Python* (DOI: 10.1017/9781009493512.004) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh R. Matai, S.P. Singh (2021) yang dipublikasikan dalam *2021 IEEE International Conference on Industrial Engineering and Engineering Management (IEEM)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
