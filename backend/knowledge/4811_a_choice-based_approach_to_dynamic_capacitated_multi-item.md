# 4811 — Production Planning & Inventory Control: A choice-based approach to dynamic capacitated multi-item lot sizing with demand uncertainty

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** A choice-based approach to dynamic capacitated multi-item lot sizing with demand uncertainty  
**Jurnal & Sitasi Utama:** Fabian Dunke, Stefan Nickel (2025). *Applied Mathematical Modelling*. DOI: [10.1016/j.apm.2024.115705](10.1016/j.apm.2024.115705)  
**Sitasi Pendukung:** Fuying Jing, Xiangrui Chao (2022). *Omega*. DOI: [10.1016/j.omega.2022.102613](10.1016/j.omega.2022.102613)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Fabian Dunke, Stefan Nickel (2025) dalam jurnal *Applied Mathematical Modelling* (DOI: 10.1016/j.apm.2024.115705) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Fuying Jing, Xiangrui Chao (2022) yang dipublikasikan dalam *Omega* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
