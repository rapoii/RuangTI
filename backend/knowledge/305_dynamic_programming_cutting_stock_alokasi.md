# Modul Komprehensif: Dynamic Programming untuk Cutting Stock Problem & Alokasi Modal
**Nomor Modul:** [305]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *Dynamic Programming and Optimal Control (Dimitri P. Bertsekas), Management Science (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Dynamic Programming untuk Cutting Stock Problem & Alokasi Modal**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Prinsip Optimalitas Bellman, Sub-masalah Knapsack 1D Gilmore-Gomory Column Generation, Unbounded DP Recursion, Capital Budgeting Allocation.
...
```python
# Algoritma Solusi Terapan untuk Dynamic Programming untuk Cutting Stock Problem & Alokasi Modal
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Reduksi Trim Loss Scrap Industri Karton Box (Pemangkasan limbah dari 8.7% ke 2.1%).
...
1. Dynamic Programming and Optimal Control (Dimitri P. Bertsekas), Management Science (2024).
