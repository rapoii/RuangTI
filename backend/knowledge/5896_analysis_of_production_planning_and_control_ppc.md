# 5896 — Production Planning & Inventory Control: Analysis of production planning and control (PPC) through the approach of systems thinking

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Analysis of production planning and control (PPC) through the approach of systems thinking  
**Jurnal & Sitasi Utama:** Rafael Maciel Silva, Lenita Pacheco Lemos Duarte, Macáliston Gonçalves Da Silva (2019). *Brazilian Journal of Development*. DOI: [10.34117/bjdv5n11-107](10.34117/bjdv5n11-107)  
**Sitasi Pendukung:** Yassine El Khayyam, Brahim Herrou (2018). *International Journal of Online and Biomedical Engineering (iJOE)*. DOI: [10.3991/ijoe.v14i12.9068](10.3991/ijoe.v14i12.9068)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Rafael Maciel Silva, Lenita Pacheco Lemos Duarte, Macáliston Gonçalves Da Silva (2019) dalam jurnal *Brazilian Journal of Development* (DOI: 10.34117/bjdv5n11-107) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "This study aims to examine the positioning of the activities of Production Planning and Control (PPC) under the paradigm of systems thinking. The research is carried out in a metalworking midsize company, where it was sought to apply the systems thinking to assist in understanding the interactions and activities developed in the PPC system of the company object of study. For this reason, the aspects of influence on the local PPC decisions were detailed in a systemic way, analyzed the strategic positioning and responsibilities of the system of PPC researched and reviewed its structure of decisions and activities performed. From a future designed state, contemplating a framework of suggested actions, the results with this approach point to a better understanding of the company regarding its processes involved in the PPC activities, fundamental to organizational learning and improvement in decision-making."

Penelitian pendukung oleh Yassine El Khayyam, Brahim Herrou (2018) yang dipublikasikan dalam *International Journal of Online and Biomedical Engineering (iJOE)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
