# 4647 — Human Factors & Cognitive Ergonomics: Comparison of Rubber Tapping Methods for Ergonomic Assessment of Work-Related Musculoskeletal Disorders (WMSDs)

**Domain:** Human Factors & Cognitive Ergonomics  
**Topik Spesifik:** Comparison of Rubber Tapping Methods for Ergonomic Assessment of Work-Related Musculoskeletal Disorders (WMSDs)  
**Jurnal & Sitasi Utama:** Regi Kumar V, Dr. P. Jyothi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4515744](10.2139/ssrn.4515744)  
**Sitasi Pendukung:** Regi Kumar V, Dr. P. Jyothi (2024). *Peer-Reviewed Journal*. DOI: [10.2139/ssrn.4515744](10.2139/ssrn.4515744)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Human Factors & Cognitive Ergonomics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Regi Kumar V, Dr. P. Jyothi (2024) dalam jurnal *Peer-Reviewed Journal* (DOI: 10.2139/ssrn.4515744) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The rubber tappers experience various types of WMSDs due to the involvement of awkward postures and repetitive movements in the various stages of tapping process. The preliminary research on the rubber tapping indicated about the different types of methods in terms of different tapping tools used for tapping in Kerala. Papers that compare the different methods with reference to ergonomic assessment of are not available. A study to compare the prevalence of WMSDs in different methods was taken up in this context.&lt;br&gt;&lt;br&gt;The major objectives of the analysis are to identify the prevalence of various WMSDs and other ergonomic risks among the rubber tappers in the State of Kerala and to compare the different methods with reference to ergonomic assessment of WMSDs with focus on the existing procedures, postures and tools. The required data for the study was collected through a pre-defined questionnaire and direct observations of the tapping process with video recordings from an appropriate sample size of rubber tappers in Kerala.&lt;br&gt;&lt;br&gt;Statistical analysis was done using descriptive statistical tools. Rapid Upper Limb Assessment (RULA) tool was used for the ergonomic analysis. More than sixty percent of the respondents reported prevalence of WMSDs and shoulder is the body part affected by WMSDs as reported by 52 percent of the tappers surveyed. Knees, neck and wrists are the other body parts affected by WMSDs as reported by a significant percent of responde"

Penelitian pendukung oleh Regi Kumar V, Dr. P. Jyothi (2024) yang dipublikasikan dalam *Peer-Reviewed Journal* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
