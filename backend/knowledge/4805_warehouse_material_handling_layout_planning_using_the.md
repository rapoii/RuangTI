# 4805 — Facilities Planning & Material Handling: Warehouse material handling layout planning using the activity relationship chart method and blocplan 90

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Warehouse material handling layout planning using the activity relationship chart method and blocplan 90  
**Jurnal & Sitasi Utama:** Syahreen Nurmutia (2024). *TEKNOSAINS : Jurnal Sains, Teknologi dan Informatika*. DOI: [10.37373/tekno.v11i2.1138](10.37373/tekno.v11i2.1138)  
**Sitasi Pendukung:** Xiaowen Wang, Bei Wang (2020). *ICTE 2019*. DOI: [10.1061/9780784482742.013](10.1061/9780784482742.013)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Syahreen Nurmutia (2024) dalam jurnal *TEKNOSAINS : Jurnal Sains, Teknologi dan Informatika* (DOI: 10.37373/tekno.v11i2.1138) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
