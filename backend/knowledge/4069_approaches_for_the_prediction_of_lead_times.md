# 4069 — Production Planning & Inventory Control: Approaches for the Prediction of Lead Times in an Engineer to Order Environment—A Systematic Review

**Domain:** Production Planning & Inventory Control  
**Topik Spesifik:** Approaches for the Prediction of Lead Times in an Engineer to Order Environment—A Systematic Review  
**Jurnal & Sitasi Utama:** Peter Burggräf, Johannes Wagner, Benjamin Koke (2020). *IEEE Access*. DOI: [10.1109/access.2020.3010050](10.1109/access.2020.3010050)  
**Sitasi Pendukung:** Beatriz Andrés, Raúl Poler, Raquel Sanchís (2021). *Computers in Industry*. DOI: [10.1016/j.compind.2021.103398](10.1016/j.compind.2021.103398)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Production Planning & Inventory Control memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Peter Burggräf, Johannes Wagner, Benjamin Koke (2020) dalam jurnal *IEEE Access* (DOI: 10.1109/access.2020.3010050) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
