# 4478 — Maintenance Engineering & Asset Life Cycle: Estimating remaining useful life for lithium-ion batteries using kalman filter banks

**Domain:** Maintenance Engineering & Asset Life Cycle  
**Topik Spesifik:** Estimating remaining useful life for lithium-ion batteries using kalman filter banks  
**Jurnal & Sitasi Utama:** Yiming BIAN, Ning LI (2020). *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)*. DOI: [10.1109/icphm49022.2020.9187030](10.1109/icphm49022.2020.9187030)  
**Sitasi Pendukung:** Wei Wang, Zhiqiang Cai, Han Wang (2025). *2025 Global Reliability and Prognostics and Health Management Conference (PHM-Xian)*. DOI: [10.1109/phm-xian66756.2025.11427830](10.1109/phm-xian66756.2025.11427830)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Maintenance Engineering & Asset Life Cycle memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Yiming BIAN, Ning LI (2020) dalam jurnal *2020 IEEE International Conference on Prognostics and Health Management (ICPHM)* (DOI: 10.1109/icphm49022.2020.9187030) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Wei Wang, Zhiqiang Cai, Han Wang (2025) yang dipublikasikan dalam *2025 Global Reliability and Prognostics and Health Management Conference (PHM-Xian)* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
