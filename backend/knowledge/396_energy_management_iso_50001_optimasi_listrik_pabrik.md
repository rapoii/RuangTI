# Modul Komprehensif: Energy Management Systems (ISO 50001) & Optimasi Konsumsi Listrik Lantai Produksi
**Nomor Modul:** [396]  
**Domain Keahlian:** Rekayasa Sistem & Teknik Industri Terpadu (Industrial & Systems Engineering)  
**Sumber Referensi:** *ISO 50001:2018 Energy Management Systems - Requirements, Applied Energy (2024)*.

---

## 1. Landasan Teori & Tinjauan Konseptual
Modul ini menyajikan pendekatan fundamental dan metodologi tingkat lanjut dalam domain **Energy Management Systems (ISO 50001) & Optimasi Konsumsi Listrik Lantai Produksi**. Di era transformasi industri kontemporer (Industry 4.0 & Society 5.0), integrasi antara pemodelan matematis, otomasi komputasi, dan optimasi proses menjadi pilar utama peningkatan produktivitas, efisiensi sumber daya, dan ketahanan operasional (*operational resilience*).

### Pokok Bahasan & Prinsip Utama:
- **Cakupan Inti**: Energy Baseline (EnB), Energy Performance Indicators (EnPI), Time-of-Use (ToU) Electricity Tariff Scheduling, Peak Shaving, Waste Heat Recovery.
...
```python
# Algoritma Solusi Terapan untuk Energy Management Systems (ISO 50001) & Optimasi Konsumsi Listrik Lantai Produksi
import numpy as np
...
**Konteks Penerapan**: Studi Kasus: Penjadwalan Ulang Tungku Peleburan Baja Berdasarkan Tarif Listrik Luar Waktu Beban Puncak (LWBP) Hemat Rp 6.8 Miliar/Tahun.
...
1. ISO 50001:2018 Energy Management Systems - Requirements, Applied Energy (2024).
