# 5889 — Facilities Planning & Material Handling: Equivalent Correction Coefficient-based Chemical Enterprise Facility Layout Design and Optimization

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Equivalent Correction Coefficient-based Chemical Enterprise Facility Layout Design and Optimization  
**Jurnal & Sitasi Utama:** Shien Zhang (2018). *Chemical engineering transactions*. DOI: [10.3303/cet1866243](10.3303/cet1866243)  
**Sitasi Pendukung:** Shengyu Liu, Sipke Hoekstra, Sebastian Thiede (2025). *Procedia CIRP*. DOI: [10.1016/j.procir.2024.12.119](10.1016/j.procir.2024.12.119)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shien Zhang (2018) dalam jurnal *Chemical engineering transactions* (DOI: 10.3303/cet1866243) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The paper analyzes the chemical enterprise facility layout design and optimization in chemical industry based on equivalent correction coefficient. Emissions from the chemical industry have strong chemical composition, and they are easily to destroy the natural environment. Therefore, under the condition of environmental protection, the improvement of the natural environment can be achieved through applying the equivalent correction coefficient. Reasonable facilities layout can effectively optimize the process of chemical emissions."

Penelitian pendukung oleh Shengyu Liu, Sipke Hoekstra, Sebastian Thiede (2025) yang dipublikasikan dalam *Procedia CIRP* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
