# 3603 — Applied Statistics & Stochastic Modeling: Queueing network models for the analysis and optimisation of material handling systems: a systematic literature review

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Queueing network models for the analysis and optimisation of material handling systems: a systematic literature review  
**Jurnal & Sitasi Utama:** Mohamed Amjath, Laoucine Kerbache, Adel Elomri (2023). *Flexible Services and Manufacturing Journal*. DOI: [10.1007/s10696-023-09505-x](10.1007/s10696-023-09505-x)  
**Sitasi Pendukung:** Andrea Marin, Michela Meo, Matteo Sereno (2024). *ACM Transactions on Modeling and Performance Evaluation of Computing Systems*. DOI: [10.1145/3649307](10.1145/3649307)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Mohamed Amjath, Laoucine Kerbache, Adel Elomri (2023) dalam jurnal *Flexible Services and Manufacturing Journal* (DOI: 10.1007/s10696-023-09505-x) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
