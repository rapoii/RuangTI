# 3501 — Facilities Planning & Material Handling: Research on Supermarket Layout Optimization based on SLP and AHP-FCE

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Research on Supermarket Layout Optimization based on SLP and AHP-FCE  
**Jurnal & Sitasi Utama:** Shichang Ren (2024). *Academic Journal of Science and Technology*. DOI: [10.54097/hkmf1f16](10.54097/hkmf1f16)  
**Sitasi Pendukung:** Israel D. Herrera-Granda, MME Alemany, D. Peluffo-Ordóñez (2026). *Cogent Engineering*. DOI: [10.1080/23311916.2026.2634432](10.1080/23311916.2026.2634432)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Shichang Ren (2024) dalam jurnal *Academic Journal of Science and Technology* (DOI: 10.54097/hkmf1f16) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "The layout of a supermarket directly impacts customers' shopping experiences and operational efficiency. A well-designed layout facilitates smooth shopping experiences for customers while enhancing the operational efficiency and profitability of the supermarket. With the impact of e-commerce on traditional retail, redesigning supermarket layouts holds significant importance. This paper takes the layout planning of M Supermarket as a case study. It begins with on-site inspections and the creation of a floor plan. Subsequently, random surveys are conducted with customers who have completed their shopping. Instead of traditional SLP using the flow of goods, customer foot traffic is considered to refine non-logistical factors, resulting in relative position maps and feasible supermarket layout proposals. Finally, the effectiveness of both old and new layout schemes is evaluated using the AHP-fuzzy comprehensive evaluation method."

Penelitian pendukung oleh Israel D. Herrera-Granda, MME Alemany, D. Peluffo-Ordóñez (2026) yang dipublikasikan dalam *Cogent Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
