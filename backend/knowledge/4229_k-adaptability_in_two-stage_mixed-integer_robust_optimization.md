# 4229 — Operations Research & Large-Scale Optimization: K-adaptability in two-stage mixed-integer robust optimization

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** K-adaptability in two-stage mixed-integer robust optimization  
**Jurnal & Sitasi Utama:** Anirudh Subramanyam, Chrysanthos E. Gounaris, Wolfram Wiesemann (2019). *Mathematical Programming Computation*. DOI: [10.1007/s12532-019-00174-2](10.1007/s12532-019-00174-2)  
**Sitasi Pendukung:** Radhakrishna Tumbalam Gooty, Rakesh Agrawal, Mohit Tawarmalani (2019). *Computers & Chemical Engineering*. DOI: [10.1016/j.compchemeng.2019.02.013](10.1016/j.compchemeng.2019.02.013)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Anirudh Subramanyam, Chrysanthos E. Gounaris, Wolfram Wiesemann (2019) dalam jurnal *Mathematical Programming Computation* (DOI: 10.1007/s12532-019-00174-2) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
Penelitian pendukung oleh Radhakrishna Tumbalam Gooty, Rakesh Agrawal, Mohit Tawarmalani (2019) yang dipublikasikan dalam *Computers & Chemical Engineering* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
