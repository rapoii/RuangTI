# 5024 — Applied Statistics & Stochastic Modeling: Enhancement of soil physico-chemical properties post compost application: Optimization using Response Surface Methodology comprehending Central Composite Design

**Domain:** Applied Statistics & Stochastic Modeling  
**Topik Spesifik:** Enhancement of soil physico-chemical properties post compost application: Optimization using Response Surface Methodology comprehending Central Composite Design  
**Jurnal & Sitasi Utama:** Payal Mazumder, Akhil PM, Jyoti (2021). *Journal of Environmental Management*. DOI: [10.1016/j.jenvman.2021.112461](10.1016/j.jenvman.2021.112461)  
**Sitasi Pendukung:** Pradeep Kumar, Tessy Vincent, Ashok Khanna (2022). *Materials Today: Proceedings*. DOI: [10.1016/j.matpr.2021.12.377](10.1016/j.matpr.2021.12.377)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Applied Statistics & Stochastic Modeling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Payal Mazumder, Akhil PM, Jyoti (2021) dalam jurnal *Journal of Environmental Management* (DOI: 10.1016/j.jenvman.2021.112461) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
