# 5321 — Industrial Artificial Intelligence & Data Analytics: Automated Defect Detection in Cigarette Manufacturing Using Improved YOLOv8 Model

**Domain:** Industrial Artificial Intelligence & Data Analytics  
**Topik Spesifik:** Automated Defect Detection in Cigarette Manufacturing Using Improved YOLOv8 Model  
**Jurnal & Sitasi Utama:** Chunliang Gu, Xinying Yu, Zhenzhen Huang (2024). *2024 International Conference on Image Processing, Computer Vision and Machine Learning (ICICML)*. DOI: [10.1109/icicml63543.2024.10957949](10.1109/icicml63543.2024.10957949)  
**Sitasi Pendukung:** P. L. Chithra, P. Bhavani (2023). *Machine Intelligence*. DOI: [10.1201/9781003424550-12](10.1201/9781003424550-12)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Industrial Artificial Intelligence & Data Analytics memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Chunliang Gu, Xinying Yu, Zhenzhen Huang (2024) dalam jurnal *2024 International Conference on Image Processing, Computer Vision and Machine Learning (ICICML)* (DOI: 10.1109/icicml63543.2024.10957949) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
