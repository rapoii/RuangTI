# 3000 — Operations Research & Large-Scale Optimization: A Robust Mixed-Integer Linear Programming Model for Sustainable Collaborative Distribution

**Domain:** Operations Research & Large-Scale Optimization  
**Topik Spesifik:** A Robust Mixed-Integer Linear Programming Model for Sustainable Collaborative Distribution  
**Jurnal & Sitasi Utama:** Islem Snoussi, Nadia Hamani, Nassim Mrabti (2021). *Mathematics*. DOI: [10.3390/math9182318](10.3390/math9182318)  
**Sitasi Pendukung:** Hipólito Hernández–Pérez, Juan‐José Salazar‐González (2021). *European Journal of Operational Research*. DOI: [10.1016/j.ejor.2021.05.040](10.1016/j.ejor.2021.05.040)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Operations Research & Large-Scale Optimization memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Islem Snoussi, Nadia Hamani, Nassim Mrabti (2021) dalam jurnal *Mathematics* (DOI: 10.3390/math9182318) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
