# 3480 — Facilities Planning & Material Handling: Facility Layout Design Tools Comparison: A Case Study of a SME in Electronic Industry

**Domain:** Facilities Planning & Material Handling  
**Topik Spesifik:** Facility Layout Design Tools Comparison: A Case Study of a SME in Electronic Industry  
**Jurnal & Sitasi Utama:** Marlene Brás, Ana Moura (2021). *Peer-Reviewed Academic Journal*. DOI: [10.46254/eu04.20210425](10.46254/eu04.20210425)  
**Sitasi Pendukung:** Rui Li, Yali Chen, Jinzhao Song (2023). *Sustainability*. DOI: [10.3390/su151612275](10.3390/su151612275)  

---

## 1. Pendahuluan dan Konteks Industri

Dalam lanskap operasional modern, disiplin Facilities Planning & Material Handling memegang peranan krusial dalam merancang, mengintegrasikan, dan memperbaiki efisiensi sistem produksi terintegrasi. Dinamika persaingan global menuntut integrasi antara alokasi sumber daya manusia, material, informasi, dan permesinan guna mencapai biaya operasional yang minimal serta keandalan output yang optimal. Artikel penelitian rujukan dari Marlene Brás, Ana Moura (2021) dalam jurnal *Peer-Reviewed Academic Journal* (DOI: 10.46254/eu04.20210425) menyajikan pendekatan sistematis terhadap pemecahan masalah operasional berskala industri.
...
> "Designing and/or redesigning a proper layout of a small production line is not an easy task for a company. Usually, this is performed using empirical methodologies and according to space availability. Mainly due to the latter, the layouts are not very efficient and optimized. This case study portrays a Small and Medium-sized Enterprise (SME) in the electronics industry, which, taking advantage of the need to introduce a new product in the production, intends to redesign the layout of a production line, whose efficiency has been decreasing. To this end, three methods were applied - Empirical Model, Systematic Layout Planning, and Lean Facility Layout System. The results prove that the Lean Layout Facility System method achieved better results by reducing both lead time and the worker's movement time and distance."

Penelitian pendukung oleh Rui Li, Yali Chen, Jinzhao Song (2023) yang dipublikasikan dalam *Sustainability* menggarisbawahi bahwa integrasi model analitis kuantitatif ke dalam lingkungan manufaktur dan logistik secara empiris memitigasi risiko kegagalan proses. Implementasi sistem ini mengharuskan arsitektur data industri terstruktur yang menghubungkan sistem *Enterprise Resource Planning* (ERP), *Manufacturing Execution Systems* (MES), dan sensor lantai pabrik secara deterministik dan terukur.
