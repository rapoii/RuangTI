...
IE_THESAURUS = {
    ...
    "graph neural networks": ["gnn", "gcn", "gat", "ketahanan rantai pasok", "supply chain resilience", "efek domino disrupsi"],
    ...
    "spc multivariat": ["manova", "hotelling t2", "mewma", "multivariate statistical process control", "poros engkol"],
    ...
    "heijunka": ["production leveling", "heijunka box", "takt time", "pitch interval", "mixed model assembly"],
    ...
    # --- Systems Modeling, Complexity, Smart Manufacturing & Industry 4.0 (Modul 376-400) ---
    "system dynamics": ["dinamika sistem", "causal loop diagram", "cld", "stock and flow", "feedback loop", "reinforcing", "balancing", "sterman"],
    ...
    "agent based modeling": ["abm", "multi-agent simulation", "helbing social force", "evakuasi darurat", "perilaku konsumen"],
    ...
    "mcgdm": ["multi-criteria group decision making", "delphi consensus", "fuzzy ahp", "triangular fuzzy numbers", "pemilihan lokasi pabrik"],
    "robust decision making": ["rdm", "deep uncertainty", "xlrm framework", "scenario discovery prim", "minimax regret"],
    "digital twins": ["cyber-physical systems", "cps", "arsitektur 5c", "bidirectional synchronization", "physics informed neural networks", "pinn"],
    "game theory rantai pasok": ["nash equilibrium", "stackelberg leader follower", "double marginalization", "revenue sharing contract"],
    "shapley value": ["cooperative game theory", "alokasi biaya logistik bersama", "fair allocation", "koalisi vendor"],
    "markov decision process": ["mdp", "penggantian mesin", "value iteration", "policy iteration", "degradasi stokastik"],
    "fms": ["flexible manufacturing systems", "agv routing", "petri nets deadlock prevention", "routing flexibility"],
    "cellular manufacturing": ["group technology", "rank order clustering", "roc algorithm", "machine part incidence matrix", "grouping efficiency"],
    "asrs": ["automated storage and retrieval systems", "wms", "single command cycle time", "dual command", "aisle crane", "slotting abc"],
    "cobot": ["kolaborasi robotik manusia", "iso/ts 15066", "speed and separation monitoring", "ssm", "power and force limiting", "pfl"],
