      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[11px] text-text-secondary leading-none -mt-0.5">
              Engineering AI
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          {profile.isLoggedIn ? (
            <Link
              href="/chat"
              className="px-4 py-2 rounded-xl bg-accent text-slate-950 font-bold text-xs hover:brightness-110 shadow-sm shadow-accent/20 transition-all flex items-center gap-1.5 active:scale-[0.97]"
            >
