...
2. **Kolom Tengah (Area Konten Utama)**: Artikel teknis komprehensif (14 panduan resmi + 684 modul RAG), rendering semantik tebal/code untuk token UI, dan transisi pergantian halaman yang gesit.
